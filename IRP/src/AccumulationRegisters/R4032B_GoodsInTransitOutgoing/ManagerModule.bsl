...
Function GetLockFields(Data) Export
	...
	Result.Insert("RegisterName", "AccumulationRegister.R4032B_GoodsInTransitOutgoing");
...
Function GetExistsRecords(Ref, RecordType = Undefined, AddInfo = Undefined) Export
	Return PostingServer.GetExistsRecordsFromAccRegister(Ref, "AccumulationRegister.R4032B_GoodsInTransitOutgoing", RecordType, AddInfo);
EndFunction
