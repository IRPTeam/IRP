...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	...
	If NeedCreateFormFields(Parameters) Then
		...
		ArrayOfFormElements = AddAttributesAndPropertiesServer.CreateFormItemFields(ThisObject, "GroupFilter",
...
Function NeedCreateFormFields(Parameters)
	Return Parameters.ChoiceMode And Parameters.Filter.Property("Item") And ValueIsFilled(Parameters.Filter.Item)
...
Procedure UpdateListWithFilter()
	...
	If ValueIsFilled(SearchString) Then
		ArrayOfItemKeysBySearchString = Catalogs.ItemKeys.GetRefsBySearchString(ThisObject.Item,
