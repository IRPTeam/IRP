...
Procedure CalculationsNewAmountBalanceOnChange(Object, Form, Item, CurrentData = Undefined) Export
	ViewClient_V2.CalculationsNewAmountBalanceOnChange(Object, Form, "Calculations", CurrentData);
EndProcedure

Procedure CalculationsAmountOnChange(Object, Form, Item, CurrentData = Undefined) Export
	ViewClient_V2.CalculationsAmountOnChange(Object, Form, "Calculations", CurrentData);
EndProcedure
