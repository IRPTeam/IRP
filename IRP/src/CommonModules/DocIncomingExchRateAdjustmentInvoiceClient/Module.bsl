...
Procedure PartnerStartChoice(Object, Form, Item, ChoiceData, StandardProcessing) Export
	...
	OpenSettings.FormParameters.Insert("DocumentFilter", New Structure("Vendor, Customer", True, True));
...
Procedure AgreementStartChoice(Object, Form, Item, ChoiceData, StandardProcessing) Export
	...
	ArrayOfAgreementTypes.Add(PredefinedValue("Enum.AgreementTypes.Customer"));
...
Procedure AgreementTextChange(Object, Form, Item, Text, StandardProcessing) Export
	ArrayOfFilters = New Array();
	ArrayOfFilters.Add(DocumentsClientServer.CreateFilterItem("DeletionMark", True, ComparisonType.NotEqual));
	ArrayOfFilters.Add(DocumentsClientServer.CreateFilterItem("Type", PredefinedValue("Enum.AgreementTypes.Vendor"),ComparisonType.Equal));
