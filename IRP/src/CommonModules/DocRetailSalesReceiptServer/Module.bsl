...
Function GetInfoShipmentConfirmationBeforeRetailSalesReceipt(Parameters) Export
	Query = New Query();
	Query.Text =
"SELECT ALLOWED
...
|	ShipmentConfirmation";
	...
	Return GetInfoShipmentConfirmationBeforeRetailSalesReceiptFromQueryResult(QueryResult);
EndFunction

Function GetInfoShipmentConfirmationBeforeRetailSalesReceiptFromQueryResult(QueryResult) Export
