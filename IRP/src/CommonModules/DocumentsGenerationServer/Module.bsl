...
Function GetDocumentTable_SalesOrder_CustomerAdvance(ArrayOfBasisDocuments, PaymentType) Export
	Query = New Query();
	Query.Text = 
	"SELECT
	|	""SalesOrder"" AS BasedOn,
	...
	|	AND PaymentType = &PaymentType) AS R3026B_SalesOrdersCustomerAdvance
	|WHERE
