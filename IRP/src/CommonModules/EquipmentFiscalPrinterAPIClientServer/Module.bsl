...
// OperationFN - Operation with the fiscal drive. 
// After the operation, a report on the conduct of the corresponding operation is printed.
//
// Returns:
...
// * InOut - Structure -
// * Out - Structure:
Function GetOperationFNSettings() Export
    Str = New Structure;
...
Function GetOpenShiftSettings() Export
    Str = New Structure;
...
// * Out - Structure:
// ** OutputParameters - See OutputParameters
Function GetCloseShiftSettings() Export
    Str = New Structure;
...
Function GetProcessCheckSettings() Export
    Str = New Structure;
...
// * Out - Structure:
// ** DocumentOutputParameters - See DocumentOutputParameters
Function GetProcessCorrectionCheckSettings() Export
    Str = New Structure;
...
// * InOut - Structure -
// * Out - Structure -
Function GetPrintTextDocumentSettings() Export
    Str = New Structure;
...
// ** Error - String - Error, if result false
// ** Success - Boolean - Operation status
// ** Document - DocumentRef.CashReceipt, DocumentRef.CashPayment, DocumentRef.CashExpense, DocumentRef.MoneyTransfer - Basis
// * In - Structure:
// ** DeviceID - String - Device ID
// ** InputParameters - See InputParameters
...
// * InOut - Structure -
// * Out - Structure:
Function GetCashInOutcomeSettings() Export
    Str = New Structure;
...
// * InOut - Structure -
// * Out - Structure:
Function GetPrintXReportSettings() Export
    Str = New Structure;
...
Function GetReportCurrentStatusOfSettlementsSettings() Export
    Str = New Structure;
...
// * InOut - Structure -
// * Out - Structure:
Function GetOpenCashDrawerSettings() Export
    Str = New Structure;
...
// * InOut - Structure -
// * Out - Structure:
Function GetOpenSessionRegistrationKMSettings() Export
    Str = New Structure;
...
// * InOut - Structure -
// * Out - Structure:
Function GetCloseSessionRegistrationKMSettings() Export
    Str = New Structure;
...
Function GetRequestKMSettings() Export
    Str = New Structure;
...
// * InOut - Structure -
// * Out - Structure:
Function GetConfirmKMSettings() Export
    Str = New Structure;
