Procedure OnCreateAtServer(Form, Cancel, StandardProcessing) Export
	...
	NewItem = Form.Items.Add("CreateFromClassifier", Type("FormButton"), Form.CommandBar);
...
Function GetBinaryDataFromTemplate(ClassifierElement) Export
	...
	If Not ClassifierElement.Property("TemplateName", TemplateName) Or Not ClassifierElement.Property("TemplatePath",
		TemplatePath) Then
		Return Undefined;
	EndIf;
