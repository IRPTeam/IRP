Procedure BasisDocumentStartChoice(Object, Form, Item, CurrentData, Parameters) Export
	...
	FilterStructure = CreateFilterByParameters(Parameters.Ref, TransferParameters, Parameters.TableName,
		OpeningEntryTableName1, OpeningEntryTableName2, DebitNoteTableName, CreditNoteTableName);
...
Function CreateFilterByParameters(Ref, Parameters, TableName, OpeningEntryTableName1 = Undefined,
	OpeningEntryTableName2 = Undefined, DebitNoteTableName = Undefined, CreditNoteTableName)
	...
	If Parameters.Property("Agreement_ApArPostingDetail") Then
		...
		ArrayOfConditionsOpeningEntry.Add(
			" AND OpeningEntry.Agreement.ApArPostingDetail = &Agreement_ApArPostingDetail");
