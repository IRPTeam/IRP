...
Strings.Insert("SalesReturn_DR_R5021T_Revenues_CR_R1040B_TaxesOutgoing",
	NStr("en='SalesReturn DR (R5021T_Revenues) CR (R1040B_TaxesOutgoing)';
		|ru='SalesReturn DR (R5021T_Revenues) CR (R1040B_TaxesOutgoing)';
		|tr='SalesReturn DR (R5021T_Revenues) CR (R1040B_TaxesOutgoing)'", Lang));
...
Strings.Insert("PurchaseReturn_DR_R2040B_TaxesIncoming_CR_R1021B_VendorsTransactions",
	NStr("en='PurchaseReturn DR (R2040B_TaxesIncoming) CR (R1021B_VendorsTransactions)';
		|ru='PurchaseReturn DR (R2040B_TaxesIncoming) CR (R1021B_VendorsTransactions)';
		|tr='PurchaseReturn DR (R2040B_TaxesIncoming) CR (R1021B_VendorsTransactions)'", Lang));
