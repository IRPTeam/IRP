Function Strings(Lang) Export
	...
	#Region Statuses
	Strings.Insert("Status_Closed"    , NStr("en = 'Closed'", Lang));
	Strings.Insert("Status_Awaiting"  , NStr("en = 'Awaiting'", Lang));
	Strings.Insert("Status_Invoicing" , NStr("en = 'Invoicing'", Lang));
	#EndRegion
