...
#Region ErrorMessages
	...
	Strings.Insert("Error_118", NStr("en='Cannot set deletion makr, document is closed by [ %1 ]';
		|ru='Отказ пометки на удаление, документ закрыт документом [%1]';
		|tr='Silmek için işaretlenemedi, evrak [%1] tarafından kapanmıştı'", Lang) + Chars.LF);
...
#Region Defaults
	...
	Strings.Insert("Default_003", NStr("en='Vendor stabdard term';
