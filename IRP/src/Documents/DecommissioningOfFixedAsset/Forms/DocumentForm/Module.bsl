...
Procedure OnReadAtServer(CurrentObject)
	DocDecommissioningOfFixedAssetServer.OnReadAtServer(Object, ThisObject, CurrentObject);
	SetVisibilityAvailability(CurrentObject, ThisObject);
EndProcedure

&AtServer
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	DocDecommissioningOfFixedAssetServer.OnCreateAtServer(Object, ThisObject, Cancel, StandardProcessing);
...
Procedure AfterWriteAtServer(CurrentObject, WriteParameters)
	DocDecommissioningOfFixedAssetServer.AfterWriteAtServer(Object, ThisObject, CurrentObject, WriteParameters);
	SetVisibilityAvailability(CurrentObject, ThisObject);
EndProcedure

&AtClient
Procedure OnOpen(Cancel)
	DocDecommissioningOfFixedAssetClient.OnOpen(Object, ThisObject, Cancel);
EndProcedure
...
Procedure AfterWrite(WriteParameters)
	DocDecommissioningOfFixedAssetClient.AfterWriteAtClient(Object, ThisObject, WriteParameters);
EndProcedure
...
Procedure DateOnChange(Item)
	DocDecommissioningOfFixedAssetClient.DateOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure CompanyOnChange(Item) Export
	DocDecommissioningOfFixedAssetClient.CompanyOnChange(Object, ThisObject, Item);
EndProcedure

&AtClient
Procedure CompanyStartChoice(Item, ChoiceData, StandardProcessing)
	DocDecommissioningOfFixedAssetClient.CompanyStartChoice(Object, ThisObject, Item, ChoiceData, StandardProcessing);
EndProcedure

&AtClient
Procedure CompanyEditTextChange(Item, Text, StandardProcessing)
	DocDecommissioningOfFixedAssetClient.CompanyEditTextChange(Object, ThisObject, Item, Text, StandardProcessing);
EndProcedure
...
Procedure StoreOnChange(Item)
	DocDecommissioningOfFixedAssetClient.StoreOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListSelection(Item, RowSelected, Field, StandardProcessing)
	DocDecommissioningOfFixedAssetClient.ItemListSelection(Object, ThisObject, Item, RowSelected, Field, StandardProcessing);
EndProcedure

&AtClient
Procedure ItemListBeforeAddRow(Item, Cancel, Clone, Parent, IsFolder, Parameter)
	DocDecommissioningOfFixedAssetClient.ItemListBeforeAddRow(Object, ThisObject, Item, Cancel, Clone, Parent, IsFolder, Parameter);
EndProcedure

&AtClient
Procedure ItemListBeforeDeleteRow(Item, Cancel)
	DocDecommissioningOfFixedAssetClient.ItemListBeforeDeleteRow(Object, ThisObject, Item, Cancel);
EndProcedure

&AtClient
Procedure ItemListAfterDeleteRow(Item)
	DocDecommissioningOfFixedAssetClient.ItemListAfterDeleteRow(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListItemOnChange(Item)
	DocDecommissioningOfFixedAssetClient.ItemListItemOnChange(Object, ThisObject, Item);
EndProcedure

&AtClient
Procedure ItemListItemStartChoice(Item, ChoiceData, StandardProcessing)
	DocDecommissioningOfFixedAssetClient.ItemListItemStartChoice(Object, ThisObject, Item, ChoiceData, StandardProcessing);
EndProcedure

&AtClient
Procedure ItemListItemEditTextChange(Item, Text, StandardProcessing)
	DocDecommissioningOfFixedAssetClient.ItemListItemEditTextChange(Object, ThisObject, Item, Text, StandardProcessing);
EndProcedure
...
Procedure ItemListItemKeyOnChange(Item)
	DocDecommissioningOfFixedAssetClient.ItemListItemKeyOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListUnitOnChange(Item)
	DocDecommissioningOfFixedAssetClient.ItemListUnitOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityOnChange(Item)
	DocDecommissioningOfFixedAssetClient.ItemListQuantityOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityInBaseUnitOnChange(Item)
	DocDecommissioningOfFixedAssetClient.ItemListQuantityInBaseUnitOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityIsFixedOnChange(Item)
	DocDecommissioningOfFixedAssetClient.ItemListQuantityIsFixedOnChange(Object, ThisObject, Item);	
EndProcedure
...
Procedure ItemListStoreOnChange(Item)
	DocDecommissioningOfFixedAssetClient.ItemListStoreOnChange(Object, ThisObject, Item);
EndProcedure
...
Function GetProcessingModule() Export
	Str = New Structure;
	Str.Insert("Client", DocDecommissioningOfFixedAssetClient);
	Str.Insert("Server", DocDecommissioningOfFixedAssetServer);
	Return Str;
EndFunction
...
Procedure EditCurrencies(Command)
	...
	If CurrentData = Undefined Then
		Return;
	EndIf;
	FormParameters = CurrenciesClientServer.GetParameters_V7(Object, CurrentData.Key, 
		CurrenciesServer.GetLandedCostCurrency(Object.Company), CurrentData.Amount);
