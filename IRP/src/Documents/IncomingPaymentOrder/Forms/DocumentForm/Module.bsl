...
Procedure DecorationGroupTitleCollapsedLalelClick(Item)
	DocIncomingPaymentOrderClient.DecorationGroupTitleCollapsedLalelClick(Object, ThisObject, Item);
EndProcedure
...
Procedure DecorationGroupTitleUncollapsedLalelClick(Item)
	DocIncomingPaymentOrderClient.DecorationGroupTitleUncollapsedLalelClick(Object, ThisObject, Item);
EndProcedure
