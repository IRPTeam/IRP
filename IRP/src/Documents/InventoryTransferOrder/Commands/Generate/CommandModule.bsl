...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)	
	...
	New Structure("Basises, Ref", CommandParameter, PredefinedValue("Document.InventoryTransferOrder.EmptyRef")));
...
Procedure AddDocumentRowsContinue(Result, AdditionalParameters) Export
	...
	For Each FillingValues In Result.FillingValues Do
		...
		OpenForm("Document.InventoryTransferOrder.ObjectForm", FormParameters, , New UUID());
	EndDo;
EndProcedure
