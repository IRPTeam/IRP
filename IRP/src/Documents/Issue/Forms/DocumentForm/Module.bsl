...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	DocIssueServer.OnCreateAtServer(Object, ThisObject, Cancel, StandardProcessing);
...
Procedure AfterWriteAtServer(CurrentObject, WriteParameters)
	DocIssueServer.AfterWriteAtServer(Object, ThisObject, CurrentObject, WriteParameters);
	SetVisibilityAvailability(CurrentObject, ThisObject);
EndProcedure
...
Procedure AfterWrite(WriteParameters)
	DocIssueClient.AfterWriteAtClient(Object, ThisObject, WriteParameters);
EndProcedure
...
Procedure DateOnChange(Item)
	DocIssueClient.DateOnChange(Object, ThisObject, Item);
EndProcedure
