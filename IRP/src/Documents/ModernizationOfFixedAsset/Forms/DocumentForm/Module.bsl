...
Procedure OnReadAtServer(CurrentObject)
	DocModernizationOfFixedAssetServer.OnReadAtServer(Object, ThisObject, CurrentObject);
	SetVisibilityAvailability(CurrentObject, ThisObject);
EndProcedure

&AtServer
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	DocModernizationOfFixedAssetServer.OnCreateAtServer(Object, ThisObject, Cancel, StandardProcessing);
...
Procedure AfterWriteAtServer(CurrentObject, WriteParameters)
	DocModernizationOfFixedAssetServer.AfterWriteAtServer(Object, ThisObject, CurrentObject, WriteParameters);
	SetVisibilityAvailability(CurrentObject, ThisObject);
EndProcedure

&AtClient
Procedure OnOpen(Cancel)
	DocModernizationOfFixedAssetClient.OnOpen(Object, ThisObject, Cancel);
EndProcedure
...
Procedure AfterWrite(WriteParameters)
	DocModernizationOfFixedAssetClient.AfterWriteAtClient(Object, ThisObject, WriteParameters);
EndProcedure
...
Procedure DateOnChange(Item)
	DocModernizationOfFixedAssetClient.DateOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure CompanyOnChange(Item) Export
	DocModernizationOfFixedAssetClient.CompanyOnChange(Object, ThisObject, Item);
EndProcedure

&AtClient
Procedure CompanyStartChoice(Item, ChoiceData, StandardProcessing)
	DocModernizationOfFixedAssetClient.CompanyStartChoice(Object, ThisObject, Item, ChoiceData, StandardProcessing);
EndProcedure

&AtClient
Procedure CompanyEditTextChange(Item, Text, StandardProcessing)
	DocModernizationOfFixedAssetClient.CompanyEditTextChange(Object, ThisObject, Item, Text, StandardProcessing);
EndProcedure
...
Procedure StoreOnChange(Item)
	DocModernizationOfFixedAssetClient.StoreOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListSelection(Item, RowSelected, Field, StandardProcessing)
	DocModernizationOfFixedAssetClient.ItemListSelection(Object, ThisObject, Item, RowSelected, Field, StandardProcessing);
EndProcedure

&AtClient
Procedure ItemListBeforeAddRow(Item, Cancel, Clone, Parent, IsFolder, Parameter)
	DocModernizationOfFixedAssetClient.ItemListBeforeAddRow(Object, ThisObject, Item, Cancel, Clone, Parent, IsFolder, Parameter);
EndProcedure

&AtClient
Procedure ItemListBeforeDeleteRow(Item, Cancel)
	DocModernizationOfFixedAssetClient.ItemListBeforeDeleteRow(Object, ThisObject, Item, Cancel);
EndProcedure

&AtClient
Procedure ItemListAfterDeleteRow(Item)
	DocModernizationOfFixedAssetClient.ItemListAfterDeleteRow(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListItemOnChange(Item)
	DocModernizationOfFixedAssetClient.ItemListItemOnChange(Object, ThisObject, Item);
EndProcedure

&AtClient
Procedure ItemListItemStartChoice(Item, ChoiceData, StandardProcessing)
	DocModernizationOfFixedAssetClient.ItemListItemStartChoice(Object, ThisObject, Item, ChoiceData, StandardProcessing);
EndProcedure

&AtClient
Procedure ItemListItemEditTextChange(Item, Text, StandardProcessing)
	DocModernizationOfFixedAssetClient.ItemListItemEditTextChange(Object, ThisObject, Item, Text, StandardProcessing);
EndProcedure
...
Procedure ItemListItemKeyOnChange(Item)
	DocModernizationOfFixedAssetClient.ItemListItemKeyOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListUnitOnChange(Item)
	DocModernizationOfFixedAssetClient.ItemListUnitOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityOnChange(Item)
	DocModernizationOfFixedAssetClient.ItemListQuantityOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityInBaseUnitOnChange(Item)
	DocModernizationOfFixedAssetClient.ItemListQuantityInBaseUnitOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityIsFixedOnChange(Item)
	DocModernizationOfFixedAssetClient.ItemListQuantityIsFixedOnChange(Object, ThisObject, Item);	
EndProcedure
...
Procedure ItemListStoreOnChange(Item)
	DocModernizationOfFixedAssetClient.ItemListStoreOnChange(Object, ThisObject, Item);
EndProcedure
...
Function GetProcessingModule() Export
	Str = New Structure;
	Str.Insert("Client", DocModernizationOfFixedAssetClient);
	Str.Insert("Server", DocModernizationOfFixedAssetServer);
	Return Str;
EndFunction
