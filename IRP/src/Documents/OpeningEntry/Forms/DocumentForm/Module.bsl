...
Procedure DecorationGroupTitleCollapsedLalelClick(Item)
	DocOpeningEntryClient.DecorationGroupTitleCollapsedLalelClick(Object, ThisObject, Item);
EndProcedure
...
Procedure DecorationGroupTitleUncollapsedLalelClick(Item)
	DocOpeningEntryClient.DecorationGroupTitleUncollapsedLalelClick(Object, ThisObject, Item);
EndProcedure
