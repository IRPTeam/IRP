...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)	
	...
	New Structure("Basises, Ref", CommandParameter, PredefinedValue("Document.PlannedReceiptReservation.EmptyRef")));
...
Procedure AddDocumentRowsContinue(Result, AdditionalParameters) Export
	...
	For Each FillingValues In Result.FillingValues Do
		...
		OpenForm("Document.PlannedReceiptReservation.ObjectForm", FormParameters, , New UUID());
	EndDo;
EndProcedure
