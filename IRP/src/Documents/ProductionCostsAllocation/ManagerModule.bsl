...
Function PostingGetDocumentDataTables(Ref, Cancel, PostingMode, Parameters, AddInfo = Undefined) Export
	...
	While QuerySelection.Next() Do
		AllocationInfo = GetAllocationInfo(QuerySelection.BusinessUnit, QuerySelection.ItemKey, QuerySelection.Duration,
			QuerySelection.Amount, Company, BeginDate, EndDate);
