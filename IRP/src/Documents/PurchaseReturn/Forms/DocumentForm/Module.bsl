...
Procedure ItemListBeforeAddRow(Item, Cancel, Clone, Parent, IsFolder, Parameter)
	DocPurchaseReturnClient.ItemListBeforeAddRow(Object, ThisObject, Item, Cancel, Clone, Parent, IsFolder, Parameter);	
EndProcedure
...
Procedure ItemListQuantityInBaseUnitOnChange(Item)
	DocPurchaseReturnClient.ItemListQuantityInBaseUnitOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityIsFixedOnChange(Item)
	DocPurchaseReturnClient.ItemListQuantityIsFixedOnChange(Object, ThisObject, Item);	
EndProcedure
...
Procedure ItemListVatRateOnChange(Item) Export
	DocPurchaseReturnClient.ItemListVatRateOnChange(Object, ThisObject, Item);
EndProcedure
