...
Procedure InputTypeOnChange(Item)
	DocPurchaseReturnClient.InputTypeOnChange(Object, ThisObject, Item);
EndProcedure
...
&AtClient
Procedure SelectPurchaseReturnOrders(Command)
	...
	OpenForm("Document.PurchaseReturn.Form.SelectPurchaseReturnOrdersForm"
		, FormParameters, , , ,
		, New NotifyDescription("SelectPurchaseReturnOrdersContinue", ThisObject));
EndProcedure

&AtClient
Procedure SelectPurchaseReturnOrdersContinue(Result, AdditionalParameters) Export
	If Result = Undefined Then
		Return;
	EndIf;
	
	SelectPurchaseReturnOrdersContinueAtServer(Result, AdditionalParameters);
	
	DocPurchaseReturnClient.ItemListOnChange(Object, ThisObject, Items.ItemList);
EndProcedure

&AtServer
Procedure SelectPurchaseReturnOrdersContinueAtServer(Result, AdditionalParameters)
