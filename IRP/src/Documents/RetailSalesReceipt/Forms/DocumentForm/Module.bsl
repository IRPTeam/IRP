...
Procedure SearchByBarcode(Command)
	DocRetailSalesReceiptClient.SearchByBarcode(Command, Object, ThisObject);
EndProcedure
...
Procedure SelectShipmentConfirmation(Command)
	...
	InfoShipmentConfirmation = DocRetailSalesReceiptServer.GetInfoShipmentConfirmationBeforeRetailSalesReceipt(CommandParameters);
...
Procedure SelectShipmentConfirmationsContinue(Result, AdditionalParameters) Export
	...
	DocRetailSalesReceiptClient.ItemListOnChange(Object, ThisObject, Items.ItemList);
EndProcedure

&AtServer
Procedure SelectShipmentConfirmationsFinish(ArrayOfBasisDocuments)
	DocRetailSalesReceiptServer.FillDocumentWithShipmentConfirmationArray(Object, ThisObject, ArrayOfBasisDocuments);
EndProcedure
