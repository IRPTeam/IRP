...
//
// Parameters:
//	CommandParameter - Array of DocumentRef.ShipmentPlaningOrder - contains a reference to the object for which the print command was executed.
...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)
	...
	For Each ItRef In CommandParameter Do
		...
		Param.NameTemplate = "ShipmentPlaningOrderPrint";
...
Function ShipmentConfirmationPrintServer(Ref, Param)
	Spreadsheet = Documents.ShipmentPlaningOrder.Print(Ref, Param);
	Return Spreadsheet;
EndFunction
