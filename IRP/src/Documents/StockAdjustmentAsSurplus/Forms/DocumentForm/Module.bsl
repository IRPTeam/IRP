...
Procedure ItemListItemOnChange(Item)
	DocStockAdjustmentAsSurplusClient.ItemListItemOnChange(Object, ThisObject);
EndProcedure
...
Procedure ItemListItemKeyOnChange(Item)
	DocStockAdjustmentAsSurplusClient.ItemListItemKeyOnChange(Object, ThisObject);
EndProcedure
...
Procedure ItemListQuantityOnChange(Item)
	DocStockAdjustmentAsSurplusClient.ItemListQuantityOnChange(Object, ThisObject);
EndProcedure
...
Procedure ItemListQuantityInBaseUnitOnChange(Item)
	DocStockAdjustmentAsSurplusClient.ItemListQuantityInBaseUnitOnChange(Object, ThisObject, Item);
EndProcedure
...
Procedure ItemListQuantityIsFixedOnChange(Item)
	DocStockAdjustmentAsSurplusClient.ItemListQuantityIsFixedOnChange(Object, ThisObject, Item);	
EndProcedure
...
Procedure ItemListUnitOnChange(Item)
	DocStockAdjustmentAsSurplusClient.ItemListUnitOnChange(Object, ThisObject);
EndProcedure
