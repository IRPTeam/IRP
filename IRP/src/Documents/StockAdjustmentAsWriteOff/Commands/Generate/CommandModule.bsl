...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)	
	...
	New Structure("Basises, Ref", CommandParameter, PredefinedValue("Document.StockAdjustmentAsWriteOff.EmptyRef")));
...
Procedure AddDocumentRowsContinue(Result, AdditionalParameters) Export
	...
	For Each FillingValues In Result.FillingValues Do
		...
		OpenForm("Document.StockAdjustmentAsWriteOff.ObjectForm", FormParameters, , New UUID());
	EndDo;
EndProcedure
