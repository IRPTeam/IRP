...
Procedure OnCreateAtServer(Cancel, StandardProcessing)
	DocStockCorrectionServer.OnCreateAtServerListForm(ThisObject, Cancel, StandardProcessing);
EndProcedure
...
Procedure InternalCommandAction(Command) Export
	DocStockCorrectionClient.RunCommandAction(Command, ThisObject, List, Items.List.SelectedRows);
EndProcedure
