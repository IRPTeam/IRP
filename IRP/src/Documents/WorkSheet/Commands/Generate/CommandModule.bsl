...
Procedure CommandProcessing(CommandParameter, CommandExecuteParameters)
	...
	FormParameters.Insert("Filter", New Structure("Basises, Ref", CommandParameter, PredefinedValue("Document.WorkSheet.EmptyRef")));
...
Procedure AddDocumentRowsContinue(Result, AdditionalParameters) Export
	...
	For Each FillingValues In Result.FillingValues Do
		...
		OpenForm("Document.WorkSheet.ObjectForm", FormParameters, , New UUID());
	EndDo;
EndProcedure