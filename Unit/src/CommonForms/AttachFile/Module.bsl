...
Procedure IRPTE_OnCreateAtServerAfter(Cancel, StandardProcessing)
    ...
    Элемент = ЭтотОбъект.Элементы.Добавить("saveFile", Тип("ПолеФормы"), ЭтотОбъект);
    ...
    //Добавляем новое поле ввода на форму
    Элемент = ЭтотОбъект.Элементы.Добавить("dragFile", Тип("ПолеФормы"), ЭтотОбъект);
    Элемент.Вид = ВидПоляФормы.ПолеВвода;
...
Procedure IRPTE_CreateBtn(Name)
	...
	Btn = ЭтотОбъект.Команды.Добавить(Name);
	Btn.Действие = Name;
	Btn.Заголовок = Name;
	
	//Добавляем новую кнопку
	Itm = ЭтотОбъект.Элементы.Добавить(Name, Тип("КнопкаФормы"), ЭтотОбъект);
