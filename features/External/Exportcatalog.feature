...
Scenario: Create catalog Users and AccessProfiles objects (LimitedAccess)
	...
	And I check or create catalog "AccessProfiles" objects:
		...
		| 'e1cib/data/Catalog.AccessProfiles?ref=b7a0d8de1a1c04c611ee1a4d84e42191' | 'False'        | 1      | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | 'Unit profile'                       | ''                 | ''               | ''               | ''             | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | '10.01.2024 20:45:01' | '11.01.2024 13:11:43' | 'True'          |
		| 'e1cib/data/Catalog.AccessProfiles?ref=b7b4b80c227e00a211eeb0635de1ba67' | 'False'        | 2      | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | 'AccumulationRegisters R2001T Sales' | ''                 | ''               | ''               | ''             | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | '11.01.2024 11:27:42' | '11.01.2024 13:22:21' | 'True'          |
...
Scenario: Create catalog AccessGroups objects (LimitedAccessRegisters)
	...
	And I check or create catalog "AccessGroups" objects:
		...
		| 'e1cib/data/Catalog.AccessGroups?ref=b7b4b80c227e00a211eeb0635de1ba68' | 'False'        | 2      | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | 'AccumulationRegisters R2001T Sales'               | ''                 | ''               | ''               | ''             | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | '11.01.2024 12:07:09' | '11.01.2024 12:15:39' |
		| 'e1cib/data/Catalog.AccessGroups?ref=b7b4b80c227e00a211eeb070971c2f4d' | 'False'        | 3      | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | 'AccumulationRegisters R2001T Sales - Access Deny' | ''                 | ''               | ''               | ''             | 'e1cib/data/Catalog.Users?ref=aa7f120ed92fbced11eb13d7279770c0' | '11.01.2024 13:00:16' | '11.01.2024 13:00:25' |
