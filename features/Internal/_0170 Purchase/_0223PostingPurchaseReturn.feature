...
Scenario: _022304 copy PR and check filling in Row Id info table
	...
	* Check copy info
		...
		And "ItemList" table became equal
			| '#' | 'Business unit' | 'Item'     | 'Item key'  | 'Dont calculate row' | 'Serial lot numbers' | 'Q'       | 'Unit' | 'Tax amount' | 'Price'  | 'VAT' | 'Offers amount' | 'Total amount' | 'Use shipment confirmation' | 'Additional analytic' | 'Store'    | 'Revenue type' | 'Return reason' | 'Net amount' | 'Purchase invoice' | 'Purchase return order' |
