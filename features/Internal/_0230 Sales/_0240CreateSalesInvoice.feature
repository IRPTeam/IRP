...
Scenario: _024004 create SI using form link/unlink
	...
	* Check RowIDInfo
		...
		| '1' | 'Sales order 16 dated 22.03.2021 12:52:58'           | ''          | '10,000' | 'SI&SC'        |
	...
	* Unlink line
		...
		And "RowIDInfo" table contains lines
			| '#' | 'Basis'                                              | 'Next step' | 'Q'      | 'Current step' |
			| '1' | 'Sales order 16 dated 22.03.2021 12:52:58'           | 'SC'        | '10,000' | 'SI&SC'        |
			| '2' | 'Shipment confirmation 17 dated 25.02.2021 16:28:54' | ''          | '10,000' | 'SI'           |
			| '3' | ''                                                   | 'SC'        | '7,000'  | ''             |
		And "ItemList" table contains lines
			| 'Item'  | 'Item key' | 'Sales order'                            |
			| 'Dress' | 'XS/Blue'  | 'Sales order 16 dated 22.03.2021 12:52:58' |
			| 'Dress' | 'S/Yellow' | ''                                         |
			| 'Shirt' | '36/Red'   | ''                                         |
	* Link line
		And I click the button named "ItemListLinkUnlinkBasisDocuments"
...
Scenario: _024005 create SI based on SO with 2 SC (SC>SO + new string + string from SO without SC)
	...
	* Create SI for all items from SO
		...
		And "ItemList" table contains lines
			...
			| '4' | 'Distribution department' | 'Basic Price Types'       | 'Shirt'   | '36/Red'   | 'No'                 | ''                   | '10,000' | 'pcs'  | '507,20'     | '350,00' | '18%' | '175,00'        | '2 817,80'   | '3 325,00'     | ''                    | 'Store 02' | '27.01.2021'    | 'Yes'                       | ''       | 'Sales order 15 dated 01.02.2021 19:50:45' | 'Revenue'      |
