...
Scenario: _0230001 create and check filling Sales order closing (SO not shipped)
	...
	* Check filling in
		...
		And "ItemList" table contains lines
			| 'Price type'              | 'Item'    | 'Dont calculate row' | 'Quantity'      | 'Unit' | 'Tax amount' | 'Price'    | 'Offers amount' | 'Net amount' | 'Total amount' | 'Store'    | 'Revenue type' | 'Detail' | 'Item key' | 'Procurement method' | 'Cancel' | 'Delivery date' | 'Cancel reason' | 'Sales person'    |
