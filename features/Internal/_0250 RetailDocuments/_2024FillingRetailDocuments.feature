...
Scenario:  _0154149 create Cash statement
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Receipt'     | '$$DateCashStatement01541491$$' | '68,48'     | '2,21'       | 'Main Company' | ''       | 'Bank account, TRY' | 'Reporting currency'           | 'USD'      | 'TRY'                  | '$$CashStatement01541491$$' | 'No'                   |
			| ''                                             | 'Receipt'     | '$$DateCashStatement01541491$$' | '400'       | '12,9'       | 'Main Company' | ''       | 'Bank account, TRY' | 'Local currency'               | 'TRY'      | 'TRY'                  | '$$CashStatement01541491$$' | 'No'                   |
			| ''                                             | 'Receipt'     | '$$DateCashStatement01541491$$' | '400'       | '12,9'       | 'Main Company' | ''       | 'Bank account, TRY' | 'en description is empty'      | 'TRY'      | 'TRY'                  | '$$CashStatement01541491$$' | 'No'                   |
