...
//	needs to be finalized
	...
	* Check creation
		...
		And "ItemList" table became equal
			| '#' | 'Retail sales receipt' | 'Item'               | 'Sales person' | 'Item key' | 'Profit loss center' | 'Dont calculate row' | 'Tax amount' | 'Serial lot numbers' | 'Unit' | 'Return reason' | 'Source of origins' | 'Quantity' | 'Price'  | 'Net amount' | 'Total amount' | 'Additional analytic' | 'Store'    | 'Revenue type' | 'Detail' | 'VAT' | 'Offers amount' | 'Landed cost' | 'Landed cost tax' |
			| '1' | ''                     | 'Shirt'              | ''             | '38/Black' | ''                   | 'No'                 | '100,80'     | ''                   | 'pcs'  | ''              | ''                  | '2,000'    | '280,00' | '560,00'     | '660,80'       | ''                    | 'Store 01' | ''             | ''       | '18%' | ''              | ''            | ''                |
			| '2' | ''                     | 'Dress'              | ''             | 'L/Green'  | ''                   | 'No'                 | '94,05'      | ''                   | 'pcs'  | ''              | ''                  | '1,000'    | '522,50' | '522,50'     | '616,55'       | ''                    | 'Store 01' | ''             | ''       | '18%' | ''              | ''            | ''                |
			| '3' | ''                     | 'Product 1 with SLN' | ''             | 'PZU'      | ''                   | 'No'                 | '36,00'      | '8908899879'         | 'pcs'  | ''              | ''                  | '2,000'    | '100,00' | '200,00'     | '236,00'       | ''                    | 'Store 01' | ''             | ''       | '18%' | ''              | ''            | ''                |
			| '4' | ''                     | 'Product 3 with SLN' | ''             | 'UNIQ'     | ''                   | 'No'                 | '39,60'      | '09987897977891'     | 'pcs'  | ''              | ''                  | '2,000'    | '110,00' | '220,00'     | '259,60'       | ''                    | 'Store 01' | ''             | ''       | '18%' | ''              | ''            | ''                |
			| '5' | ''                     | 'Product 4 with SLN' | ''             | 'UNIQ'     | ''                   | 'No'                 | '21,60'      | '899007790088'       | 'pcs'  | ''              | ''                  | '1,000'    | '120,00' | '120,00'     | '141,60'       | ''                    | 'Store 01' | ''             | ''       | '18%' | ''              | ''            | ''                |
		And in the table "ItemList" I click "Goods receipts" button
		And Delay 2
		And "DocumentsTree" table became equal
			| 'Presentation'                                         | 'Invoice' | 'QuantityInDocument' | 'Quantity' |
