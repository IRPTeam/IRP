...
Scenario: _029902 create SI for SO without reserve and check its movements (SO-SI)
	...
	* Check SI movements (Register  "R2021 Customer transactions")
		...
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '4 519,68'  | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | '$$SalesOrder029901$$' | 'No'                   | ''                           |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | '$$SalesOrder029901$$' | 'No'                   | ''                           |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | ''       | 'TRY'                          | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | '$$SalesOrder029901$$' | 'No'                   | ''                           |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | ''       | 'en description is empty'      | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | '$$SalesOrder029901$$' | 'No'                   | ''                           |
...
Scenario: _029905 create Sales ivoice for SO (SC first) without reserve and check its movements (SO-SC-SI)
		...
		* Check SI movements (Register  "R2021 Customer transactions")
			...
			| ''                                        | 'Record type' | 'Period'                     | 'Resources' | 'Dimensions'   | ''       | ''                             | ''         | ''                 | ''         | ''                         | ''                       | ''                     | 'Attributes'           | ''                           |
			| ''                                        | ''            | ''                           | 'Amount'    | 'Company'      | 'Branch' | 'Multi currency movement type' | 'Currency' | 'Legal name'       | 'Partner'  | 'Agreement'                | 'Basis'                  | 'Order'                | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '4 519,68'  | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | '$$SalesOrder029903$$' | 'No'                   | ''                           |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '26 400'    | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | '$$SalesOrder029903$$' | 'No'                   | ''                           |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '26 400'    | 'Main Company' | ''       | 'TRY'                          | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | '$$SalesOrder029903$$' | 'No'                   | ''                           |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '26 400'    | 'Main Company' | ''       | 'en description is empty'      | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | '$$SalesOrder029903$$' | 'No'                   | ''                           |
