...
Scenario: _029902 create SI for SO without reserve and check its movements (SO-SI)
	...
	* Check SI movements (Register  "R2021 Customer transactions")
		...
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '4 519,68'  | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | ''                   |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | ''                   |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | ''                   |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029901$$' | ''                   |
...
Scenario: _029905 create Sales ivoice for SO (SC first) without reserve and check its movements (SO-SC-SI)
		...
		* Check SI movements (Register  "R2021 Customer transactions")
			...
			| ''                                        | 'Record type' | 'Period'                     | 'Resources' | 'Dimensions'   | ''                             | ''         | ''                 | ''         | ''                         | ''                       | 'Attributes'           |
			| ''                                        | ''            | ''                           | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name'       | 'Partner'  | 'Agreement'                | 'Basis'                  | 'Deferred calculation' |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '4 519,68'  | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | ''                   |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '26 400'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | ''                   |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '26 400'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | ''                   |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice029903$$' | '26 400'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesInvoice029903$$' | ''                   |
		* Check SI movements (Register  "Register  "Taxes turnovers")
			And I select "Taxes turnovers" exact value from "Register" drop-down list
			And I click "Generate report" button
			And "ResultTable" spreadsheet document contains lines:
