...
Scenario: _029901 create Sales order without reserve and check its movements (SI, without SC)
...
Scenario: _029902 create SI for SO without reserve and check its movements (without SC)
	* Create SI 
		Given I open hyperlink "e1cib/list/Document.SalesOrder"
		And I go to line in "List" table
			| 'Number'  |
		...
		And I save the window as "$$SalesOrder029901$$"
		And I save the value of "Date" field as "$$DateSalesInvoice029901$$"
		And I click "Registrations report" button	
	* Check SI movements (Register  "Partner AR transactions")
		...
		And I click "Generate report" button
			...
			| ''                                    | 'Receipt'     | '$$DateSalesInvoice029901$$' | '4 519,68'  | 'Main Company' | '$$SalesOrder029901$$' | 'Lomaniti' | 'Company Lomaniti' | 'Basic Partner terms, TRY' | 'USD'      | 'Reporting currency'           | 'No'                   |
			| ''                                    | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | '$$SalesOrder029901$$' | 'Lomaniti' | 'Company Lomaniti' | 'Basic Partner terms, TRY' | 'TRY'      | 'Local currency'               | 'No'                   |
			| ''                                    | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | '$$SalesOrder029901$$' | 'Lomaniti' | 'Company Lomaniti' | 'Basic Partner terms, TRY' | 'TRY'      | 'TRY'                          | 'No'                   |
			| ''                                    | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | '$$SalesOrder029901$$' | 'Lomaniti' | 'Company Lomaniti' | 'Basic Partner terms, TRY' | 'TRY'      | 'en description is empty'      | 'No'                   |
	...
	* Check SI movements (Register  "Register  "R2001 Sales")
		...
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '2 122,88' | '1 799,05'   | ''              | 'Main Company' | 'Reporting currency'           | 'USD'      | '$$SalesOrder029901$$' | '38/Yellow' | '*'       |
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '12 400'   | '10 508,47'  | ''              | 'Main Company' | 'Local currency'               | 'TRY'      | '$$SalesOrder029901$$' | '38/Yellow' | '*'       |
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '12 400'   | '10 508,47'  | ''              | 'Main Company' | 'TRY'                          | 'TRY'      | '$$SalesOrder029901$$' | '38/Yellow' | '*'       |
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '12 400'   | '10 508,47'  | ''              | 'Main Company' | 'en description is empty'      | 'TRY'      | '$$SalesOrder029901$$' | '38/Yellow' | '*'       |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '2 396,8'  | '2 031,19'   | ''              | 'Main Company' | 'Reporting currency'           | 'USD'      | '$$SalesOrder029901$$' | '38/Black'  | '*'       |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '14 000'   | '11 864,41'  | ''              | 'Main Company' | 'Local currency'               | 'TRY'      | '$$SalesOrder029901$$' | '38/Black'  | '*'       |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '14 000'   | '11 864,41'  | ''              | 'Main Company' | 'TRY'                          | 'TRY'      | '$$SalesOrder029901$$' | '38/Black'  | '*'       |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '14 000'   | '11 864,41'  | ''              | 'Main Company' | 'en description is empty'      | 'TRY'      | '$$SalesOrder029901$$' | '38/Black'  | '*'       |
	...
	* Check SI movements (Register  "R2021 Customer transactions")
		...
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '4 519,68'  | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesOrder029901$$' | 'No'                   |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesOrder029901$$' | 'No'                   |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesOrder029901$$' | 'No'                   |
		| ''                                        | 'Receipt'     | '$$DateSalesInvoice029901$$' | '26 400'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | '$$SalesOrder029901$$' | 'No'                   |
	* Check SI movements (Register  "Register  "Taxes turnovers")
		...
		| ''                               | '$$DateSalesInvoice029901$$' | '323,83'    | '323,83'        | '1 799,05'   | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'USD'      | 'Reporting currency'           | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '365,61'    | '365,61'        | '2 031,19'   | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'USD'      | 'Reporting currency'           | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '1 891,53'  | '1 891,53'      | '10 508,47'  | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'TRY'      | 'Local currency'               | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '1 891,53'  | '1 891,53'      | '10 508,47'  | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'TRY'      | 'TRY'                          | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '1 891,53'  | '1 891,53'      | '10 508,47'  | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'TRY'      | 'en description is empty'      | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '2 135,59'  | '2 135,59'      | '11 864,41'  | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'TRY'      | 'Local currency'               | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '2 135,59'  | '2 135,59'      | '11 864,41'  | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'TRY'      | 'TRY'                          | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '2 135,59'  | '2 135,59'      | '11 864,41'  | '$$SalesOrder029901$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'TRY'      | 'en description is empty'      | 'No'                   |
	...
	* Check SI movements (Register  "Accounts statement")
		...
		| ''                               | 'Receipt'     | '$$DateSalesInvoice029901$$' | ''                     | ''               | ''                       | '26 400'         | 'Main Company' | 'Lomaniti' | 'Company Lomaniti' | '$$SalesOrder029901$$' | 'TRY'      |
	...
	* Check SI movements (Register  "Sales turnovers")
		...
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '2 122,88' | '1 799,05'   | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'USD'      | '38/Yellow' | '*'       | 'Reporting currency'           | ''                  | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '12 400'   | '10 508,47'  | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'TRY'      | '38/Yellow' | '*'       | 'Local currency'               | ''                  | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '12 400'   | '10 508,47'  | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'TRY'      | '38/Yellow' | '*'       | 'TRY'                          | ''                  | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '31'        | '12 400'   | '10 508,47'  | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'TRY'      | '38/Yellow' | '*'       | 'en description is empty'      | ''                  | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '2 396,8'  | '2 031,19'   | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'USD'      | '38/Black'  | '*'       | 'Reporting currency'           | ''                  | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '14 000'   | '11 864,41'  | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'TRY'      | '38/Black'  | '*'       | 'Local currency'               | ''                  | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '14 000'   | '11 864,41'  | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'TRY'      | '38/Black'  | '*'       | 'TRY'                          | ''                  | 'No'                   |
		| ''                               | '$$DateSalesInvoice029901$$' | '40'        | '14 000'   | '11 864,41'  | ''              | 'Main Company' | '$$SalesOrder029901$$' | 'TRY'      | '38/Black'  | '*'       | 'en description is empty'      | ''                  | 'No'                   |

	// * Check SI movements (Register  "R4011B_FreeStocks")
	// 	And I select "Sales turnovers" exact value from "Register" drop-down list
	// 	And I click "Generate report" button
	// 	And "ResultTable" spreadsheet document contains lines:
	// 		| 'Register "R4011B_FreeStocks"' | '' | '' | '' | '' | '' |
...
Scenario: _029903 create Sales order without reserve and check its movements (SC, without SI)
	* Open form for create order
		Given I open hyperlink "e1cib/list/Document.SalesOrder"
		And I click the button named "FormCreate"
	* Filling the document heading
