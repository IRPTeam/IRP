...
Scenario: _034032 check the Document discount by selected row in Purchase invoice
	And I close all client application windows
	* Activating discount Document discount
		Given I open hyperlink "e1cib/list/Catalog.SpecialOffers"
		And I click "List" button
...
Scenario: _034033 check the Document discount by selected row in Purchase order
	And I close all client application windows
	* Activating discount Document discount
		Given I open hyperlink "e1cib/list/Catalog.SpecialOffers"
		And I click "List" button
		...
		And I click "Save and close" button
	* Create Purchase order
		* Open form for creating Purchase order
			Given I open hyperlink "e1cib/list/Document.PurchaseOrder"
			And I click the button named "FormCreate"
		* Filling in vendor's info
			And I click Select button of "Partner" field
