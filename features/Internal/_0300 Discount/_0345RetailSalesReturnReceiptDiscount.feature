...
Scenario: _034503  check the Document discount by selected row in Retail sales receipt
	* Create Retail sales receipt
		* Open a form to create Retail sales receipt
			Given I open hyperlink "e1cib/list/Document.RetailSalesReceipt"
			And I click the button named "FormCreate"
	...
	* Filling in payment tab
		...
		And I select current line in "List" table
		And I activate "Amount" field in "Payments" table
		And I input "130 800,00" text in "Amount" field of "Payments" table
		And I finish line editing in "Payments" table
	And I click the button named "FormPost"
	And I delete "$$NumberRetailSalesReceipt034503$$" variable
	And I delete "$$RetailSalesReceipt034503$$" variable
	And I save the value of "Number" field as "$$NumberRetailSalesReceipt034503$$"
	And I save the window as "$$RetailSalesReceipt034503$$"
	And I click the button named "FormPostAndClose"
