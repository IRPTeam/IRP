...
Scenario: _0401671 check Sales order closing movements by the Register  "T2014 Advances info"
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | ''          | 'No'                      | 'Yes'                  | 'Receipt'     | 'Main Company' | 'Distribution department' | '10.03.2022 11:27:01' | '                                    ' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Sales order 229 dated 10.03.2022 10:57:17' | 'No'                | 'Yes'                 | 'e21ed38a-6599-4592-9453-ab8c228f2356' | 'Basic Partner terms, TRY' | ''        |				
		And I close all client application windows
