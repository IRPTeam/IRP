...
Scenario: _0401671 check Sales order closing movements by the Register  "T2014 Advances info"
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | 'Main Company' | 'Distribution department' | '10.03.2022 11:27:01' | '                                    ' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Sales order 229 dated 10.03.2022 10:57:17' | 'No'                | 'Yes'                 | 'd10927f5-e8f5-4d36-8bcc-e62031527a48' | 'Basic Partner terms, TRY' | ''        | 'en description is empty' | 'TRY'                  | ''       | 'No'                      | 'Yes'                  | 'Receipt'     |		
		And I close all client application windows
...
Scenario: _040171 check Sales order closing movements by the Register (different ItemKey)		
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "Posted documents registry"'             | ''                                                | ''                    | ''                    | ''                                     | ''                                          | ''                                          | ''                                     | ''                                          | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                  | 'Document'                                        | 'Date'                | 'Number'              | 'Create date'                          | 'Modify date'                               | 'Author'                                    | 'Editor'                               | 'Manual movements edit'                     | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                  | 'Sales order closing 5 dated 10.04.2025 22:14:52' | '10.04.2025 22:14:52' | '5'                   | '29.10.2025 16:07:32'                  | '31.10.2025 08:53:51'                       | 'en description is empty'                   | 'en description is empty'              | 'No'                                        | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                  | ''                                                | ''                    | ''                    | ''                                     | ''                                          | ''                                          | ''                                     | ''                                          | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| 'Register  "R2010 Sales orders"'                    | ''                                                | ''                    | ''                    | ''                                     | ''                                          | ''                                          | ''                                     | ''                                          | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			...
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Main Company'        | ''                    | 'Local currency'                       | 'TRY'                                       | 'Sales order 231 dated 10.04.2025 22:03:13' | 'ODS'                                  | '301edaee-47dc-4a86-905c-dfc21874661c'      | 'Stock'              | ''                    | '50'                                   | '27 500'                   | '23 305,08'  | ''                        | 'No'                   | ''       | ''                        | ''                     | ''            |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Main Company'        | ''                    | 'Local currency'                       | 'TRY'                                       | 'Sales order 231 dated 10.04.2025 22:03:13' | 'PZU'                                  | 'dc45f5ab-d66f-4e97-9657-b9d795e3a812'      | 'Stock'              | ''                    | '50'                                   | '26 000'                   | '22 033,9'   | ''                        | 'No'                   | ''       | ''                        | ''                     | ''            |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Main Company'        | ''                    | 'Reporting currency'                   | 'USD'                                       | 'Sales order 231 dated 10.04.2025 22:03:13' | 'ODS'                                  | '301edaee-47dc-4a86-905c-dfc21874661c'      | 'Stock'              | ''                    | '50'                                   | '4 708'                    | '3 989,83'   | ''                        | 'No'                   | ''       | ''                        | ''                     | ''            |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Main Company'        | ''                    | 'Reporting currency'                   | 'USD'                                       | 'Sales order 231 dated 10.04.2025 22:03:13' | 'PZU'                                  | 'dc45f5ab-d66f-4e97-9657-b9d795e3a812'      | 'Stock'              | ''                    | '50'                                   | '4 451,2'                  | '3 772,2'    | ''                        | 'No'                   | ''       | ''                        | ''                     | ''            |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Main Company'        | ''                    | 'en description is empty'              | 'TRY'                                       | 'Sales order 231 dated 10.04.2025 22:03:13' | 'ODS'                                  | '301edaee-47dc-4a86-905c-dfc21874661c'      | 'Stock'              | ''                    | '50'                                   | '27 500'                   | '23 305,08'  | ''                        | 'No'                   | ''       | ''                        | ''                     | ''            |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Main Company'        | ''                    | 'en description is empty'              | 'TRY'                                       | 'Sales order 231 dated 10.04.2025 22:03:13' | 'PZU'                                  | 'dc45f5ab-d66f-4e97-9657-b9d795e3a812'      | 'Stock'              | ''                    | '50'                                   | '26 000'                   | '22 033,9'   | ''                        | 'No'                   | ''       | ''                        | ''                     | ''            |
			| ''                                                  | ''                                                | ''                    | ''                    | ''                                     | ''                                          | ''                                          | ''                                     | ''                                          | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| 'Register  "R2011 Shipment of sales orders"'        | ''                                                | ''                    | ''                    | ''                                     | ''                                          | ''                                          | ''                                     | ''                                          | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			...
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Receipt'             | 'Main Company'        | ''                                     | 'Sales order 231 dated 10.04.2025 22:03:13' | 'TRY'                                       | 'ODS'                                  | '301edaee-47dc-4a86-905c-dfc21874661c'      | '50'                 | '27 500'              | '23 305,08'                            | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Receipt'             | 'Main Company'        | ''                                     | 'Sales order 231 dated 10.04.2025 22:03:13' | 'TRY'                                       | 'PZU'                                  | 'dc45f5ab-d66f-4e97-9657-b9d795e3a812'      | '50'                 | '26 000'              | '22 033,9'                             | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                  | ''                                                | ''                    | ''                    | ''                                     | ''                                          | ''                                          | ''                                     | ''                                          | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| 'Register  "T2014 Advances info"'                   | ''                                                | ''                    | ''                    | ''                                     | ''                                          | ''                                          | ''                                     | ''                                          | ''                   | ''                    | ''                                     | ''                         | ''           | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                  | 'Company'                                         | 'Branch'              | 'Date'                | 'Key'                                  | 'Currency'                                  | 'Partner'                                   | 'Legal name'                           | 'Order'                                     | 'Is vendor advance'  | 'Is customer advance' | 'Unique ID'                            | 'Advance agreement'        | 'Project'    | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is purchase order close' | 'Is sales order close' | 'Record type' |
			| ''                                                  | 'Main Company'                                    | ''                    | '10.04.2025 22:14:52' | '                                    ' | 'TRY'                                       | 'Ferron BP'                                 | 'Company Ferron BP'                    | 'Sales order 231 dated 10.04.2025 22:03:13' | 'No'                 | 'Yes'                 | 'f1537bf2-08f0-4b9d-8de0-74a33a4686af' | 'Basic Partner terms, TRY' | ''           | 'en description is empty' | 'TRY'                  | ''       | 'No'                      | 'Yes'                  | 'Receipt'     |		
		And I close all client application windows		
