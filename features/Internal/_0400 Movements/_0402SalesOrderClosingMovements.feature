...
Scenario: _0401671 check Sales order closing movements by the Register  "T2014 Advances info"
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | 'Amount'    | 'Is purchase order close' | 'Is sales order close' | 'Company'      | 'Branch'                  | 'Date'                | 'Key'                                  | 'Currency' | 'Partner'   | 'Legal name'        | 'Order'                                     | 'Is vendor advance' | 'Is customer advance' | 'Unique ID' | 'Advance agreement'        | 'Advance document' |
			| ''                                                | ''          | 'No'                      | 'Yes'                  | 'Main Company' | 'Distribution department' | '10.03.2022 11:27:01' | '                                    ' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Sales order 229 dated 10.03.2022 10:57:17' | 'No'                | 'Yes'                 | '*'         | 'Basic Partner terms, TRY' | ''                 |
		And I close all client application windows
