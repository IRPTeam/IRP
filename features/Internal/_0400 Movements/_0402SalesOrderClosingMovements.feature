...
Scenario: _040159 check Sales order closing movements by the Register  "R2010 Sales orders"
	...
	* Check movements by the Register  "R2010 Sales orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | ''                    | 'Quantity'  | 'Amount'    | 'Net amount' | 'Offers amount' | 'Company'      | 'Branch'                  | 'Multi currency movement type' | 'Currency' | 'Order'                                   | 'Item key' | 'Row key'                              | 'Procurement method' | 'Deferred calculation' |
			...
			| ''                                                | '28.01.2021 14:46:50' | '-10'       | '-3 325'    | '-2 817,8'   | '-175'          | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '36/Red'   | 'e34f52ea-1fe2-47b2-9b37-63c093896662' | 'No reserve'         | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-10'       | '-3 325'    | '-2 817,8'   | '-175'          | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '36/Red'   | 'e34f52ea-1fe2-47b2-9b37-63c093896662' | 'No reserve'         | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-10'       | '-3 325'    | '-2 817,8'   | '-175'          | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '36/Red'   | 'e34f52ea-1fe2-47b2-9b37-63c093896662' | 'No reserve'         | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-10'       | '-569,24'   | '-482,41'    | '-29,96'        | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '36/Red'   | 'e34f52ea-1fe2-47b2-9b37-63c093896662' | 'No reserve'         | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-494'      | '-418,64'    | '-26'           | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'XS/Blue'  | '63008c12-b682-4aff-b29f-e6927036b05a' | 'Stock'              | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-494'      | '-418,64'    | '-26'           | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'XS/Blue'  | '63008c12-b682-4aff-b29f-e6927036b05a' | 'Stock'              | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-494'      | '-418,64'    | '-26'           | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'XS/Blue'  | '63008c12-b682-4aff-b29f-e6927036b05a' | 'Stock'              | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-95'       | '-80,51'     | '-5'            | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | ''                   | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-95'       | '-80,51'     | '-5'            | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | ''                   | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-95'       | '-80,51'     | '-5'            | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | ''                   | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-84,57'    | '-71,67'     | '-4,45'         | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'XS/Blue'  | '63008c12-b682-4aff-b29f-e6927036b05a' | 'Stock'              | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-1'        | '-16,26'    | '-13,78'     | '-0,86'         | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | ''                   | 'No'                   |
		And I close all client application windows
...
Scenario: _040160 check Sales order closing movements by the Register  "R2014 Canceled sales orders"
	...
	* Check movements by the Register  "R2014 Canceled sales orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | '28.01.2021 14:46:50' | '1'         | '16,26'    | '13,78'      | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | 'not available' | 'No'                   |
			...
			| ''                                                | '28.01.2021 14:46:50' | '1'         | '95'       | '80,51'      | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | 'not available' | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '1'         | '95'       | '80,51'      | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | 'not available' | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '1'         | '95'       | '80,51'      | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | 'Interner' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | 'not available' | 'No'                   |
...
Scenario: _040165 check Sales order closing movements by the Register  "R2013 Procurement of sales orders"
	...
	* Check movements by the Register  "R2013 Procurement of sales orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | ''                    | 'Ordered quantity' | 'Re ordered quantity' | 'Purchase quantity' | 'Receipt quantity' | 'Shipped quantity' | 'Sales quantity' | 'Company'      | 'Branch'                  | 'Order'                                   | 'Item key' |
			| ''                                                | '28.01.2021 14:46:50' | '-24'              | ''                    | ''                  | ''                 | ''                 | ''               | 'Main Company' | 'Distribution department' | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  |
		And I close all client application windows
...
Scenario: _040170 check Sales order closing movements by the Register  "TM1010B Row ID movements"
	...
	* Check movements by the Register  "TM1010B Row ID movements" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | 'Receipt'     | '28.01.2021 14:46:50' | '-24'       | '5d82f8d1-e3f8-4453-aa45-4f7ac9601689' | 'PO&PI' | 'Sales order 1 dated 27.01.2021 19:50:45' | '5d82f8d1-e3f8-4453-aa45-4f7ac9601689' |
			| ''                                                | 'Receipt'     | '28.01.2021 14:46:50' | '-10'       | 'e34f52ea-1fe2-47b2-9b37-63c093896662' | 'SI&SC' | 'Sales order 1 dated 27.01.2021 19:50:45' | 'e34f52ea-1fe2-47b2-9b37-63c093896662' |
			| ''                                                | 'Receipt'     | '28.01.2021 14:46:50' | '-1'        | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | 'SI'    | 'Sales order 1 dated 27.01.2021 19:50:45' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' |
			| ''                                                | 'Receipt'     | '28.01.2021 14:46:50' | '-1'        | '63008c12-b682-4aff-b29f-e6927036b05a' | 'SI&SC' | 'Sales order 1 dated 27.01.2021 19:50:45' | '63008c12-b682-4aff-b29f-e6927036b05a' |
		And I close all client application windows
