...
Scenario: _040171 check Sales order closing movements by the Register (different ItemKey)		
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Receipt'             | 'Main Company' | ''            | 'Sales order 231 dated 10.04.2025 22:03:13' | 'TRY'                     | 'ODS'                     | '301edaee-47dc-4a86-905c-dfc21874661c' | ''         | '27 500' | '23 305,08'  |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Receipt'             | 'Main Company' | ''            | 'Sales order 231 dated 10.04.2025 22:03:13' | 'TRY'                     | 'PZU'                     | 'dc45f5ab-d66f-4e97-9657-b9d795e3a812' | ''         | '26 000' | '22 033,9'   |
			| ''                                                  | ''                                                | ''                    | ''             | ''            | ''                                          | ''                        | ''                        | ''                                     | ''         | ''       | ''           |
			| 'Register  "R4011 Free stocks"'                     | ''                                                | ''                    | ''             | ''            | ''                                          | ''                        | ''                        | ''                                     | ''         | ''       | ''           |
			| ''                                                  | 'Period'                                          | 'RecordType'          | 'Store'        | 'Item key'    | 'Quantity'                                  | ''                        | ''                        | ''                                     | ''         | ''       | ''           |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Expense'             | 'Store 03'     | 'PZU'         | '-50'                                       | ''                        | ''                        | ''                                     | ''         | ''       | ''           |
			| ''                                                  | ''                                                | ''                    | ''             | ''            | ''                                          | ''                        | ''                        | ''                                     | ''         | ''       | ''           |
			| 'Register  "R4012 Stock Reservation"'               | ''                                                | ''                    | ''             | ''            | ''                                          | ''                        | ''                        | ''                                     | ''         | ''       | ''           |
			| ''                                                  | 'Period'                                          | 'RecordType'          | 'Store'        | 'Item key'    | 'Order'                                     | 'Quantity'                | ''                        | ''                                     | ''         | ''       | ''           |
			| ''                                                  | '10.04.2025 22:14:52'                             | 'Receipt'             | 'Store 03'     | 'PZU'         | 'Sales order 231 dated 10.04.2025 22:03:13' | '-50'                     | ''                        | ''                                     | ''         | ''       | ''           |
		And I close all client application windows		
