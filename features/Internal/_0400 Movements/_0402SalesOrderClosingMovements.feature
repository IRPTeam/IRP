...
Scenario: _0401671 check Sales order closing movements by the Register  "T2014 Advances info"
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | ''          | 'No'                      | 'Yes'                  | '10.03.2022 11:27:01' | ''    | 'Main Company' | 'Distribution department' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'No'                | 'Yes'                 | '096ec34d-633b-47b2-85b6-199304e9438a' |
		And I close all client application windows
...
Scenario: _040170 check Sales order closing movements by the Register  "TM1010B Row ID movements"
	...
	* Check movements by the Register  "TM1010B Row ID movements" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | 'Receipt'     | '28.01.2021 14:46:50' | '-1'        | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | '0a13bddb-cb97-4515-a9ef-777b6924ebf1' | 'SI'    | 'Sales order 1 dated 27.01.2021 19:50:45' | '*'                                       |
		And I close all client application windows
