...
Scenario: _040159 check Sales order closing movements by the Register  "R2010 Sales orders"
	...
	* Check movements by the Register  "R2010 Sales orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | '28.01.2021 14:46:50' | '-24'       | '-15 960'   | '-13 525,42' | '-840'          | 'Main Company' | 'Local currency'               | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'Purchase'           | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-24'       | '-15 960'   | '-13 525,42' | '-840'          | 'Main Company' | 'TRY'                          | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'Purchase'           | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-24'       | '-15 960'   | '-13 525,42' | '-840'          | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'Purchase'           | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '-24'       | '-2 732,35' | '-2 315,55'  | '-143,81'       | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'Purchase'           | 'No'                   |
...
Scenario: _040160 check Sales order closing movements by the Register  "R2014 Canceled sales orders"
	...
	* Check movements by the Register  "R2014 Canceled sales orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | '28.01.2021 14:46:50' | '24'        | '15 960'   | '13 525,42' | 'Main Company' | 'Local currency'               | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'not available' | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '24'        | '15 960'   | '13 525,42' | 'Main Company' | 'TRY'                          | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'not available' | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '24'        | '15 960'   | '13 525,42' | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'not available' | 'No'                   |
			| ''                                                | '28.01.2021 14:46:50' | '24'        | '2 732,35' | '2 315,55'  | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Sales order 1 dated 27.01.2021 19:50:45' | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' | 'not available' | 'No'                   |
...
Scenario: _040167 check Sales order closing movements by the Register  "R2012 Invoice closing of sales orders"
	...
	* Check movements by the Register  "R2012 Invoice closing of sales orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | 'Receipt'     | '28.01.2021 14:46:50' | '-24'       | '-15 960' | '-13 525,42' | 'Main Company' | 'Sales order 1 dated 27.01.2021 19:50:45' | 'TRY'      | '37/18SD'  | 'b5d82f8d1-e3f8-4453-aa45-4f7ac960168' |
