...
Scenario: _040130 preparation (Sales invoice)
	...
	* Check query for sales invoice movements
		...
		And "Info" table contains lines
			...
			| 'SalesInvoice' | 'R8013B_ConsignorBatchWiseBallance' | 'Yes'      | ''                                                                                                                                                                                                                                                                              | 'SELECT\n    VALUE(AccumulationRecordType.Expense) AS RecordType,\n    ItemList.Period AS Period,\n    ItemList.Company AS Company,\n    ConsignorBatchesInfo.Batch AS Batch,\n    ConsignorBatchesInfo.ItemKey AS ItemKey,\n    ConsignorBatchesInfo.Store AS Store,\n    ConsignorBatchesInfo.Quantity AS Quantity\nINTO R8013B_ConsignorBatchWiseBallance\nFROM\n    ItemList AS ItemList\n        INNER JOIN ConsignorBatchesInfo AS ConsignorBatchesInfo\n        ON (ItemList.IsSales)\n            AND (ItemList.IsConsignorStocks)\n            AND ItemList.Key = ConsignorBatchesInfo.Key'                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 'Ref: Sales invoice\nBalancePeriod: Undefined' | 'No'      | 'Yes'     |
...
Scenario: _0401350 check Sales invoice movements by the Register  "T2015 Transactions info" (consignor and own stocks)
	...
	* Check movements by the Register  "T2015 Transactions info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                            | '2 920'     | 'Yes'    | 'No'      | '04.11.2022 16:33:38' | '                                    ' | 'Main Company' | 'Distribution department' | 'TRY'      | 'Lomaniti' | 'Company Lomaniti' | 'Basic Partner terms, TRY' | ''      | 'No'                    | 'Yes'                     | 'Sales invoice 194 dated 04.11.2022 16:33:38' | '38f54eec-7248-4946-9c12-6c011bcb6f5b' |	
		And I close all client application windows
