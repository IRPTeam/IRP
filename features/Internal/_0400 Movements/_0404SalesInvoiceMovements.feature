...
Scenario: _0401352 check Sales invoice movements by the Register  "R6060 Cost of goods sold"
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'Local currency'          | 'TRY'      | '175'      | '51 906,78'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'Local currency'          | 'TRY'      | '80'       | '25 762,71'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'en description is empty' | 'TRY'      | '175'      | '51 906,78'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '51 906,78'    | '51 906,78'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'Local currency'          | 'TRY'      | '175'      | '51 906,78'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '51 906,78'    | '51 906,78'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'Reporting currency'      | 'USD'      | '175'      | '8 886,44'       | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '8 886,44'     | '8 886,44'         | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'en description is empty' | 'TRY'      | '80'       | '25 762,71'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '25 762,71'    | '25 762,71'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'Local currency'          | 'TRY'      | '80'       | '25 762,71'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '25 762,71'    | '25 762,71'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '05.05.2025 12:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'Reporting currency'      | 'USD'      | '80'       | '4 410,58'       | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '4 410,58'     | '4 410,58'         | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
	And I close all client application windows		