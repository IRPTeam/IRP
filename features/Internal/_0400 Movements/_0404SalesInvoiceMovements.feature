...
Scenario: _040143 check Sales invoice movements by the Register  "R2040 Taxes incoming"
	...
	* Check movements by the Register  "R2040 Taxes incoming"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '13,78'          | '2,48'       | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '71,67'          | '12,9'       | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '80,51'          | '14,49'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '80,51'          | '14,49'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '418,64'         | '75,36'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '418,64'         | '75,36'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '482,41'         | '86,83'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '2 817,8'        | '507,2'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                          | 'Receipt'     | '28.01.2021 18:48:53' | '2 817,8'        | '507,2'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |	
		And I close all client application windows
...
Scenario: _0401344 check Sales invoice movements by the Register  "R2040 Taxes incoming" (consignor and own stocks)
	...
	* Check movements by the Register  "R2040 Taxes incoming"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                            | 'Record type' | 'Period'              | 'Resources'      | ''           | 'Dimensions'   | ''                        | ''    | ''            | ''                             | ''         | ''                     |
			| ''                                            | ''            | ''                    | 'Taxable amount' | 'Tax amount' | 'Company'      | 'Branch'                  | 'Tax' | 'Tax rate'    | 'Multi currency movement type' | 'Currency' | 'Transaction currency' |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '14,51'          | '2,61'       | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '58,03'          | '10,45'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '75,44'          | '13,58'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '84,75'          | '15,25'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '84,75'          | '15,25'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '136,96'         | ''           | 'Main Company' | 'Distribution department' | 'VAT' | 'Without VAT' | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '159,59'         | '28,73'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '338,98'         | '61,02'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '338,98'         | '61,02'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '440,68'         | '79,32'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '440,68'         | '79,32'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '800'            | ''           | 'Main Company' | 'Distribution department' | 'VAT' | 'Without VAT' | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '800'            | ''           | 'Main Company' | 'Distribution department' | 'VAT' | 'Without VAT' | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '932,2'          | '167,8'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                            | 'Receipt'     | '04.11.2022 16:33:38' | '932,2'          | '167,8'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'         | 'en description is empty'      | 'TRY'      | 'TRY'                  |	
		And I close all client application windows		
