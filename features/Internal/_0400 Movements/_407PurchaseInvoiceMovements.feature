...
Scenario: _040993 check Purchase invoice movements by the Register  "R1005 Special offers of purchases" (with special offers)
	...
	* Check movements by the Register  "R1005 Special offers of purchases"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R1005 Special offers of purchases"'    | ''                      | ''                | ''               | ''               | ''                               | ''           | ''                                                 | ''            | ''            | ''            | ''                                       | ''                   | ''                        |
			| ''                                                 | 'Period'                | 'Resources'       | 'Dimensions'     | ''               | ''                               | ''           | ''                                                 | ''            | ''            | ''            | ''                                       | ''                   | 'Attributes'              |
			| ''                                                 | ''                      | 'Offers amount'   | 'Company'        | 'Branch'         | 'Multi currency movement type'   | 'Currency'   | 'Invoice'                                          | 'Item key'    | 'Fixed asset' | 'Ledger type' | 'Row key'                                | 'Special offer'      | 'Deferred calculation'    |
...
Scenario: _0401070 check Purchase invoice movements by the Register  "R5022 Expenses" (PO-PI)
	...
	* Check movements by the Register  "R5022 Expenses"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                 | '12.02.2021 15:12:15'   | '39,17'       | '46,22'               | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | ''           | ''           | 'USD'        | ''                      | 'Reporting currency'             | ''                             |
			| ''                                                 | '12.02.2021 15:12:15'   | '228,81'      | '270'                 | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | ''           | ''           | 'TRY'        | ''                      | 'Local currency'                 | ''                             |
			| ''                                                 | '12.02.2021 15:12:15'   | '228,81'      | '270'                 | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | ''           | ''           | 'TRY'        | ''                      | 'TRY'                            | ''                             |
			| ''                                                 | '12.02.2021 15:12:15'   | '228,81'      | '270'                 | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | ''           | ''           | 'TRY'        | ''                      | 'en description is empty'        | ''                             |
		And I close all client application windows
