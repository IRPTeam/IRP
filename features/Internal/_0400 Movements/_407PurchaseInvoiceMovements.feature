...
Scenario: _0401036 check Purchase invoice movements by the Register  "T2015 Transactions info" (Purchase)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | 'Main Company' | 'Front office' | ''                                             | '12.02.2021 15:12:15' | '                                    ' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Yes'                   | 'No'                      | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | '*'         | 'Project 01' | 'en description is empty' | 'TRY'                  | '2 400'  | 'Yes'    | 'No'      |
			| ''                                               | 'Main Company' | 'Front office' | 'Purchase order 117 dated 12.02.2021 12:45:05' | '12.02.2021 15:12:15' | '                                    ' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Yes'                   | 'No'                      | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | '*'         | 'Project 01' | 'en description is empty' | 'TRY'                  | '2 070'  | 'Yes'    | 'No'      |
		And I close all client application windows
