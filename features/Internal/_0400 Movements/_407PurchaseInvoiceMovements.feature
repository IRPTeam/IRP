...
Scenario: _04097 check Purchase invoice movements by the Register  "R1021 Vendors transactions"
	...
	* Check movements by the Register  "R1021 Vendors transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '393,76'    | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | 'No'                   | ''                         |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '2 300'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | 'No'                   | ''                         |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '2 300'     | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | 'No'                   | ''                         |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '2 300'     | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | 'No'                   | ''                         |
		And I close all client application windows
...
Scenario: _0401028 check Purchase invoice movements by the Register  "R8012 Consignor inventory" (Receipt from consignor)
	...
	* Check movements by the Register  "R8012 Consignor inventory" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | 'Receipt'     | '02.11.2022 16:31:38' | '2'         | 'Main Company' | 'ODS'      | 'Consignor 1' | 'Consignor partner term 1' |
			| ''                                               | 'Receipt'     | '02.11.2022 16:31:38' | '4'         | 'Main Company' | 'UNIQ'     | 'Consignor 1' | 'Consignor partner term 1' |
...
Scenario: _0401029 check Purchase invoice movements by the Register  "R8013 Consignor batch wise ballance" (Receipt from consignor)
	* Select Purchase invoice
		And I close all client application windows
		Given I open hyperlink "e1cib/list/Document.PurchaseInvoice"
		And I go to line in "List" table
	...
	* Check movements by the Register  "R8013 Consignor batch wise ballance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | 'Receipt'     | '02.11.2022 16:31:38' | '2'         | 'Main Company' | 'Purchase invoice 195 dated 02.11.2022 16:31:38' | 'Store 02' | 'ODS'      |
			| ''                                                | 'Receipt'     | '02.11.2022 16:31:38' | '4'         | 'Main Company' | 'Purchase invoice 195 dated 02.11.2022 16:31:38' | 'Store 02' | 'UNIQ'     |
