...
Scenario: _040107 check Purchase invoice movements by the Register  "R1040 Taxes outgoing"
	...
	* Check movements by the Register  "R1040 Taxes outgoing"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '43,53'          | '7,83'       | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '145,09'         | '26,11'      | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '145,09'         | '26,11'      | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '254,24'         | '45,76'      | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '254,24'         | '45,76'      | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '847,46'         | '152,54'     | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '847,46'         | '152,54'     | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '847,46'         | '152,54'     | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                               | 'Receipt'     | '12.02.2021 15:13:56' | '847,46'         | '152,54'     | 'Main Company' | 'Front office' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |	
		And I close all client application windows
