...
Scenario: _0401040 check Purchase invoice movements by the Register  "R1001 Purchases"
	...
	* Check movements by the Register  "R1001 Purchases"
		...
		And "ItemList" table became equal
			...
			| '1' | 'Dress'              | 'XS/Blue'  | ''                               | ''                  | '10,000'   | 'en description is empty' | 'pcs'  | '100,00' | '18%' | ''              | 'No'                 | '152,54'     | '847,46'     | '1 000,00'     | 'Store 02' | ''        | ''              | ''             | ''                   | ''               | ''            | ''                        | 'Yes'               | ''       | ''                    | ''                          |
			| '2' | 'Scarf'              | 'XS/Red'   | ''                               | ''                  | '5,000'    | 'en description is empty' | 'pcs'  | '20,00'  | '18%' | ''              | 'No'                 | '15,25'      | '84,75'      | '100,00'       | 'Store 02' | ''        | ''              | ''             | ''                   | ''               | ''            | ''                        | 'Yes'               | ''       | ''                    | ''                          |
			| '3' | 'Product 1 with SLN' | 'ODS'      | '9090098908'                     | ''                  | '10,000'   | 'en description is empty' | 'pcs'  | '100,00' | '18%' | ''              | 'No'                 | '152,54'     | '847,46'     | '1 000,00'     | 'Store 02' | ''        | ''              | ''             | ''                   | ''               | ''            | ''                        | 'Yes'               | ''       | ''                    | ''                          |
			| '4' | 'Product 3 with SLN' | 'UNIQ'     | '09987897977889; 09987897977890' | ''                  | '10,000'   | 'en description is empty' | 'pcs'  | '100,00' | '18%' | ''              | 'No'                 | '152,54'     | '847,46'     | '1 000,00'     | 'Store 02' | ''        | ''              | ''             | ''                   | ''               | ''            | ''                        | 'Yes'               | ''       | ''                    | ''                          |
		And I close all client application windows
