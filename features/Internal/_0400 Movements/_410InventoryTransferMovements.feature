...
Scenario: _0402301 check Inventory transfer movements by the Register  "R4050 Stock inventory"
	...
	* Check movements by the Register  "R4050 Stock inventory"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | 'Receipt'     | '*'      | '2'         | 'Main Company' | 'Logistics department' | 'Store 03' | '36/Yellow' |
			| ''                                                | 'Receipt'     | '*'      | '10'        | 'Main Company' | 'Logistics department' | 'Store 03' | 'S/Yellow'  |
			| ''                                                | 'Receipt'     | '*'      | '10'        | 'Main Company' | 'Logistics department' | 'Store 03' | 'XS/Blue'   |
			| ''                                                | 'Receipt'     | '*'      | '15'        | 'Main Company' | 'Logistics department' | 'Store 03' | '36/Red'    |
			| ''                                                | 'Expense'     | '*'      | '2'         | 'Main Company' | 'Logistics department' | 'Store 02' | '36/Yellow' |
			| ''                                                | 'Expense'     | '*'      | '10'        | 'Main Company' | 'Logistics department' | 'Store 02' | 'S/Yellow'  |
			| ''                                                | 'Expense'     | '*'      | '10'        | 'Main Company' | 'Logistics department' | 'Store 02' | 'XS/Blue'   |
			| ''                                                | 'Expense'     | '*'      | '15'        | 'Main Company' | 'Logistics department' | 'Store 02' | '36/Red'    |
