...
Scenario: _041170 check Purchase order closing movements by the Register (different ItemKey)		
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "Posted documents registry"'                | ''                                                   | ''                    | ''                    | ''                                     | ''                                               | ''                                               | ''                        | ''                                               | ''                  | ''                    | ''                                     | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | 'Document'                                           | 'Date'                | 'Number'              | 'Create date'                          | 'Modify date'                                    | 'Author'                                         | 'Editor'                  | 'Manual movements edit'                          | ''                  | ''                    | ''                                     | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | 'Purchase order closing 2 dated 10.04.2025 22:26:08' | '10.04.2025 22:26:08' | '2'                   | '29.10.2025 16:30:36'                  | '31.10.2025 08:59:15'                            | 'en description is empty'                        | 'en description is empty' | 'No'                                             | ''                  | ''                    | ''                                     | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | ''                                                   | ''                    | ''                    | ''                                     | ''                                               | ''                                               | ''                        | ''                                               | ''                  | ''                    | ''                                     | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| 'Register  "R1010 Purchase orders"'                    | ''                                                   | ''                    | ''                    | ''                                     | ''                                               | ''                                               | ''                        | ''                                               | ''                  | ''                    | ''                                     | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			...
			| ''                                                     | 'Main Company'                                       | ''                    | '10.04.2025 22:26:08' | '                                    ' | 'TRY'                                            | 'Ferron BP'                                      | 'Company Ferron BP'       | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'Yes'               | 'No'                  | '17749acf-642f-48fd-b7ae-9a69de92435b' | 'Vendor Ferron, TRY'   | ''        | 'en description is empty' | 'TRY'                  | ''       | 'Yes'                     | 'No'                   | 'Receipt'     |		
		And I close all client application windows
