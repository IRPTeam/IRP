...
Scenario: _041159 check Purchase order closing movements by the Register  "Register  "R1010 Purchase orders""
	...
	* Check movements by the Register  "R2010 Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                   | '09.03.2021 15:41:08' | '-8'        | '-960'    | '-813'       | 'Main Company' | 'Local currency'               | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '-8'        | '-960'    | '-813'       | 'Main Company' | 'TRY'                          | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '-8'        | '-960'    | '-813'       | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '-8'        | '-164,35' | '-139,28'    | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'No'                   |
			...
			| ''                                                   | '09.03.2021 15:41:08' | '1'         | '150'     | '127,12'     | 'Main Company' | 'Local currency'               | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | '38/Black' | 'b5d168e5-e60d-44c9-9168-b13a2695077f' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '1'         | '150'     | '127,12'     | 'Main Company' | 'TRY'                          | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | '38/Black' | 'b5d168e5-e60d-44c9-9168-b13a2695077f' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '1'         | '150'     | '127,12'     | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | '38/Black' | 'b5d168e5-e60d-44c9-9168-b13a2695077f' | 'No'                   |
		And I close all client application windows
...
Scenario: _041160 check Purchase order closing movements by the Register  "R2014 Canceled Purchase orders"
	...
	* Check movements by the Register  "R2014 Canceled Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                   | '09.03.2021 15:41:08' | '8'         | '164,35' | '139,28'     | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'not available' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '8'         | '960'    | '813'        | 'Main Company' | 'Local currency'               | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'not available' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '8'         | '960'    | '813'        | 'Main Company' | 'TRY'                          | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'not available' | 'No'                   |
			| ''                                                   | '09.03.2021 15:41:08' | '8'         | '960'    | '813'        | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'not available' | 'No'                   |
		And I close all client application windows
...
Scenario: _041162 check Purchase order closing movements by the Register  "R2011 Shipment of Purchase orders"
	...
	* Check movements by the Register  "R2011 Shipment of Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                   | 'Receipt'     | '09.03.2021 15:41:08' | '-8'        | 'Main Company' | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  |
...
Scenario: _041167 check Purchase order closing movements by the Register  "R1012 Invoice closing of Purchase orders"
	...
	* Check movements by the Register  "R2012 Invoice closing of Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | 'Receipt'     | '09.03.2021 15:41:08' | '-8'        | '-960'| '-813,56'    | 'Main Company' | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'TRY'      | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' |
