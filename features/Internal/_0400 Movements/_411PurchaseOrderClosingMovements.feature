...
Scenario: _041170 check Purchase order closing movements by the Register (different ItemKey)		
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Main Company'        | ''                    | 'Local currency'                       | 'TRY'                                            | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'ODS'                     | '*'                                              | '50'                | '17 500'              | '14 830,51'  | 'No'                   | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Main Company'        | ''                    | 'Local currency'                       | 'TRY'                                            | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'PZU'                     | '*'                                              | '50'                | '16 000'              | '13 559,32'  | 'No'                   | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Main Company'        | ''                    | 'Reporting currency'                   | 'USD'                                            | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'ODS'                     | '*'                                              | '50'                | '2 996'               | '2 538,98'   | 'No'                   | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Main Company'        | ''                    | 'Reporting currency'                   | 'USD'                                            | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'PZU'                     | '*'                                              | '50'                | '2 739,2'             | '2 321,36'   | 'No'                   | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Main Company'        | ''                    | 'en description is empty'              | 'TRY'                                            | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'ODS'                     | '*'                                              | '50'                | '17 500'              | '14 830,51'  | 'No'                   | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Main Company'        | ''                    | 'en description is empty'              | 'TRY'                                            | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'PZU'                     | '*'                                              | '50'                | '16 000'              | '13 559,32'  | 'No'                   | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | ''                                                   | ''                    | ''                    | ''                                     | ''                                               | ''                                               | ''                        | ''                                               | ''                  | ''                    | ''           | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| 'Register  "R1012 Invoice closing of purchase orders"' | ''                                                   | ''                    | ''                    | ''                                     | ''                                               | ''                                               | ''                        | ''                                               | ''                  | ''                    | ''           | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | 'Period'                                             | 'RecordType'          | 'Company'             | 'Branch'                               | 'Order'                                          | 'Currency'                                       | 'Item key'                | 'Row key'                                        | 'Quantity'          | 'Amount'              | 'Net amount' | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Main Company'        | ''                                     | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'TRY'                                            | 'ODS'                     | '*'                                              | '50'                | '17 500'              | '14 830,51'  | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Main Company'        | ''                                     | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'TRY'                                            | 'PZU'                     | '*'                                              | '50'                | '16 000'              | '13 559,32'  | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                                     | ''                                                   | ''                    | ''                    | ''                                     | ''                                               | ''                                               | ''                        | ''                                               | ''                  | ''                    | ''           | ''                     | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			...
			| ''                                                     | 'Main Company'                                       | ''                    | '10.04.2025 22:26:08' | '                                    ' | 'TRY'                                            | 'Ferron BP'                                      | 'Company Ferron BP'       | 'Purchase order 2 326 dated 10.04.2025 22:01:33' | 'Yes'               | 'No'                  | '*'          | 'Vendor Ferron, TRY'   | ''        | 'en description is empty' | 'TRY'                  | ''       | 'Yes'                     | 'No'                   | 'Receipt'     |
		And I close all client application windows
