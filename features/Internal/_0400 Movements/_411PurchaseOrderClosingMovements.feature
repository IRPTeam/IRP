...
Scenario: _041168 check Purchase order closing movements by the Register  "TM1010B Row ID movements"
	...
	* Check movements by the Register  "TM1010B Row ID movements" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                     | 'Receipt'     | '$$DatePurchaseOrderClosing37$$' | '-64'       | '0e65d648-bd28-47a2-84dc-e260219c1395' | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'PI&GR' | 'Purchase order 37 dated 09.03.2021 14:29:00' |
			| ''                                     | 'Receipt'     | '$$DatePurchaseOrderClosing37$$' | '-1'        | 'da5e404f-fed0-41c5-81dc-b8eadd89e699' | 'da5e404f-fed0-41c5-81dc-b8eadd89e699' | 'PI'    | 'Purchase order 37 dated 09.03.2021 14:29:00' |
		And I close all client application windows
