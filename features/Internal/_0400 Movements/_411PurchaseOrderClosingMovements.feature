...
Scenario: _041159 check Purchase order closing movements by the Register  "Register  "R1010 Purchase orders""
	...
	* Check movements by the Register  "R2010 Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                  | '$$DatePurchaseOrderClosing37$$' | '-8'        | '-960'    | '-813,56'    | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'No'                   |
			| ''                                  | '$$DatePurchaseOrderClosing37$$' | '-8'        | '-960'    | '-813,56'    | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'No'                   |
			| ''                                  | '$$DatePurchaseOrderClosing37$$' | '-8'        | '-164,35' | '-139,28'    | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'No'                   |
...
Scenario: _041160 check Purchase order closing movements by the Register  "R2014 Canceled Purchase orders"
	...
	* Check movements by the Register  "R2014 Canceled Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | '$$DatePurchaseOrderClosing37$$' | '8'         | '164,35' | '139,28'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'not available' | 'No'                   |
			| ''                                           | '$$DatePurchaseOrderClosing37$$' | '8'         | '960'    | '813,56'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'not available' | 'No'                   |
			| ''                                           | '$$DatePurchaseOrderClosing37$$' | '8'         | '960'    | '813,56'     | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | 'not available' | 'No'                   |
		And I close all client application windows
...
Scenario: _041167 check Purchase order closing movements by the Register  "R1012 Invoice closing of Purchase orders"
	...
	* Check movements by the Register  "R2012 Invoice closing of Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | '$$DatePurchaseOrderClosing37$$' | 'Receipt'    | 'Main Company' | 'Front office' | 'Purchase order 37 dated 09.03.2021 14:29:00' | 'TRY'      | 'XS/Blue'  | '0e65d648-bd28-47a2-84dc-e260219c1395' | '-8'       | '-960'   | '-813,56'    |
...
Scenario: _041170 check Purchase order closing movements by the Register (different ItemKey)		
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "Posted documents registry"'                | ''                                                   | ''                    | ''             | ''            | ''                                            | ''         | ''                                     | ''                                     | ''         | ''       | ''           |
			| ''                                                     | 'Document'                                           | 'Date'                | 'Number'       | 'Create date' | 'Modify date'                                 | 'Author'   | 'Editor'                               | 'Manual movements edit'                | ''         | ''       | ''           |
			| ''                                                     | 'Purchase order closing 2 dated 10.04.2025 22:26:08' | '10.04.2025 22:26:08' | '2'            | '*'           | '*'                                           | '*'        | '*'                                    | 'No'                                   | ''         | ''       | ''           |
			| ''                                                     | ''                                                   | ''                    | ''             | ''            | ''                                            | ''         | ''                                     | ''                                     | ''         | ''       | ''           |
			| 'Register  "R1011 Receipt of purchase orders"'         | ''                                                   | ''                    | ''             | ''            | ''                                            | ''         | ''                                     | ''                                     | ''         | ''       | ''           |
			| ''                                                     | 'Period'                                             | 'RecordType'          | 'Company'      | 'Branch'      | 'Order'                                       | 'Item key' | 'Row key'                              | 'Quantity'                             | ''         | ''       | ''           |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Main Company' | ''            | 'Purchase order 38 dated 10.04.2025 22:01:33' | 'XS/Blue'  | '0d8ae922-3dce-43ba-bf9e-16911ea3d9a1' | '50'                                   | ''         | ''       | ''           |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Main Company' | ''            | 'Purchase order 38 dated 10.04.2025 22:01:33' | 'M/White'  | '0d8ae922-3dce-43ba-bf9e-16911ea3d9a1' | '-50'                                  | ''         | ''       | ''           |
			| ''                                                     | ''                                                   | ''                    | ''             | ''            | ''                                            | ''         | ''                                     | ''                                     | ''         | ''       | ''           |
			| 'Register  "R1012 Invoice closing of purchase orders"' | ''                                                   | ''                    | ''             | ''            | ''                                            | ''         | ''                                     | ''                                     | ''         | ''       | ''           |
			| ''                                                     | 'Period'                                             | 'RecordType'          | 'Company'      | 'Branch'      | 'Order'                                       | 'Currency' | 'Item key'                             | 'Row key'                              | 'Quantity' | 'Amount' | 'Net amount' |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Main Company' | ''            | 'Purchase order 38 dated 10.04.2025 22:01:33' | 'TRY'      | 'S/Yellow'                             | 'd1131a2c-5a04-4f52-9ab9-2407964a3439' | ''         | '17 500' | '14 830,51'  |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Main Company' | ''            | 'Purchase order 38 dated 10.04.2025 22:01:33' | 'TRY'      | 'M/White'                              | '0d8ae922-3dce-43ba-bf9e-16911ea3d9a1' | ''         | '16 000' | '13 559,32'  |
			| ''                                                     | ''                                                   | ''                    | ''             | ''            | ''                                            | ''         | ''                                     | ''                                     | ''         | ''       | ''           |
			| 'Register  "R4035 Incoming stocks"'                    | ''                                                   | ''                    | ''             | ''            | ''                                            | ''         | ''                                     | ''                                     | ''         | ''       | ''           |
			| ''                                                     | 'Period'                                             | 'RecordType'          | 'Store'        | 'Item key'    | 'Order'                                       | 'Quantity' | ''                                     | ''                                     | ''         | ''       | ''           |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Store 01'     | 'S/Yellow'    | 'Purchase order 38 dated 10.04.2025 22:01:33' | '-50'      | ''                                     | ''                                     | ''         | ''       | ''           |
			| ''                                                     | '10.04.2025 22:26:08'                                | 'Receipt'             | 'Store 03'     | 'M/White'     | 'Purchase order 38 dated 10.04.2025 22:01:33' | '-50'      | ''                                     | ''                                     | ''         | ''       | ''           |
		And I close all client application windows