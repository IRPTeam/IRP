...
Scenario: _041201 check Sales return order movements by the Register  "R2010 Sales orders"
	...
	* Check movements by the Register  "R2010 Sales orders"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                 | '12.03.2021 09:19:54' | '1'         | '95'       | '80,51'      | '5'             | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales return order 102 dated 12.03.2021 09:19:54' | 'Internet' | '37e26a55-1218-4af2-a620-5129b5ac46c9' | ''                   | ''             | 'No'                   |
			...
			| ''                                                 | '12.03.2021 09:19:54' | '1'         | '494'      | '418,64'     | '26'            | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales return order 102 dated 12.03.2021 09:19:54' | 'XS/Blue'  | '9504489e-16cb-4b67-9691-4fef4a8c41e5' | ''                   | ''             | 'No'                   |
			...
			| ''                                                 | '12.03.2021 09:19:54' | '10'        | '3 325'    | '2 817,8'    | '175'           | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales return order 102 dated 12.03.2021 09:19:54' | '36/Red'   | '51779d1c-2838-4ad7-b00f-42a0f64224ba' | ''                   | ''             | 'No'                   |
			...
			| ''                                                 | '12.03.2021 09:19:54' | '24'        | '15 960'   | '13 525,42'  | '840'           | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales return order 102 dated 12.03.2021 09:19:54' | '36/18SD'  | '77531307-5aaa-44a6-a1df-979318620e56' | ''                   | ''             | 'No'                   |
