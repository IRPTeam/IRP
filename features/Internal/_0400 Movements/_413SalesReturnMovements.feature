...
Scenario: _041307 check Sales return movements by the Register  "R1040 Taxes outgoing"
	...
	* Check movements by the Register  "R1040 Taxes outgoing"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '32,75'     | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Return'       | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '191,29'    | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Return'       | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '191,29'    | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Return'       | 'en description is empty'      | 'TRY'      | 'TRY'                  |		
	And I close all client application windows
...
Scenario: _041341 check Sales return movements by the Register  "Posted documents registry"
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Sales return 102 dated 12.03.2021 08:50:27' | '12.03.2021 08:50:27' | '102'    | '*'           | '*'           | 'en description is empty' | 'en description is empty' | 'No'                    |
	And I close all client application windows		

Scenario: _041342 check Sales return movements by the Register  "R6060 Cost of goods sold"
	And I close all client application windows
	Given I open hyperlink "e1cib/list/Document.SalesReturn"
	And I go to line in "List" table
		| 'Number' |
	...
	* Check movements by the Register "Posted documents registry"
		...
		And I click "Generate report" button
		Then "ResultTable" spreadsheet document is equal
			| 'Sales return 1 114 dated 12.05.2025 0:00:00'       | ''                   | ''             | ''                                              | ''         | ''                        | ''         | ''         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | ''                                                      |
			...
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'Local currency'          | 'TRY'      | '-50'      | '-14 830,51'     | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'Local currency'          | 'TRY'      | '-30'      | '-9 661,02'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'en description is empty' | 'TRY'      | '-50'      | '-14 830,51'     | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '-14 830,51'   | '-14 830,51'       | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'Local currency'          | 'TRY'      | '-50'      | '-14 830,51'     | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '-14 830,51'   | '-14 830,51'       | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/Brown'  | 'Reporting currency'      | 'USD'      | '-50'      | '-2 538,98'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '-2 538,98'    | '-2 538,98'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'en description is empty' | 'TRY'      | '-30'      | '-9 661,02'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '-9 661,02'    | '-9 661,02'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'Local currency'          | 'TRY'      | '-30'      | '-9 661,02'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '-9 661,02'    | '-9 661,02'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                  | '12.05.2025 0:00:00' | 'Main Company' | 'Sales invoice 1 114 dated 05.05.2025 12:00:00' | 'M/White'  | 'Reporting currency'      | 'USD'      | '-30'      | '-1 653,97'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '-1 653,97'    | '-1 653,97'        | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
	And I close all client application windows		