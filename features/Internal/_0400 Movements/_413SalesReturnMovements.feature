...
Scenario: _041307 check Sales return movements by the Register  "R1040 Taxes outgoing"
	...
	* Check movements by the Register  "R1040 Taxes outgoing"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '13,78'          | '2,48'       | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '71,67'          | '12,9'       | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '80,51'          | '14,49'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '80,51'          | '14,49'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '96,48'          | '17,37'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '418,64'         | '75,36'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '418,64'         | '75,36'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '563,56'         | '101,44'     | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                           | 'Receipt'     | '12.03.2021 08:44:18' | '563,56'         | '101,44'     | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |	
	And I close all client application windows
