...
Scenario: _041326 check Sales return movements by the Register  "T2015 Transactions info"
	...
	* Check movements by the Register  "T2015 Transactions info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | '-9 360'    | 'Yes'    | 'No'      | 'Main Company' | 'Distribution department' | ''      | '21.04.2021 14:19:47' | '                                    ' | 'TRY'      | 'Lunch'   | 'Company Lunch' | 'Basic Partner terms, TRY' | 'No'                    | 'Yes'                     | 'Sales return 106 dated 21.04.2021 14:19:47' | '*'         | ''        | 'en description is empty' | 'TRY'                  |
	And I close all client application windows
