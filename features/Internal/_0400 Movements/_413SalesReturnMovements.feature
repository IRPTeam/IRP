...
Scenario: _041309 check Sales return movements by the Register  "R5021 Revenues"
	...
	* Check movements by the Register  "R5021 Revenues"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | '12.03.2021 08:44:18' | '-80,51'    | '-95'               | 'Main Company' | 'Distribution department' | 'Front office'            | 'Revenue'      | 'Internet' | 'TRY'      | ''                    | 'Local currency'               |
			| ''                                           | '12.03.2021 08:44:18' | '-80,51'    | '-95'               | 'Main Company' | 'Distribution department' | 'Front office'            | 'Revenue'      | 'Internet' | 'TRY'      | ''                    | 'TRY'                          |
			| ''                                           | '12.03.2021 08:44:18' | '-80,51'    | '-95'               | 'Main Company' | 'Distribution department' | 'Front office'            | 'Revenue'      | 'Internet' | 'TRY'      | ''                    | 'en description is empty'      |
			...
			| ''                                           | '12.03.2021 08:44:18' | '-13,78'    | '-16,26'            | 'Main Company' | 'Distribution department' | 'Front office'            | 'Revenue'      | 'Internet' | 'USD'      | ''                    | 'Reporting currency'           |		
	And I close all client application windows
...
Scenario: _041327 check Sales return movements by the Register  "R2001 Sales" (withot SI)
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Period'              | 'Resources' | ''        | ''           | ''              | 'Dimensions'   | ''                     | ''                             | ''         | ''                                           | ''         | ''                                     | ''             |
			| ''                                           | ''                    | 'Quantity'  | 'Amount'  | 'Net amount' | 'Offers amount' | 'Company'      | 'Branch'               | 'Multi currency movement type' | 'Currency' | 'Invoice'                                    | 'Item key' | 'Row key'                              | 'Sales person' |
			| ''                                           | '12.03.2021 08:50:27' | '-2'        | '-665'    | '-563,56'    | '-35'           | 'Main Company' | 'Logistics department' | 'Local currency'               | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | '36/Red'   | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-2'        | '-665'    | '-563,56'    | '-35'           | 'Main Company' | 'Logistics department' | 'TRY'                          | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | '36/Red'   | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-2'        | '-665'    | '-563,56'    | '-35'           | 'Main Company' | 'Logistics department' | 'en description is empty'      | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | '36/Red'   | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-2'        | '-113,85' | '-96,48'     | '-5,99'         | 'Main Company' | 'Logistics department' | 'Reporting currency'           | 'USD'      | 'Sales return 102 dated 12.03.2021 08:50:27' | '36/Red'   | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '-494'    | '-418,64'    | '-26'           | 'Main Company' | 'Logistics department' | 'Local currency'               | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'XS/Blue'  | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '-494'    | '-418,64'    | '-26'           | 'Main Company' | 'Logistics department' | 'TRY'                          | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'XS/Blue'  | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '-494'    | '-418,64'    | '-26'           | 'Main Company' | 'Logistics department' | 'en description is empty'      | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'XS/Blue'  | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '-84,57'  | '-71,67'     | '-4,45'         | 'Main Company' | 'Logistics department' | 'Reporting currency'           | 'USD'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'XS/Blue'  | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '0,86'    | '0,73'       | '-0,86'         | 'Main Company' | 'Logistics department' | 'Reporting currency'           | 'USD'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'Internet' | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '5'       | '4,24'       | '-5'            | 'Main Company' | 'Logistics department' | 'Local currency'               | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'Internet' | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '5'       | '4,24'       | '-5'            | 'Main Company' | 'Logistics department' | 'TRY'                          | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'Internet' | '                                    ' | ''             |
			| ''                                           | '12.03.2021 08:50:27' | '-1'        | '5'       | '4,24'       | '-5'            | 'Main Company' | 'Logistics department' | 'en description is empty'      | 'TRY'      | 'Sales return 102 dated 12.03.2021 08:50:27' | 'Internet' | '                                    ' | ''             |		
	And I close all client application windows
