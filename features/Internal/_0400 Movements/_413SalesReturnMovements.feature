...
Scenario: _041322 check Sales return movements by the Register  "R2020 Advances from customer" (Due as advance - True)
	...
	* Check movements by the Register  "R2020 Advances from customer"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Receipt'     | '21.04.2021 14:19:47' | '1 602,43'  | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Company Lunch' | 'Lunch'   | 'Sales return 106 dated 21.04.2021 14:19:47' | 'No'                   | ''                           |
			| ''                                           | 'Receipt'     | '21.04.2021 14:19:47' | '9 360'     | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Company Lunch' | 'Lunch'   | 'Sales return 106 dated 21.04.2021 14:19:47' | 'No'                   | ''                           |
			| ''                                           | 'Receipt'     | '21.04.2021 14:19:47' | '9 360'     | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Company Lunch' | 'Lunch'   | 'Sales return 106 dated 21.04.2021 14:19:47' | 'No'                   | ''                           |						
	And I close all client application windows
