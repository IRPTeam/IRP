...
Scenario: _041501 check Purchase return order movements by the Register "R1010 Purchase orders"
	...
	* Check movements by the Register  "R1010 Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '46,22'  | '39,17'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
...
Scenario: _041502 check Purchase return order movements by the Register "R1012 Invoice closing of purchase orders"
	...
	* Check movements by the Register  "R1012 Invoice closing of purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | 'Receipt'     | '14.03.2021 18:52:33' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'TRY'      | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' |
