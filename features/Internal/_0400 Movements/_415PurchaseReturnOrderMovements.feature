...
Scenario: _041501 check Purchase return order movements by the Register "R1010 Purchase orders"
	...
	* Check movements by the Register  "R1010 Purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                    | '14.03.2021 18:52:33' | '1'         | '30,82'  | '26,11'      | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '1'         | '180'    | '152,54'     | 'Main Company' | 'Local currency'               | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '1'         | '180'    | '152,54'     | 'Main Company' | 'TRY'                          | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '1'         | '180'    | '152,54'     | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '46,22'  | '39,17'      | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Local currency'               | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '270'    | '228,81'     | 'Main Company' | 'TRY'                          | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '2'         | '270'    | '228,81'     | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '5'         | '77,04'  | '65,29'      | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '5'         | '450'    | '381,36'     | 'Main Company' | 'Local currency'               | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '5'         | '450'    | '381,36'     | 'Main Company' | 'TRY'                          | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | 'No'                   |
			| ''                                                    | '14.03.2021 18:52:33' | '5'         | '450'    | '381,36'     | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | 'No'                   |
	And I close all client application windows
...
Scenario: _041502 check Purchase return order movements by the Register "R1012 Invoice closing of purchase orders"
	...
	* Check movements by the Register  "R1012 Invoice closing of purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | 'Receipt'     | '14.03.2021 18:52:33' | '1'         | '180'    | '152,54'     | 'Main Company' | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'TRY'      | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' |
