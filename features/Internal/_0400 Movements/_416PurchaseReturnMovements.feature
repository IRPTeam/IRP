...
Scenario: _041601 check Purchase return movements by the Register  "R1002 Purchase returns"
	...
	* Check movements by the Register  "R1002 Purchase returns" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '14.03.2021 18:53:34' | '1'         | '30,82'  | '26,11'      | 'Main Company' | 'Reporting currency'           | 'USD'      | ''        | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '1'         | '180'    | '152,54'     | 'Main Company' | 'Local currency'               | 'TRY'      | ''        | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '1'         | '180'    | '152,54'     | 'Main Company' | 'TRY'                          | 'TRY'      | ''        | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '1'         | '180'    | '152,54'     | 'Main Company' | 'en description is empty'      | 'TRY'      | ''        | '36/Yellow' | '923e7825-c20f-4a3e-a983-2b85d80e475a' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '46,22'  | '39,17'      | 'Main Company' | 'Reporting currency'           | 'USD'      | ''        | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Local currency'               | 'TRY'      | ''        | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '270'    | '228,81'     | 'Main Company' | 'TRY'                          | 'TRY'      | ''        | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '270'    | '228,81'     | 'Main Company' | 'en description is empty'      | 'TRY'      | ''        | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '5'         | '77,04'  | '65,29'      | 'Main Company' | 'Reporting currency'           | 'USD'      | ''        | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '5'         | '450'    | '381,36'     | 'Main Company' | 'Local currency'               | 'TRY'      | ''        | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '5'         | '450'    | '381,36'     | 'Main Company' | 'TRY'                          | 'TRY'      | ''        | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '5'         | '450'    | '381,36'     | 'Main Company' | 'en description is empty'      | 'TRY'      | ''        | 'S/Yellow'  | '4fcbb4cf-3824-47fb-89b5-50d151315d4d' | ''              | 'No'                   |
	And I close all client application windows
