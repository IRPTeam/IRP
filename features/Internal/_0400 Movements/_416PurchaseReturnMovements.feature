...
Scenario: _041601 check Purchase return movements by the Register  "R1002 Purchase returns"
	...
	* Check movements by the Register  "R1002 Purchase returns" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '46,22'  | '39,17'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | ''              | 'No'                   |
...
Scenario: _041602 check Purchase return movements by the Register  "R1021 Vendors transactions" (Due as advance - False)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-900'      | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-900'      | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-900'      | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-154,08'   | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | 'No'                   | ''                         |
	And I close all client application windows
...
Scenario: _041603 check Purchase return movements by the Register  "R1005 Special offers of purchases" (with special offer)
	...
	* Check movements by the Register  "R1005 Special offers of purchases" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '14.03.2021 18:53:34' | '5,14'          | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Purchase return 231 dated 14.03.2021 18:53:34' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'DocumentDiscount' | 'No'                   |
			...
			| ''                                              | '14.03.2021 18:53:34' | '30'            | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Purchase return 231 dated 14.03.2021 18:53:34' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'DocumentDiscount' | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '30'            | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'Purchase return 231 dated 14.03.2021 18:53:34' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'DocumentDiscount' | 'No'                   |
			| ''                                              | '14.03.2021 18:53:34' | '30'            | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Purchase return 231 dated 14.03.2021 18:53:34' | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' | 'DocumentDiscount' | 'No'                   |
...
Scenario: _041608 check Purchase return movements by the Register  "R1012 Invoice closing of purchase orders" (with PRO)
	...
	* Check movements by the Register  "R1012 Invoice closing of purchase orders" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | 'Expense'     | '14.03.2021 18:53:34' | '2'         | '270'    | '228,81'     | 'Main Company' | 'Front office' | 'Purchase return order 231 dated 14.03.2021 18:52:33' | 'TRY'      | 'Interner'  | '1b90516b-b3ac-4ca5-bb47-44477975f242' |
...
Scenario: _041617 check Purchase return movements by the Register  "R1020 Advances to vendors" (Due as advance - True)
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | 'Receipt'     | '14.03.2021 19:26:51' | '68,48'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | ''                                              | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 19:26:51' | '400'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | ''                                              | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 19:26:51' | '400'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | ''                                              | 'No'                   | ''                         |		
	And I close all client application windows
