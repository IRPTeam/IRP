...
Scenario: _041602 check Purchase return movements by the Register  "R1021 Vendors transactions" (Due as advance - False)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-900'      | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-900'      | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-900'      | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | ''                         |
			| ''                                              | 'Receipt'     | '14.03.2021 18:53:34' | '-154,08'   | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'No'                   | ''                         |
	And I close all client application windows
