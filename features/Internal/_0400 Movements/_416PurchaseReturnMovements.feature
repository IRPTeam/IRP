...
Scenario: _041618 check Purchase return movements by the Register  "R5022 Expenses"
	...
	* Check movements by the Register  "R5022 Expenses" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | '14.03.2021 18:53:34'   | '-228,81'     | '-270'                | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | 'TRY'        | ''                      | 'Local currency'                 | ''                             |
			| ''                                                | '14.03.2021 18:53:34'   | '-228,81'     | '-270'                | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | 'TRY'        | ''                      | 'TRY'                            | ''                             |
			| ''                                                | '14.03.2021 18:53:34'   | '-228,81'     | '-270'                | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | 'TRY'        | ''                      | 'en description is empty'        | ''                             |
			| ''                                                | '14.03.2021 18:53:34'   | '-39,17'      | '-46,22'              | ''              | 'Main Company'   | 'Front office'   | 'Front office'         | 'Expense'        | 'Internet'   | 'USD'        | ''                      | 'Reporting currency'             | ''                             |
	And I close all client application windows
