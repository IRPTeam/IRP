...
Scenario: _041623 check Purchase return movements by the Register  "T2015 Transactions info" (Return to vendor)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | 'Main Company' | 'Front office' | ''      | '14.03.2021 19:26:51' | '                                    ' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Yes'                   | 'No'                      | 'Purchase return 233 dated 14.03.2021 19:26:51' | 'cc52ea86-6a8c-4017-855b-474c88a46215' | ''        | '-400'   | 'Yes'    | 'No'      |		
	And I close all client application windows
