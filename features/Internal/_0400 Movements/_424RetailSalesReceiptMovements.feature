...
Scenario: _042413 check Retail sales receipt movements by the Register  "R2001 Sales" (consignor and own stocks) 
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | '14.11.2022 13:29:44' | '1'         | '466,1'  | '466,1'      | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | 'XL/Black' | ''                  | '8b0b91bc-33a7-4a41-a6f9-c2759ac4de23' | ''             |
			...
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '1 100'  | '932,2'      | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | 'UNIQ'     | '0514'              | '6ebea8a7-366d-409c-84a7-19f5714085e9' | ''             |
			...
			| ''                                                     | '14.11.2022 13:29:44' | '4'         | '1 600'  | '1 600'      | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | 'XL/Green' | ''                  | 'f3d688c7-7c7b-4432-9725-06721e496320' | ''             |
...
Scenario: _042423 check Retail sales receipt movements by the Register  "R8014 Consignor sales" (consignor and own stocks) 
	...
	* Check movements by the Register  "R8014 Consignor sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | '14.11.2022 13:29:44' | '1'         | '466,1'      | '466,1'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Black' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'TRY'                          | 'TRY'      | 'No'                | ''                       | '466,1' |
			...
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '932,2'      | '1 100'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'UNIQ'     | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'TRY'                          | 'TRY'      | 'No'                | ''                       | '466,1' |
			...
			| ''                                                     | '14.11.2022 13:29:44' | '4'         | '1 600'      | '1 600'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Green' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'TRY'                          | 'TRY'      | 'No'                | ''                       | '400'   |
...
Scenario: _0424286 check Retail sales receipt movements by the Register  "R2001 Sales" (serial lot numbers)
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | '14.12.2023 16:12:46' | '1'         | '33,33'    | '28,25'      | '1,67'          | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 315 dated 14.12.2023 16:12:46' | 'PZU'      | '8908899879'        | 'b3fefa15-d15b-4319-946a-10cb1e53e17e' | ''             |
			...
			| ''                                                     | '14.12.2023 16:12:46' | '2'         | '66,67'    | '56,5'       | '3,33'          | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 315 dated 14.12.2023 16:12:46' | 'PZU'      | '8908899877'        | 'b3fefa15-d15b-4319-946a-10cb1e53e17e' | ''             |
			...
			| ''                                                     | '14.12.2023 16:12:46' | '3'         | '118'      | '100'        | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 315 dated 14.12.2023 16:12:46' | 'S/Yellow' | ''                  | '33027652-ad8b-4e9b-a577-ccbd10be66e4' | ''             |
			...
			| ''                                                     | '14.12.2023 16:12:46' | '3'         | '428,34'   | '363'        | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 315 dated 14.12.2023 16:12:46' | 'PZU'      | '8908899879'        | '9aab5db9-aec6-4b53-83b4-9abf09f928f2' | ''             |
			...
			| ''                                                     | '14.12.2023 16:12:46' | '3'         | '1 947,02' | '1 650,02'   | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 315 dated 14.12.2023 16:12:46' | 'PZU'      | '0512'              | 'd103bb73-25db-4a27-915a-f51f024596aa' | ''             |
			...
			| ''                                                     | '14.12.2023 16:12:46' | '5'         | '130,11'   | '110,26'     | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 315 dated 14.12.2023 16:12:46' | 'UNIQ'     | '0512'              | 'b974016c-56d7-415d-8f5a-f3859d6404ca' | ''             |
			...
			| ''                                                     | '14.12.2023 16:12:46' | '6'         | '3 894,05' | '3 300,04'   | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 315 dated 14.12.2023 16:12:46' | 'PZU'      | '0514'              | 'd103bb73-25db-4a27-915a-f51f024596aa' | ''             |
