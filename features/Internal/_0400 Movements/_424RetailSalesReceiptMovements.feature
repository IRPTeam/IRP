...
Scenario: _042413 check Retail sales receipt movements by the Register  "R2001 Sales" (consignor and own stocks) 
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '188,32' | '159,59'     | ''              | 'Main Company' | 'Shop 01' | 'Reporting currency'           | 'USD'      | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | 'UNIQ'     | '6ebea8a7-366d-409c-84a7-19f5714085e9' | ''             |
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '1 100'  | '932,2'      | ''              | 'Main Company' | 'Shop 01' | 'Local currency'               | 'TRY'      | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | 'UNIQ'     | '6ebea8a7-366d-409c-84a7-19f5714085e9' | ''             |
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '1 100'  | '932,2'      | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | 'UNIQ'     | '6ebea8a7-366d-409c-84a7-19f5714085e9' | ''             |
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '1 100'  | '932,2'      | ''              | 'Main Company' | 'Shop 01' | 'en description is empty'      | 'TRY'      | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | 'UNIQ'     | '6ebea8a7-366d-409c-84a7-19f5714085e9' | ''             |
