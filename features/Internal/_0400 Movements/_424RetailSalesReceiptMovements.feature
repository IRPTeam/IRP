...
Scenario: _0424288 check Retail sales receipt movements by the Register  "R6060 Cost of goods sold"
	...
	* Check movements by the Register "Posted documents registry"
		...
		And I click "Generate report" button
		Then "ResultTable" spreadsheet document is equal
			| 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | ''                   | ''             | ''                                                    | ''              | ''                        | ''         | ''         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | ''                                                      |
			...
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Router'        | 'Local currency'          | 'TRY'      | '1'        | '225,1'          | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Scarf + Dress' | 'Local currency'          | 'TRY'      | '10'       | '1 406,88'       | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''             | ''                 | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Router'        | 'en description is empty' | 'TRY'      | '1'        | '225,1'          | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '225,1'        | '225,1'            | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Router'        | 'Local currency'          | 'TRY'      | '1'        | '225,1'          | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '225,1'        | '225,1'            | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Router'        | 'Reporting currency'      | 'USD'      | '1'        | '38,54'          | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '38,54'        | '38,54'            | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Scarf + Dress' | 'en description is empty' | 'TRY'      | '10'       | '1 406,88'       | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '1 406,88'     | '1 406,88'         | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Scarf + Dress' | 'Local currency'          | 'TRY'      | '10'       | '1 406,88'       | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '1 406,88'     | '1 406,88'         | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
			| ''                                                    | '07.04.2025 0:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 0:00:00' | 'Scarf + Dress' | 'Reporting currency'      | 'USD'      | '10'       | '240,86'         | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '240,86'       | '240,86'           | ''                 | 'Calculation movement costs 1 dated 01.05.2025 0:00:00' |
	And I close all client application windows		