...
Scenario: _042423 check Retail sales receipt movements by the Register  "R8014 Consignor sales" (consignor and own stocks) 
	...
	* Check movements by the Register  "R8014 Consignor sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | 'Period'              | 'Resources' | ''           | ''       | 'Dimensions'                           | ''             | ''               | ''                    | ''                                                     | ''                        | ''         | ''                  | ''                 | ''     | ''                        | ''                          | ''                             | ''         | ''                  | ''                       | ''      | ''                     |
			| ''                                                     | ''                    | 'Quantity'  | 'Net amount' | 'Amount' | 'DELETE row key'                       | 'Company'      | 'DELETE partner' | 'DELETE Partner term' | 'Sales invoice'                                        | 'DELETE purchase invoice' | 'Item key' | 'Serial lot number' | 'Source of origin' | 'Unit' | 'Price type'              | 'DELETE dont calculate row' | 'Multi currency movement type' | 'Currency' | 'Price include tax' | 'DELETE consignor price' | 'Price' | 'Transaction currency' |
			| ''                                                     | '14.11.2022 13:29:44' | '1'         | '79,8'       | '79,8'   | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Black' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Reporting currency'           | 'USD'      | 'No'                | ''                       | '79,8'  | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '1'         | '466,1'      | '466,1'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Black' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Local currency'               | 'TRY'      | 'No'                | ''                       | '466,1' | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '1'         | '466,1'      | '466,1'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Black' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'en description is empty'      | 'TRY'      | 'No'                | ''                       | '466,1' | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '159,59'     | '188,32' | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'UNIQ'     | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Reporting currency'           | 'USD'      | 'No'                | ''                       | '79,8'  | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '932,2'      | '1 100'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'UNIQ'     | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Local currency'               | 'TRY'      | 'No'                | ''                       | '466,1' | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '2'         | '932,2'      | '1 100'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'UNIQ'     | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'en description is empty'      | 'TRY'      | 'No'                | ''                       | '466,1' | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '4'         | '273,92'     | '273,92' | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Green' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Reporting currency'           | 'USD'      | 'No'                | ''                       | '68,48' | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '4'         | '1 600'      | '1 600'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Green' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Local currency'               | 'TRY'      | 'No'                | ''                       | '400'   | 'TRY'                  |
			| ''                                                     | '14.11.2022 13:29:44' | '4'         | '1 600'      | '1 600'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Green' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'en description is empty'      | 'TRY'      | 'No'                | ''                       | '400'   | 'TRY'                  |
		And I close all client application windows
...
Scenario: _0424285 check postponed Retail sales receipt movements
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | 'Retail sales receipt 1 314 dated 07.09.2023 16:01:50' | '07.09.2023 16:01:50'                                  | '1 314'                                | '24.06.2026 18:22:36'      | '24.06.2026 18:22:37' | 'en description is empty' | 'en description is empty' | 'No'                    |
			| ''                                                     | ''                                                     | ''                                                     | ''                                     | ''                         | ''                    | ''                        | ''                        | ''                      |
			| 'Register  "Row IDStamps"'                             | ''                                                     | ''                                                     | ''                                     | ''                         | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | 'Period'                                               | 'Resources'                                            | 'Dimensions'                           | ''                         | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | ''                                                     | 'Value'                                                | 'Row ref'                              | 'Attribute'                | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | '533b1402-4586-42be-a323-791c92034c95' | 'IsFixedItemKey'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | '533b1402-4586-42be-a323-791c92034c95' | 'IsFixedStore'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | '533b1402-4586-42be-a323-791c92034c95' | 'IsVariableItemKey'        | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | '533b1402-4586-42be-a323-791c92034c95' | 'IsVariableStore'          | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | '533b1402-4586-42be-a323-791c92034c95' | 'PriceIncludeTaxPurchases' | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'IsFixedItemKey'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'IsFixedStore'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'IsVariableItemKey'        | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'IsVariableStore'          | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'No'                                                   | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'PriceIncludeTaxPurchases' | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Yes'                                                  | '533b1402-4586-42be-a323-791c92034c95' | 'PriceIncludeTaxSales'     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Yes'                                                  | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'PriceIncludeTaxSales'     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Retail partner term'                                  | '533b1402-4586-42be-a323-791c92034c95' | 'AgreementSales'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Retail partner term'                                  | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'AgreementSales'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Shop 01'                                              | '533b1402-4586-42be-a323-791c92034c95' | 'Branch'                   | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Shop 01'                                              | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'Branch'                   | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Main Company'                                         | '533b1402-4586-42be-a323-791c92034c95' | 'Company'                  | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Main Company'                                         | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'Company'                  | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Company Retail customer'                              | '533b1402-4586-42be-a323-791c92034c95' | 'LegalNameSales'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Company Retail customer'                              | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'LegalNameSales'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'TRY'                                                  | '533b1402-4586-42be-a323-791c92034c95' | 'CurrencySales'            | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'TRY'                                                  | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'CurrencySales'            | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'XS/Blue'                                              | '533b1402-4586-42be-a323-791c92034c95' | 'ItemKey'                  | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | '37/18SD'                                              | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'ItemKey'                  | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Dress'                                                | '533b1402-4586-42be-a323-791c92034c95' | 'Item'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Boots'                                                | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'Item'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Retail customer'                                      | '533b1402-4586-42be-a323-791c92034c95' | 'PartnerSales'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Retail customer'                                      | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'PartnerSales'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Sam Jons'                                             | '533b1402-4586-42be-a323-791c92034c95' | 'RetailCustomer'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Sam Jons'                                             | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'RetailCustomer'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Store 01'                                             | '533b1402-4586-42be-a323-791c92034c95' | 'Store'                    | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Store 01'                                             | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'Store'                    | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'pcs'                                                  | '533b1402-4586-42be-a323-791c92034c95' | 'Unit'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'pcs'                                                  | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'Unit'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Retail sales receipt 1 314 dated 07.09.2023 16:01:50' | '533b1402-4586-42be-a323-791c92034c95' | 'Basis'                    | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Retail sales receipt 1 314 dated 07.09.2023 16:01:50' | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'Basis'                    | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Return from customer'                                 | '533b1402-4586-42be-a323-791c92034c95' | 'TransactionTypeRGR'       | ''                    | ''                        | ''                        | ''                      |
			| ''                                                     | '07.09.2023 16:01:50'                                  | 'Return from customer'                                 | 'b5cee53d-1a83-47f8-b263-f8f8fe6a3b4b' | 'TransactionTypeRGR'       | ''                    | ''                        | ''                        | ''                      |	
...
Scenario: _0424287 check Retail sales receipt movements by the Register  "Posted documents registry"
	And I close all client application windows
	Given I open hyperlink "e1cib/list/Document.RetailSalesReceipt"
	And I go to line in "List" table
		| 'Number' |
