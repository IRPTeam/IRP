...
Scenario: _0424285 check postponed Retail sales receipt movements
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                     | 'Retail sales receipt 1 314 dated 07.09.2023 16:01:50' | '07.09.2023 16:01:50' | '1 314'  | '27.09.2024 13:29:30' | '27.09.2024 13:29:30' | 'en description is empty' | 'en description is empty' | 'No'                    |		
