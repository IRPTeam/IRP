...
Scenario: _042518 check Retail return receipt movements by the Register  "R2001 Sales" (consignor and own stocks)
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                      | '14.11.2022 13:57:09' | '-2'        | '-1 040'  | '-881,36'    | ''              | 'Main Company' | 'Shop 01' | 'Local currency'               | 'TRY'      | ''                                                     | 'XS/Blue'  | '57bbb717-2bd9-4f1b-8b07-1e0b4c2839a4' | ''             |
			| ''                                                      | '14.11.2022 13:57:09' | '-2'        | '-1 040'  | '-881,36'    | ''              | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | ''                                                     | 'XS/Blue'  | '57bbb717-2bd9-4f1b-8b07-1e0b4c2839a4' | ''             |
			| ''                                                      | '14.11.2022 13:57:09' | '-2'        | '-1 040'  | '-881,36'    | ''              | 'Main Company' | 'Shop 01' | 'en description is empty'      | 'TRY'      | ''                                                     | 'XS/Blue'  | '57bbb717-2bd9-4f1b-8b07-1e0b4c2839a4' | ''             |
			...
			| ''                                                      | '14.11.2022 13:57:09' | '-2'        | '-178,05' | '-150,89'    | ''              | 'Main Company' | 'Shop 01' | 'Reporting currency'           | 'USD'      | ''                                                     | 'XS/Blue'  | '57bbb717-2bd9-4f1b-8b07-1e0b4c2839a4' | ''             |		
		And I close all client application windows
