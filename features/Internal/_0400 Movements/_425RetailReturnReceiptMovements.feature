...
Scenario: _042516 check Retail return receipt movements by the Register  "R3022 Cash in transit (outgoing)" (payment by POS, PostponedPayment) 
	...
	* Check movements by the Register  "R3022 Cash in transit (outgoing)"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R3022 Cash in transit (outgoing)"'          | ''            | ''                    | ''          | ''           | ''             | ''        | ''                             | ''         | ''                     | ''                                     | ''                                                      | ''                     |
			| ''                                                      | 'Record type' | 'Period'              | 'Resources' | ''           | 'Dimensions'   | ''        | ''                             | ''         | ''                     | ''                                     | ''                                                      | 'Attributes'           |
			| ''                                                      | ''            | ''                    | 'Amount'    | 'Commission' | 'Company'      | 'Branch'  | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Account'                              | 'Basis'                                                 | 'Deferred calculation' |
			| ''                                                      | 'Receipt'     | '27.06.2022 16:11:19' | '123,26'    | '1,23'       | 'Main Company' | 'Shop 01' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Retail return receipt 1 205 dated 27.06.2022 16:11:19' | 'No'                   |
			| ''                                                      | 'Receipt'     | '27.06.2022 16:11:19' | '719,99'    | '7,2'        | 'Main Company' | 'Shop 01' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Retail return receipt 1 205 dated 27.06.2022 16:11:19' | 'No'                   |
			| ''                                                      | 'Receipt'     | '27.06.2022 16:11:19' | '719,99'    | '7,2'        | 'Main Company' | 'Shop 01' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Retail return receipt 1 205 dated 27.06.2022 16:11:19' | 'No'                   |
			| ''                                                      | 'Receipt'     | '27.06.2022 16:11:19' | '719,99'    | '7,2'        | 'Main Company' | 'Shop 01' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Retail return receipt 1 205 dated 27.06.2022 16:11:19' | 'No'                   |
		And I close all client application windows
...
Scenario: _042526 check Retail return receipt movements by the Register  "R8013 Consignor batch wise balance" (consignor and own stocks)
	...
	* Check movements by the Register  "R8013 Consignor batch wise balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                      | 'Receipt'     | '14.11.2022 13:57:09' | '1'         | 'Main Company' | 'Purchase invoice 196 dated 03.11.2022 16:32:57' | 'Store 02' | 'UNIQ'     | '09987897977890'    | ''                  |
			| ''                                                      | 'Receipt'     | '14.11.2022 13:57:09' | '2'         | 'Main Company' | 'Purchase invoice 195 dated 02.11.2022 16:31:38' | 'Store 02' | 'S/Yellow' | ''                  | ''                  |
			| ''                                                      | 'Receipt'     | '14.11.2022 13:57:09' | '2'         | 'Main Company' | 'Purchase invoice 195 dated 02.11.2022 16:31:38' | 'Store 02' | 'UNIQ'     | '09987897977890'    | ''                  |
		And I close all client application windows
...
Scenario: _042531 check Retail return receipt movements by the Register  "R2021 Customer transactions" (bank credit)
	...
	* Check movements by the Register  "R2021 Customer transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                      | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''        | ''                             | ''         | ''                     | ''           | ''        | ''          | ''                                                      | ''      | 'Attributes'           | ''                           |
			| ''                                                      | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'  | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name' | 'Partner' | 'Agreement' | 'Basis'                                                 | 'Order' | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                                      | 'Receipt'     | '01.02.2023 10:28:22' | '-5 750'    | 'Main Company' | 'Shop 02' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Bank 1'     | 'Bank 1'  | 'Bank 1'    | 'Retail return receipt 1 206 dated 01.02.2023 10:28:22' | ''      | 'No'                   | ''                           |
			| ''                                                      | 'Receipt'     | '01.02.2023 10:28:22' | '-5 750'    | 'Main Company' | 'Shop 02' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Bank 1'     | 'Bank 1'  | 'Bank 1'    | 'Retail return receipt 1 206 dated 01.02.2023 10:28:22' | ''      | 'No'                   | ''                           |
			| ''                                                      | 'Receipt'     | '01.02.2023 10:28:22' | '-5 750'    | 'Main Company' | 'Shop 02' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Bank 1'     | 'Bank 1'  | 'Bank 1'    | 'Retail return receipt 1 206 dated 01.02.2023 10:28:22' | ''      | 'No'                   | ''                           |
			| ''                                                      | 'Receipt'     | '01.02.2023 10:28:22' | '-984,4'    | 'Main Company' | 'Shop 02' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Bank 1'     | 'Bank 1'  | 'Bank 1'    | 'Retail return receipt 1 206 dated 01.02.2023 10:28:22' | ''      | 'No'                   | ''                           |		
		And I close all client application windows
