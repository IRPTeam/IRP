...
Scenario: _042527 check Retail return receipt movements by the Register  "R8014 Consignor sales" (consignor and own stocks)
	...
	* Check movements by the Register  "R8014 Consignor sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                      | '14.11.2022 13:57:09' | '-3'        | '-1 200'     | '-1 200'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Green' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Local currency'               | 'TRY'      | 'No'                | ''                       | '400'   | 'TRY'                  |
			| ''                                                      | '14.11.2022 13:57:09' | '-3'        | '-1 200'     | '-1 200'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Green' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'en description is empty'      | 'TRY'      | 'No'                | ''                       | '400'   | 'TRY'                  |
			| ''                                                      | '14.11.2022 13:57:09' | '-3'        | '-205,44'    | '-205,44' | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'XL/Green' | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Reporting currency'           | 'USD'      | 'No'                | ''                       | '68,48' | 'TRY'                  |
			| ''                                                      | '14.11.2022 13:57:09' | '-2'        | '-932,2'     | '-1 100'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'UNIQ'     | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Local currency'               | 'TRY'      | 'No'                | ''                       | '466,1' | 'TRY'                  |
			| ''                                                      | '14.11.2022 13:57:09' | '-2'        | '-932,2'     | '-1 100'  | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'UNIQ'     | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'en description is empty'      | 'TRY'      | 'No'                | ''                       | '466,1' | 'TRY'                  |
			| ''                                                      | '14.11.2022 13:57:09' | '-2'        | '-159,59'    | '-188,32' | '                                    ' | 'Main Company' | ''               | ''                    | 'Retail sales receipt 1 113 dated 14.11.2022 13:29:44' | ''                        | 'UNIQ'     | ''                  | ''                 | 'pcs'  | 'en description is empty' | 'No'                        | 'Reporting currency'           | 'USD'      | 'No'                | ''                       | '79,8'  | 'TRY'                  |
		And I close all client application windows
...
Scenario: _042539 check postponed Retail return receipt movements
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                      | 'Retail return receipt 1 314 dated 07.09.2023 17:35:13' | '07.09.2023 17:35:13'                                   | '1 314'                                | '24.06.2026 18:30:14'      | '24.06.2026 18:30:15' | 'en description is empty' | 'en description is empty' | 'No'                    |
			| ''                                                      | ''                                                      | ''                                                      | ''                                     | ''                         | ''                    | ''                        | ''                        | ''                      |
			| 'Register  "Row IDStamps"'                              | ''                                                      | ''                                                      | ''                                     | ''                         | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | 'Period'                                                | 'Resources'                                             | 'Dimensions'                           | ''                         | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | ''                                                      | 'Value'                                                 | 'Row ref'                              | 'Attribute'                | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'IsFixedItemKey'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'IsFixedStore'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'IsVariableItemKey'        | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'IsVariableStore'          | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'PriceIncludeTaxPurchases' | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'PriceIncludeTaxSales'     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'IsFixedItemKey'           | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'IsFixedStore'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'IsVariableItemKey'        | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'IsVariableStore'          | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'PriceIncludeTaxPurchases' | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'No'                                                    | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'PriceIncludeTaxSales'     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Shop 02'                                               | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'BranchReturn'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Shop 02'                                               | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'BranchReturn'             | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Main Company'                                          | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'CompanyReturn'            | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Main Company'                                          | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'CompanyReturn'            | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'XS/Blue'                                               | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'ItemKey'                  | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'L/Green'                                               | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'ItemKey'                  | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Dress'                                                 | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'Item'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Dress'                                                 | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'Item'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Store 01'                                              | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'StoreReturn'              | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Store 01'                                              | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'StoreReturn'              | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'pcs'                                                   | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'Unit'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'pcs'                                                   | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'Unit'                     | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Retail return receipt 1 314 dated 07.09.2023 17:35:13' | 'c29a6108-1e22-47f8-bae4-ae9f861c0737' | 'Basis'                    | ''                    | ''                        | ''                        | ''                      |
			| ''                                                      | '07.09.2023 17:35:13'                                   | 'Retail return receipt 1 314 dated 07.09.2023 17:35:13' | 'fd3e6dc6-4bb0-4009-b8e9-a47357f272bb' | 'Basis'                    | ''                    | ''                        | ''                        | ''                      |		
...
Scenario: _042543 check Retail return receipt movements by the Register  "R6060 Cost of goods sold"
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                      | '15.04.2025 00:00:00' | 'Main Company' | 'Retail sales receipt 1 317 dated 07.04.2025 00:00:00' | 'Scarf + Dress' | 'Local currency'          | 'TRY'      | ''                  | ''                 | '-10'      | '-1 406,88'      | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | '-1 406,88'    | '-1 406,88'        | ''                 | ''                     | ''                   | ''                       | 'Calculation movement costs 1 dated 01.05.2025 00:00:00' |
