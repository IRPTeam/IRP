...
Scenario: _042905 check Opening entry movements by the Register  "R1020 Advances to vendors" 
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17,12'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | ''        | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | ''        | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | ''        | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'EUR'      | 'EUR'                  | 'Big foot'          | 'Big foot'  | ''      | 'Test Big foot'      | ''        | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '1 800'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'EUR'                  | 'Big foot'          | 'Big foot'  | ''      | 'Test Big foot'      | ''        | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '2 000'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'EUR'                  | 'Big foot'          | 'Big foot'  | ''      | 'Test Big foot'      | ''        | 'No'                   | ''                         |		
		And I close all client application windows
...
Scenario: _042906 check Opening entry movements by the Register  "R2020 Advances from customer" 
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17,12'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Kalipso' | 'Kalipso' | ''      | 'Basic Partner terms, TRY' | ''        | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '34,24'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'DFC'             | 'DFC'     | ''      | 'Partner term DFC'         | ''        | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Kalipso' | 'Kalipso' | ''      | 'Basic Partner terms, TRY' | ''        | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Kalipso' | 'Kalipso' | ''      | 'Basic Partner terms, TRY' | ''        | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'DFC'             | 'DFC'     | ''      | 'Partner term DFC'         | ''        | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'DFC'             | 'DFC'     | ''      | 'Partner term DFC'         | ''        | 'No'                   | ''                           |				
		And I close all client application windows
...
Scenario: _042911 check Opening entry movements by the Register  "R5012 Vendors aging" by partner term 
	...
	* Check movements by the Register  "R5012 Vendors aging" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '17,12'     | 'Main Company' | 'Front office' | 'USD'      | 'Partner term Maxim' | 'Maxim'   | 'Opening entry 9 dated 07.09.2020 21:27:57' | '01.06.2021 00:00:00' | 'Reporting currency'           | 'TRY'                  | ''              |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '17,12'     | 'Main Company' | 'Front office' | 'USD'      | 'Partner term Maxim' | 'Maxim'   | 'Opening entry 9 dated 07.09.2020 21:27:57' | '05.06.2021 00:00:00' | 'Reporting currency'           | 'TRY'                  | ''              |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '100'       | 'Main Company' | 'Front office' | 'TRY'      | 'Partner term Maxim' | 'Maxim'   | 'Opening entry 9 dated 07.09.2020 21:27:57' | '01.06.2021 00:00:00' | 'Local currency'               | 'TRY'                  | ''              |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '100'       | 'Main Company' | 'Front office' | 'TRY'      | 'Partner term Maxim' | 'Maxim'   | 'Opening entry 9 dated 07.09.2020 21:27:57' | '01.06.2021 00:00:00' | 'en description is empty'      | 'TRY'                  | ''              |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '100'       | 'Main Company' | 'Front office' | 'TRY'      | 'Partner term Maxim' | 'Maxim'   | 'Opening entry 9 dated 07.09.2020 21:27:57' | '05.06.2021 00:00:00' | 'Local currency'               | 'TRY'                  | ''              |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '100'       | 'Main Company' | 'Front office' | 'TRY'      | 'Partner term Maxim' | 'Maxim'   | 'Opening entry 9 dated 07.09.2020 21:27:57' | '05.06.2021 00:00:00' | 'en description is empty'      | 'TRY'                  | ''              |		
		And I close all client application windows
...
Scenario: _042912 check Opening entry movements by the Register  "R5011 Customers aging" by partner term 
	...
	* Check movements by the Register  "R5011 Customers aging" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''             | ''         | ''                 | ''        | ''                                          | ''                    | ''                             | ''                     | 'Attributes'    |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'       | 'Currency' | 'Agreement'        | 'Partner' | 'Invoice'                                   | 'Payment date'        | 'Multi currency movement type' | 'Transaction currency' | 'Aging closing' |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '34,24'     | 'Main Company' | 'Front office' | 'USD'      | 'Partner term DFC' | 'DFC'     | 'Opening entry 9 dated 07.09.2020 21:27:57' | '01.01.2022 00:00:00' | 'Reporting currency'           | 'TRY'                  | ''              |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '200'       | 'Main Company' | 'Front office' | 'TRY'      | 'Partner term DFC' | 'DFC'     | 'Opening entry 9 dated 07.09.2020 21:27:57' | '01.01.2022 00:00:00' | 'Local currency'               | 'TRY'                  | ''              |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '200'       | 'Main Company' | 'Front office' | 'TRY'      | 'Partner term DFC' | 'DFC'     | 'Opening entry 9 dated 07.09.2020 21:27:57' | '01.01.2022 00:00:00' | 'en description is empty'      | 'TRY'                  | ''              |		
		And I close all client application windows
...
Scenario: _042918 check Opening entry movements by the Register  "R4050 Stock inventory" (shipment to trade agent)
	...
	* Check movements by the Register  "R4050 Stock inventory" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Receipt'       | '01.12.2022 12:41:27'   | '20'          | ''                    | 'Main Company'   | 'Trade agent store'   | 'PZU'         | '8908899879'        | ''                 | ''                         |
			...
			| ''                                             | 'Expense'       | '01.12.2022 12:41:27'   | '20'          | ''                    | 'Main Company'   | 'Store 05'            | 'PZU'         | '8908899879'        | ''                 | ''                         |
...
Scenario: _042928 check Opening entry movements by the Register  "R8015 Consignor prices" (receipt from consignor)
	...
	* Check movements by the Register  "R8015 Consignor prices" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | ''                    | 'Price'     | 'Company'      | 'Partner'     | 'Partner term'             | 'Purchase invoice'                           | 'Item key' | 'Serial lot number' | 'Source of origin'     | 'Multi currency movement type' | 'Currency' | 'Transaction currency' |
			| ''                                           | '01.12.2022 12:41:39' | '8,56'      | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '0514'              | 'Source of origin 909' | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                           | '01.12.2022 12:41:39' | '8,56'      | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'M/Black'  | ''                  | ''                     | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '0514'              | 'Source of origin 909' | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '0514'              | 'Source of origin 909' | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'M/Black'  | ''                  | ''                     | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'M/Black'  | ''                  | ''                     | 'en description is empty'      | 'TRY'      | 'TRY'                  |
		And I close all client application windows
...
Scenario: _042933 check Opening entry movements by the Register  "R3027 Employee cash advance"
	...
	* Check movements by the Register  "R3027 Employee cash advance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                            | 'Receipt'     | '03.03.2023 16:56:36' | '100'       | 'Main Company' | ''       | 'David Romanov' | 'David Romanov cash advance, TRY' | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                            | 'Receipt'     | '03.03.2023 16:56:36' | '171,2'     | 'Main Company' | ''       | 'Arina Brown'   | 'Arina Brown cash advance, TRY'   | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                            | 'Receipt'     | '03.03.2023 16:56:36' | '562,75'    | 'Main Company' | ''       | 'David Romanov' | 'David Romanov cash advance, TRY' | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                            | 'Receipt'     | '03.03.2023 16:56:36' | '562,75'    | 'Main Company' | ''       | 'David Romanov' | 'David Romanov cash advance, TRY' | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |
			| ''                                            | 'Receipt'     | '03.03.2023 16:56:36' | '1 000'     | 'Main Company' | ''       | 'Arina Brown'   | 'Arina Brown cash advance, TRY'   | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                            | 'Receipt'     | '03.03.2023 16:56:36' | '1 000'     | 'Main Company' | ''       | 'Arina Brown'   | 'Arina Brown cash advance, TRY'   | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |		
		And I close all client application windows
...
Scenario: _042943 check Opening entry movements by the Register  "T2014 Advances info" (Advances)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'TRY'      | 'Kalipso'   | 'Company Kalipso'   | ''      | 'No'                | 'Yes'                 | '*'         | 'Basic Partner terms, TRY' | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'                      | 'No'                   | 'Receipt'     |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'EUR'      | 'Big foot'  | 'Big foot'          | ''      | 'Yes'               | 'No'                  | '*'         | 'Test Big foot'            | ''        | 'en description is empty' | 'EUR'                  | '200'    | 'No'                      | 'No'                   | 'Receipt'     |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'Yes'               | 'No'                  | '*'         | 'Vendor Ferron, TRY'       | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'                      | 'No'                   | 'Receipt'     |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'TRY'      | 'DFC'       | 'DFC'               | ''      | 'No'                | 'Yes'                 | '*'         | 'Partner term DFC'         | ''        | 'en description is empty' | 'TRY'                  | '200'    | 'No'                      | 'No'                   | 'Receipt'     |
		And I close all client application windows
...
Scenario: _042944 check Opening entry movements by the Register  "T2015 Transactions info" (AP-by partner term)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Main Company' | 'Front office' | ''      | '07.09.2020 21:27:01' | '*'   | 'TRY'      | 'DFC'     | 'DFC'        | 'DFC Vendor by Partner terms' | 'Yes'                   | 'No'                      | ''                  | '*'         | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'Yes'    | 'No'      |
		And I close all client application windows
...
Scenario: _042945 check Opening entry movements by the Register  "T2015 Transactions info" (AR-by partner term)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2015 Transactions info"'       | ''             | ''             | ''      | ''                    | ''    | ''         | ''        | ''           | ''                              | ''                      | ''                        | ''                  | ''          | ''        | ''                        | ''                     | ''       | ''       | ''        |
			| ''                                          | 'Company'      | 'Branch'       | 'Order' | 'Date'                | 'Key' | 'Currency' | 'Partner' | 'Legal name' | 'Agreement'                     | 'Is vendor transaction' | 'Is customer transaction' | 'Transaction basis' | 'Unique ID' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is due' | 'Is paid' |
			| ''                                          | 'Main Company' | 'Front office' | ''      | '07.09.2020 21:27:18' | '*'   | 'TRY'      | 'DFC'     | 'DFC'        | 'DFC Customer by Partner terms' | 'No'                    | 'Yes'                     | ''                  | '*'         | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'Yes'    | 'No'      |
		And I close all client application windows
...
Scenario: _042945 check Opening entry movements by the Register  "T2015 Transactions info" (AP-by documents)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2015 Transactions info"'       | ''             | ''             | ''      | ''                    | ''    | ''         | ''        | ''              | ''                        | ''                      | ''                        | ''                                          | ''          | ''        | ''                        | ''                     | ''       | ''       | ''        |
			| ''                                          | 'Company'      | 'Branch'       | 'Order' | 'Date'                | 'Key' | 'Currency' | 'Partner' | 'Legal name'    | 'Agreement'               | 'Is vendor transaction' | 'Is customer transaction' | 'Transaction basis'                         | 'Unique ID' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is due' | 'Is paid' |
			| ''                                          | 'Main Company' | 'Front office' | ''      | '07.09.2020 21:27:57' | '*'   | 'TRY'      | 'DFC'     | 'DFC'           | 'Partner term vendor DFC' | 'Yes'                   | 'No'                      | 'Opening entry 9 dated 07.09.2020 21:27:57' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'Yes'    | 'No'      |
			| ''                                          | 'Main Company' | 'Front office' | ''      | '07.09.2020 21:27:57' | '*'   | 'TRY'      | 'DFC'     | 'DFC'           | 'Partner term DFC'        | 'No'                    | 'Yes'                     | 'Opening entry 9 dated 07.09.2020 21:27:57' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '200'    | 'Yes'    | 'No'      |
			| ''                                          | 'Main Company' | 'Front office' | ''      | '07.09.2020 21:27:57' | '*'   | 'TRY'      | 'Maxim'   | 'Company Maxim' | 'Partner term Maxim'      | 'Yes'                   | 'No'                      | 'Opening entry 9 dated 07.09.2020 21:27:57' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '200'    | 'Yes'    | 'No'      |
		And I close all client application windows
...
Scenario: _042947 check Opening entry movements by the Register  "Posted documents registry"
	And I close all client application windows
	Given I open hyperlink "e1cib/list/Document.OpeningEntry"
	And I go to line in "List" table
		| 'Number' |
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Opening entry 1 dated 07.09.2020 21:26:04' | '07.09.2020 21:26:04' | '1'      | '*'           | '*'           | 'en description is empty' | 'en description is empty' | 'No'                    |
	And I close all client application windows		
