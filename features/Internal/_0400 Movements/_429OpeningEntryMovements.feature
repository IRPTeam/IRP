...
Scenario: _042943 check Opening entry movements by the Register  "T2014 Advances info" (Advances)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | 'ae2db5b9-17fe-411f-ad64-097cda61a524' | 'TRY'      | 'Kalipso'   | 'Company Kalipso'   | ''      | 'No'                | 'Yes'                 | 'd1bac132-20dc-4ab4-95d0-3884efec08bf' | 'Basic Partner terms, TRY' | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'                      | 'No'                   | 'Receipt'     |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | 'cbae6569-e98d-4777-a5fb-f46b92cac00c' | 'EUR'      | 'Big foot'  | 'Big foot'          | ''      | 'Yes'               | 'No'                  | '3072acfa-8e08-4945-a5f1-caa049a3f0b0' | 'Test Big foot'            | ''        | 'en description is empty' | 'EUR'                  | '200'    | 'No'                      | 'No'                   | 'Receipt'     |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | 'd1396d1a-4a30-48cb-9003-88763ec7c8d0' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'Yes'               | 'No'                  | '74f9f40a-c775-47f0-93e8-db621d3c3778' | 'Vendor Ferron, TRY'       | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'                      | 'No'                   | 'Receipt'     |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | 'da08940f-c44e-490d-ab30-04d83d7a3149' | 'TRY'      | 'DFC'       | 'DFC'               | ''      | 'No'                | 'Yes'                 | '33763e52-eb9a-428e-81d4-2c25f555f96b' | 'Partner term DFC'         | ''        | 'en description is empty' | 'TRY'                  | '200'    | 'No'                      | 'No'                   | 'Receipt'     |		
		And I close all client application windows
