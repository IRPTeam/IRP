...
Scenario: _042905 check Opening entry movements by the Register  "R1020 Advances to vendors" 
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17,12'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '220'       | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Big foot'          | 'Big foot'  | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
...
Scenario: _042906 check Opening entry movements by the Register  "R2020 Advances from customer" 
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17,12'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Kalipso' | 'Kalipso' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '34,24'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'DFC'             | 'DFC'     | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
