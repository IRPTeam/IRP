...
Scenario: _042903 check Opening entry movements by the Register  "R3010 Cash on hand"
	...
	* Check movements by the Register  "R3010 Cash on hand" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '5 840'     | 'Main Company' | 'Front office' | 'Cash desk №2'      | 'TRY'      | 'Local currency'               | 'No'                   |
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '25 000'    | 'Main Company' | 'Front office' | 'Bank account, USD' | 'TRY'      | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '52 000'    | 'Main Company' | 'Front office' | 'Bank account, EUR' | 'TRY'      | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '58 400'    | 'Main Company' | 'Front office' | 'Bank account, TRY' | 'USD'      | 'Reporting currency'           | 'No'                   |
		And I close all client application windows
...
Scenario: _042905 check Opening entry movements by the Register  "R1020 Advances to vendors" 
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17'        | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'EUR'      | 'Big foot'          | 'Big foot'  | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '1 100'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Big foot'          | 'Big foot'  | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '1 200'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Big foot'          | 'Big foot'  | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
		And I close all client application windows
...
Scenario: _042906 check Opening entry movements by the Register  "R2020 Advances from customer" 
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17'        | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Kalipso' | 'Kalipso' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '34'        | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'DFC'             | 'DFC'     | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Company Kalipso' | 'Kalipso' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Company Kalipso' | 'Kalipso' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'DFC'             | 'DFC'     | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'DFC'             | 'DFC'     | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
		And I close all client application windows
...
Scenario: _042907 check Opening entry movements by the Register  "R1021 Vendors transactions" by partner term 
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:01' | '584'       | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'DFC'        | 'DFC'     | 'DFC Vendor by Partner terms' | ''      | 'No'                   | ''                         |
		And I close all client application windows
...
Scenario: _042908 check Opening entry movements by the Register  "R1021 Vendors transactions" by document
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''             | ''                             | ''         | ''              | ''        | ''                        | ''                                          | 'Attributes'           | ''                         |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'       | 'Multi currency movement type' | 'Currency' | 'Legal name'    | 'Partner' | 'Agreement'               | 'Basis'                                     | 'Deferred calculation' | 'Vendors advances closing' |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '17'        | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'DFC'           | 'DFC'     | 'Partner term vendor DFC' | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'No'                   | ''                         |
...
Scenario: _042909 check Opening entry movements by the Register  "R2021 Customer transactions"  by document
	...
	* Check movements by the Register  "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '34'        | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'DFC'        | 'DFC'     | 'Partner term DFC' | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'No'                   | ''                           |
...
Scenario: _042910 check Opening entry movements by the Register  "R2021 Customer transactions" by partner term 
	...
	* Check movements by the Register  "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:18' | '584'       | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'DFC'        | 'DFC'     | 'DFC Customer by Partner terms' | ''      | 'No'                   | ''                           |
		And I close all client application windows
