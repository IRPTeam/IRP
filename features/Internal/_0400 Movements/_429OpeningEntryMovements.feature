...
Scenario: _042905 check Opening entry movements by the Register  "R1020 Advances to vendors" 
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''             | ''                             | ''         | ''                     | ''                  | ''          | ''      | ''          | ''                                          | 'Attributes'           | ''                         |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'       | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name'        | 'Partner'   | 'Order' | 'Agreement' | 'Basis'                                     | 'Deferred calculation' | 'Vendors advances closing' |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17,12'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'EUR'      | 'EUR'                  | 'Big foot'          | 'Big foot'  | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '220'       | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'EUR'                  | 'Big foot'          | 'Big foot'  | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '1 200'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'EUR'                  | 'Big foot'          | 'Big foot'  | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                         |
		And I close all client application windows
...
Scenario: _042906 check Opening entry movements by the Register  "R2020 Advances from customer" 
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''             | ''                             | ''         | ''                     | ''                | ''        | ''      | ''          | ''                                          | 'Attributes'           | ''                           |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'       | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name'      | 'Partner' | 'Order' | 'Agreement' | 'Basis'                                     | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17,12'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Kalipso' | 'Kalipso' | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '34,24'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'DFC'             | 'DFC'     | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Kalipso' | 'Kalipso' | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Kalipso' | 'Kalipso' | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'DFC'             | 'DFC'     | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'DFC'             | 'DFC'     | ''      | ''          | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | ''                           |
		And I close all client application windows
...
Scenario: _042928 check Opening entry movements by the Register  "R8015 Consignor prices" (receipt from consignor)
	...
	* Check movements by the Register  "R8015 Consignor prices" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '0514'              | 'Source of origin 909' | 'TRY'                          | 'TRY'      |
			...
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'M/Black'  | ''                  | ''                     | 'TRY'                          | 'TRY'      |
...
Scenario: _042938 check Opening entry movements by the Register  "R5015 Other partners transactions" (other partner transaction)
	...
	* Check movements by the Register  "R5015 Other partners transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | 'Receipt'     | '07.07.2023 12:17:50' | '10'        | 'Main Company' | ''       | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Other partner 2' | 'Other partner 2' | 'Other partner 2' | ''      | 'No'                   |
			...
			| ''                                              | 'Expense'     | '07.07.2023 12:17:50' | '50'        | 'Main Company' | ''       | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Other partner 1' | 'Other partner 1' | 'Other partner 1' | ''      | 'No'                   |
