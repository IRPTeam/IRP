...
Scenario: _042903 check Opening entry movements by the Register  "R3010 Cash on hand"
	...
	* Check movements by the Register  "R3010 Cash on hand" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '1 100'     | 'Main Company' | 'Front office' | 'Cash desk №3'      | 'USD'      | 'USD'                  | 'Reporting currency'           | 'No'                   |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '1 712'     | 'Main Company' | 'Front office' | 'Bank account, TRY' | 'USD'      | 'USD'                  | 'Reporting currency'           | 'No'                   |
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '5 627,5'   | 'Main Company' | 'Front office' | 'Cash desk №2'      | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '6 000'     | 'Main Company' | 'Front office' | 'Cash desk №3'      | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '8 000'     | 'Main Company' | 'Front office' | 'Bank account, EUR' | 'EUR'      | 'EUR'                  | 'en description is empty'      | 'No'                   |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '8 800'     | 'Main Company' | 'Front office' | 'Bank account, EUR' | 'USD'      | 'USD'                  | 'Reporting currency'           | 'No'                   |
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '28 137,5'  | 'Main Company' | 'Front office' | 'Bank account, USD' | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:04' | '52 000'    | 'Main Company' | 'Front office' | 'Bank account, EUR' | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
...
Scenario: _042921 check Opening entry movements by the Register  "T6020 Batch keys info" (shipment to trade agent)
	...
	* Check movements by the Register  "T6020 Batch keys info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | ''                    | 'Quantity'  | 'Amount' | 'Amount tax' | 'Amount cost ratio' | 'Not direct costs' | 'Company'      | 'Store'             | 'Item key' | 'Direction' | 'Currency movement type' | 'Currency' | 'Batch document' | 'Sales invoice' | 'Row ID'                               | 'Profit loss center' | 'Expense type' | 'Branch' | 'Work' | 'Work sheet' | 'Batch consignor' | 'Serial lot number' | 'Source of origin' | 'Production document' |
