...
Scenario: _042925 check Opening entry movements by the Register  "R4014 Serial lot numbers" (receipt from consignor)
	...
	* Check movements by the Register  "R4014 Serial lot numbers" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''       | ''      | ''         | ''                  |
			| ''                                           | ''            | ''                    | 'Quantity'  | 'Company'      | 'Branch' | 'Store' | 'Item key' | 'Serial lot number' |
			| ''                                           | 'Receipt'     | '01.12.2022 12:41:39' | '70'        | 'Main Company' | ''       | ''      | 'UNIQ'     | '11111111111111'    |		
		And I close all client application windows
...
Scenario: _042928 check Opening entry movements by the Register  "R8015 Consignor prices" (receipt from consignor)
	...
	* Check movements by the Register  "R8015 Consignor prices" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | '01.12.2022 12:41:39' | '8,56'      | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '11111111111111'    | 'Source of origin 909' | 'Reporting currency'           | 'USD'      |
			...
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '11111111111111'    | 'Source of origin 909' | 'Local currency'               | 'TRY'      |
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '11111111111111'    | 'Source of origin 909' | 'TRY'                          | 'TRY'      |
			| ''                                           | '01.12.2022 12:41:39' | '50'        | 'Main Company' | 'Consignor 1' | 'Consignor partner term 1' | 'Opening entry 15 dated 01.12.2022 12:41:39' | 'UNIQ'     | '11111111111111'    | 'Source of origin 909' | 'en description is empty'      | 'TRY'      |
