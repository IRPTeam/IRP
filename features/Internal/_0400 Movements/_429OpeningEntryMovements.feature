...
Scenario: _042941 check Opening entry movements by the Register  "R5020 Partners balance" (customers and vendors)
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | '07.09.2020 21:27:57' | 'Receipt'    | 'Main Company' | 'Front office' | 'DFC'     | 'DFC'           | 'Partner term DFC'        | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'TRY'      | 'TRY'                          | 'TRY'                  | '200'    | '200'                  | ''                 | ''                   | ''               | ''                  | ''                 |
			...
			| ''                                          | '07.09.2020 21:27:57' | 'Expense'    | 'Main Company' | 'Front office' | 'DFC'     | 'DFC'           | 'Partner term vendor DFC' | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'TRY'      | 'TRY'                          | 'TRY'                  | '100'    | ''                     | ''                 | '100'                | ''               | ''                  | ''                 |
			...
			| ''                                          | '07.09.2020 21:27:57' | 'Expense'    | 'Main Company' | 'Front office' | 'Maxim'   | 'Company Maxim' | 'Partner term Maxim'      | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'TRY'      | 'TRY'                          | 'TRY'                  | '200'    | ''                     | ''                 | '200'                | ''               | ''                  | ''                 |
...
Scenario: _042942 check Opening entry movements by the Register  "R5020 Partners balance" (other partner transaction)
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                            | '07.07.2023 12:17:50' | 'Receipt'    | 'Main Company' | ''       | 'Other partner 2' | 'Other partner 2' | 'Other partner 2' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '10'     | ''                     | ''                 | ''                   | ''               | '10'                | ''                 |
			...
			| ''                                            | '07.07.2023 12:17:50' | 'Expense'    | 'Main Company' | ''       | 'Other partner 1' | 'Other partner 1' | 'Other partner 1' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '50'     | ''                     | ''                 | ''                   | ''               | '50'                | ''                 |
			...
			| ''                                            | '07.07.2023 12:17:50' | 'Expense'    | 'Main Company' | ''       | 'Other partner 2' | 'Other partner 2' | 'Other partner 2' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '100'    | ''                     | ''                 | ''                   | ''               | '100'               | ''                 |
...
Scenario: _042943 check Opening entry movements by the Register  "T2014 Advances info" (Advances)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'TRY'      | 'Kalipso'   | 'Company Kalipso'   | ''      | 'No'                | 'Yes'                 | '*'         | ''                  | ''        | '100'    | 'No'                      | 'No'                   | ''            |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'EUR'      | 'Big foot'  | 'Big foot'          | ''      | 'Yes'               | 'No'                  | '*'         | ''                  | ''        | '200'    | 'No'                      | 'No'                   | ''            |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'Yes'               | 'No'                  | '*'         | ''                  | ''        | '100'    | 'No'                      | 'No'                   | ''            |
			| ''                                          | 'Main Company' | 'Front office' | '07.09.2020 21:26:50' | '*'   | 'TRY'      | 'DFC'       | 'DFC'               | ''      | 'No'                | 'Yes'                 | '*'         | ''                  | ''        | '200'    | 'No'                      | 'No'                   | ''            |
		And I close all client application windows
