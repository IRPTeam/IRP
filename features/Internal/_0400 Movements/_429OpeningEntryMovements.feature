...
Scenario: _042906 check Opening entry movements by the Register  "R2020 Advances from customer" 
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '17'        | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Kalipso' | 'Kalipso' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '34'        | 'Main Company' | 'Reporting currency'           | 'USD'      | 'DFC'             | 'DFC'     | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Kalipso' | 'Kalipso' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '100'       | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Kalipso' | 'Kalipso' | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'Local currency'               | 'TRY'      | 'DFC'             | 'DFC'     | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:26:50' | '200'       | 'Main Company' | 'en description is empty'      | 'TRY'      | 'DFC'             | 'DFC'     | 'Opening entry 3 dated 07.09.2020 21:26:50' | 'No'                   | 'No'                |
		And I close all client application windows
...
Scenario: _042909 check Opening entry movements by the Register  "R2021 Customer transactions"  by document
	...
	* Check movements by the Register  "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '34'        | 'Main Company' | 'Reporting currency'           | 'USD'      | 'DFC'        | 'DFC'     | 'Partner term DFC' | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '200'       | 'Main Company' | 'Local currency'               | 'TRY'      | 'DFC'        | 'DFC'     | 'Partner term DFC' | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '200'       | 'Main Company' | 'TRY'                          | 'TRY'      | 'DFC'        | 'DFC'     | 'Partner term DFC' | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:57' | '200'       | 'Main Company' | 'en description is empty'      | 'TRY'      | 'DFC'        | 'DFC'     | 'Partner term DFC' | 'Opening entry 9 dated 07.09.2020 21:27:57' | 'No'                   | 'No'                |
		And I close all client application windows
...
Scenario: _042910 check Opening entry movements by the Register  "R2021 Customer transactions" by partner term 
	...
	* Check movements by the Register  "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''                             | ''         | ''           | ''        | ''                              | ''      | 'Attributes'           | ''                  |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name' | 'Partner' | 'Agreement'                     | 'Basis' | 'Deferred calculation' | 'Offset of advance' |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:18' | '100'       | 'Main Company' | 'Local currency'               | 'TRY'      | 'DFC'        | 'DFC'     | 'DFC Customer by Partner terms' | ''      | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:18' | '100'       | 'Main Company' | 'TRY'                          | 'TRY'      | 'DFC'        | 'DFC'     | 'DFC Customer by Partner terms' | ''      | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:18' | '100'       | 'Main Company' | 'en description is empty'      | 'TRY'      | 'DFC'        | 'DFC'     | 'DFC Customer by Partner terms' | ''      | 'No'                   | 'No'                |
			| ''                                          | 'Receipt'     | '07.09.2020 21:27:18' | '584'       | 'Main Company' | 'Reporting currency'           | 'USD'      | 'DFC'        | 'DFC'     | 'DFC Customer by Partner terms' | ''      | 'No'                   | 'No'                |
		And I close all client application windows
