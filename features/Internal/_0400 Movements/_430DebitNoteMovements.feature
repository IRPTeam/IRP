...
Scenario: _043002 check Debit note movements by the Register "R2021 Customer transactions" (with customer)
	...
	* Check movements by the Register  "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                        | 'Receipt'     | '05.04.2021 09:31:09' | '17,12'     | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:31:09' | '100'       | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:31:09' | '100'       | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:31:09' | '100'       | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'No'                   | 'No'                |
	And I close all client application windows
...
Scenario: _043004 check Debit note movements by the Register "R1021 Vendors transactions" (with vendor)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                       | 'Receipt'     | '05.04.2021 09:30:36' | '-2 300'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'No'                   | 'No'                |
			| ''                                       | 'Receipt'     | '05.04.2021 09:30:36' | '-2 300'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'No'                   | 'No'                |
			| ''                                       | 'Receipt'     | '05.04.2021 09:30:36' | '-2 300'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'No'                   | 'No'                |
			| ''                                       | 'Receipt'     | '05.04.2021 09:30:36' | '-393,76'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'No'                   | 'No'                |
	And I close all client application windows
