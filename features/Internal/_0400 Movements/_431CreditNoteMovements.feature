...
Scenario: _043102 check Credit note movements by the Register "R2020 Advances from customer" (with customer)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Receipt'       | '05.04.2021 09:30:58'   | '119,84'      | 'Main Company'   | 'Front office'   | 'Reporting currency'             | 'USD'        | 'TRY'                    | 'Company Ferron BP'   | 'Ferron BP'   | ''        | 'Basic Partner terms, TRY'        | 'No'                     | ''                              |
			| ''                                           | 'Receipt'       | '05.04.2021 09:30:58'   | '700'         | 'Main Company'   | 'Front office'   | 'Local currency'                 | 'TRY'        | 'TRY'                    | 'Company Ferron BP'   | 'Ferron BP'   | ''        | 'Basic Partner terms, TRY'        | 'No'                     | ''                              |
			| ''                                           | 'Receipt'       | '05.04.2021 09:30:58'   | '700'         | 'Main Company'   | 'Front office'   | 'en description is empty'        | 'TRY'        | 'TRY'                    | 'Company Ferron BP'   | 'Ferron BP'   | ''        | 'Basic Partner terms, TRY'        | 'No'                     | ''                              |
		And I close all client application windows
