...
Scenario: _043102 check Credit note movements by the Register "R2021 Customer transactions" (with customer)
	...
	* Check movements by the Register  "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:58' | '-700'      | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 3 dated 28.01.2021 18:50:57' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:58' | '-700'      | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 3 dated 28.01.2021 18:50:57' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:58' | '-700'      | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 3 dated 28.01.2021 18:50:57' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:58' | '-119,84'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 3 dated 28.01.2021 18:50:57' | 'No'                   | 'No'                |
		And I close all client application windows
...
Scenario: _043104 check Credit note movements by the Register "R1021 Vendors transactions" (with vendor)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                        | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''                             | ''         | ''                  | ''          | ''                   | ''                                               | 'Attributes'           | ''                  |
			| ''                                        | ''            | ''                    | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name'        | 'Partner'   | 'Agreement'          | 'Basis'                                          | 'Deferred calculation' | 'Offset of advance' |
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:47' | '85,6'      | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:47' | '500'       | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:47' | '500'       | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'No'                   | 'No'                |
			| ''                                        | 'Receipt'     | '05.04.2021 09:30:47' | '500'       | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'No'                   | 'No'                |
		And I close all client application windows
