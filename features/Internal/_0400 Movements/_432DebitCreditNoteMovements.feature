...
Scenario: check DebitCreditNote movements by the register "R2020 Advances from customer" (CA-CT, by partner terms, diferent partner)
	...
	* Check movements by the Register "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''             | ''                             | ''         | ''                     | ''                                     | ''                                     | ''      | ''                                     | ''        | 'Attributes'           | ''                           |
			| ''                                              | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'       | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name'                           | 'Partner'                              | 'Order' | 'Agreement'                            | 'Project' | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                              | 'Expense'     | '20.02.2024 20:53:00' | '85,6'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Customer (Advance, by partner terms)' | 'Customer (Advance, by partner terms)' | ''      | 'Customer (Advance, by partner terms)' | ''        | 'No'                   | ''                           |
			| ''                                              | 'Expense'     | '20.02.2024 20:53:00' | '500'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Customer (Advance, by partner terms)' | 'Customer (Advance, by partner terms)' | ''      | 'Customer (Advance, by partner terms)' | ''        | 'No'                   | ''                           |
			| ''                                              | 'Expense'     | '20.02.2024 20:53:00' | '500'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Customer (Advance, by partner terms)' | 'Customer (Advance, by partner terms)' | ''      | 'Customer (Advance, by partner terms)' | ''        | 'No'                   | ''                           |		
	And I close all client application windows
