...
Scenario: _0432002 check DebitCreditNote movements by the register "R2020 Advances from customer" (CA-CT, by documents, same partner)
	...
	* Check movements by the Register "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '20.02.2024 13:27:56' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Basic Partner terms, TRY' | ''        | '500'    | 'No'                   | ''                           |		
...
Scenario: _0432003 check DebitCreditNote movements by the register "R2021 Customer transactions" (CA-CT, by documents, same partner)
	...
	* Check movements by the Register  "R2021 Customer transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '20.02.2024 13:27:56' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, TRY' | 'Sales invoice 116 dated 19.02.2024 19:49:32' | ''      | ''        | '500'    | 'No'                   | ''                           |	
...
Scenario: _0432006 check DebitCreditNote movements by the register  "R5020 Partners balance" (CA-CT, by documents, same partner)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '20.02.2024 13:27:56' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, TRY' | ''                                            | 'TRY'      | 'TRY'                          | 'TRY'                  | '500'    | ''                     | '500'              | ''                   | ''               | ''                  | ''                 |
			...
			| ''                                              | '20.02.2024 13:27:56' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, TRY' | 'Sales invoice 116 dated 19.02.2024 19:49:32' | 'TRY'      | 'TRY'                          | 'TRY'                  | '500'    | '500'                  | ''                 | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432008 check DebitCreditNote movements by the register "R2021 Customer transactions" (CT-VA, by documents, same partner)
	...
	* Check movements by the Register "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '20.02.2024 10:01:09' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, TRY' | ''      | ''      | ''        | '121'    | 'No'                   | ''                           |	
...
Scenario: _0432009 check DebitCreditNote movements by the register "R1020 Advances to vendors" (CT-VA, by documents, same partner)
	...
	* Check movements by the Register  "R1020 Advances to vendors"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '20.02.2024 10:01:09' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Vendor (by documents)' | ''        | '121'    | 'No'                   | ''                         |	
...
Scenario: _0432012 check DebitCreditNote movements by the register  "R5020 Partners balance" (CT-VA, by documents, same partner)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '20.02.2024 10:01:09' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Vendor (by documents)'    | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '121'    | ''                     | ''                 | ''                   | '121'            | ''                  | ''                 |
			...
			| ''                                              | '20.02.2024 10:01:09' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, TRY' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '121'    | '121'                  | ''                 | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432013 check DebitCreditNote movements by the register "R2020 Advances from customer" (CA-CA, by documents, same partner)
	...
	* Check movements by the Register "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '30.03.2024 11:34:17' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Basic Partner terms, without VAT' | ''        | '128'    | 'No'                   | ''                           |
			...
			| ''                                              | '30.03.2024 11:34:17' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Basic Partner terms, TRY'         | ''        | '128'    | 'No'                   | ''                           |
...
Scenario: _0432015 check DebitCreditNote movements by the register  "R5020 Partners balance" (CA-CA, by documents, same partner)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '30.03.2024 11:34:17' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, TRY'         | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '128'    | ''                     | '128'              | ''                   | ''               | ''                  | ''                 |
			...
			| ''                                              | '30.03.2024 11:34:17' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, without VAT' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '128'    | ''                     | '128'              | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432016 check DebitCreditNote movements by the register "R1020 Advances to vendors" (VA-VA, by documents, same partner)
	...
	* Check movements by the Register "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '01.04.2024 11:48:58' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Vendor (by documents) 2' | ''        | '127'    | 'No'                   | ''                         |
			...
			| ''                                              | '01.04.2024 11:48:58' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Vendor (by documents)'   | ''        | '127'    | 'No'                   | ''                         |
...
Scenario: _0432018 check DebitCreditNote movements by the register  "R5020 Partners balance" (VA-VA, by documents, same partner)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '01.04.2024 11:48:58' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Vendor (by documents) 2' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '127'    | ''                     | ''                 | ''                   | '127'            | ''                  | ''                 |
			...
			| ''                                              | '01.04.2024 11:48:58' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Vendor (by documents)'   | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '127'    | ''                     | ''                 | ''                   | '127'            | ''                  | ''                 |
...
Scenario: _0432019 check DebitCreditNote movements by the register "R2021 Customer transactions" (CT-CT, by partner terms, same partner)
	...
	* Check movements by the Register "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '02.04.2024 13:06:46' | 'Receipt'    | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Transacrions, by partner terms)' | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''      | ''      | ''        | '111'    | 'No'                   | ''                           |
			...
			| ''                                              | '02.04.2024 13:06:46' | 'Expense'    | 'Main Company' | 'Front office'            | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Transacrions, by partner terms)' | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''      | ''      | ''        | '111'    | 'No'                   | ''                           |
...
Scenario: _0432059 check DebitCreditNote movements by the register "R5020 Partners balance" (CT-CT, by partner terms, same partner)
	...
	* Check movements by the Register "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '02.04.2024 13:06:46' | 'Receipt'    | 'Main Company' | 'Distribution department' | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '111'    | '111'                  | ''                 | ''                   | ''               | ''                  | ''                 |
			...
			| ''                                              | '02.04.2024 13:06:46' | 'Expense'    | 'Main Company' | 'Front office'            | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '111'    | '111'                  | ''                 | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432021 check DebitCreditNote movements by the register "R1021 Vendors transactions" (CT-CT, by partner terms, same partner)
	...
	* Check movements by the Register "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '26.04.2024 13:20:20' | 'Receipt'    | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by partner term)' | 'Vendor (Transactions, by partner term)' | 'Vendor, TRY' | ''      | ''      | ''        | '109'    | 'No'                   | ''                         |
			...
			| ''                                              | '26.04.2024 13:20:20' | 'Expense'    | 'Main Company' | 'Front office'            | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by partner term)' | 'Vendor (Transactions, by partner term)' | 'Vendor, TRY' | ''      | ''      | ''        | '109'    | 'No'                   | ''                         |
...
Scenario: _0432023 check DebitCreditNote movements by the register "R1021 Vendors transactions" (VA-VT, by documents, different partners)
	...
	* Check movements by the Register "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '26.04.2024 13:31:41' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | ''      | ''      | ''        | '21'     | 'No'                   | ''                         |		
...
Scenario: _0432024 check DebitCreditNote movements by the register "R1020 Advances to vendors" (VA-VT, by documents, different partners)
	...
	* Check movements by the Register  "R1020 Advances to vendors"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '26.04.2024 13:31:41' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Advance, by documents)' | 'Vendor (Advance, by documents)' | ''      | 'Vendor (Advance, by documents)' | ''        | '21'     | 'No'                   | ''                         |	
...
Scenario: _0432025 check DebitCreditNote movements by the register "R5020 Partners balance" (VA-VT, by documents, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '26.04.2024 13:31:41' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '21'     | ''                     | ''                 | '21'                 | ''               | ''                  | ''                 |
			...
			| ''                                              | '26.04.2024 13:31:41' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor (Advance, by documents)'      | 'Vendor (Advance, by documents)'      | 'Vendor (Advance, by documents)'      | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '21'     | ''                     | ''                 | ''                   | '21'             | ''                  | ''                 |
...
Scenario: _0432028 check DebitCreditNote movements by the register "R1021 Vendors transactions" (VT-CA, by documents, different partners)
	...
	* Check movements by the Register "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '03.04.2024 14:19:17' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | ''      | ''      | ''        | '41'     | 'No'                   | ''                         |
...
Scenario: _0432029 check DebitCreditNote movements by the register "R2020 Advances from customer" (VT-CA, by documents, different partners)
	...
	* Check movements by the Register  "R2020 Advances from customer"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '03.04.2024 14:19:17' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Advance, by documents)' | 'Customer (Advance, by documents)' | ''      | 'Basic Partner terms, TRY' | ''        | '41'     | 'No'                   | ''                           |		
...
Scenario: _0432030 check DebitCreditNote movements by the register "R5020 Partners balance" (VT-CA, by documents, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '03.04.2024 14:19:17' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '41'     | ''                     | ''                 | '41'                 | ''               | ''                  | ''                 |
			...
			| ''                                              | '03.04.2024 14:19:17' | 'Expense'    | 'Main Company' | 'Front office' | 'Customer (Advance, by documents)'    | 'Customer (Advance, by documents)'    | 'Basic Partner terms, TRY'            | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '41'     | ''                     | '41'               | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432033 check DebitCreditNote movements by the register "R1021 Vendors transactions" (VT-CT, by documents, different partners)
	...
	* Check movements by the Register "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '26.04.2024 16:15:09' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | 'Vendor (Transactions, by documents)' | ''      | ''      | ''        | '51'     | 'No'                   | ''                         |			
...
Scenario: _0432034 check DebitCreditNote movements by the register "R2021 Customer transactions" (VT-CT, by documents, different partners)
	...
	* Check movements by the Register  "R2021 Customer transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '26.04.2024 16:15:09' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Transactions, by documents)' | 'Customer (Transactions, by documents)' | 'Basic Partner terms, TRY' | ''      | ''      | ''        | '51'     | 'No'                   | ''                           |	
...
Scenario: _0432035 check DebitCreditNote movements by the register "R5020 Partners balance" (VT-CT, by documents, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '26.04.2024 16:15:09' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor (Transactions, by documents)'   | 'Vendor (Transactions, by documents)'   | 'Vendor (Transactions, by documents)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '51'     | ''                     | ''                 | '51'                 | ''               | ''                  | ''                 |
			...
			| ''                                              | '26.04.2024 16:15:09' | 'Expense'    | 'Main Company' | 'Front office' | 'Customer (Transactions, by documents)' | 'Customer (Transactions, by documents)' | 'Basic Partner terms, TRY'            | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '51'     | '51'                   | ''                 | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432037 check DebitCreditNote movements by the register "R1020 Advances to vendors" (CT-VA, by documents, different partners)
	...
	* Check movements by the Register "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '26.04.2024 17:51:11' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Advance, by documents)' | 'Vendor (Advance, by documents)' | ''      | 'Vendor (Advance, by documents)' | ''        | '74'     | 'No'                   | ''                         |
...
Scenario: _0432038 check DebitCreditNote movements by the register "R2021 Customer transactions" (CT-VA, by documents, different partners)
	...
	* Check movements by the Register  "R2021 Customer transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '26.04.2024 17:51:11' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Transactions, by documents)' | 'Customer (Transactions, by documents)' | 'Basic Partner terms, TRY' | ''      | ''      | ''        | '74'     | 'No'                   | ''                           |
...
Scenario: _0432039 check DebitCreditNote movements by the register "R5020 Partners balance" (CT-VA, by documents, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '26.04.2024 17:51:11' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor (Advance, by documents)'        | 'Vendor (Advance, by documents)'        | 'Vendor (Advance, by documents)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '74'     | ''                     | ''                 | ''                   | '74'             | ''                  | ''                 |
			...
			| ''                                               | '26.04.2024 17:51:11' | 'Expense'    | 'Main Company' | 'Front office' | 'Customer (Transactions, by documents)' | 'Customer (Transactions, by documents)' | 'Basic Partner terms, TRY'       | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '74'     | '74'                   | ''                 | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432042 check DebitCreditNote movements by the register "R1020 Advances to vendors" (CA-VA, by documents, different partners)
	...
	* Check movements by the Register "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 10:25:38' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Advance, by documents)' | 'Vendor (Advance, by documents)' | ''      | 'Vendor (Advance, by documents)' | ''        | '48'     | 'No'                   | ''                         |
...
Scenario: _0432043 check DebitCreditNote movements by the register "R2020 Advances from customer" (CA-VA, by documents, different partners)
	...
	* Check movements by the Register  "R2020 Advances from customer"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 10:25:38' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Advance, by documents)' | 'Customer (Advance, by documents)' | ''      | 'Basic Partner terms, TRY' | ''        | '48'     | 'No'                   | ''                           |	
...
Scenario: _0432061 check DebitCreditNote movements by the register "R5020 Partners balance" (CA-VA, by documents, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 10:25:38' | 'Receipt'    | 'Main Company' | 'Front office' | 'Customer (Advance, by documents)' | 'Customer (Advance, by documents)' | 'Basic Partner terms, TRY'       | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '48'     | ''                     | '48'               | ''                   | ''               | ''                  | ''                 |
			...
			| ''                                               | '29.04.2024 10:25:38' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor (Advance, by documents)'   | 'Vendor (Advance, by documents)'   | 'Vendor (Advance, by documents)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '48'     | ''                     | ''                 | ''                   | '48'             | ''                  | ''                 |
...
Scenario: _0432045 check DebitCreditNote movements by the register "R1021 Vendors transactions" (CT-VT, by partner term, different partners)
	...
	* Check movements by the Register "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 10:42:01' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by partner term)' | 'Vendor (Transactions, by partner term)' | 'Vendor, TRY' | ''      | ''      | ''        | '43'     | 'No'                   | ''                         |	
...
Scenario: _0432046 check DebitCreditNote movements by the register "R2021 Customer transactions" (CT-VT, by partner term, different partners)
	...
	* Check movements by the Register  "R2021 Customer transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 10:42:01' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Transacrions, by partner terms)' | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''      | ''      | ''        | '43'     | 'No'                   | ''                           |	
...
Scenario: _0432047 check DebitCreditNote movements by the register "R5020 Partners balance" (CT-VT, by partner term, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 10:42:01' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor (Transactions, by partner term)'    | 'Vendor (Transactions, by partner term)'    | 'Vendor, TRY'                               | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '43'     | ''                     | ''                 | '43'                 | ''               | ''                  | ''                 |
			...
			| ''                                               | '29.04.2024 10:42:01' | 'Expense'    | 'Main Company' | 'Front office' | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '43'     | '43'                   | ''                 | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432049 check DebitCreditNote movements by the register "R1020 Advances to vendors" (VA-VA, by documents, different partners)
	...
	* Check movements by the Register "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 11:06:59' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Vendor (by documents) 2'        | ''        | '47'     | 'No'                   | ''                         |
			...
			| ''                                               | '29.04.2024 11:06:59' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Advance, by documents)'     | 'Vendor (Advance, by documents)'     | ''      | 'Vendor (Advance, by documents)' | ''        | '47'     | 'No'                   | ''                         |
...
Scenario: _0432050 check DebitCreditNote movements by the register "R5020 Partners balance" (VA-VA, by documents, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 11:06:59' | 'Receipt'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Vendor (by documents) 2'        | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '47'     | ''                     | ''                 | ''                   | '47'             | ''                  | ''                 |
			...
			| ''                                               | '29.04.2024 11:06:59' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor (Advance, by documents)'     | 'Vendor (Advance, by documents)'     | 'Vendor (Advance, by documents)' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '47'     | ''                     | ''                 | ''                   | '47'             | ''                  | ''                 |
...
Scenario: _0432052 check DebitCreditNote movements by the register "R2020 Advances from customer" (СA-СA, by documents, different partners)
	...
	* Check movements by the Register "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 11:15:01' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | ''      | 'Basic Partner terms, TRY' | ''        | '49'     | 'No'                   | ''                           |
			...
			| ''                                               | '29.04.2024 11:15:01' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Advance, by documents)'   | 'Customer (Advance, by documents)'   | ''      | 'Basic Partner terms, TRY' | ''        | '49'     | 'No'                   | ''                           |
...
Scenario: _0432053 check DebitCreditNote movements by the register "R5020 Partners balance" (СA-СA, by documents, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 11:15:01' | 'Receipt'    | 'Main Company' | 'Front office' | 'Customer (Advance, by documents)'   | 'Customer (Advance, by documents)'   | 'Basic Partner terms, TRY' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '49'     | ''                     | '49'               | ''                   | ''               | ''                  | ''                 |
			...
			| ''                                               | '29.04.2024 11:15:01' | 'Expense'    | 'Main Company' | 'Front office' | 'Vendor and Customer (by documents)' | 'Vendor and Customer (by documents)' | 'Basic Partner terms, TRY' | ''         | 'TRY'      | 'TRY'                          | 'TRY'                  | '49'     | ''                     | '49'               | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432055 check DebitCreditNote movements by the register "R2021 Customer transactions" (СT-СT, by documents and partner term, different partners)
	...
	* Check movements by the Register "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 11:21:10' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Transacrions, by partner terms)' | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''                                            | ''      | ''        | '53'     | 'No'                   | ''                           |
			...
			| ''                                               | '29.04.2024 11:21:10' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Customer (Transactions, by documents)'     | 'Customer (Transactions, by documents)'     | 'Basic Partner terms, TRY'                  | 'Sales invoice 114 dated 17.02.2024 12:00:00' | ''      | ''        | '53'     | 'No'                   | ''                           |
...
Scenario: _0432064 check DebitCreditNote movements by the register "R5020 Partners balance" (СT-СT, by documents and partner term, different partners)
	...
	* Check movements by the Register  "R5020 Partners balance"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 11:21:10' | 'Receipt'    | 'Main Company' | 'Front office' | 'Customer (Transactions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | 'Customer (Transacrions, by partner terms)' | ''                                            | 'TRY'      | 'TRY'                          | 'TRY'                  | '53'     | '53'                   | ''                 | ''                   | ''               | ''                  | ''                 |
...
Scenario: _0432057 check DebitCreditNote movements by the register "R1021 Vendors transactions" (СT-СT, by documents and partner term, different partners)
	...
	* Check movements by the Register "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                               | '29.04.2024 12:14:25' | 'Receipt'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by documents)'    | 'Vendor (Transactions, by documents)'    | 'Vendor (Transactions, by documents)' | 'Purchase invoice 325 dated 18.02.2024 19:37:36' | ''      | ''        | '54'     | 'No'                   | ''                         |
			...
			| ''                                               | '29.04.2024 12:14:25' | 'Expense'    | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Vendor (Transactions, by partner term)' | 'Vendor (Transactions, by partner term)' | 'Vendor, TRY'                         | ''                                               | ''      | ''        | '54'     | 'No'                   | ''                         |
