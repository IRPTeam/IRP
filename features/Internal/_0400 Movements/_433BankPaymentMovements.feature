...
Scenario: _0433331 check Bank payment movements (WithholdingTaxInvoice)
	And I close all client application windows
	Given I open hyperlink "e1cib/list/Document.BankPayment"
	And I go to line in "List" table
		| 'Number' |
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T1040 Accounting amounts"'         | ''                                             | ''                                     | ''                        | ''                             | ''                                     | ''                        | ''                        | ''                                                    | ''                   | ''                             | ''                                                    | ''                                                    | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | 'Period'                                       | 'Row key'                              | 'Operation'               | 'Multi currency movement type' | 'Currency'                             | 'Revaluated currency'     | 'Dr currency'             | 'Cr currency'                                         | 'Amount'             | 'Dr currency amount'           | 'Cr currency amount'                                  | 'Deferred calculation'                                | 'Advances closing'                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | '05.05.2025 13:57:00'                          | '88844169-cde5-4890-8f02-33a9d4dd0797' | 'en description is empty' | 'Local currency'               | 'TRY'                                  | ''                        | 'TRY'                     | ''                                                    | '500'                | '500'                          | ''                                                    | 'No'                                                  | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | '05.05.2025 13:57:00'                          | '88844169-cde5-4890-8f02-33a9d4dd0797' | 'en description is empty' | 'Reporting currency'           | 'USD'                                  | ''                        | 'TRY'                     | ''                                                    | '85,6'               | '500'                          | ''                                                    | 'No'                                                  | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | '05.05.2025 13:57:00'                          | '88844169-cde5-4890-8f02-33a9d4dd0797' | 'en description is empty' | 'en description is empty'      | 'TRY'                                  | ''                        | 'TRY'                     | ''                                                    | '500'                | '500'                          | ''                                                    | 'No'                                                  | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | ''                                             | ''                                     | ''                        | ''                             | ''                                     | ''                        | ''                        | ''                                                    | ''                   | ''                             | ''                                                    | ''                                                    | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| 'Register  "T2015 Transactions info"'          | ''                                             | ''                                     | ''                        | ''                             | ''                                     | ''                        | ''                        | ''                                                    | ''                   | ''                             | ''                                                    | ''                                                    | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | 'Company'                                      | 'Branch'                               | 'Order'                   | 'Date'                         | 'Key'                                  | 'Currency'                | 'Partner'                 | 'Legal name'                                          | 'Agreement'          | 'Is vendor transaction'        | 'Is customer transaction'                             | 'Transaction basis'                                   | 'Unique ID'                            | 'Project'          | 'Amount'               | 'Is due'                   | 'Is paid'           | ''                 |
			| ''                                             | 'Main Company'                                 | ''                                     | ''                        | '05.05.2025 13:57:00'          | '88844169-cde5-4890-8f02-33a9d4dd0797' | 'TRY'                     | 'Ferron BP'               | 'Company Ferron BP'                                   | 'Vendor Ferron, TRY' | 'Yes'                          | 'No'                                                  | 'Withholding tax invoice 4 dated 02.05.2025 15:12:12' | 'c6e620e0-5783-4e4d-8637-e6eb5eb04e2a' | ''                 | '500'                  | 'No'                       | 'Yes'               | ''                 |
	And I close all client application windows