...
Scenario: _043306 check Bank payment movements by the Register "R1020 Advances to vendors" (payment to vendor, without basis document )
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '12.02.2021 11:24:13' | '342,4'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank payment 10 dated 12.02.2021 11:24:13' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '12.02.2021 11:24:13' | '2 000'     | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank payment 10 dated 12.02.2021 11:24:13' | 'No'                   | ''                         |
			| ''                                          | 'Receipt'     | '12.02.2021 11:24:13' | '2 000'     | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank payment 10 dated 12.02.2021 11:24:13' | 'No'                   | ''                         |
	And I close all client application windows
...
Scenario: _043322 check Bank payment movements by the Register "R1020 Advances to vendors" (with partner term by document, without basis)
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''                        | ''                             | ''         | ''                     | ''                  | ''          | ''      | ''                   | ''                                           | 'Attributes'           | ''                         |
			| ''                                           | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'                  | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name'        | 'Partner'   | 'Order' | 'Agreement'          | 'Basis'                                      | 'Deferred calculation' | 'Vendors advances closing' |
			| ''                                           | 'Receipt'     | '08.02.2022 13:43:58' | '8,56'      | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | 'Bank payment 328 dated 08.02.2022 13:43:58' | 'No'                   | ''                         |
			| ''                                           | 'Receipt'     | '08.02.2022 13:43:58' | '50'        | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | 'Bank payment 328 dated 08.02.2022 13:43:58' | 'No'                   | ''                         |
			| ''                                           | 'Receipt'     | '08.02.2022 13:43:58' | '50'        | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | 'Bank payment 328 dated 08.02.2022 13:43:58' | 'No'                   | ''                         |
	And I close all client application windows
...
Scenario: _043327 check Bank payment movements by the Register "R2020 Advances from customer" (Return to customer by POS, without basis document)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Receipt'     | '24.06.2022 18:07:02' | '-50'       | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank payment 1 330 dated 24.06.2022 18:07:02' | 'No'                   | ''                           |
			| ''                                             | 'Receipt'     | '24.06.2022 18:07:02' | '-50'       | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank payment 1 330 dated 24.06.2022 18:07:02' | 'No'                   | ''                           |
			| ''                                             | 'Receipt'     | '24.06.2022 18:07:02' | '-8,56'     | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank payment 1 330 dated 24.06.2022 18:07:02' | 'No'                   | ''                           |
	And I close all client application windows
