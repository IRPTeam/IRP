...
Scenario: _043301 check Bank payment movements by the Register "R3010 Cash on hand"
	...
	* Check movements by the Register  "R3010 Cash on hand" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Expense'     | '05.04.2021 12:28:47' | '500'       | 'Main Company' | 'Main Company' | 'Bank account, EUR' | 'EUR'      | 'en description is empty'      | 'No'                   |
			| ''                                         | 'Expense'     | '05.04.2021 12:28:47' | '550'       | 'Main Company' | 'Main Company' | 'Bank account, EUR' | 'USD'      | 'Reporting currency'           | 'No'                   |
			| ''                                         | 'Expense'     | '05.04.2021 12:28:47' | '2 500'     | 'Main Company' | 'Main Company' | 'Bank account, EUR' | 'TRY'      | 'Local currency'               | 'No'                   |
...
Scenario: _043302 check Bank payment movements by the Register "R5010 Reconciliation statement" (payment to vendor)
	...
	* Check movements by the Register  "R5010 Reconciliation statement" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Receipt'     | '07.09.2020 19:16:43' | '1 000'     | 'TRY'        | 'Main Company' | 'Main Company' | 'Company Ferron BP' |
	And I close all client application windows
...
Scenario: _043304 check Bank payment movements by the Register "R1021 Vendors transactions" (payment to vendor, basis document exist)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Expense'     | '07.09.2020 19:16:43' | '171,2'     | 'Main Company' | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 12 dated 07.09.2020 17:53:38' | 'No'                   | ''                         |
			| ''                                         | 'Expense'     | '07.09.2020 19:16:43' | '1 000'     | 'Main Company' | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 12 dated 07.09.2020 17:53:38' | 'No'                   | ''                         |
			| ''                                         | 'Expense'     | '07.09.2020 19:16:43' | '1 000'     | 'Main Company' | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 12 dated 07.09.2020 17:53:38' | 'No'                   | ''                         |
			| ''                                         | 'Expense'     | '07.09.2020 19:16:43' | '1 000'     | 'Main Company' | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 12 dated 07.09.2020 17:53:38' | 'No'                   | ''                         |
	And I close all client application windows
...
Scenario: _043306 check Bank payment movements by the Register "R1020 Advances to vendors" (payment to vendor, without basis document )
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '12.02.2021 11:24:13' | '342,4'     | 'Main Company' | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Bank payment 10 dated 12.02.2021 11:24:13' | 'No'                   | ''                |
			| ''                                         | 'Receipt'     | '12.02.2021 11:24:13' | '2 000'     | 'Main Company' | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Bank payment 10 dated 12.02.2021 11:24:13' | 'No'                   | ''                |
			| ''                                         | 'Receipt'     | '12.02.2021 11:24:13' | '2 000'     | 'Main Company' | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Bank payment 10 dated 12.02.2021 11:24:13' | 'No'                   | ''                |
	And I close all client application windows
...
Scenario: _043315 check Bank payment movements by the Register "R3035 Cash planning" (payment to vendor, with planning transaction basis)
	...
	* Check movements by the Register  "R3035 Cash planning" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | '03.06.2021 17:01:44' | '-1 500'    | 'Main Company' | 'Main Company' | 'Outgoing payment order 323 dated 07.09.2020 19:23:44' | 'Bank account, TRY' | 'TRY'      | 'Outgoing'            | 'Ferron BP' | 'Company Ferron BP' | 'Local currency'               | 'Movement type 1' | 'First'           | 'No'                   |
			| ''                                           | '03.06.2021 17:01:44' | '-1 500'    | 'Main Company' | 'Main Company' | 'Outgoing payment order 323 dated 07.09.2020 19:23:44' | 'Bank account, TRY' | 'TRY'      | 'Outgoing'            | 'Ferron BP' | 'Company Ferron BP' | 'en description is empty'      | 'Movement type 1' | 'First'           | 'No'                   |
			| ''                                           | '03.06.2021 17:01:44' | '-400'      | 'Main Company' | 'Main Company' | 'Outgoing payment order 323 dated 07.09.2020 19:23:44' | 'Bank account, TRY' | 'TRY'      | 'Outgoing'            | 'Kalipso'   | 'Company Kalipso'   | 'Local currency'               | 'Movement type 1' | 'First'           | 'No'                   |
			| ''                                           | '03.06.2021 17:01:44' | '-400'      | 'Main Company' | 'Main Company' | 'Outgoing payment order 323 dated 07.09.2020 19:23:44' | 'Bank account, TRY' | 'TRY'      | 'Outgoing'            | 'Kalipso'   | 'Company Kalipso'   | 'en description is empty'      | 'Movement type 1' | 'First'           | 'No'                   |
			| ''                                           | '03.06.2021 17:01:44' | '-256,8'    | 'Main Company' | 'Main Company' | 'Outgoing payment order 323 dated 07.09.2020 19:23:44' | 'Bank account, TRY' | 'USD'      | 'Outgoing'            | 'Ferron BP' | 'Company Ferron BP' | 'Reporting currency'           | 'Movement type 1' | 'First'           | 'No'                   |
			| ''                                           | '03.06.2021 17:01:44' | '-68,48'    | 'Main Company' | 'Main Company' | 'Outgoing payment order 323 dated 07.09.2020 19:23:44' | 'Bank account, TRY' | 'USD'      | 'Outgoing'            | 'Kalipso'   | 'Company Kalipso'   | 'Reporting currency'           | 'Movement type 1' | 'First'           | 'No'                   |
	And I close all client application windows
...
Scenario: _043316 check Bank payment movements by the Register "R3035 Cash planning" (currency exchange, with planning transaction basis)
	...
	* Check movements by the Register  "R3035 Cash planning" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Period'              | 'Resources' | 'Dimensions'   | ''   | ''                                                | ''                  | ''         | ''                    | ''        | ''           | ''                             | ''                | ''                | 'Attributes'           |
			| ''                                           | ''                    | 'Amount'    | 'Company'      | 'Branch'      | 'Basis document'                                  | 'Account'           | 'Currency' | 'Cash flow direction' | 'Partner' | 'Legal name' | 'Multi currency movement type' | 'Movement type'   | 'Planning period' | 'Deferred calculation' |
			| ''                                           | '03.06.2021 17:05:34' | '-1 000'    | 'Main Company' | 'Main Company' | 'Cash transfer order 3 dated 05.04.2021 12:23:49' | 'Bank account, TRY' | 'TRY'      | 'Outgoing'            | ''        | ''           | 'Local currency'               | 'Movement type 1' | ''                | 'No'                   |
			| ''                                           | '03.06.2021 17:05:34' | '-1 000'    | 'Main Company' | 'Main Company' | 'Cash transfer order 3 dated 05.04.2021 12:23:49' | 'Bank account, TRY' | 'TRY'      | 'Outgoing'            | ''        | ''           | 'en description is empty'      | 'Movement type 1' | ''                | 'No'                   |
			| ''                                           | '03.06.2021 17:05:34' | '-171,2'    | 'Main Company' | 'Main Company' | 'Cash transfer order 3 dated 05.04.2021 12:23:49' | 'Bank account, TRY' | 'USD'      | 'Outgoing'            | ''        | ''           | 'Reporting currency'           | 'Movement type 1' | ''                | 'No'                   |
	And I close all client application windows
...
Scenario: _043317 check Bank payment movements by the Register "R3035 Cash planning" (cash transfer order, with planning transaction basis)
	...
	* Check movements by the Register  "R3035 Cash planning" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Period'              | 'Resources' | 'Dimensions'   | ''   | ''                                                | ''                  | ''         | ''                    | ''        | ''           | ''                             | ''                | ''                | 'Attributes'           |
			| ''                                           | ''                    | 'Amount'    | 'Company'      | 'Branch'      | 'Basis document'                                  | 'Account'           | 'Currency' | 'Cash flow direction' | 'Partner' | 'Legal name' | 'Multi currency movement type' | 'Movement type'   | 'Planning period' | 'Deferred calculation' |
			| ''                                           | '03.06.2021 17:04:49' | '-4 500'    | 'Main Company' | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account, EUR' | 'TRY'      | 'Outgoing'            | ''        | ''           | 'Local currency'               | 'Movement type 1' | ''                | 'No'                   |
			| ''                                           | '03.06.2021 17:04:49' | '-550'      | 'Main Company' | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account, EUR' | 'USD'      | 'Outgoing'            | ''        | ''           | 'Reporting currency'           | 'Movement type 1' | ''                | 'No'                   |
			| ''                                           | '03.06.2021 17:04:49' | '-500'      | 'Main Company' | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account, EUR' | 'EUR'      | 'Outgoing'            | ''        | ''           | 'en description is empty'      | 'Movement type 1' | ''                | 'No'                   |
	And I close all client application windows
