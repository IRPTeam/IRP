...
Scenario: _043412 check Bank receipt movements by the Register "R2020 Advances from customer" (without basis document)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '15.04.2021 10:21:22' | '9 381,76'  | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Lomaniti' | 'Lomaniti' | ''      | ''          | 'Bank receipt 5 dated 15.04.2021 10:21:22' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '15.04.2021 10:21:22' | '54 800'    | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Lomaniti' | 'Lomaniti' | ''      | ''          | 'Bank receipt 5 dated 15.04.2021 10:21:22' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '15.04.2021 10:21:22' | '54 800'    | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Lomaniti' | 'Lomaniti' | ''      | ''          | 'Bank receipt 5 dated 15.04.2021 10:21:22' | 'No'                   | ''                           |
	And I close all client application windows
...
Scenario: _043427 check Bank receipt movements by the Register "R2020 Advances from customer" (with partner term by document, without basis)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''       | ''                             | ''         | ''                     | ''                  | ''          | ''      | ''                         | ''                                           | 'Attributes'           | ''                           |
			| ''                                           | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch' | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name'        | 'Partner'   | 'Order' | 'Agreement'                | 'Basis'                                      | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                           | 'Receipt'     | '08.02.2022 13:39:01' | '8,56'      | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY' | 'Bank receipt 518 dated 08.02.2022 13:39:01' | 'No'                   | ''                           |
			| ''                                           | 'Receipt'     | '08.02.2022 13:39:01' | '50'        | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY' | 'Bank receipt 518 dated 08.02.2022 13:39:01' | 'No'                   | ''                           |
			| ''                                           | 'Receipt'     | '08.02.2022 13:39:01' | '50'        | 'Main Company' | ''       | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY' | 'Bank receipt 518 dated 08.02.2022 13:39:01' | 'No'                   | ''                           |
	And I close all client application windows
...
Scenario: _0434281 check Bank receipt movements by the Register "R2020 Advances from customer" (Payment from customer by POS, without bases)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''                        | ''                             | ''         | ''                     | ''                  | ''          | ''      | ''          | ''                                             | 'Attributes'           | ''                           |
			| ''                                             | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'                  | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name'        | 'Partner'   | 'Order' | 'Agreement' | 'Basis'                                        | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                             | 'Receipt'     | '23.06.2022 19:41:15' | '17,12'     | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank receipt 1 520 dated 23.06.2022 19:41:15' | 'No'                   | ''                           |
			| ''                                             | 'Receipt'     | '23.06.2022 19:41:15' | '100'       | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank receipt 1 520 dated 23.06.2022 19:41:15' | 'No'                   | ''                           |
			| ''                                             | 'Receipt'     | '23.06.2022 19:41:15' | '100'       | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Bank receipt 1 520 dated 23.06.2022 19:41:15' | 'No'                   | ''                           |
	And I close all client application windows
