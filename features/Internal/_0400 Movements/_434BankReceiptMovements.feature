...
Scenario: _0434292 check Bank receipt movements by the Register "R3021 Cash in transit (incoming)" (Transfer from POS, comission is separate)
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Expense'     | '24.06.2022 15:19:35' | '17,12'     | '1,71'       | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Bank account, TRY'  | ''      | 'No'                   |
			| ''                                             | 'Expense'     | '24.06.2022 15:19:35' | '100'       | '10'         | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Bank account, TRY'  | ''      | 'No'                   |
			| ''                                             | 'Expense'     | '24.06.2022 15:19:35' | '100'       | '10'         | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Bank account, TRY'  | ''      | 'No'                   |
		And I close all client application windows
...
Scenario: _0434293 check Bank receipt movements by the Register "R3021 Cash in transit (incoming)" (Transfer from POS, comission include)
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Record type' | 'Period'              | 'Resources' | ''           | 'Dimensions'   | ''                        | ''                             | ''         | ''                     | ''                                    | ''                   | ''      | 'Attributes'           |
			| ''                                             | ''            | ''                    | 'Amount'    | 'Commission' | 'Company'      | 'Branch'                  | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Account'                             | 'Receipting account' | 'Basis' | 'Deferred calculation' |
			| ''                                             | 'Expense'     | '24.06.2022 15:19:39' | '8,56'      | '0,86'       | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'POS Account, Comission include, TRY' | 'Bank account, TRY'  | ''      | 'No'                   |
			| ''                                             | 'Expense'     | '24.06.2022 15:19:39' | '50'        | '5'          | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'POS Account, Comission include, TRY' | 'Bank account, TRY'  | ''      | 'No'                   |
			| ''                                             | 'Expense'     | '24.06.2022 15:19:39' | '50'        | '5'          | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'POS Account, Comission include, TRY' | 'Bank account, TRY'  | ''      | 'No'                   |
		And I close all client application windows
