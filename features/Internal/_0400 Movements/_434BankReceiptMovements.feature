...
Scenario: _043400 preparation (Bank receipt)
	...
	* Load Cash transfer order
		...
		And I execute 1C:Enterprise script at server
			| "Documents.BankPayment.FindByNumber(516).GetObject().Write(DocumentWriteMode.Posting);"    |
		And I execute 1C:Enterprise script at server
			| "Documents.BankPayment.FindByNumber(517).GetObject().Write(DocumentWriteMode.Posting);"    |
		And I execute 1C:Enterprise script at server
...
Scenario: _043426 check Bank receipt movements by the Register "R1021 Vendors transactions" (Return from vendor, with basis)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Receipt'     | '08.02.2022 12:44:01' | '8,56'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Maxim' | 'Maxim'   | 'Partner term Maxim' | 'Purchase return 21 dated 28.04.2021 21:50:02' | ''      | ''        | 'No'                   | ''                         |
			| ''                                           | 'Receipt'     | '08.02.2022 12:44:01' | '50'        | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Maxim' | 'Maxim'   | 'Partner term Maxim' | 'Purchase return 21 dated 28.04.2021 21:50:02' | ''      | ''        | 'No'                   | ''                         |
			| ''                                           | 'Receipt'     | '08.02.2022 12:44:01' | '50'        | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Maxim' | 'Maxim'   | 'Partner term Maxim' | 'Purchase return 21 dated 28.04.2021 21:50:02' | ''      | ''        | 'No'                   | ''                         |
	And I close all client application windows
...
Scenario: _0434351 check Bank receipt movements by the Register  "T2015 Transactions info" (Payment from customer, advance=false)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Main Company' | ''       | ''      | '07.09.2020 19:14:59' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'No'                    | 'Yes'                     | 'Sales invoice 1 dated 28.01.2021 18:48:53' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'     | 'Yes'     |
	And I close all client application windows
...
Scenario: _0434352 check Bank receipt movements by the Register  "T2014 Advances info" (Payment from customer, advance=true)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Main Company' | 'Distribution department' | '21.04.2021 13:09:56' | '*'   | 'USD'      | 'Kalipso' | 'Company Kalipso' | ''      | 'No'                | 'Yes'                 | '*'         | 'Personal Partner terms, $' | ''        | 'en description is empty' | 'USD'                  | '25 000' | 'No'                      | 'No'                   | 'Receipt'     |
	And I close all client application windows
...
Scenario: _0434355 check Bank receipt movements by the Register  "T2015 Transactions info" (Return from vendor, with basis)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2015 Transactions info"'        | ''             | ''             | ''      | ''                    | ''    | ''         | ''        | ''              | ''                   | ''                      | ''                        | ''                                             | ''          | ''        | ''                        | ''                     | ''       | ''       | ''        |
			| ''                                           | 'Company'      | 'Branch'       | 'Order' | 'Date'                | 'Key' | 'Currency' | 'Partner' | 'Legal name'    | 'Agreement'          | 'Is vendor transaction' | 'Is customer transaction' | 'Transaction basis'                            | 'Unique ID' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is due' | 'Is paid' |
			| ''                                           | 'Main Company' | 'Front office' | ''      | '08.02.2022 12:44:01' | '*'   | 'TRY'      | 'Maxim'   | 'Company Maxim' | 'Partner term Maxim' | 'Yes'                   | 'No'                      | 'Purchase return 21 dated 28.04.2021 21:50:02' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '-50'    | 'No'     | 'Yes'     |
	And I close all client application windows
...
Scenario: _0434357 check Bank receipt movements by the Register  "T2014 Advances info" (Return from vendor, without basis)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2014 Advances info"'            | ''             | ''             | ''                    | ''    | ''         | ''          | ''                  | ''      | ''                  | ''                    | ''          | ''                        | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                           | 'Company'      | 'Branch'       | 'Date'                | 'Key' | 'Currency' | 'Partner'   | 'Legal name'        | 'Order' | 'Is vendor advance' | 'Is customer advance' | 'Unique ID' | 'Advance agreement'       | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is purchase order close' | 'Is sales order close' | 'Record type' |
			| ''                                           | 'Main Company' | 'Front office' | '02.09.2021 14:30:07' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'Yes'               | 'No'                  | '*'         | 'Vendor Ferron, TRY'      | ''        | 'en description is empty' | 'TRY'                  | '-100'   | 'No'                      | 'No'                   | 'Receipt'     |
			| ''                                           | 'Main Company' | 'Front office' | '02.09.2021 14:30:07' | '*'   | 'TRY'      | 'DFC'       | 'DFC'               | ''      | 'Yes'               | 'No'                  | '*'         | 'Partner term vendor DFC' | ''        | 'en description is empty' | 'TRY'                  | '-200'   | 'No'                      | 'No'                   | 'Receipt'     |
	And I close all client application windows
...
Scenario: _0434357 check Bank receipt movements by the Register  "T2014 Advances info" (Payment from customer by POS, advance=true)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2014 Advances info"'              | ''             | ''                        | ''                    | ''    | ''         | ''          | ''                  | ''      | ''                  | ''                    | ''          | ''                         | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                             | 'Company'      | 'Branch'                  | 'Date'                | 'Key' | 'Currency' | 'Partner'   | 'Legal name'        | 'Order' | 'Is vendor advance' | 'Is customer advance' | 'Unique ID' | 'Advance agreement'        | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is purchase order close' | 'Is sales order close' | 'Record type' |
			| ''                                             | 'Main Company' | 'Distribution department' | '23.06.2022 19:41:15' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'No'                | 'Yes'                 | '*'         | 'Basic Partner terms, TRY' | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'                      | 'No'                   | 'Receipt'     |
	And I close all client application windows
...
Scenario: _0434355 check Bank receipt movements by the Register  "T2015 Transactions info" (Payment from customer by POS,  advance=false)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2015 Transactions info"'          | ''             | ''                        | ''      | ''                    | ''    | ''         | ''          | ''                  | ''                         | ''                      | ''                        | ''                                          | ''          | ''        | ''                        | ''                     | ''       | ''       | ''        |
			| ''                                             | 'Company'      | 'Branch'                  | 'Order' | 'Date'                | 'Key' | 'Currency' | 'Partner'   | 'Legal name'        | 'Agreement'                | 'Is vendor transaction' | 'Is customer transaction' | 'Transaction basis'                         | 'Unique ID' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is due' | 'Is paid' |
			| ''                                             | 'Main Company' | 'Distribution department' | ''      | '23.06.2022 17:50:08' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'No'                    | 'Yes'                     | 'Sales invoice 3 dated 28.01.2021 18:50:57' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'     | 'Yes'     |
	And I close all client application windows
...
Scenario: _0434358 check Bank receipt movements by the Register  "R3011 Cash flow" (Salary return,  Branch in lines)
	...
	* Check movements by the Register  "R3011 Cash flow" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | '02.09.2024 17:20:24' | 'Main Company' | 'Accountants office'      | 'Bank account, TRY' | 'Incoming'  | 'Movement type 1'         | 'Distribution department' | ''                | 'TRY'      | 'Local currency'               | '100'    | 'No'                   |
			| ''                                             | '02.09.2024 17:20:24' | 'Main Company' | 'Accountants office'      | 'Bank account, TRY' | 'Incoming'  | 'Movement type 1'         | 'Distribution department' | ''                | 'TRY'      | 'en description is empty'      | '100'    | 'No'                   |
			| ''                                             | '02.09.2024 17:20:24' | 'Main Company' | 'Accountants office'      | 'Bank account, TRY' | 'Incoming'  | 'Movement type 1'         | 'Distribution department' | ''                | 'USD'      | 'Reporting currency'           | '17,12'  | 'No'                   |
...
Scenario: _0434358 check Bank receipt movements by the Register  "R3011 Cash flow" (Salary return,  Branch in header)
	...
	* Check movements by the Register  "R3011 Cash flow" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | '02.09.2024 17:23:53' | 'Main Company' | 'Front office' | 'Bank account, TRY' | 'Incoming'  | 'Movement type 1'         | 'Distribution department' | ''                | 'TRY'      | 'Local currency'               | '100'    | 'No'                   |
			| ''                                             | '02.09.2024 17:23:53' | 'Main Company' | 'Front office' | 'Bank account, TRY' | 'Incoming'  | 'Movement type 1'         | 'Distribution department' | ''                | 'TRY'      | 'en description is empty'      | '100'    | 'No'                   |
			| ''                                             | '02.09.2024 17:23:53' | 'Main Company' | 'Front office' | 'Bank account, TRY' | 'Incoming'  | 'Movement type 1'         | 'Distribution department' | ''                | 'USD'      | 'Reporting currency'           | '17,12'  | 'No'                   |		
	And I close all client application windows
