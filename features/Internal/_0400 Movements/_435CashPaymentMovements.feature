...
Scenario: _043538 check Cash payment movements by the Register  "T2015 Transactions info" (Payment to the vendor, advance=false)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Main Company' | 'Front office' | ''      | '05.04.2021 12:40:00' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Yes'                   | 'No'                      | 'Purchase invoice 323 dated 30.05.2021 15:08:40' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '1 000'  | 'No'     | 'Yes'     |
	And I close all client application windows

Scenario: _043539 check Cash payment movements by the Register  "T2014 Advances info" (Payment to the vendor, advance=true)
	And I close all client application windows
	* Select Cash payment
		Given I open hyperlink "e1cib/list/Document.CashPayment"
		And I go to line in "List" table
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Main Company' | 'Front office' | '04.06.2021 11:30:02' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'Yes'               | 'No'                  | '*'         | 'Vendor Ferron, TRY' | ''        | 'en description is empty' | 'TRY'                  | '960'    | 'No'                      | 'No'                   | 'Receipt'     |
	And I close all client application windows
...
Scenario: _043542 check Cash payment movements by the Register  "T2014 Advances info" (Return to customer, without basis)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2014 Advances info"'            | ''             | ''             | ''                    | ''    | ''         | ''          | ''                  | ''      | ''                  | ''                    | ''          | ''                  | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                           | 'Company'      | 'Branch'       | 'Date'                | 'Key' | 'Currency' | 'Partner'   | 'Legal name'        | 'Order' | 'Is vendor advance' | 'Is customer advance' | 'Unique ID' | 'Advance agreement' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is purchase order close' | 'Is sales order close' | 'Record type' |
			| ''                                           | 'Main Company' | 'Front office' | '02.09.2021 14:09:26' | '*'   | 'USD'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'No'                | 'Yes'                 | '*'         | 'Ferron, USD'       | ''        | 'en description is empty' | 'USD'                  | '-450'   | 'No'                      | 'No'                   | 'Receipt'     |
	And I close all client application windows
...
Scenario: _043550 check Cash payment movements by the Register "T1040 Accounting amounts" (WithholdingTaxInvoice)
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | '05.05.2025 13:57:00' | '*'       | 'en description is empty' | 'Local currency'               | 'TRY'      | ''                    | 'TRY'         | ''            | '150'    | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                             | '05.05.2025 13:57:00' | '*'       | 'en description is empty' | 'Reporting currency'           | 'USD'      | ''                    | 'TRY'         | ''            | '25,68'  | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                             | '05.05.2025 13:57:00' | '*'       | 'en description is empty' | 'en description is empty'      | 'TRY'      | ''                    | 'TRY'         | ''            | '150'    | ''                   | ''                   | 'No'                   | ''                 |
	And I close all client application windows
...
Scenario: _043551 check Cash payment movements by the Register "T2015 Transactions info" (WithholdingTaxInvoice)
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2015 Transactions info"'          | ''             | ''       | ''      | ''                    | ''    | ''         | ''          | ''                  | ''                   | ''                      | ''                        | ''                                                    | ''          | ''        | ''                        | ''                     | ''       | ''       | ''        |
			| ''                                             | 'Company'      | 'Branch' | 'Order' | 'Date'                | 'Key' | 'Currency' | 'Partner'   | 'Legal name'        | 'Agreement'          | 'Is vendor transaction' | 'Is customer transaction' | 'Transaction basis'                                   | 'Unique ID' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is due' | 'Is paid' |
			| ''                                             | 'Main Company' | ''       | ''      | '05.05.2025 13:57:00' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Yes'                   | 'No'                      | 'Withholding tax invoice 2 dated 03.05.2025 12:25:23' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '150'    | 'No'     | 'Yes'     |
	And I close all client application windows