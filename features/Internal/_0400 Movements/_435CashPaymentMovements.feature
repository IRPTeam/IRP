...
Scenario: _043544 check Cash payment movements (WithholdingTaxInvoice)
	And I close all client application windows
	Given I open hyperlink "e1cib/list/Document.CashPayment"
	And I go to line in "List" table
		| 'Number' |
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | '05.05.2025 13:57:00'                          | 'b643ac0c-e512-4225-a613-4b2bad7c6796' | 'en description is empty' | 'Local currency'               | 'TRY'                                  | ''                        | 'TRY'                     | ''                                                    | '150'                | '150'                          | ''                                                    | 'No'                                                  | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | '05.05.2025 13:57:00'                          | 'b643ac0c-e512-4225-a613-4b2bad7c6796' | 'en description is empty' | 'Reporting currency'           | 'USD'                                  | ''                        | 'TRY'                     | ''                                                    | '25,68'              | '150'                          | ''                                                    | 'No'                                                  | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | '05.05.2025 13:57:00'                          | 'b643ac0c-e512-4225-a613-4b2bad7c6796' | 'en description is empty' | 'en description is empty'      | 'TRY'                                  | ''                        | 'TRY'                     | ''                                                    | '150'                | '150'                          | ''                                                    | 'No'                                                  | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | ''                                             | ''                                     | ''                        | ''                             | ''                                     | ''                        | ''                        | ''                                                    | ''                   | ''                             | ''                                                    | ''                                                    | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| 'Register  "T2015 Transactions info"'          | ''                                             | ''                                     | ''                        | ''                             | ''                                     | ''                        | ''                        | ''                                                    | ''                   | ''                             | ''                                                    | ''                                                    | ''                                     | ''                 | ''                     | ''                         | ''                  | ''                 |
			| ''                                             | 'Company'                                      | 'Branch'                               | 'Order'                   | 'Date'                         | 'Key'                                  | 'Currency'                | 'Partner'                 | 'Legal name'                                          | 'Agreement'          | 'Is vendor transaction'        | 'Is customer transaction'                             | 'Transaction basis'                                   | 'Unique ID'                            | 'Project'          | 'Amount'               | 'Is due'                   | 'Is paid'           | ''                 |
			| ''                                             | 'Main Company'                                 | ''                                     | ''                        | '05.05.2025 13:57:00'          | 'b643ac0c-e512-4225-a613-4b2bad7c6796' | 'TRY'                     | 'Ferron BP'               | 'Company Ferron BP'                                   | 'Vendor Ferron, TRY' | 'Yes'                          | 'No'                                                  | 'Withholding tax invoice 2 dated 03.05.2025 12:25:23' | 'b79208bc-b20d-4985-9fbf-497edd122f6e' | ''                 | '150'                  | 'No'                       | 'Yes'               | ''                 |
	And I close all client application windows