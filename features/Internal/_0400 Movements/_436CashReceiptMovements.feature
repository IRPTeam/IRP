...
Scenario: _043627 check Cash receipt movements by the Register "R3021 Cash in transit (incoming)" (cash in)
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Expense'     | '25.08.2022 16:46:16' | '171,2'     | ''           | 'Main Company' | 'Shop 02' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Cash desk №2' | 'Pos cash account 1' | 'Money transfer 11 dated 25.08.2022 16:45:16' | 'No'                   |
			| ''                                             | 'Expense'     | '25.08.2022 16:46:16' | '1 000'     | ''           | 'Main Company' | 'Shop 02' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Cash desk №2' | 'Pos cash account 1' | 'Money transfer 11 dated 25.08.2022 16:45:16' | 'No'                   |
			| ''                                             | 'Expense'     | '25.08.2022 16:46:16' | '1 000'     | ''           | 'Main Company' | 'Shop 02' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Cash desk №2' | 'Pos cash account 1' | 'Money transfer 11 dated 25.08.2022 16:45:16' | 'No'                   |
	And I close all client application windows
...
Scenario: _043629 check Cash receipt movements by the Register "R3021 Cash in transit (incoming)" (cash out)
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Record type' | 'Period'              | 'Resources' | ''           | 'Dimensions'   | ''        | ''                             | ''         | ''                     | ''                   | ''                   | ''                                            | 'Attributes'           |
			| ''                                             | ''            | ''                    | 'Amount'    | 'Commission' | 'Company'      | 'Branch'  | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Account'            | 'Receipting account' | 'Basis'                                       | 'Deferred calculation' |
			| ''                                             | 'Expense'     | '25.08.2022 16:46:40' | '171,2'     | ''           | 'Main Company' | 'Shop 02' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Pos cash account 1' | 'Cash desk №2'       | 'Money transfer 13 dated 25.08.2022 16:46:25' | 'No'                   |
			| ''                                             | 'Expense'     | '25.08.2022 16:46:40' | '1 000'     | ''           | 'Main Company' | 'Shop 02' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Pos cash account 1' | 'Cash desk №2'       | 'Money transfer 13 dated 25.08.2022 16:46:25' | 'No'                   |
			| ''                                             | 'Expense'     | '25.08.2022 16:46:40' | '1 000'     | ''           | 'Main Company' | 'Shop 02' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Pos cash account 1' | 'Cash desk №2'       | 'Money transfer 13 dated 25.08.2022 16:46:25' | 'No'                   |
	And I close all client application windows
