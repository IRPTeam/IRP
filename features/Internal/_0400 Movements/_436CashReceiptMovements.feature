...
Scenario: _043654 check Cash receipt movements by the Register  "R3011 Cash flow" (Salary return, branch in header)
	...
	* Check movements by the Register  "R3011 Cash flow" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | '02.09.2024 17:37:07' | 'Main Company' | 'Front office' | 'Cash desk №4' | 'Incoming'  | 'Movement type 2'         | 'Distribution department' | ''                | 'TRY'      | 'Local currency'               | '100'    | 'No'                   |
			| ''                                           | '02.09.2024 17:37:07' | 'Main Company' | 'Front office' | 'Cash desk №4' | 'Incoming'  | 'Movement type 2'         | 'Distribution department' | ''                | 'TRY'      | 'en description is empty'      | '100'    | 'No'                   |
			| ''                                           | '02.09.2024 17:37:07' | 'Main Company' | 'Front office' | 'Cash desk №4' | 'Incoming'  | 'Movement type 2'         | 'Distribution department' | ''                | 'USD'      | 'Reporting currency'           | '17,12'  | 'No'                   |		
	And I close all client application windows
