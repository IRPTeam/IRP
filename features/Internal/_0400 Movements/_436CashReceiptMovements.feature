...
Scenario: _043612 check Cash receipt movements by the Register "R2020 Advances from customer" (without basis document)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '171,2'     | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Cash receipt 4 dated 27.04.2021 11:31:10' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '1 000'     | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Cash receipt 4 dated 27.04.2021 11:31:10' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '1 000'     | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''          | 'Cash receipt 4 dated 27.04.2021 11:31:10' | 'No'                   | ''                           |
	And I close all client application windows
...
Scenario: _043625 check Cash receipt movements by the Register "R2020 Advances from customer" (with partner term by document, without basis)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''             | ''                             | ''         | ''                     | ''                  | ''          | ''      | ''                         | ''                                           | 'Attributes'           | ''                           |
			| ''                                           | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'       | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Legal name'        | 'Partner'   | 'Order' | 'Agreement'                | 'Basis'                                      | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                           | 'Receipt'     | '08.02.2022 13:39:52' | '8,56'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY' | 'Cash receipt 518 dated 08.02.2022 13:39:52' | 'No'                   | ''                           |
			| ''                                           | 'Receipt'     | '08.02.2022 13:39:52' | '50'        | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY' | 'Cash receipt 518 dated 08.02.2022 13:39:52' | 'No'                   | ''                           |
			| ''                                           | 'Receipt'     | '08.02.2022 13:39:52' | '50'        | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY' | 'Cash receipt 518 dated 08.02.2022 13:39:52' | 'No'                   | ''                           |
	And I close all client application windows
