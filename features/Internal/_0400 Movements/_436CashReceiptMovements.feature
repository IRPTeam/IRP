...
Scenario: _043624 check Cash receipt movements by the Register "R1021 Vendors transactions" (Return from vendor, with basis)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Receipt'     | '08.02.2022 13:18:32' | '8,56'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Maxim' | 'Maxim'   | 'Partner term Maxim' | 'Purchase return 21 dated 28.04.2021 21:50:02' | ''      | ''        | 'No'                   | ''                         |
			| ''                                           | 'Receipt'     | '08.02.2022 13:18:32' | '50'        | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Maxim' | 'Maxim'   | 'Partner term Maxim' | 'Purchase return 21 dated 28.04.2021 21:50:02' | ''      | ''        | 'No'                   | ''                         |
			| ''                                           | 'Receipt'     | '08.02.2022 13:18:32' | '50'        | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Maxim' | 'Maxim'   | 'Partner term Maxim' | 'Purchase return 21 dated 28.04.2021 21:50:02' | ''      | ''        | 'No'                   | ''                         |
	And I close all client application windows
...
Scenario: _043645 check Cash receipt movements by the Register  "T2015 Transactions info" (Payment from customer, advance=false)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Main Company' | 'Front office' | ''      | '05.04.2021 14:33:49' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'No'                    | 'Yes'                     | 'Sales invoice 1 dated 28.01.2021 18:48:53' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '100'    | 'No'     | 'Yes'     |
	And I close all client application windows
...
Scenario: _043646 check Cash receipt movements by the Register  "T2014 Advances info" (Payment from customer, advance=true)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Main Company' | 'Distribution department' | '27.04.2021 11:31:10' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'No'                | 'Yes'                 | '*'         | 'Basic Partner terms, TRY' | ''        | 'en description is empty' | 'TRY'                  | '1 000'  | 'No'                      | 'No'                   | 'Receipt'     |
	And I close all client application windows
...
Scenario: _043649 check Cash receipt movements by the Register  "T2015 Transactions info" (Return from vendor, with basis)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2015 Transactions info"'        | ''             | ''             | ''      | ''                    | ''    | ''         | ''        | ''              | ''                   | ''                      | ''                        | ''                                             | ''          | ''        | ''                        | ''                     | ''       | ''       | ''        |
			| ''                                           | 'Company'      | 'Branch'       | 'Order' | 'Date'                | 'Key' | 'Currency' | 'Partner' | 'Legal name'    | 'Agreement'          | 'Is vendor transaction' | 'Is customer transaction' | 'Transaction basis'                            | 'Unique ID' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is due' | 'Is paid' |
			| ''                                           | 'Main Company' | 'Front office' | ''      | '08.02.2022 13:18:32' | '*'   | 'TRY'      | 'Maxim'   | 'Company Maxim' | 'Partner term Maxim' | 'Yes'                   | 'No'                      | 'Purchase return 21 dated 28.04.2021 21:50:02' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '-50'    | 'No'     | 'Yes'     |
	And I close all client application windows
...
Scenario: _043651 check Cash receipt movements by the Register  "T2014 Advances info" (Return from vendor, without basis)
	...
	* Check movements by the Register  "T2014 Advances info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2014 Advances info"'            | ''             | ''             | ''                    | ''    | ''         | ''          | ''                  | ''      | ''                  | ''                    | ''          | ''                   | ''        | ''                        | ''                     | ''       | ''                        | ''                     | ''            |
			| ''                                           | 'Company'      | 'Branch'       | 'Date'                | 'Key' | 'Currency' | 'Partner'   | 'Legal name'        | 'Order' | 'Is vendor advance' | 'Is customer advance' | 'Unique ID' | 'Advance agreement'  | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is purchase order close' | 'Is sales order close' | 'Record type' |
			| ''                                           | 'Main Company' | 'Front office' | '02.09.2021 14:17:00' | '*'   | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | ''      | 'Yes'               | 'No'                  | '*'         | 'Vendor Ferron, TRY' | ''        | 'en description is empty' | 'TRY'                  | '-100'   | 'No'                      | 'No'                   | 'Receipt'     |
	And I close all client application windows
