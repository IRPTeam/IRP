...
Scenario: _043601 check Cash receipt movements by the Register "R3010 Cash on hand"
	...
	* Check movements by the Register  "R3010 Cash on hand" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '05.04.2021 14:34:09' | '500'       | 'Main Company' | 'Front office' | 'Cash desk №2' | 'USD'      | 'Reporting currency'           | 'No'                   |
			| ''                                         | 'Receipt'     | '05.04.2021 14:34:09' | '500'       | 'Main Company' | 'Front office' | 'Cash desk №2' | 'USD'      | 'en description is empty'      | 'No'                   |
			| ''                                         | 'Receipt'     | '05.04.2021 14:34:09' | '2 813,75'  | 'Main Company' | 'Front office' | 'Cash desk №2' | 'TRY'      | 'Local currency'               | 'No'                   |
	And I close all client application windows
...
Scenario: _043610 check Cash receipt movements by the Register "R2021 Customer transactions" (basis document exist)
	...
	* Check movements by the Register  "R2021 Customer transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Expense'     | '05.04.2021 14:33:49' | '17,12'     | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | ''                           | 'No'                   | ''                           |
			| ''                                         | 'Expense'     | '05.04.2021 14:33:49' | '100'       | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | ''                           | 'No'                   | ''                           |
			| ''                                         | 'Expense'     | '05.04.2021 14:33:49' | '100'       | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | ''                           | 'No'                   | ''                           |
			| ''                                         | 'Expense'     | '05.04.2021 14:33:49' | '100'       | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | ''                           | 'No'                   | ''                           |
	And I close all client application windows
...
Scenario: _043612 check Cash receipt movements by the Register "R2020 Advances from customer" (without basis document)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '171,2'     | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | ''                                         | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '1 000'     | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | ''                                         | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '1 000'     | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | ''                                         | 'No'                   | ''                           |
	And I close all client application windows
...
Scenario: _043626 check Cash receipt movements by the Register "R3010 Cash on hand" (cash in)
	...
	* Check movements by the Register  "R3010 Cash on hand" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''        | ''                   | ''         | ''                             | 'Attributes'           |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'  | 'Account'            | 'Currency' | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                          | 'Receipt'     | '25.08.2022 16:46:16' | '171,2'     | 'Main Company' | 'Shop 02' | 'Pos cash account 1' | 'USD'      | 'Reporting currency'           | 'No'                   |
			| ''                                          | 'Receipt'     | '25.08.2022 16:46:16' | '1 000'     | 'Main Company' | 'Shop 02' | 'Pos cash account 1' | 'TRY'      | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '25.08.2022 16:46:16' | '1 000'     | 'Main Company' | 'Shop 02' | 'Pos cash account 1' | 'TRY'      | 'en description is empty'      | 'No'                   |
	And I close all client application windows
...
Scenario: _043628 check Cash receipt movements by the Register "R3010 Cash on hand" (cash out)
	...
	* Check movements by the Register  "R3010 Cash on hand" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''        | ''             | ''         | ''                             | 'Attributes'           |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'  | 'Account'      | 'Currency' | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                          | 'Receipt'     | '25.08.2022 16:46:40' | '171,2'     | 'Main Company' | 'Shop 02' | 'Cash desk №2' | 'USD'      | 'Reporting currency'           | 'No'                   |
			| ''                                          | 'Receipt'     | '25.08.2022 16:46:40' | '1 000'     | 'Main Company' | 'Shop 02' | 'Cash desk №2' | 'TRY'      | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '25.08.2022 16:46:40' | '1 000'     | 'Main Company' | 'Shop 02' | 'Cash desk №2' | 'TRY'      | 'en description is empty'      | 'No'                   |	
	And I close all client application windows
