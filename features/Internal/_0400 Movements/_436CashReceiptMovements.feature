...
Scenario: _043602 check Cash receipt movements by the Register "R5010 Reconciliation statement" (payment to vendor)
	...
	* Check movements by the Register  "R5010 Reconciliation statement" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                           | 'Expense'     | '05.04.2021 14:33:49' | '100'       | 'Main Company' | 'Front office' | 'TRY'      | 'Company Ferron BP' |
	And I close all client application windows
...
Scenario: _043612 check Cash receipt movements by the Register "R2020 Advances from customer" (without basis document)
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '171,2'     | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Cash receipt 4 dated 27.04.2021 11:31:10' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '1 000'     | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Cash receipt 4 dated 27.04.2021 11:31:10' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '27.04.2021 11:31:10' | '1 000'     | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Cash receipt 4 dated 27.04.2021 11:31:10' | 'No'                   | ''                           |
	And I close all client application windows
