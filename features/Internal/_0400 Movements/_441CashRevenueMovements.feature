...
Scenario: _044107 check Cash revenue movements by the Register "R3027 Employee cash advance" (Other company revenue)
	...
	* Check movements by the Register  "R3027 Employee cash advance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Receipt'     | '04.03.2023 11:03:03' | '85,6'      | 'Second Company' | ''       | 'Anna Petrova' | ''          | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                          | 'Receipt'     | '04.03.2023 11:03:03' | '171,2'     | 'Second Company' | ''       | 'Arina Brown'  | ''          | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                          | 'Receipt'     | '04.03.2023 11:03:03' | '500'       | 'Second Company' | ''       | 'Anna Petrova' | ''          | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '04.03.2023 11:03:03' | '500'       | 'Second Company' | ''       | 'Anna Petrova' | ''          | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |
			| ''                                          | 'Receipt'     | '04.03.2023 11:03:03' | '1 000'     | 'Second Company' | ''       | 'Arina Brown'  | ''          | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                          | 'Receipt'     | '04.03.2023 11:03:03' | '1 000'     | 'Second Company' | ''       | 'Arina Brown'  | ''          | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |
			| ''                                          | 'Expense'     | '04.03.2023 11:03:03' | '85,6'      | 'Main Company'   | ''       | 'Anna Petrova' | ''          | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                          | 'Expense'     | '04.03.2023 11:03:03' | '171,2'     | 'Main Company'   | ''       | 'Arina Brown'  | ''          | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                          | 'Expense'     | '04.03.2023 11:03:03' | '500'       | 'Main Company'   | ''       | 'Anna Petrova' | ''          | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                          | 'Expense'     | '04.03.2023 11:03:03' | '500'       | 'Main Company'   | ''       | 'Anna Petrova' | ''          | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |
			| ''                                          | 'Expense'     | '04.03.2023 11:03:03' | '1 000'     | 'Main Company'   | ''       | 'Arina Brown'  | ''          | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                          | 'Expense'     | '04.03.2023 11:03:03' | '1 000'     | 'Main Company'   | ''       | 'Arina Brown'  | ''          | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |		
	And I close all client application windows
