...
Scenario: _044101 check Cash revenue movements by the Register "R3010 Cash on hand"
	...
	* Check movements by the Register  "R3010 Cash on hand" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '07.09.2020 19:24:49' | '100'       | 'Main Company' | 'Shop 01' | 'Bank account, TRY' | 'TRY'      | 'Local currency'               | 'No'                   |
			| ''                                         | 'Receipt'     | '07.09.2020 19:24:49' | '100'       | 'Main Company' | 'Shop 01' | 'Bank account, TRY' | 'TRY'      | 'en description is empty'      | 'No'                   |
			| ''                                         | 'Receipt'     | '07.09.2020 19:24:49' | '584'       | 'Main Company' | 'Shop 01' | 'Bank account, TRY' | 'USD'      | 'Reporting currency'           | 'No'                   |
	And I close all client application windows
...
Scenario: _044102 check Cash revenue movements by the Register "R5021 Revenues"
	...
	* Check movements by the Register  "R5021 Revenues" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | '07.09.2020 19:24:49' | '100'       | 'Main Company' | 'Shop 01' | 'Front office'       | 'Fuel'         | ''         | 'TRY'      | ''                    | 'Local currency'               |
			| ''                                         | '07.09.2020 19:24:49' | '100'       | 'Main Company' | 'Shop 01' | 'Front office'       | 'Fuel'         | ''         | 'TRY'      | ''                    | 'en description is empty'      |
			| ''                                         | '07.09.2020 19:24:49' | '584'       | 'Main Company' | 'Shop 01' | 'Front office'       | 'Fuel'         | ''         | 'USD'      | ''                    | 'Reporting currency'           |
	And I close all client application windows
