...
Scenario: _045203 check Cash transfer order movements by the Register "R3035 Cash planning"
	...
	* Check movements by the Register  "R3035 Cash planning" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | '05.04.2021 12:09:54'   | '500'         | 'Main Company'   | 'Accountants office'   | 'Cash transfer order 2 dated 05.04.2021 12:09:54'   | 'Bank account 2, EUR'   | 'EUR'        | 'Incoming'              | ''          | ''             | 'en description is empty'        | 'Movement type 1'           | 'Second'            | 'No'                      |
			...
			| ''                                                  | '05.04.2021 12:09:54'   | '550'         | 'Main Company'   | 'Accountants office'   | 'Cash transfer order 2 dated 05.04.2021 12:09:54'   | 'Bank account 2, EUR'   | 'USD'        | 'Incoming'              | ''          | ''             | 'Reporting currency'             | 'Movement type 1'           | 'Second'            | 'No'                      |
			...
			| ''                                                  | '05.04.2021 12:09:54'   | '4 500'       | 'Main Company'   | 'Accountants office'   | 'Cash transfer order 2 dated 05.04.2021 12:09:54'   | 'Bank account 2, EUR'   | 'TRY'        | 'Incoming'              | ''          | ''             | 'Local currency'                 | 'Movement type 1'           | 'Second'            | 'No'                      |
	And I close all client application windows
