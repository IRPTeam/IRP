...
Scenario: _045203 check Cash transfer order movements by the Register "R3035 Cash planning"
	...
	* Check movements by the Register  "R3035 Cash planning" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                | '05.04.2021 00:00:00' | '500'       | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account, EUR'   | 'EUR'      | 'Outgoing'            | ''        | ''           | 'en description is empty'      | 'Movement type 1' | 'No'                   |
			| ''                                                | '05.04.2021 00:00:00' | '500'       | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account 2, EUR' | 'EUR'      | 'Incoming'            | ''        | ''           | 'en description is empty'      | 'Movement type 1' | 'No'                   |
			| ''                                                | '05.04.2021 00:00:00' | '550'       | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account, EUR'   | 'USD'      | 'Outgoing'            | ''        | ''           | 'Reporting currency'           | 'Movement type 1' | 'No'                   |
			| ''                                                | '05.04.2021 00:00:00' | '550'       | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account 2, EUR' | 'USD'      | 'Incoming'            | ''        | ''           | 'Reporting currency'           | 'Movement type 1' | 'No'                   |
			| ''                                                | '05.04.2021 00:00:00' | '4 500'     | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account, EUR'   | 'TRY'      | 'Outgoing'            | ''        | ''           | 'Local currency'               | 'Movement type 1' | 'No'                   |
			| ''                                                | '05.04.2021 00:00:00' | '4 500'     | 'Main Company' | 'Cash transfer order 2 dated 05.04.2021 12:09:54' | 'Bank account 2, EUR' | 'TRY'      | 'Incoming'            | ''        | ''           | 'Local currency'               | 'Movement type 1' | 'No'                   |
	And I close all client application windows
