...
Scenario: _045307 check Money transfer movements by the Register "R3021 Cash in transit (incoming)" (cash in)
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Receipt'     | '25.08.2022 16:45:16' | '171,2'     | ''           | 'Main Company' | 'Front office' | 'Cash desk №2' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Pos cash account 1' | 'Money transfer 11 dated 25.08.2022 16:45:16' | 'No'                   |
			| ''                                             | 'Receipt'     | '25.08.2022 16:45:16' | '1 000'     | ''           | 'Main Company' | 'Front office' | 'Cash desk №2' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Pos cash account 1' | 'Money transfer 11 dated 25.08.2022 16:45:16' | 'No'                   |
			| ''                                             | 'Receipt'     | '25.08.2022 16:45:16' | '1 000'     | ''           | 'Main Company' | 'Front office' | 'Cash desk №2' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Pos cash account 1' | 'Money transfer 11 dated 25.08.2022 16:45:16' | 'No'                   |
		And I close all client application windows
...
Scenario: _045309 check Money transfer movements by the Register "R3021 Cash in transit (incoming)" (cash out)
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Record type' | 'Period'              | 'Resources' | ''           | 'Dimensions'   | ''        | ''                   | ''                             | ''         | ''                     | ''                   | ''                                            | 'Attributes'           |
			| ''                                             | ''            | ''                    | 'Amount'    | 'Commission' | 'Company'      | 'Branch'  | 'Account'            | 'Multi currency movement type' | 'Currency' | 'Transaction currency' | 'Receipting account' | 'Basis'                                       | 'Deferred calculation' |
			| ''                                             | 'Receipt'     | '25.08.2022 16:46:25' | '171,2'     | ''           | 'Main Company' | 'Shop 02' | 'Pos cash account 1' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Cash desk №2'       | 'Money transfer 13 dated 25.08.2022 16:46:25' | 'No'                   |
			| ''                                             | 'Receipt'     | '25.08.2022 16:46:25' | '1 000'     | ''           | 'Main Company' | 'Shop 02' | 'Pos cash account 1' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Cash desk №2'       | 'Money transfer 13 dated 25.08.2022 16:46:25' | 'No'                   |
			| ''                                             | 'Receipt'     | '25.08.2022 16:46:25' | '1 000'     | ''           | 'Main Company' | 'Shop 02' | 'Pos cash account 1' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Cash desk №2'       | 'Money transfer 13 dated 25.08.2022 16:46:25' | 'No'                   |
		And I close all client application windows
