...
Scenario: _045403 check CashStatement movements by the Register  "R3021 Cash in transit (incoming)"
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                             | 'Receipt'     | '23.06.2022 22:53:32' | '34,24'     | '3,42'       | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Bank account, TRY'  | 'Cash statement 11 dated 23.06.2022 22:53:32' | 'No'                   |
			| ''                                             | 'Receipt'     | '23.06.2022 22:53:32' | '200'       | '20'         | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Bank account, TRY'  | 'Cash statement 11 dated 23.06.2022 22:53:32' | 'No'                   |
			| ''                                             | 'Receipt'     | '23.06.2022 22:53:32' | '200'       | '20'         | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'POS account, Comission separate, TRY' | 'Bank account, TRY'  | 'Cash statement 11 dated 23.06.2022 22:53:32' | 'No'                   |
		And I close all client application windows
