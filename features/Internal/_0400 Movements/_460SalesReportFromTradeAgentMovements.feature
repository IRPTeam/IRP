...
Scenario: _046007 check Sales report from trade agent movements by the Register  "T6020 Batch keys info"
	...
	* Check movements by the Register  "T6020 Batch keys info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | '03.11.2022 10:53:35' | '1'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                             | ''                             | ''                             | 'Main Company' | 'Distribution department' | 'Trade agent store' | 'PZU'      | 'Expense'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''            |
			| ''                                                          | '03.11.2022 10:53:35' | '2'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                             | ''                             | ''                             | 'Main Company' | 'Distribution department' | 'Trade agent store' | 'XS/Blue'  | 'Expense'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''            |
			| ''                                                          | '03.11.2022 10:53:35' | '2'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                             | ''                             | ''                             | 'Main Company' | 'Distribution department' | 'Trade agent store' | 'UNIQ'     | 'Expense'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''            |
		And I close all client application windows
