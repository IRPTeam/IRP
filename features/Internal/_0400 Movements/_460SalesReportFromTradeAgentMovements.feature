...
Scenario: _046002 check Sales report from trade agent movements by the Register  "R2001 Sales"
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                            | '03.11.2022 10:53:35'   | '1'           | '34,24'    | '29,02'        | ''                | 'Main Company'   | 'Distribution department'   | 'Reporting currency'             | 'USD'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'PZU'        | 'c8bc1fbd-3764-4658-b8ed-d200b9e40e0e'   | ''                |
			| ''                                                            | '03.11.2022 10:53:35'   | '1'           | '200'      | '169,49'       | ''                | 'Main Company'   | 'Distribution department'   | 'Local currency'                 | 'TRY'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'PZU'        | 'c8bc1fbd-3764-4658-b8ed-d200b9e40e0e'   | ''                |
			| ''                                                            | '03.11.2022 10:53:35'   | '1'           | '200'      | '169,49'       | ''                | 'Main Company'   | 'Distribution department'   | 'TRY'                            | 'TRY'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'PZU'        | 'c8bc1fbd-3764-4658-b8ed-d200b9e40e0e'   | ''                |
			| ''                                                            | '03.11.2022 10:53:35'   | '1'           | '200'      | '169,49'       | ''                | 'Main Company'   | 'Distribution department'   | 'en description is empty'        | 'TRY'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'PZU'        | 'c8bc1fbd-3764-4658-b8ed-d200b9e40e0e'   | ''                |
			| ''                                                            | '03.11.2022 10:53:35'   | '2'           | '71,9'     | '60,94'        | ''                | 'Main Company'   | 'Distribution department'   | 'Reporting currency'             | 'USD'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'UNIQ'       | '893e35ad-5a64-4039-bd9e-9b987e6f8fca'   | ''                |
			...
			| ''                                                            | '03.11.2022 10:53:35'   | '2'           | '420'      | '355,93'       | ''                | 'Main Company'   | 'Distribution department'   | 'Local currency'                 | 'TRY'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'UNIQ'       | '893e35ad-5a64-4039-bd9e-9b987e6f8fca'   | ''                |
			| ''                                                            | '03.11.2022 10:53:35'   | '2'           | '420'      | '355,93'       | ''                | 'Main Company'   | 'Distribution department'   | 'TRY'                            | 'TRY'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'UNIQ'       | '893e35ad-5a64-4039-bd9e-9b987e6f8fca'   | ''                |
			| ''                                                            | '03.11.2022 10:53:35'   | '2'           | '420'      | '355,93'       | ''                | 'Main Company'   | 'Distribution department'   | 'en description is empty'        | 'TRY'        | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35'   | 'UNIQ'       | '893e35ad-5a64-4039-bd9e-9b987e6f8fca'   | ''                |
...
Scenario: _046006 check Sales report from trade agent movements by the Register  "R5021 Revenues"
	...
	* Check movements by the Register  "R5021 Revenues"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                            | '03.11.2022 10:53:35'   | '169,49'      | '200'                 | 'Main Company'   | 'Distribution department'   | ''                     | ''               | 'PZU'        | 'TRY'        | ''                      | 'TRY'                             |
			...
			| ''                                                            | '03.11.2022 10:53:35'   | '355,93'      | '420'                 | 'Main Company'   | 'Distribution department'   | ''                     | ''               | 'UNIQ'       | 'TRY'        | ''                      | 'TRY'                             |
			...
			| ''                                                            | '03.11.2022 10:53:35'   | '881,36'      | '1 040'               | 'Main Company'   | 'Distribution department'   | ''                     | ''               | 'XS/Blue'    | 'TRY'        | ''                      | 'TRY'                             |
...
Scenario: _046008 check Sales report from trade agent movements by the Register  "R4010 Actual stocks"
	...
	* Check movements by the Register  "R4010 Actual stocks"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | 'Expense'     | '03.11.2022 10:53:35' | '1'         | 'Trade agent store' | 'PZU'      | '8908899879'        |
			| ''                                                          | 'Expense'     | '03.11.2022 10:53:35' | '2'         | 'Trade agent store' | 'XS/Blue'  | ''                  |
			| ''                                                          | 'Expense'     | '03.11.2022 10:53:35' | '2'         | 'Trade agent store' | 'UNIQ'     | ''                  |		
		And I close all client application windows
...
Scenario: _046009 check Sales report from trade agent movements by the Register  "T2015 Transactions info"
	...
	* Check movements by the Register  "T2015 Transactions info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | '1 660'     | 'Yes'    | 'No'      | 'Main Company' | 'Distribution department' | ''      | '03.11.2022 10:53:35' | '                                    ' | 'TRY'      | 'Trade agent 1' | 'Trade agent 1' | 'Trade agent partner term 1' | 'No'                    | 'Yes'                     | ''                  | '2bce293b-35ee-48de-936f-16aaad853858' |		
		And I close all client application windows