...
Scenario: _046002 check Sales report from trade agent movements by the Register  "R2001 Sales"
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | '03.11.2022 10:53:35' | '1'         | '200'    | '169,49'     | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35' | 'PZU'      | '8908899879'        | 'c8bc1fbd-3764-4658-b8ed-d200b9e40e0e' | ''             |
			...
			| ''                                                          | '03.11.2022 10:53:35' | '2'         | '420'    | '355,93'     | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35' | 'UNIQ'     | '899007790088'      | '893e35ad-5a64-4039-bd9e-9b987e6f8fca' | ''             |
			...
			| ''                                                          | '03.11.2022 10:53:35' | '2'         | '1 040'  | '881,36'     | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35' | 'XS/Blue'  | ''                  | '00f17e8c-56fc-4dfa-a313-36d9337c11b6' | ''             |
...
Scenario: _046002 check Sales report from trade agent movements by the Register  "R2021 Customer transactions"
	...
	* Check movements by the Register  "R2021 Customer transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '1 660'     | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Trade agent 1' | 'Trade agent 1' | 'Trade agent partner term 1' | ''      | ''      | ''        | 'No'                   | ''                           |
	...
	* Check movements by the Register  "R2040 Taxes incoming"
	...
	//Outgoing
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '29,02'          | '5,22'       | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '60,94'          | '10,97'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '150,89'         | '27,16'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '169,49'         | '30,51'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '169,49'         | '30,51'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '355,93'         | '64,07'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '355,93'         | '64,07'      | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '881,36'         | '158,64'     | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '881,36'         | '158,64'     | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |	
		And I close all client application windows
...
Scenario: _046010 check Sales report from trade agent movements by the Register  "R2001 Sales"
	...
	* Check movements by the Register  "R2001 Sales"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                              | '15.12.2023 11:10:35' | '1'         | '33,33'  | '28,25'      | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 115 dated 15.12.2023 11:10:35' | 'UNIQ'     | '0514'              | 'c8caa0fe-40e6-4157-ad4c-b6306d4f4163' | ''             |
			...
			| ''                                                              | '15.12.2023 11:10:35' | '1'         | '49,99'  | '42,37'      | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 115 dated 15.12.2023 11:10:35' | 'PZU'      | '8908899879'        | '3fa6fcc7-129a-471e-93b6-52e895ce461f' | ''             |
			...
			| ''                                                              | '15.12.2023 11:10:35' | '1'         | '50'     | '42,37'      | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 115 dated 15.12.2023 11:10:35' | 'PZU'      | '8908899880'        | '3fa6fcc7-129a-471e-93b6-52e895ce461f' | ''             |
			...
			| ''                                                              | '15.12.2023 11:10:35' | '2'         | '66,67'  | '56,5'       | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 115 dated 15.12.2023 11:10:35' | 'UNIQ'     | '899007790088'      | 'c8caa0fe-40e6-4157-ad4c-b6306d4f4163' | ''             |
			...
			| ''                                                              | '15.12.2023 11:10:35' | '2'         | '1 040'  | '881,36'     | ''              | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Sales report from trade agent 1 115 dated 15.12.2023 11:10:35' | 'XS/Blue'  | ''                  | '13086eac-e1c7-4213-845b-73ffa79b17f8' | ''             |
