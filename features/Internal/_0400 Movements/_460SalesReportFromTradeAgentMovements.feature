	...
	* Check movements by the Register  "R2040 Taxes incoming"
	...
	//Outgoing
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '43,35'     | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Invoice'      | 'Reporting currency'           | 'USD'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '253,22'    | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Invoice'      | 'Local currency'               | 'TRY'      | 'TRY'                  |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '253,22'    | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Invoice'      | 'en description is empty'      | 'TRY'      | 'TRY'                  |		
		And I close all client application windows
...
Scenario: _046007 check Sales report from trade agent movements by the Register  "T6020 Batch keys info"
	...
	* Check movements by the Register  "T6020 Batch keys info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | '03.11.2022 10:53:35' | '1'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | 'Distribution department' | 'Trade agent store' | 'PZU'      | 'Expense'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''            | 'No'             | ''               |
			| ''                                                          | '03.11.2022 10:53:35' | '2'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | 'Distribution department' | 'Trade agent store' | 'XS/Blue'  | 'Expense'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''            | 'No'             | ''               |
			| ''                                                          | '03.11.2022 10:53:35' | '2'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | 'Distribution department' | 'Trade agent store' | 'UNIQ'     | 'Expense'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''            | 'No'             | ''               |
...
Scenario: _046009 check Sales report from trade agent movements by the Register  "T2015 Transactions info"
	...
	* Check movements by the Register  "T2015 Transactions info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | '1 660'     | 'Yes'    | 'No'      | 'Main Company' | 'Distribution department' | ''      | '03.11.2022 10:53:35' | '                                    ' | 'TRY'      | 'Trade agent 1' | 'Trade agent 1' | 'Trade agent partner term 1' | 'No'                    | 'Yes'                     | ''                  | '*'         | ''        | 'en description is empty' | 'TRY'                  |
		And I close all client application windows
...
Scenario: _046011 check Sales report from trade agent movements by the Register "Posted documents registry"
	...
	* Check movements by the Register "Posted documents registry"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | 'Sales report from trade agent 1 dated 03.11.2022 10:53:35' | '03.11.2022 10:53:35' | '1'      | '*'           | '*'           | 'en description is empty' | 'en description is empty' | 'No'                    |
	And I close all client application windows		
