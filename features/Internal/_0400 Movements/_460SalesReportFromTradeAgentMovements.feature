...
Scenario: _046002 check Sales report from trade agent movements by the Register  "R2021 Customer transactions"
	...
	* Check movements by the Register  "R2021 Customer transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '249,95'    | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Trade agent 1' | 'Trade agent 1' | 'Trade agent partner term 1' | ''      | ''      | 'No'                   | ''                           |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '1 460'     | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Trade agent 1' | 'Trade agent 1' | 'Trade agent partner term 1' | ''      | ''      | 'No'                   | ''                           |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '1 460'     | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Trade agent 1' | 'Trade agent 1' | 'Trade agent partner term 1' | ''      | ''      | 'No'                   | ''                           |
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '1 460'     | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Trade agent 1' | 'Trade agent 1' | 'Trade agent partner term 1' | ''      | ''      | 'No'                   | ''                           |		
		And I close all client application windows
...
Scenario: _046005 check Sales report from trade agent movements by the Register  "R5010 Reconciliation statement"
	...
	* Check movements by the Register  "R5010 Reconciliation statement"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                          | 'Receipt'     | '03.11.2022 10:53:35' | '1 460'     | 'Main Company' | 'Distribution department' | 'TRY'      | 'Trade agent 1' | ''                    |		
		And I close all client application windows
