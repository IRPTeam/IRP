...
Scenario: _047004 check Sales report to consignor movements by the Register  "T2015 Transactions info"
	...
	* Check movements by the Register  "T2015 Transactions info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                       | '2 900'     | 'Yes'    | 'No'      | 'Main Company' | 'Distribution department' | ''      | '31.12.2022 10:00:00' | '                                    ' | 'TRY'      | 'Consignor 2' | 'Consignor 2' | 'Consignor 2 partner term' | 'Yes'                   | 'No'                      | ''                  | '*'         | ''        | 'en description is empty' | 'TRY'                  |
		And I close all client application windows
	...
	* Check movements by the Register  "R1040 Taxes outgoing"
	//Incoming
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                       | '31.12.2022 10:00:00' | 'Receipt'    | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Invoice'      | 'Local currency'               | 'TRY'      | 'TRY'                  | '-442,37' |
			| ''                                                       | '31.12.2022 10:00:00' | 'Receipt'    | 'Main Company' | 'Distribution department' | 'VAT' | '18%'      | 'Invoice'      | 'Reporting currency'           | 'USD'      | 'TRY'                  | '-75,73'  |
