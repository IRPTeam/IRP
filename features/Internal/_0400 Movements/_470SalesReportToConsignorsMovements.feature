...
Scenario: _047002 check Sales report to consignor movements by the Register  "R1021 Vendors transactions"
	...
	* Check movements by the Register  "R1021 Vendors transactions"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                       | 'Receipt'     | '12.12.2022 09:53:54' | '2 044,13'  | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Consignor 1' | 'Consignor 1' | 'Consignor partner term 1' | ''      | ''      | 'No'                   | ''                         |
			| ''                                                       | 'Receipt'     | '12.12.2022 09:53:54' | '11 940'    | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Consignor 1' | 'Consignor 1' | 'Consignor partner term 1' | ''      | ''      | 'No'                   | ''                         |
			| ''                                                       | 'Receipt'     | '12.12.2022 09:53:54' | '11 940'    | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Consignor 1' | 'Consignor 1' | 'Consignor partner term 1' | ''      | ''      | 'No'                   | ''                         |
			| ''                                                       | 'Receipt'     | '12.12.2022 09:53:54' | '11 940'    | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Consignor 1' | 'Consignor 1' | 'Consignor partner term 1' | ''      | ''      | 'No'                   | ''                         |			
		And I close all client application windows
...
Scenario: _047004 check Sales report to consignor movements by the Register  "T2015 Transactions info"
	...
	* Check movements by the Register  "T2015 Transactions info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                       | '11 940'    | 'Yes'    | 'No'      | '12.12.2022 09:53:54' | '                                    ' | 'Main Company' | 'Distribution department' | 'TRY'      | 'Consignor 1' | 'Consignor 1' | 'Consignor partner term 1' | ''      | 'Yes'                   | 'No'                      | ''                  | 'b3b2fdcd-b091-4689-8aba-16cd48873931' |		
		And I close all client application windows