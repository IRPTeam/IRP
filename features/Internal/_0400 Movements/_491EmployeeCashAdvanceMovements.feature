...
Scenario: _040910 preparation (Employee cash advance movements)
	...
	* Data for employee cash adance
		...
		And I execute 1C:Enterprise script at server
			| "Documents.EmployeeCashAdvance.FindByNumber(2).GetObject().Write(DocumentWriteMode.Posting);"    |
		And I execute 1C:Enterprise script at server
...
Scenario: _040912 check EmployeeCashAdvance movements by the Register  "R3027 Employee cash advance" (paymentcurrency not equal currency ECA)
		And I close all client application windows
	...
	* Check movements by the Register  "R3027 Employee cash advance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '13,7'      | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'USD'      | 'USD'                  | 'Reporting currency'           | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '13,7'      | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'USD'      | 'USD'                  | 'en description is empty'      | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '17,12'     | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '17,12'     | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'USD'      | 'USD'                  | 'Reporting currency'           | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '17,12'     | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'USD'      | 'USD'                  | 'en description is empty'      | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '80'        | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'TRY'      | 'USD'                  | 'Local currency'               | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'Alexander Orlov' | 'Alexander Orlov cash advance, USD' | 'TRY'      | 'USD'                  | 'Local currency'               | 'No'                   |		
		And I close all client application windows
...
Scenario: _040913 check EmployeeCashAdvance movements by the Register  "R1021 Vendors transactions" (with PI)
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '17,12'     | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'DFC'        | 'DFC'     | 'Partner term vendor DFC' | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | ''      | ''        | 'No'                   | ''                         |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'DFC'        | 'DFC'     | 'Partner term vendor DFC' | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | ''      | ''        | 'No'                   | ''                         |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'DFC'        | 'DFC'     | 'Partner term vendor DFC' | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | ''      | ''        | 'No'                   | ''                         |	
		And I close all client application windows
...
Scenario: _040914 check EmployeeCashAdvance movements by the Register  "R5010 Reconciliation statement" (with PI)
	...
	* Check movements by the Register  "R5010 Reconciliation statements" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | 'Receipt'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'TRY'      | 'DFC'        | ''                    |	
		And I close all client application windows
...
Scenario: _040915 check EmployeeCashAdvance movements by the Register  "R5020 Partners balance" (with PI)
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | 'Receipt'     | '02.05.2024 10:12:05' | '17,12'     | ''                     | ''                 | '17,12'              | ''               | ''                  | 'Main Company' | 'Distribution department' | 'DFC'     | 'DFC'        | 'Partner term vendor DFC' | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | 'USD'      | 'Reporting currency'           | 'TRY'                  | ''                 |
			| ''                                                  | 'Receipt'     | '02.05.2024 10:12:05' | '100'       | ''                     | ''                 | '100'                | ''               | ''                  | 'Main Company' | 'Distribution department' | 'DFC'     | 'DFC'        | 'Partner term vendor DFC' | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | 'TRY'      | 'Local currency'               | 'TRY'                  | ''                 |
			| ''                                                  | 'Receipt'     | '02.05.2024 10:12:05' | '100'       | ''                     | ''                 | '100'                | ''               | ''                  | 'Main Company' | 'Distribution department' | 'DFC'     | 'DFC'        | 'Partner term vendor DFC' | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | 'TRY'      | 'en description is empty'      | 'TRY'                  | ''                 |	
		And I close all client application windows
...
Scenario: _040915 check EmployeeCashAdvance movements by the Register  "T2015 Transactions info" (with PI)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | '100'       | 'No'     | 'Yes'     | 'Main Company' | 'Distribution department' | ''      | '02.05.2024 10:12:05' | '*'   | 'TRY'      | 'DFC'     | 'DFC'        | 'Partner term vendor DFC' | 'Yes'                   | 'No'                      | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | '*'         | ''        | 'en description is empty' | 'TRY'                  |
		And I close all client application windows
...
Scenario: _040916 check EmployeeCashAdvance movements by the Register  "R5012 Vendors aging" (with PI)
	...
	* Check movements by the Register  "R5012 Vendors aging" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '17,12'     | 'Main Company' | 'Distribution department' | 'USD'      | 'Partner term vendor DFC' | 'DFC'     | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | '02.05.2024 00:00:00' | 'Reporting currency'           | 'TRY'                  | 'Vendors advances closing 213 dated 02.05.2024 15:34:27' |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'TRY'      | 'Partner term vendor DFC' | 'DFC'     | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | '02.05.2024 00:00:00' | 'Local currency'               | 'TRY'                  | 'Vendors advances closing 213 dated 02.05.2024 15:34:27' |
			| ''                                                  | 'Expense'     | '02.05.2024 10:12:05' | '100'       | 'Main Company' | 'Distribution department' | 'TRY'      | 'Partner term vendor DFC' | 'DFC'     | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | '02.05.2024 00:00:00' | 'en description is empty'      | 'TRY'                  | 'Vendors advances closing 213 dated 02.05.2024 15:34:27' |		
		And I close all client application windows

Scenario: _040917 check EmployeeCashAdvance movements by the Register  "R3027 Employee cash advance" (paymentcurrency=currency ECA)
		And I close all client application windows
	* Select EmployeeCashAdvance
		Given I open hyperlink "e1cib/list/Document.EmployeeCashAdvance"
		And I go to line in "List" table
	...
	* Check movements by the Register  "R3027 Employee cash advance" 
		...
		And I click "Generate report" button
		Then "ResultTable" spreadsheet document is equal
			| 'Employee cash advance 2 dated 26.08.2024 13:54:54' | ''            | ''                    | ''          | ''             | ''                        | ''            | ''                              | ''         | ''                     | ''                             | ''                     |
			| 'Document registrations records'                    | ''            | ''                    | ''          | ''             | ''                        | ''            | ''                              | ''         | ''                     | ''                             | ''                     |
			| 'Register  "R3027 Employee cash advance"'           | ''            | ''                    | ''          | ''             | ''                        | ''            | ''                              | ''         | ''                     | ''                             | ''                     |
			| ''                                                  | 'Record type' | 'Period'              | 'Resources' | 'Dimensions'   | ''                        | ''            | ''                              | ''         | ''                     | ''                             | 'Attributes'           |
			| ''                                                  | ''            | ''                    | 'Amount'    | 'Company'      | 'Branch'                  | 'Partner'     | 'Agreement'                     | 'Currency' | 'Transaction currency' | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                                  | 'Expense'     | '26.08.2024 13:54:54' | '3,08'      | 'Main Company' | 'Distribution department' | 'Arina Brown' | 'Arina Brown cash advance, TRY' | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                                  | 'Expense'     | '26.08.2024 13:54:54' | '13,7'      | 'Main Company' | 'Distribution department' | 'Arina Brown' | 'Arina Brown cash advance, TRY' | 'USD'      | 'TRY'                  | 'Reporting currency'           | 'No'                   |
			| ''                                                  | 'Expense'     | '26.08.2024 13:54:54' | '18'        | 'Main Company' | 'Distribution department' | 'Arina Brown' | 'Arina Brown cash advance, TRY' | 'TRY'      | 'TRY'                  | 'Local currency'               | 'No'                   |
			| ''                                                  | 'Expense'     | '26.08.2024 13:54:54' | '18'        | 'Main Company' | 'Distribution department' | 'Arina Brown' | 'Arina Brown cash advance, TRY' | 'TRY'      | 'TRY'                  | 'en description is empty'      | 'No'                   |
