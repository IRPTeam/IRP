...
Scenario: _040916 check EmployeeCashAdvance movements by the Register  "R5012 Vendors aging" (with PI)
	...
	* Check movements by the Register  "R5012 Vendors aging" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | '02.05.2024 10:12:05' | 'Expense'    | 'Main Company' | 'Distribution department' | 'TRY'      | 'Partner term vendor DFC' | 'DFC'     | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | '02.05.2024 00:00:00' | '100'    | 'Vendors advances closing 213 dated 02.05.2024 15:34:27' |	
		And I close all client application windows
