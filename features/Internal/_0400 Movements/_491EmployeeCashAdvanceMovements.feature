...
Scenario: _040915 check EmployeeCashAdvance movements by the Register  "T2015 Transactions info" (with PI)
	...
	* Check movements by the Register  "T2015 Transactions info" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                  | '100'       | 'No'     | 'Yes'     | 'Main Company' | 'Distribution department' | ''      | '02.05.2024 10:12:05' | '*'   | 'TRY'      | 'DFC'     | 'DFC'        | 'Partner term vendor DFC' | 'Yes'                   | 'No'                      | 'Purchase invoice 213 dated 01.05.2024 12:00:00' | '*'         | ''        |
		And I close all client application windows
