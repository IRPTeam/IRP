...
Scenario: _0513005 check Expense accruals movements by the Register "R6070 Other periods expenses" (Void)
	...
	* Check movements by the Register  "R6070 Other periods expenses" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R6070 Other periods expenses"'      | ''                    | ''           | ''             | ''             | ''                                     | ''                                              | ''         | ''         | ''                     | ''                        | ''                          | ''       | ''           |
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                         | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period expense type' | 'Amount' | 'Amount tax' |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '-180'   | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Expense accruals'          | '-180'   | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '-32,62' | ''           |		
	And I close all client application windows
...
Scenario: _0513013 check Revenue accruals movements by the Register "R6080 Other periods revenues" (Void)
	...
	* Check movements by the Register  "R6080 Other periods revenues" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R6080 Other periods revenues"'      | ''                    | ''           | ''             | ''             | ''                                     | ''                                              | ''         | ''         | ''                     | ''                        | ''                          | ''       | ''           |
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                         | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period revenue type' | 'Amount' | 'Amount tax' |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '-180'   | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Revenue accruals'          | '-180'   | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '-34,42' | ''           |		
	And I close all client application windows
