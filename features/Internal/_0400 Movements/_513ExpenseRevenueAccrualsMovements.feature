...
Scenario: _0513003 check Expense accruals movements by the Register "R6070 Other periods expenses" (without basis)
	...
	* Check movements by the Register  "R6070 Other periods expenses" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                         | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period expense type' | 'Amount' | '' |
			| ''                                              | '30.04.2024 12:30:37' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 170 dated 30.04.2024 12:30:37' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '100'    | '' |
			| ''                                              | '30.04.2024 12:30:37' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 170 dated 30.04.2024 12:30:37' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Expense accruals'          | '100'    | '' |
			| ''                                              | '30.04.2024 12:30:37' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 170 dated 30.04.2024 12:30:37' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '19,12'  | '' |
	And I close all client application windows
#
...
Scenario: _0513005 check Expense accruals movements by the Register "R6070 Other periods expenses" (Void)
	...
	* Check movements by the Register  "R6070 Other periods expenses" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '-100'   | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '-100'   | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '-80'    | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '-80'    | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Expense accruals'          | '-100'   | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Expense accruals'          | '-80'    | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '-18,12' | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '-18,12' | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '-14,5'  | ''           |
			| ''                                              | '02.05.2024 18:00:06' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 171 dated 30.04.2024 14:01:53' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '-14,5'  | ''           |
	And I close all client application windows
...
Scenario: _0513007 check Expense accruals movements by the Register "R6070 Other periods expenses" (Reverse)
	...
	* Check movements by the Register  "R6070 Other periods expenses" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R6070 Other periods expenses"'      | ''                    | ''           | ''             | ''             | ''                                     | ''                                              | ''         | ''         | ''                     | ''                        | ''                          | ''       | ''           |
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                         | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period expense type' | 'Amount' | 'Amount tax' |
			| ''                                              | '02.05.2024 18:00:55' | 'Receipt'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 170 dated 30.04.2024 12:30:37' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '100'    | ''           |
			| ''                                              | '02.05.2024 18:00:55' | 'Receipt'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 170 dated 30.04.2024 12:30:37' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Expense accruals'          | '100'    | ''           |
			| ''                                              | '02.05.2024 18:00:55' | 'Receipt'    | 'Main Company' | 'Front office' | '                                    ' | 'Expense accrual 170 dated 30.04.2024 12:30:37' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '19,12'  | ''           |
	And I close all client application windows
...
Scenario: _0513009 check Expense accruals movements by the Register "R6070 Other periods expenses" (with PI)
	...
	* Check movements by the Register  "R6070 Other periods expenses" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R6070 Other periods expenses"'      | ''                    | ''           | ''             | ''             | ''                                     | ''                                               | ''         | ''         | ''                     | ''                        | ''                          | ''       | ''           |
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                          | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period expense type' | 'Amount' | 'Amount tax' |
			| ''                                              | '02.05.2024 18:01:03' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Purchase invoice 171 dated 30.04.2024 12:55:27' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Expense accruals'          | '1 000'  | ''           |
			| ''                                              | '02.05.2024 18:01:03' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Purchase invoice 171 dated 30.04.2024 12:55:27' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Expense accruals'          | '1 000'  | ''           |
			| ''                                              | '02.05.2024 18:01:03' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Purchase invoice 171 dated 30.04.2024 12:55:27' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Expense accruals'          | '251,71' | ''           |
	And I close all client application windows
...
Scenario: _0513011 check Revenue accruals movements by the Register "R6080 Other periods revenues" (without basis)
	...
	* Check movements by the Register  "R6080 Other periods revenues" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                              | '01.05.2024 18:35:11' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 171 dated 01.05.2024 18:35:11' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '100'    | ''           |
			| ''                                              | '01.05.2024 18:35:11' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 171 dated 01.05.2024 18:35:11' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Revenue accruals'          | '100'    | ''           |
			| ''                                              | '01.05.2024 18:35:11' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 171 dated 01.05.2024 18:35:11' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '17,12'  | ''           |
	And I close all client application windows
#
...
Scenario: _0513013 check Revenue accruals movements by the Register "R6080 Other periods revenues" (Void)
	...
	* Check movements by the Register  "R6080 Other periods revenues" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R6080 Other periods revenues"'      | ''                    | ''           | ''             | ''             | ''                                     | ''                                              | ''         | ''         | ''                     | ''                        | ''                          | ''       | ''           |
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                         | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period revenue type' | 'Amount' | 'Amount tax' |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '-100'   | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '-100'   | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '-80'    | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '-80'    | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Revenue accruals'          | '-100'   | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Revenue accruals'          | '-80'    | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '-19,12' | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '-19,12' | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '-15,3'  | ''           |
			| ''                                              | '02.05.2024 18:04:29' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 172 dated 01.05.2024 18:43:16' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '-15,3'  | ''           |
	And I close all client application windows
...
Scenario: _0513015 check Revenue accruals movements by the Register "R6080 Other periods revenues" (Reverse)
	...
	* Check movements by the Register  "R6080 Other periods revenues" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R6080 Other periods revenues"'      | ''                    | ''           | ''             | ''             | ''                                     | ''                                              | ''         | ''         | ''                     | ''                        | ''                          | ''       | ''           |
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                         | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period revenue type' | 'Amount' | 'Amount tax' |
			| ''                                              | '02.05.2024 18:08:21' | 'Receipt'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 171 dated 01.05.2024 18:35:11' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '100'    | ''           |
			| ''                                              | '02.05.2024 18:08:21' | 'Receipt'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 171 dated 01.05.2024 18:35:11' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Revenue accruals'          | '100'    | ''           |
			| ''                                              | '02.05.2024 18:08:21' | 'Receipt'    | 'Main Company' | 'Front office' | '                                    ' | 'Revenue accrual 171 dated 01.05.2024 18:35:11' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '17,12'  | ''           |
	And I close all client application windows
...
Scenario: _0513017 check Revenue accruals movements by the Register "R6080 Other periods revenues" (with SI)
	...
	* Check movements by the Register  "R6080 Other periods revenues" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "R6080 Other periods revenues"'      | ''                    | ''           | ''             | ''             | ''                                     | ''                                            | ''         | ''         | ''                     | ''                        | ''                          | ''       | ''           |
			| ''                                              | 'Period'              | 'RecordType' | 'Company'      | 'Branch'       | 'Row ID'                               | 'Basis'                                       | 'Item key' | 'Currency' | 'Transaction currency' | 'Currency movement type'  | 'Other period revenue type' | 'Amount' | 'Amount tax' |
			| ''                                              | '02.05.2024 18:10:47' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Sales invoice 171 dated 30.04.2024 13:36:19' | ''         | 'TRY'      | 'TRY'                  | 'Local currency'          | 'Revenue accruals'          | '500'    | ''           |
			| ''                                              | '02.05.2024 18:10:47' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Sales invoice 171 dated 30.04.2024 13:36:19' | ''         | 'TRY'      | 'TRY'                  | 'en description is empty' | 'Revenue accruals'          | '500'    | ''           |
			| ''                                              | '02.05.2024 18:10:47' | 'Expense'    | 'Main Company' | 'Front office' | '                                    ' | 'Sales invoice 171 dated 30.04.2024 13:36:19' | ''         | 'USD'      | 'TRY'                  | 'Reporting currency'      | 'Revenue accruals'          | '156,05' | ''           |
	And I close all client application windows