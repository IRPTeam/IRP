...
Scenario: _52053 check Cash payment movements by the Register  "R5020 Partners balance" (PaymentToVendor, IsAdvance = False)
	And I close all client application windows
	* Select Cash payment
		Given I open hyperlink "e1cib/list/Document.CashPayment"
		And I go to line in "List" table
...
Scenario: _52071 check Debit note to consignor movements by the Register  "R5020 Partners balance" (IsVendor, IsAdvance = True)
	And I close all client application windows
	* Select Debit note
		Given I open hyperlink "e1cib/list/Document.DebitNote"
		And I go to line in "List" table
...
Scenario: _52072 check Debit note to consignor movements by the Register  "R5020 Partners balance" (IsCustomer, IsAdvance = False)
	And I close all client application windows
	* Select Debit note
		Given I open hyperlink "e1cib/list/Document.DebitNote"
		And I go to line in "List" table
...
Scenario: _52073 check Credit note to consignor movements by the Register  "R5020 Partners balance" (IsCustomer, IsAdvance = True)
	And I close all client application windows
	* Select Credit note
		Given I open hyperlink "e1cib/list/Document.CreditNote"
		And I go to line in "List" table
...
Scenario: _52073 check Credit note to consignor movements by the Register  "R5020 Partners balance" (IsCustomer, IsAdvance = True)
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                        | 'Record type' | 'Period'              | 'Resources' | ''                     | ''                 | ''                   | ''               | ''                  | 'Dimensions'    | ''       | ''                            | ''           | ''          | ''         | ''         | ''                             | ''                     | 'Attributes'       |
			| ''                                        | ''            | ''                    | 'Amount'    | 'Customer transaction' | 'Customer advance' | 'Vendor transaction' | 'Vendor advance' | 'Other transaction' | 'Company'       | 'Branch' | 'Partner'                     | 'Legal name' | 'Agreement' | 'Document' | 'Currency' | 'Multi currency movement type' | 'Transaction currency' | 'Advances closing' |
			| ''                                        | 'Expense'     | '24.02.2023 11:02:48' | ''          | ''                     | ''                 | ''                   | ''               | ''                  | 'Own company 2' | ''       | 'Customer 2 (2 partner term)' | 'Client 2'   | ''          | ''         | 'EUR'      | 'Budgeting currency, EUR'      | 'TRY'                  | ''                 |
			| ''                                        | 'Expense'     | '24.02.2023 11:02:48' | '0,75'      | ''                     | '0,75'             | ''                   | ''               | ''                  | 'Own company 2' | ''       | 'Customer 2 (2 partner term)' | 'Client 2'   | ''          | ''         | 'EUR'      | 'Reporting currency, EUR'      | 'TRY'                  | ''                 |
			| ''                                        | 'Expense'     | '24.02.2023 11:02:48' | '15'        | ''                     | '15'               | ''                   | ''               | ''                  | 'Own company 2' | ''       | 'Customer 2 (2 partner term)' | 'Client 2'   | ''          | ''         | 'TRY'      | 'Legal currency, TRY'          | 'TRY'                  | ''                 |
			| ''                                        | 'Expense'     | '24.02.2023 11:02:48' | '15'        | ''                     | '15'               | ''                   | ''               | ''                  | 'Own company 2' | ''       | 'Customer 2 (2 partner term)' | 'Client 2'   | ''          | ''         | 'TRY'      | 'en description is empty'      | 'TRY'                  | ''                 |
