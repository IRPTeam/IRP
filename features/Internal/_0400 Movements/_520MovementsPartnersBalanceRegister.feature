...
Scenario: _52071 check Debit note movements by the Register  "R5020 Partners balance" (IsVendor, without basis document)
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                       | 'Expense'     | '24.02.2023 11:03:25' | '-25'       | ''                     | ''                 | '-25'                | ''               | ''                  | 'Own company 2' | 'Business unit 1' | 'Vendor 1 (1 partner term)' | 'Vendor 1'   | 'Partner term with vendor 1' | ''         | 'TRY'      | 'Agreement currency, TRY'      | 'TRY'                  | ''                 |
...
Scenario: _52073 check Credit note movements by the Register  "R5020 Partners balance" (IsCustomer, without basis document)
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                        | 'Receipt'     | '07.05.2023 12:00:01' | '-50'       | '-50'                  | ''                 | ''                   | ''               | ''                  | 'Own company 2' | 'Business unit 1' | 'Customer 1 (3 partner terms)' | 'Client 1'   | 'Partner term with customer (by document + credit limit)' | 'Credit note 2 dated 07.05.2023 12:00:01' | 'TRY'      | 'Agreement currency, TRY'      | 'TRY'                  | ''                 |
...
Scenario: _52098 check Report R5020 PartnersBalance in the different currencies
	...
	* Reporting currency, EUR - Customer
		...
		And "Result" spreadsheet document contains lines:	
			...
			| 'Partner'                                                   | 'Legal name'                                                                                                              | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                                  | 'Agreement'                                                                                                               | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                                             | ''                                                                                                                        | ''         | ''                             | '44,73'   | '44,73'   | ''        | '37,98'   | '12,66'   | '25,32'   | '32,07'   | '57,39'   | '-25,32'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 6'                                                | 'Customer 6'                                                                                                              | ''         | ''                             | '44,73'   | '44,73'   | ''        | '37,98'   | '12,66'   | '25,32'   | '32,07'   | '57,39'   | '-25,32'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Foreign currency revaluation 13 dated 31.01.2024 12:00:00' | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '0,43'    | '0,43'    | ''        | ''        | ''        | '25,32'   | '0,43'    | '0,43'    | '-25,32'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                                     | ''                                                                                                                        | ''         | ''                             | '44,73'   | '44,73'   | ''        | '37,98'   | '12,66'   | '25,32'   | '32,07'   | '57,39'   | '-25,32'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
	And I close all client application windows			