...
Scenario: _52098 check Report R5020 PartnersBalance in the different currencies
	...
	* Select partner, period and currency movement type
		...
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                      | 'Legal name'                                                                                                                         | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                     | 'Agreement'                                                                                                                          | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                                | ''                                                                                                                                   | ''         | ''                             | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | '200,00'  | '200,00'  | '128,00'  | '328,00'  | '-200,00' | ''        | ''        | ''        |
			| 'Vendor 3 (1 partner term)'                    | 'Vendor 3'                                                                                                                           | ''         | ''                             | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | '200,00'  | '200,00'  | '128,00'  | '328,00'  | '-200,00' | ''        | ''        | ''        |
			| 'Purchase invoice 7 dated 05.12.2023 12:00:00' | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '528,00'  | '-528,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '528,00'  | '-528,00' | ''        | ''        | ''        |
			| 'Cash payment 7 dated 06.12.2023 12:03:11'     | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | '400,00'  | ''        | '-128,00' | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | '400,00'  | ''        | ''        | '-528,00' | ''        | ''        | ''        |
			| 'Cash payment 8 dated 07.12.2023 12:00:00'     | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | '128,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | '128,00'  | ''        | '-400,00' | ''        | ''        | ''        |
			| 'Purchase return 3 dated 10.12.2023 12:00:00'  | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '-264,00' | '264,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | '-264,00' | '-136,00' | ''        | ''        | ''        |
			| 'Cash receipt 6 dated 11.12.2023 12:00:00'     | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '200,00'  | '64,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '200,00'  | '200,00'  | ''        | ''        | '-136,00' | ''        | ''        | ''        |
			| 'Cash receipt 7 dated 14.12.2023 12:00:00'     | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '64,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '200,00'  | ''        | '64,00'   | '-200,00' | ''        | ''        | ''        |
			| 'Total'                                        | ''                                                                                                                                   | ''         | ''                             | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | '200,00'  | '200,00'  | '128,00'  | '328,00'  | '-200,00' | ''        | ''        | ''        |
	* Reporting currency, EUR - Vendor
		...
		And "Result" spreadsheet document contains lines:	
			...
			| 'Partner'                                                   | 'Legal name'                                                                                                                             | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                                  | 'Agreement'                                                                                                                              | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                                             | ''                                                                                                                                       | ''         | ''                             | '17,25'   | '17,24'   | '0,01'    | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | '6,95'    | '6,12'    | '4,18'    | '10,29'   | '-6,11'   | ''        | ''        | ''        |
			| 'Vendor 3 (1 partner term)'                                 | 'Vendor 3'                                                                                                                               | ''         | ''                             | '17,25'   | '17,24'   | '0,01'    | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | '6,95'    | '6,12'    | '4,18'    | '10,29'   | '-6,11'   | ''        | ''        | ''        |
			| 'Purchase invoice 7 dated 05.12.2023 12:00:00'              | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '17,25'   | '-17,25'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '17,25'   | '-17,25'  | ''        | ''        | ''        |
			| 'Cash payment 7 dated 06.12.2023 12:03:11'                  | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '13,07'   | ''        | '-4,18'   | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | ''        | '13,07'   | ''        | ''        | '-17,25'  | ''        | ''        | ''        |
			| 'Cash payment 8 dated 07.12.2023 12:00:00'                  | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '4,18'    | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | '4,18'    | ''        | '-13,07'  | ''        | ''        | ''        |
			| 'Purchase return 3 dated 10.12.2023 12:00:00'               | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '-8,62'   | '8,62'    | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | ''        | '-8,62'   | '-4,45'   | ''        | ''        | ''        |
			| 'Cash receipt 6 dated 11.12.2023 12:00:00'                  | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '6,53'    | '2,09'    | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '6,53'    | '6,54'    | ''        | ''        | '-4,45'   | ''        | ''        | ''        |
			| 'Cash receipt 7 dated 14.12.2023 12:00:00'                  | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '2,09'    | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '6,54'    | ''        | '2,09'    | '-6,54'   | ''        | ''        | ''        |
			| 'Foreign currency revaluation 12 dated 31.12.2023 12:00:00' | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '0,21'    | '6,33'    | ''        | '-0,21'   | '-6,33'   | ''        | ''        | ''        |
			| 'Foreign currency revaluation 13 dated 31.01.2024 12:00:00' | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '-0,01'   | '0,01'    | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '0,21'    | '6,12'    | ''        | '-0,22'   | '-6,11'   | ''        | ''        | ''        |
			| 'Total'                                                     | ''                                                                                                                                       | ''         | ''                             | '17,25'   | '17,24'   | '0,01'    | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | '6,95'    | '6,12'    | '4,18'    | '10,29'   | '-6,11'   | ''        | ''        | ''        |
	* Reporting currency, EUR - Customer
		...
		And "Result" spreadsheet document contains lines:	
			...
			| 'Partner'                                    | 'Legal name'                                                                                                              | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                                                                                               | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                                                                                        | ''         | ''                             | '44,30'   | '44,30'   | ''        | '12,66'   | '12,66'   | ''        | '31,64'   | '31,64'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 6'                                 | 'Customer 6'                                                                                                              | ''         | ''                             | '44,30'   | '44,30'   | ''        | '12,66'   | '12,66'   | ''        | '31,64'   | '31,64'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Sales return 10 dated 28.12.2023 12:00:00'  | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '-31,64'  | ''        | '-31,64'  | ''        | ''        | '-12,66'  | '-31,64'  | ''        | '-18,98'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 14 dated 28.12.2023 17:00:00'  | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '31,64'   | ''        | ''        | ''        | ''        | '-12,66'  | '31,64'   | ''        | '12,66'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Bank payment 15 dated 30.12.2023 17:48:36'  | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '12,66'   | ''        | ''        | '12,66'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                                                                                        | ''         | ''                             | '44,30'   | '44,30'   | ''        | '12,66'   | '12,66'   | ''        | '31,64'   | '31,64'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
	And I close all client application windows
