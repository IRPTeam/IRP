...
Scenario: _52005 PI-PR-CP-DN-BR (AP - by partner terms, BR - return from vendor, IsAdvance = False)
	...
	* Check
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                      | 'Legal name'                                                                                                                         | ''         | ''                             | 'Receipt' | 'Expense'   | 'Closing'    | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense'   | 'Closing'    | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                     | 'Agreement'                                                                                                                          | 'Currency' | 'Multi currency movement type' | ''        | ''          | ''           | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''          | ''           | ''        | ''        | ''        |
			| 'Own company 2'                                | ''                                                                                                                                   | ''         | ''                             | '500,00'  | '13 465,05' | '-12 965,05' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '500,00'  | '13 465,05' | '-12 965,05' | ''        | ''        | ''        |
			| 'Vendor 1 (1 partner term)'                    | 'Vendor 1'                                                                                                                           | ''         | ''                             | '500,00'  | '13 465,05' | '-12 965,05' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '500,00'  | '13 465,05' | '-12 965,05' | ''        | ''        | ''        |
			...
			| 'Debit note 1 dated 24.02.2023 11:03:25'       | 'Partner term with vendor 1'                                                                                                         | 'TRY'      | 'Legal currency, TRY'          | ''        | '-25,00'    | '-13 085,05' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '-25,00'    | '-13 085,05' | ''        | ''        | ''        |
			| 'Purchase return 1 dated 24.02.2023 17:01:27'  | 'Partner term with vendor 1'                                                                                                         | 'TRY'      | 'Legal currency, TRY'          | ''        | '-220,00'   | '-12 865,05' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '-220,00'   | '-12 865,05' | ''        | ''        | ''        |
			| 'Bank receipt 8 dated 10.08.2023 12:00:00'     | 'Partner term with vendor 1'                                                                                                         | 'TRY'      | 'Legal currency, TRY'          | ''        | '100,00'    | '-12 965,05' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '100,00'    | '-12 965,05' | ''        | ''        | ''        |
			| 'Total'                                        | ''                                                                                                                                   | ''         | ''                             | '500,00'  | '13 465,05' | '-12 965,05' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '500,00'  | '13 465,05' | '-12 965,05' | ''        | ''        | ''        |
	And I close all client application windows					
...
Scenario: _52007 SR-BP (AP - by documents, IsAdvance = False)
	...
	* Check				
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                  | 'Legal name'                                                                                                                            | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing'  | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing'  | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                 | 'Agreement'                                                                                                                             | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''         | ''        | ''        | ''        | ''        | ''        | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                            | ''                                                                                                                                      | ''         | ''                             | ''        | ''        | '1 670,00' | ''        | ''        | '-850,00' | ''        | ''        | '2 520,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 1 (3 partner terms)'             | 'Client 1'                                                                                                                              | ''         | ''                             | ''        | ''        | '1 670,00' | ''        | ''        | '-850,00' | ''        | ''        | '2 520,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 4 dated 10.08.2023 12:00:00' | 'Partner term with customer (by document + credit limit)'                                                                               | 'TRY'      | 'Legal currency, TRY'          | '-100,00' | ''        | '1 570,00' | ''        | ''        | '-850,00' | '-100,00' | ''        | '2 420,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 3 dated 11.08.2023 12:00:00' | 'Partner term with customer (by document + credit limit)'                                                                               | 'TRY'      | 'Legal currency, TRY'          | '100,00'  | ''        | '1 670,00' | ''        | ''        | '-850,00' | '100,00'  | ''        | '2 520,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                    | ''                                                                                                                                      | ''         | ''                             | ''        | ''        | '1 670,00' | ''        | ''        | '-850,00' | ''        | ''        | '2 520,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |	
		And I close all client application windows
...
Scenario: _52008 SI-BR (AP - by documents, BR - PaymentFromCustomerByPOS IsAdvance = True, IsAdvance = False, without customer advance closing)
	...
	* Check				
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                              | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                               | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                        | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | ''        | '400,00'  | '-400,00' | '750,00'  | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 3'                                 | 'Client 3'                                                | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | ''        | '400,00'  | '-400,00' | '750,00'  | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Bank receipt 12 dated 02.12.2023 15:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''        | '400,00'  | '-150,00' | ''        | '400,00'  | '-400,00' | ''        | ''        | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                        | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | ''        | '400,00'  | '-400,00' | '750,00'  | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
		And I close all client application windows				
...
Scenario: _52009 SI-BR-SR-BP (AP - by documents, BP - Return to customer, BR- Payment from customer, IsAdvance = True, IsAdvance = False, without customer advance closing)
	...
	* Select partner, period and currency movement type
		...
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                              | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                               | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                        | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '150,00'  | '400,00'  | '-250,00' | '600,00'  | '500,00'  | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 3'                                 | 'Client 3'                                                | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '150,00'  | '400,00'  | '-250,00' | '600,00'  | '500,00'  | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales invoice 12 dated 02.12.2023 12:00:00' | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '750,00'  | ''        | '750,00'  | ''        | ''        | ''        | '750,00'  | ''        | '750,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 11 dated 02.12.2023 14:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''        | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 12 dated 02.12.2023 15:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''        | '400,00'  | '-150,00' | ''        | '400,00'  | '-400,00' | ''        | ''        | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 7 dated 04.12.2023 12:00:00'   | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '-300,00' | ''        | '-450,00' | ''        | ''        | '-400,00' | '-300,00' | ''        | '-50,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 11 dated 04.12.2023 16:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '150,00'  | ''        | '-300,00' | '150,00'  | ''        | '-250,00' | ''        | ''        | '-50,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 12 dated 05.12.2023 12:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '150,00'  | ''        | '-150,00' | ''        | ''        | '-250,00' | '150,00'  | ''        | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                        | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '150,00'  | '400,00'  | '-250,00' | '600,00'  | '500,00'  | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
		And I close all client application windows
...
Scenario: _52010 BP (OtherPartner)
	...
	* Select partner, period and currency movement type
		And I click Choice button of the field named "SettingsComposerUserSettingsItem0Value"
		And I input "10.01.2024" text in the field named "DateBegin"
		...
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                          | 'Legal name'                                                                                                             | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                         | 'Agreement'                                                                                                              | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                                    | ''                                                                                                                       | ''         | ''                             | '499,80'  | '590,00'  | '-90,20'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '499,80'  | '590,00'  | '-90,20'  |
			| 'Other partner'                                    | 'Other partner'                                                                                                          | ''         | ''                             | '499,80'  | '590,00'  | '-90,20'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '499,80'  | '590,00'  | '-90,20'  |
			| 'Retail sales receipt 3 dated 10.01.2024 16:03:16' | 'Other partner term'                                                                                                     | 'TRY'      | 'Legal currency, TRY'          | '490,00'  | ''        | '490,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '490,00'  | ''        | '490,00'  |
			| 'Bank receipt 14 dated 11.01.2024 10:00:00'        | 'Other partner term'                                                                                                     | 'TRY'      | 'Legal currency, TRY'          | ''        | '490,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '490,00'  | ''        |
			| 'Credit note 6 dated 21.03.2024 12:00:00'          | 'Other partner term'                                                                                                     | 'TRY'      | 'Legal currency, TRY'          | ''        | '100,00'  | '-100,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '100,00'  | '-100,00' |
			| 'Bank payment 13 dated 22.03.2024 10:51:11'        | 'Other partner term'                                                                                                     | 'TRY'      | 'Legal currency, TRY'          | '9,80'    | ''        | '-90,20'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '9,80'    | ''        | '-90,20'  |
			| 'Total'                                            | ''                                                                                                                       | ''         | ''                             | '499,80'  | '590,00'  | '-90,20'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '499,80'  | '590,00'  | '-90,20'  |		
	And I close all client application windows
...
Scenario: _52014 BR (AP - by documents, BR - ReturnFromVendor, IsAdvance = True, without vendor advance closing)
	...
	* Select partner, period and currency movement type
		...
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                      | 'Legal name'                                                                                                                   | ''         | ''                             | 'Receipt'  | 'Expense'  | 'Closing'   | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt'  | 'Expense' | 'Closing'  | 'Receipt'  | 'Expense'  | 'Closing'   | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                     | 'Agreement'                                                                                                                    | 'Currency' | 'Multi currency movement type' | ''         | ''         | ''          | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''        | ''         | ''         | ''         | ''          | ''        | ''        | ''        |
			| 'Own company 2'                                | ''                                                                                                                             | ''         | ''                             | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 200,00' | ''        | '1 200,00' | '4 000,00' | '9 735,00' | '-5 735,00' | ''        | ''        | ''        |
			| 'Customer and vendor'                          | 'Client and vendor'                                                                                                            | ''         | ''                             | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 200,00' | ''        | '1 200,00' | '4 000,00' | '9 735,00' | '-5 735,00' | ''        | ''        | ''        |
			| 'Purchase invoice 5 dated 02.12.2023 12:30:00' | 'Partner term with vendor (advance payment by document)'                                                                       | 'TRY'      | 'Legal currency, TRY'          | ''         | '9 685,00' | '-9 685,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''        | ''         | ''         | '9 685,00' | '-9 685,00' | ''        | ''        | ''        |
			| 'Bank payment 8 dated 02.12.2023 16:00:00'     | 'Partner term with vendor (advance payment by document)'                                                                       | 'TRY'      | 'Legal currency, TRY'          | '4 000,00' | ''         | '-5 685,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''        | ''         | '4 000,00' | ''         | '-5 685,00' | ''        | ''        | ''        |
			| 'Cash payment 5 dated 03.12.2023 12:00:00'     | 'Partner term with vendor (advance payment by document)'                                                                       | 'TRY'      | 'Legal currency, TRY'          | '1 000,00' | ''         | '-4 685,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 000,00' | ''        | '1 000,00' | ''         | ''         | '-5 685,00' | ''        | ''        | ''        |
			| 'Bank payment 9 dated 03.12.2023 12:30:00'     | 'Partner term with vendor (advance payment by document)'                                                                       | 'TRY'      | 'Legal currency, TRY'          | '200,00'   | ''         | '-4 485,00' | ''        | ''        | ''        | ''        | ''        | ''        | '200,00'   | ''        | '1 200,00' | ''         | ''         | '-5 685,00' | ''        | ''        | ''        |
			| 'Bank receipt 13 dated 05.12.2023 10:00:00'    | 'Partner term with vendor (advance payment by document)'                                                                       | 'TRY'      | 'Legal currency, TRY'          | ''         | '50,00'    | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''        | '1 200,00' | ''         | '50,00'    | '-5 735,00' | ''        | ''        | ''        |
			| 'Total'                                        | ''                                                                                                                             | ''         | ''                             | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 200,00' | ''        | '1 200,00' | '4 000,00' | '9 735,00' | '-5 735,00' | ''        | ''        | ''        |
		And I close all client application windows
...
Scenario: _52016 RSR - RRR - BR (StatusType = Completed, UsePartnerTransactions, BR - Payment from customer by POS, IsAdvance = True)
	...
	* Select partner, period and currency movement type
		...
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                           | 'Legal name'                                              | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                          | 'Agreement'                                               | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                                     | ''                                                        | ''         | ''                             | ''        | '100,00'  | '-250,00' | ''        | '100,00'  | '-350,00' | ''        | ''        | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 3'                                        | 'Client 3'                                                | ''         | ''                             | ''        | '100,00'  | '-250,00' | ''        | '100,00'  | '-350,00' | ''        | ''        | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Retail sales receipt 4 dated 02.02.2024 00:00:05'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '490,00'  | '490,00'  | '-150,00' | ''        | ''        | '-250,00' | '490,00'  | '490,00'  | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 15 dated 02.02.2024 10:00:00'         | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''        | '100,00'  | '-250,00' | ''        | '100,00'  | '-350,00' | ''        | ''        | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Retail return receipt 2 dated 02.02.2024 16:00:00' | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '-490,00' | '-490,00' | '-250,00' | ''        | ''        | '-350,00' | '-490,00' | '-490,00' | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                             | ''                                                        | ''         | ''                             | ''        | '100,00'  | '-250,00' | ''        | '100,00'  | '-350,00' | ''        | ''        | '100,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
		And I close all client application windows
...
Scenario: _52017 SI - SR - CP (Return to customer, IsAdvance = True, IsAdvance = False, without customer advance closing)
	...
	* Check
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                                                                                          | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                                                                                           | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                                                                                    | ''         | ''                             | '760,00'  | '190,00'  | '570,00'  | ''        | '190,00'  | '-190,00' | '760,00'  | ''        | '760,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 4'                                 | 'Client 4'                                                                                                            | ''         | ''                             | '760,00'  | '190,00'  | '570,00'  | ''        | '190,00'  | '-190,00' | '760,00'  | ''        | '760,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Cash receipt 9 dated 21.03.2024 12:25:12'   | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '190,00'  | ''        | ''        | '190,00'  | '-190,00' | ''        | ''        | '190,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Cash payment 9 dated 22.03.2024 12:24:16'   | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '380,00'  | ''        | '380,00'  | ''        | ''        | '-190,00' | '380,00'  | ''        | '570,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Cash payment 10 dated 22.03.2024 12:25:12'  | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '190,00'  | ''        | '570,00'  | ''        | ''        | '-190,00' | '190,00'  | ''        | '760,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                                                                                    | ''         | ''                             | '760,00'  | '190,00'  | '570,00'  | ''        | '190,00'  | '-190,00' | '760,00'  | ''        | '760,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |	
		And I close all client application windows
		
Scenario: _52018 PR - CR (Return from vendor, IsAdvance = False, without vendor advance closing)
	And I close all client application windows
	* Open report R5020_PartnersBalance and select option
		Given I open hyperlink "e1cib/app/Report.R5020_PartnersBalance"
		And I click "Select option..." button
	...
	* Check
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                     | 'Legal name'                                                                                                                         | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                    | 'Agreement'                                                                                                                          | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                               | ''                                                                                                                                   | ''         | ''                             | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | ''        | '-400,00' | ''        | ''        | ''        |
			| 'Vendor 3 (1 partner term)'                   | 'Vendor 3'                                                                                                                           | ''         | ''                             | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | ''        | '-400,00' | ''        | ''        | ''        |
			| 'Purchase return 3 dated 10.12.2023 12:00:00' | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '-264,00' | '264,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | '-264,00' | '-136,00' | ''        | ''        | ''        |
			| 'Cash receipt 6 dated 11.12.2023 12:00:00'    | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '200,00'  | '64,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | '200,00'  | '-336,00' | ''        | ''        | ''        |
			| 'Cash receipt 7 dated 14.12.2023 12:00:00'    | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '64,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | '64,00'   | '-400,00' | ''        | ''        | ''        |
			| 'Total'                                       | ''                                                                                                                                   | ''         | ''                             | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | ''        | ''        | '-400,00' | ''        | ''        | ''        |	
		And I close all client application windows
...
Scenario: _52022 SI-BR-SR-BP (PaymentFromCustomerByPOS, ReturnToCustomerByPOS, IsAdvance = True, IsAdvance = False, without customer advance closing)
	...
	* Check
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                              | ''         | ''                             | 'Receipt'   | 'Expense'  | 'Closing'   | 'Receipt' | 'Expense' | 'Closing' | 'Receipt'   | 'Expense'  | 'Closing'  | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                               | 'Currency' | 'Multi currency movement type' | ''          | ''         | ''          | ''        | ''        | ''        | ''          | ''         | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                        | ''         | ''                             | '1 400,00'  | '1 800,00' | '-400,00'   | '400,00'  | '800,00'  | '-400,00' | '1 000,00'  | '1 000,00' | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 6'                                 | 'Customer 6'                                              | ''         | ''                             | '1 400,00'  | '1 800,00' | '-400,00'   | '400,00'  | '800,00'  | '-400,00' | '1 000,00'  | '1 000,00' | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Bank receipt 16 dated 26.12.2023 17:29:14'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''          | '1 400,00' | '-400,00'   | ''        | '400,00'  | '-400,00' | ''          | '1 000,00' | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Bank receipt 17 dated 26.12.2023 17:32:09'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''          | '400,00'   | '-400,00'   | ''        | '400,00'  | '-800,00' | ''          | ''         | '400,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 10 dated 28.12.2023 12:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '-1 000,00' | ''         | '-1 400,00' | ''        | ''        | '-800,00' | '-1 000,00' | ''         | '-600,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 14 dated 28.12.2023 17:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '1 000,00'  | ''         | '-400,00'   | ''        | ''        | '-800,00' | '1 000,00'  | ''         | '400,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 11 dated 29.12.2023 12:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '-400,00'   | ''         | '-800,00'   | ''        | ''        | '-800,00' | '-400,00'   | ''         | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 15 dated 30.12.2023 17:48:36'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '400,00'    | ''         | '-400,00'   | '400,00'  | ''        | '-400,00' | ''          | ''         | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                        | ''         | ''                             | '1 400,00'  | '1 800,00' | '-400,00'   | '400,00'  | '800,00'  | '-400,00' | '1 000,00'  | '1 000,00' | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
		And I close all client application windows
...
Scenario: _52051 check Bank receipt movements by the Register  "R5020 Partners balance" (PaymentFromCustomerByPOS, IsAdvance = False)
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Record type' | 'Period'              | 'Resources' | ''                     | ''                 | ''                   | ''               | ''                  | 'Dimensions'    | ''                | ''           | ''           | ''                                                        | ''                                           | ''         | ''                             | ''                     | 'Attributes'       |
			| ''                                          | ''            | ''                    | 'Amount'    | 'Customer transaction' | 'Customer advance' | 'Vendor transaction' | 'Vendor advance' | 'Other transaction' | 'Company'       | 'Branch'          | 'Partner'    | 'Legal name' | 'Agreement'                                               | 'Document'                                   | 'Currency' | 'Multi currency movement type' | 'Transaction currency' | 'Advances closing' |
			| ''                                          | 'Expense'     | '26.12.2023 17:29:14' | ''          | ''                     | ''                 | ''                   | ''               | ''                  | 'Own company 2' | 'Business unit 1' | 'Customer 6' | 'Customer 6' | 'Partner term with customer (by document + credit limit)' | ''                                           | 'EUR'      | 'Budgeting currency, EUR'      | 'TRY'                  | ''                 |
...
Scenario: _52083 SI-BR-SR-BP (AP - by documents, BP - Return to customer, BR- Payment from customer, IsAdvance = True, IsAdvance = False, with customer advance closing)
	...
	* Select partner, period and currency movement type
		...
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                              | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                               | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                        | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | '600,00'  | '600,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 3'                                 | 'Client 3'                                                | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | '600,00'  | '600,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales invoice 12 dated 02.12.2023 12:00:00' | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '750,00'  | ''        | '750,00'  | ''        | ''        | ''        | '750,00'  | ''        | '750,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 11 dated 02.12.2023 14:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''        | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 12 dated 02.12.2023 15:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''        | '400,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | ''        | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 7 dated 04.12.2023 12:00:00'   | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '-300,00' | ''        | '-450,00' | '-300,00' | ''        | '-450,00' | '-300,00' | '-300,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 11 dated 04.12.2023 16:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '150,00'  | ''        | '-300,00' | '150,00'  | ''        | '-300,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 12 dated 05.12.2023 12:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '150,00'  | ''        | '-150,00' | '150,00'  | ''        | '-150,00' | '150,00'  | '150,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                        | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | '600,00'  | '600,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
		And I close all client application windows
...
Scenario: _52084 SI-BR (AP - by documents, BR - PaymentFromCustomerByPOS IsAdvance = True, IsAdvance = False, with customer advance closing)
	...
	* Check				
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                                                                                          | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                                                                                           | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                                                                                    | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | '750,00'  | '750,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 3'                                 | 'Client 3'                                                                                                            | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | '750,00'  | '750,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales invoice 12 dated 02.12.2023 12:00:00' | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '750,00'  | ''        | '750,00'  | ''        | ''        | ''        | '750,00'  | ''        | '750,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 11 dated 02.12.2023 14:00:00'  | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | '500,00'  | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 12 dated 02.12.2023 15:00:00'  | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '400,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | ''        | '250,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                                                                                    | ''         | ''                             | '750,00'  | '900,00'  | '-150,00' | '250,00'  | '400,00'  | '-150,00' | '750,00'  | '750,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |	
		And I close all client application windows

Scenario: _52085 BR (AP - by documents, BR - ReturnFromVendor, IsAdvance = False, with vendor advance closing)
	And I close all client application windows
	* Open report R5020_PartnersBalance and select option
		Given I open hyperlink "e1cib/app/Report.R5020_PartnersBalance"
		And I click "Select option..." button
	...
	* Select partner, period and currency movement type
		...
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                      | 'Legal name'                                             | ''         | ''                             | 'Receipt'  | 'Expense'  | 'Closing'   | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt'  | 'Expense'  | 'Closing' | 'Receipt'  | 'Expense'  | 'Closing'   | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                     | 'Agreement'                                              | 'Currency' | 'Multi currency movement type' | ''         | ''         | ''          | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''         | ''        | ''         | ''         | ''          | ''        | ''        | ''        |
			| 'Own company 2'                                | ''                                                       | ''         | ''                             | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 200,00' | '1 200,00' | ''        | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        |
			| 'Customer and vendor'                          | 'Client and vendor'                                      | ''         | ''                             | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 200,00' | '1 200,00' | ''        | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        |
			| 'Purchase invoice 5 dated 02.12.2023 12:30:00' | 'Partner term with vendor (advance payment by document)' | 'TRY'      | 'Legal currency, TRY'          | ''         | '9 685,00' | '-9 685,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''         | ''        | ''         | '9 685,00' | '-9 685,00' | ''        | ''        | ''        |
			| 'Bank payment 8 dated 02.12.2023 16:00:00'     | 'Partner term with vendor (advance payment by document)' | 'TRY'      | 'Legal currency, TRY'          | '4 000,00' | ''         | '-5 685,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''         | ''        | '4 000,00' | ''         | '-5 685,00' | ''        | ''        | ''        |
			| 'Cash payment 5 dated 03.12.2023 12:00:00'     | 'Partner term with vendor (advance payment by document)' | 'TRY'      | 'Legal currency, TRY'          | '1 000,00' | ''         | '-4 685,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 000,00' | '1 000,00' | ''        | '1 000,00' | ''         | '-4 685,00' | ''        | ''        | ''        |
			| 'Bank payment 9 dated 03.12.2023 12:30:00'     | 'Partner term with vendor (advance payment by document)' | 'TRY'      | 'Legal currency, TRY'          | '200,00'   | ''         | '-4 485,00' | ''        | ''        | ''        | ''        | ''        | ''        | '200,00'   | '200,00'   | ''        | '200,00'   | ''         | '-4 485,00' | ''        | ''        | ''        |
			| 'Bank receipt 13 dated 05.12.2023 10:00:00'    | 'Partner term with vendor (advance payment by document)' | 'TRY'      | 'Legal currency, TRY'          | ''         | '50,00'    | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''         | ''         | ''        | ''         | '50,00'    | '-4 535,00' | ''        | ''        | ''        |
			| 'Total'                                        | ''                                                       | ''         | ''                             | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        | ''        | ''        | ''        | '1 200,00' | '1 200,00' | ''        | '5 200,00' | '9 735,00' | '-4 535,00' | ''        | ''        | ''        |
		And I close all client application windows		
	
Scenario: _52086 SI - SR - CP (Return to customer, IsAdvance = False, IsAdvance = False, with customer advance closing)
	And I close all client application windows
	* Open report R5020_PartnersBalance and select option
		Given I open hyperlink "e1cib/app/Report.R5020_PartnersBalance"
		And I click "Select option..." button
	...
	* Check
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                                                                                          | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                                                                                           | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                                                                                    | ''         | ''                             | '760,00'  | '190,00'  | '570,00'  | '190,00'  | '190,00'  | ''        | '760,00'  | '190,00'  | '570,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 4'                                 | 'Client 4'                                                                                                            | ''         | ''                             | '760,00'  | '190,00'  | '570,00'  | '190,00'  | '190,00'  | ''        | '760,00'  | '190,00'  | '570,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales invoice 13 dated 01.08.2023 12:00:00' | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '760,00'  | ''        | '760,00'  | ''        | ''        | ''        | '760,00'  | ''        | '760,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 8 dated 02.08.2023 12:00:00'   | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '-380,00' | ''        | '380,00'  | ''        | ''        | ''        | '-380,00' | ''        | '380,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 9 dated 10.08.2023 12:00:00'   | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '-190,00' | ''        | '190,00'  | ''        | ''        | ''        | '-190,00' | ''        | '190,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Cash receipt 9 dated 21.03.2024 12:25:12'   | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '190,00'  | ''        | '190,00'  | '190,00'  | ''        | ''        | '190,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Cash payment 9 dated 22.03.2024 12:24:16'   | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '380,00'  | ''        | '380,00'  | ''        | ''        | ''        | '380,00'  | ''        | '380,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Cash payment 10 dated 22.03.2024 12:25:12'  | 'Partner term with customer (by document + credit limit)'                                                             | 'TRY'      | 'Legal currency, TRY'          | '190,00'  | ''        | '570,00'  | ''        | ''        | ''        | '190,00'  | ''        | '570,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                                                                                    | ''         | ''                             | '760,00'  | '190,00'  | '570,00'  | '190,00'  | '190,00'  | ''        | '760,00'  | '190,00'  | '570,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |	
		And I close all client application windows
...
Scenario: _52087 PI - CP- PR - CR (Return from vendor, IsAdvance = True, IsAdvance = False, with vendor advance closing)
	...
	* Check
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                      | 'Legal name'                                                                                                                         | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                     | 'Agreement'                                                                                                                          | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                                | ''                                                                                                                                   | ''         | ''                             | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | '400,00'  | ''        | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        |
			| 'Vendor 3 (1 partner term)'                    | 'Vendor 3'                                                                                                                           | ''         | ''                             | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | '400,00'  | ''        | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        |
			...
			| 'Cash receipt 6 dated 11.12.2023 12:00:00'     | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '200,00'  | '64,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '200,00'  | '64,00'   | ''        | ''        | ''        |
			| 'Cash receipt 7 dated 14.12.2023 12:00:00'     | '№31-92'                                                                                                                             | 'TRY'      | 'Legal currency, TRY'          | ''        | '64,00'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '64,00'   | ''        | ''        | ''        | ''        |
			| 'Total'                                        | ''                                                                                                                                   | ''         | ''                             | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '400,00'  | '400,00'  | ''        | '528,00'  | '528,00'  | ''        | ''        | ''        | ''        |	
		And I close all client application windows
...
Scenario: _52089 SI-BR-SR-BP (PaymentFromCustomerByPOS, ReturnToCustomerByPOS, IsAdvance = True, IsAdvance = False, with customer advance closing)
	...
	* Check
		And "Result" spreadsheet document contains lines:
			...
			| 'Partner'                                    | 'Legal name'                                              | ''         | ''                             | 'Receipt'   | 'Expense'  | 'Closing'   | 'Receipt'   | 'Expense'  | 'Closing'   | 'Receipt'   | 'Expense'   | 'Closing'  | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                   | 'Agreement'                                               | 'Currency' | 'Multi currency movement type' | ''          | ''         | ''          | ''          | ''         | ''          | ''          | ''          | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                              | ''                                                        | ''         | ''                             | '1 400,00'  | '1 800,00' | '-400,00'   | '-600,00'   | '1 800,00' | '-2 400,00' | '2 000,00'  | ''          | '2 000,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 6'                                 | 'Customer 6'                                              | ''         | ''                             | '1 400,00'  | '1 800,00' | '-400,00'   | '-600,00'   | '1 800,00' | '-2 400,00' | '2 000,00'  | ''          | '2 000,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales invoice 16 dated 25.12.2023 12:00:00' | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '1 000,00'  | ''         | '1 000,00'  | ''          | ''         | ''          | '1 000,00'  | ''          | '1 000,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank receipt 16 dated 26.12.2023 17:29:14'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | ''          | '1 400,00' | '-400,00'   | ''          | '400,00'   | '-400,00'   | ''          | '1 000,00'  | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales invoice 17 dated 26.12.2023 17:30:34' | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '400,00'    | ''         | ''          | '400,00'    | ''         | ''          | '400,00'    | '400,00'    | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Sales return 10 dated 28.12.2023 12:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '-1 000,00' | ''         | '-1 400,00' | '-1 000,00' | ''         | '-1 400,00' | '-1 000,00' | '-1 000,00' | ''         | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 14 dated 28.12.2023 17:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '1 000,00'  | ''         | '-400,00'   | ''          | '1 000,00' | '-2 400,00' | '2 000,00'  | ''          | '2 000,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 11 dated 29.12.2023 12:00:00'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '-400,00'   | ''         | '-800,00'   | '-400,00'   | ''         | '-2 800,00' | '-400,00'   | '-400,00'   | '2 000,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 15 dated 30.12.2023 17:48:36'  | 'Partner term with customer (by document + credit limit)' | 'TRY'      | 'Legal currency, TRY'          | '400,00'    | ''         | '-400,00'   | '400,00'    | ''         | '-2 400,00' | ''          | ''          | '2 000,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Total'                                      | ''                                                        | ''         | ''                             | '1 400,00'  | '1 800,00' | '-400,00'   | '-600,00'   | '1 800,00' | '-2 400,00' | '2 000,00'  | ''          | '2 000,00' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
		And I close all client application windows
...
Scenario: _52098 check Report R5020 PartnersBalance in the different currencies
	...
	* Reporting currency, EUR - Vendor
		...
		And "Result" spreadsheet document contains lines:	
			...
			| 'Partner'                                      | 'Legal name'                                                                                                                             | ''         | ''                             | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' | 'Receipt' | 'Expense' | 'Closing' |
			| 'Recorder'                                     | 'Agreement'                                                                                                                              | 'Currency' | 'Multi currency movement type' | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Own company 2'                                | ''                                                                                                                                       | ''         | ''                             | '17,25'   | '17,25'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | '13,07'   | ''        | '17,25'   | '17,25'   | ''        | ''        | ''        | ''        |
			| 'Vendor 3 (1 partner term)'                    | 'Vendor 3'                                                                                                                               | ''         | ''                             | '17,25'   | '17,25'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | '13,07'   | ''        | '17,25'   | '17,25'   | ''        | ''        | ''        | ''        |
			...
			| 'Cash receipt 6 dated 11.12.2023 12:00:00'     | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '6,53'    | '2,09'    | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '6,53'    | '2,09'    | ''        | ''        | ''        |
			| 'Cash receipt 7 dated 14.12.2023 12:00:00'     | '№31-92'                                                                                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '2,09'    | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '2,09'    | ''        | ''        | ''        | ''        |
			| 'Total'                                        | ''                                                                                                                                       | ''         | ''                             | '17,25'   | '17,25'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | '13,07'   | '13,07'   | ''        | '17,25'   | '17,25'   | ''        | ''        | ''        | ''        |	
	* Reporting currency, EUR - Customer
		And I remove checkbox named "SettingsComposerUserSettingsItem0Use"
		And I select from the drop-down list named "SettingsComposerUserSettingsItem2Value" by "Customer 6" string
		And I click "Generate" button
		And "Result" spreadsheet document contains lines:
			| 'Own company 2'                                             | ''                                                                                                                        | ''         | ''                             | '45,16'   | '57,39'   | '-12,23'  | '-18,55'  | '56,96'   | '-75,51'  | '63,71'   | '0,43'    | '63,28'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Customer 6'                                                | 'Customer 6'                                                                                                              | ''         | ''                             | '45,16'   | '57,39'   | '-12,23'  | '-18,55'  | '56,96'   | '-75,51'  | '63,71'   | '0,43'    | '63,28'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Bank receipt 16 dated 26.12.2023 17:29:14'                 | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | ''        | '44,30'   | '-12,66'  | ''        | '12,66'   | '-12,66'  | ''        | '31,64'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			...
			| 'Sales return 10 dated 28.12.2023 12:00:00'                 | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '-31,64'  | ''        | '-44,30'  | '-31,64'  | ''        | '-44,30'  | '-31,64'  | '-31,64'  | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Bank payment 14 dated 28.12.2023 17:00:00'                 | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '31,64'   | ''        | '-12,66'  | ''        | '31,64'   | '-75,94'  | '63,28'   | ''        | '63,28'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
			| 'Sales return 11 dated 29.12.2023 12:00:00'                 | 'Partner term with customer (by document + credit limit)'                                                                 | 'EUR'      | 'Reporting currency, EUR'      | '-12,66'  | ''        | '-25,32'  | '-12,66'  | ''        | '-88,60'  | '-12,66'  | '-12,66'  | '63,28'   | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        | ''        |
