...
Scenario: _052205 check Additional cost allocation movements by the Register  "T6020 Batch keys info"
	...
	* Check movements by the Register  "T6020 Batch keys info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '79,1'                  | '14,24'                     | ''                         | ''                             | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '118,64'                | '21,36'                     | ''                         | ''                             | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '89088088989'       | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '142,38'                | '25,62'                     | ''                         | ''                             | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '8908899877'        | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '189,84'                | '34,16'                     | ''                         | ''                             | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '8908899879'        | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            |
...
Scenario: _052206 check Additional cost allocation movements by the Register  "T6060 Batch cost allocation info"
	...
	* Check movements by the Register  "T6060 Batch cost allocation info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                           | '14.01.2025 09:50:56' | '79,1'      | '14,24'      | 'Main Company' | 'Store 03' | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | 'PZU'       | 'Local currency'         | 'TRY'      | ''                  |
			| ''                                                           | '14.01.2025 09:50:56' | '118,64'    | '21,36'      | 'Main Company' | 'Store 03' | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | 'PZU'       | 'Local currency'         | 'TRY'      | '89088088989'       |
			| ''                                                           | '14.01.2025 09:50:56' | '142,38'    | '25,62'      | 'Main Company' | 'Store 03' | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | 'PZU'       | 'Local currency'         | 'TRY'      | '8908899877'        |
			| ''                                                           | '14.01.2025 09:50:56' | '189,84'    | '34,16'      | 'Main Company' | 'Store 03' | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | 'PZU'       | 'Local currency'         | 'TRY'      | '8908899879'        |
