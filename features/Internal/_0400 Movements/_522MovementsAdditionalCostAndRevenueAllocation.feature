...
Scenario: _052205 check Additional cost allocation movements by the Register  "T6020 Batch keys info"
	...
	* Check movements by the Register  "T6020 Batch keys info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                           | ''                    | 'Quantity'  | 'Invoice amount' | 'Invoice tax amount' | 'Indirect cost amount' | 'Indirect cost tax amount' | 'Extra cost amount by ratio' | 'Extra cost tax amount by ratio' | 'Extra direct cost amount' | 'Extra direct cost tax amount' | 'Allocated cost amount' | 'Allocated cost tax amount' | 'Allocated revenue amount' | 'Allocated revenue tax amount' | 'Preliminary quantity' | 'Preliminary amount' | 'Preliminary tax amount' | 'Company'      | 'Branch' | 'Store'    | 'Item key'  | 'Direction' | 'Currency movement type' | 'Currency' | 'Batch document' | 'Sales invoice' | 'Row ID'                               | 'Profit loss center' | 'Expense type' | 'Work' | 'Work sheet' | 'DELETE batch consignor' | 'Serial lot number' | 'Source of origin' | 'Production document' | 'Purchase invoice document'                        | 'Fixed asset' | 'Is preliminary' | 'Preliminary ID' |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '39,55'                 | '7,12'                      | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'ODS'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '39,55'                 | '7,12'                      | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '59,32'                 | '10,68'                     | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '89088088989'       | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '71,19'                 | '12,81'                     | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '8908899877'        | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '94,92'                 | '17,08'                     | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'PZU'       | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '8908899879'        | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
			| ''                                                           | '14.01.2025 09:50:56' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | '395,47'                | '71,19'                     | ''                         | ''                             | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | '36/Yellow' | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
...
Scenario: _052209 check Additional revenue allocation movements by the Register  "T6020 Batch keys info"
	...
	* Check movements by the Register  "T6020 Batch keys info"
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                              | 'Period'              | 'Resources' | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                     | ''                   | ''                       | 'Dimensions'   | ''       | ''         | ''         | ''          | ''                       | ''         | ''               | ''              | ''                                     | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                                                 | ''            | ''               | ''               |
			| ''                                                              | ''                    | 'Quantity'  | 'Invoice amount' | 'Invoice tax amount' | 'Indirect cost amount' | 'Indirect cost tax amount' | 'Extra cost amount by ratio' | 'Extra cost tax amount by ratio' | 'Extra direct cost amount' | 'Extra direct cost tax amount' | 'Allocated cost amount' | 'Allocated cost tax amount' | 'Allocated revenue amount' | 'Allocated revenue tax amount' | 'Preliminary quantity' | 'Preliminary amount' | 'Preliminary tax amount' | 'Company'      | 'Branch' | 'Store'    | 'Item key' | 'Direction' | 'Currency movement type' | 'Currency' | 'Batch document' | 'Sales invoice' | 'Row ID'                               | 'Profit loss center' | 'Expense type' | 'Work' | 'Work sheet' | 'DELETE batch consignor' | 'Serial lot number' | 'Source of origin' | 'Production document' | 'Purchase invoice document'                        | 'Fixed asset' | 'Is preliminary' | 'Preliminary ID' |
			| ''                                                              | '14.01.2025 10:11:39' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | '76,92'                    | '13,85'                        | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'PZU'      | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '89088088989'       | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
			| ''                                                              | '14.01.2025 10:11:39' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | '123,08'                   | '22,15'                        | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'PZU'      | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '8908899879'        | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
			| ''                                                              | '14.01.2025 10:11:39' | ''          | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | '200'                      | '36'                           | ''                     | ''                   | ''                       | 'Main Company' | ''       | 'Store 03' | 'PZU'      | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | '8908899877'        | ''                 | ''                    | 'Purchase invoice 2 203 dated 12.01.2025 12:00:00' | ''            | 'No'             | ''               |
		And I close all client application windows
