...
Scenario: _052303 create SPO same with SO
	...
	* Check registers
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                      | '$$ShipmentPlaningOrder01$$'           | '*'                                    | '1'                                    | '*'                                    | ''                                     | 'en description is empty'              | ''                                     | 'No'                    | ''                 | ''                 |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			...
			| ''                                      | 'b174d88c-b83f-4cc3-b6fa-ac5538c4600d' | '06c243aa-3ec3-4301-b062-21c7beb30762' | '38b2c2be-7923-4d4d-aa7c-45d626cd73f2' | '$$SalesOrder01$$'                     | '06c243aa-3ec3-4301-b062-21c7beb30762' | '06c243aa-3ec3-4301-b062-21c7beb30762' | ''                                     | ''                      | 'pcs'              | ''                 |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| 'Register  "TM1010B Row ID movements"'  | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Period'                               | 'RecordType'                           | 'Row ref'                              | 'Row ID'                               | 'Step'                                 | 'Basis'                                | 'Basis key'                            | 'Quantity'              | ''                 | ''                 |
			| ''                                      | '*'                                    | 'Receipt'                              | '06c243aa-3ec3-4301-b062-21c7beb30762' | '06c243aa-3ec3-4301-b062-21c7beb30762' | 'SI&SC'                                | '$$ShipmentPlaningOrder01$$'           | 'b174d88c-b83f-4cc3-b6fa-ac5538c4600d' | '1 000'                 | ''                 | ''                 |
...
Scenario: _052304 create SPO with different Store
	...
	* Check registers
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "Posted documents registry"' | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Document'                             | 'Date'                                 | 'Number'                               | 'Create date'                          | 'Modify date'                          | 'Author'                               | 'Editor'                               | 'Manual movements edit' | ''                 | ''                 |
			| ''                                      | '$$ShipmentPlaningOrder02$$'           | '*'                                    | '2'                                    | '*'                                    | ''                                     | 'en description is empty'              | ''                                     | 'No'                    | ''                 | ''                 |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| 'Register  "R9610 Shipment planing"'    | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Period'                               | 'Company'                              | 'Branch'                               | 'Partner'                              | 'Store'                                | 'Item key'                             | 'Source of origin'                     | 'Order'                 | 'Planned quantity' | 'Shipped quantity' |
			...
			| 'Register  "T3010S Row ID info"'        | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Key'                                  | 'Row ID'                               | 'Unique ID'                            | 'Basis'                                | 'Basis key'                            | 'Row ref'                              | 'Price'                                | 'Currency'              | 'Unit'             | ''                 |
			| ''                                      | '4d76926f-ae66-4047-9a84-8cc1bf60d4d4' | '2caf9482-91cd-4774-903e-b820d89d760f' | '1ac7614f-1d34-44f2-9fe6-5461dded23f2' | '$$SalesOrder02$$'                     | '2caf9482-91cd-4774-903e-b820d89d760f' | '2caf9482-91cd-4774-903e-b820d89d760f' | ''                                     | ''                      | 'pcs'              | ''                 |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| 'Register  "TM1010B Row ID movements"'  | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Period'                               | 'RecordType'                           | 'Row ref'                              | 'Row ID'                               | 'Step'                                 | 'Basis'                                | 'Basis key'                            | 'Quantity'              | ''                 | ''                 |
			| ''                                      | '*'                                    | 'Receipt'                              | '2caf9482-91cd-4774-903e-b820d89d760f' | '2caf9482-91cd-4774-903e-b820d89d760f' | 'SI&SC'                                | '$$ShipmentPlaningOrder02$$'           | '4d76926f-ae66-4047-9a84-8cc1bf60d4d4' | '1 500'                 | ''                 | ''                 |
...
Scenario: _052305 create SPO with different ItemKey
	...
	* Check registers
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "Posted documents registry"' | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Document'                             | 'Date'                                 | 'Number'                               | 'Create date'                          | 'Modify date'                          | 'Author'                               | 'Editor'                               | 'Manual movements edit' | ''                 | ''                 |
			| ''                                      | '$$ShipmentPlaningOrder03$$'           | '22.04.2025 14:07:21'                  | '3'                                    | '*'                                    | ''                                     | 'en description is empty'              | ''                                     | 'No'                    | ''                 | ''                 |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| 'Register  "R9610 Shipment planing"'    | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Period'                               | 'Company'                              | 'Branch'                               | 'Partner'                              | 'Store'                                | 'Item key'                             | 'Source of origin'                     | 'Order'                 | 'Planned quantity' | 'Shipped quantity' |
			...
			| 'Register  "T3010S Row ID info"'        | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Key'                                  | 'Row ID'                               | 'Unique ID'                            | 'Basis'                                | 'Basis key'                            | 'Row ref'                              | 'Price'                                | 'Currency'              | 'Unit'             | ''                 |
			| ''                                      | '6e9fa838-f5cf-4ba1-ac32-68b85de47b27' | '9dd30e29-95d5-4e48-8c03-2dbf2b1b8ef8' | '3cb0a2b7-27cb-4bea-8b8a-d247dac08850' | '$$SalesOrder03$$'                     | '9dd30e29-95d5-4e48-8c03-2dbf2b1b8ef8' | '9dd30e29-95d5-4e48-8c03-2dbf2b1b8ef8' | ''                                     | ''                      | 'pcs'              | ''                 |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| 'Register  "TM1010B Row ID movements"'  | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''                 | ''                 |
			| ''                                      | 'Period'                               | 'RecordType'                           | 'Row ref'                              | 'Row ID'                               | 'Step'                                 | 'Basis'                                | 'Basis key'                            | 'Quantity'              | ''                 | ''                 |
			| ''                                      | '*'                                    | 'Receipt'                              | '9dd30e29-95d5-4e48-8c03-2dbf2b1b8ef8' | '9dd30e29-95d5-4e48-8c03-2dbf2b1b8ef8' | 'SI&SC'                                | '$$ShipmentPlaningOrder03$$'           | '6e9fa838-f5cf-4ba1-ac32-68b85de47b27' | '5 000'                 | ''                 | ''                 |
...
Scenario: _052306 create SPO
	...
	* Check registers
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "Posted documents registry"' | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''     |
			| ''                                      | 'Document'                             | 'Date'                                 | 'Number'                               | 'Create date'                          | 'Modify date'                          | 'Author'                               | 'Editor'                               | 'Manual movements edit' | ''     |
			| ''                                      | '$$ShipmentPlaningOrder04$$'           | '*'                                    | '4'                                    | '*'                                    | ''                                     | 'en description is empty'              | ''                                     | 'No'                    | ''     |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''     |
			| 'Register  "T3010S Row ID info"'        | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''     |
			| ''                                      | 'Key'                                  | 'Row ID'                               | 'Unique ID'                            | 'Basis'                                | 'Basis key'                            | 'Row ref'                              | 'Price'                                | 'Currency'              | 'Unit' |
			| ''                                      | '4402c245-0f76-49ac-80ca-95fdf5c0145f' | '4402c245-0f76-49ac-80ca-95fdf5c0145f' | '1d245033-6d44-48cb-b309-e94cf79b522d' | ''                                     | '                                    ' | '4402c245-0f76-49ac-80ca-95fdf5c0145f' | ''                                     | ''                      | 'pcs'  |
			| ''                                      | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''     |
			| 'Register  "TM1010B Row ID movements"'  | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                                     | ''                      | ''     |
			| ''                                      | 'Period'                               | 'RecordType'                           | 'Row ref'                              | 'Row ID'                               | 'Step'                                 | 'Basis'                                | 'Basis key'                            | 'Quantity'              | ''     |
			| ''                                      | '*'                                    | 'Receipt'                              | '4402c245-0f76-49ac-80ca-95fdf5c0145f' | '4402c245-0f76-49ac-80ca-95fdf5c0145f' | 'SI&SC'                                | '$$ShipmentPlaningOrder04$$'           | '4402c245-0f76-49ac-80ca-95fdf5c0145f' | '10 000'                | ''     |
	And I close all client application windows		
