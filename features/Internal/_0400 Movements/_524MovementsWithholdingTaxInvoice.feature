...
Scenario: _052411 check With holding Tax Invoice movements by register "T1040 Accounting amounts"
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                    | '01.05.2025 13:00:00' | '6b2d9f85-c6d7-43b6-98d1-19eb1f80424a' | 'en description is empty' | 'Local currency'               | 'TRY'      | ''                    | ''            | 'TRY'         | '150'    | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '01.05.2025 13:00:00' | '6b2d9f85-c6d7-43b6-98d1-19eb1f80424a' | 'en description is empty' | 'Reporting currency'           | 'USD'      | ''                    | ''            | 'TRY'         | '25,68'  | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '01.05.2025 13:00:00' | '6b2d9f85-c6d7-43b6-98d1-19eb1f80424a' | 'en description is empty' | 'en description is empty'      | 'TRY'      | ''                    | ''            | 'TRY'         | '150'    | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '01.05.2025 13:00:00' | '6b2d9f85-c6d7-43b6-98d1-19eb1f80424a' | 'en description is empty' | 'Local currency'               | 'TRY'      | ''                    | ''            | 'TRY'         | '22,88'  | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '01.05.2025 13:00:00' | '6b2d9f85-c6d7-43b6-98d1-19eb1f80424a' | 'en description is empty' | 'Reporting currency'           | 'USD'      | ''                    | ''            | 'TRY'         | '3,92'   | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '01.05.2025 13:00:00' | '6b2d9f85-c6d7-43b6-98d1-19eb1f80424a' | 'en description is empty' | 'en description is empty'      | 'TRY'      | ''                    | ''            | 'TRY'         | '22,88'  | ''                   | ''                   | 'No'                   | ''                 |
...
Scenario: _052412 check With holding Tax Invoice movements by register "T2015 Transactions info"
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                    | 'Main Company' | ''       | ''      | '01.05.2025 13:00:00' | '                                    ' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Yes'                   | 'No'                      | 'Withholding tax invoice 1 dated 01.05.2025 13:00:00' | '*'         | ''        | 'en description is empty' | 'TRY'                  | '150'    | 'Yes'    | 'No'      |
	And I close all client application windows		
...
Scenario: _052421 check With holding Tax Invoice movements by register "T1040 Accounting amounts" (transaction currency not equal local currency)
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T1040 Accounting amounts"'                | ''                    | ''                                     | ''                        | ''                             | ''         | ''                    | ''            | ''            | ''       | ''                   | ''                   | ''                     | ''                 |
			| ''                                                    | 'Period'              | 'Row key'                              | 'Operation'               | 'Multi currency movement type' | 'Currency' | 'Revaluated currency' | 'Dr currency' | 'Cr currency' | 'Amount' | 'Dr currency amount' | 'Cr currency amount' | 'Deferred calculation' | 'Advances closing' |
			| ''                                                    | '25.09.2025 18:12:10' | 'e91395fd-86de-46b8-83ff-7982831daa48' | 'en description is empty' | 'Local currency'               | 'TRY'      | ''                    | ''            | 'TRY'         | '844,13' | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '25.09.2025 18:12:10' | 'e91395fd-86de-46b8-83ff-7982831daa48' | 'en description is empty' | 'Reporting currency'           | 'USD'      | ''                    | ''            | 'TRY'         | '150'    | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '25.09.2025 18:12:10' | 'e91395fd-86de-46b8-83ff-7982831daa48' | 'en description is empty' | 'en description is empty'      | 'USD'      | ''                    | ''            | 'TRY'         | '150'    | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '25.09.2025 18:12:10' | 'e91395fd-86de-46b8-83ff-7982831daa48' | 'en description is empty' | 'Local currency'               | 'TRY'      | ''                    | ''            | 'TRY'         | '128,76' | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '25.09.2025 18:12:10' | 'e91395fd-86de-46b8-83ff-7982831daa48' | 'en description is empty' | 'Reporting currency'           | 'USD'      | ''                    | ''            | 'TRY'         | '22,88'  | ''                   | ''                   | 'No'                   | ''                 |
			| ''                                                    | '25.09.2025 18:12:10' | 'e91395fd-86de-46b8-83ff-7982831daa48' | 'en description is empty' | 'en description is empty'      | 'USD'      | ''                    | ''            | 'TRY'         | '22,88'  | ''                   | ''                   | 'No'                   | ''                 |
...
Scenario: _052422 check With holding Tax Invoice movements by register "T2015 Transactions info" (transaction currency not equal local currency)
	...
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| 'Register  "T2015 Transactions info"'                 | ''             | ''       | ''      | ''                    | ''                                     | ''         | ''          | ''                  | ''                   | ''                      | ''                        | ''                                                    | ''          | ''        | ''                        | ''                     | ''       | ''       | ''        |
			| ''                                                    | 'Company'      | 'Branch' | 'Order' | 'Date'                | 'Key'                                  | 'Currency' | 'Partner'   | 'Legal name'        | 'Agreement'          | 'Is vendor transaction' | 'Is customer transaction' | 'Transaction basis'                                   | 'Unique ID' | 'Project' | 'Currency movement type'  | 'Transaction currency' | 'Amount' | 'Is due' | 'Is paid' |
			| ''                                                    | 'Main Company' | ''       | ''      | '25.09.2025 18:12:10' | '                                    ' | 'USD'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Yes'                   | 'No'                      | 'Withholding tax invoice 6 dated 25.09.2025 18:12:10' | '*'         | ''        | 'en description is empty' | 'USD'                  | '150'    | 'Yes'    | 'No'      |
	And I close all client application windows		
