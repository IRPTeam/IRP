...
Scenario: _060005 create Purchase invoice with the type of settlements under standard contracts and check its movements
	...
	* Check Purchase Invoice movements 
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                       | 'Receipt'     | '*'      | '1 883,2'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
		And I close all client application windows
	...
	* Create Cash payment
		...
		* Filling in the tabular part
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                       | 'Record type' | 'Period' | 'Resources' | 'Dimensions'   | ''                             | ''         | ''                 | ''        | ''                                           | ''      | 'Attributes'           | ''                  |
			| ''                                       | ''            | ''       | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name'       | 'Partner' | 'Agreement'                                  | 'Basis' | 'Deferred calculation' | 'Vendors advances closing' |
			| ''                                       | 'Expense'     | '*'      | '1 883,2'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Veritas ' | 'Veritas' | 'Posting by Standard Partner term (Veritas)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Posting by Standard Partner term (Veritas)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Posting by Standard Partner term (Veritas)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Posting by Standard Partner term (Veritas)' | ''      | 'No'                   | ''                |
		And I close all client application windows
	...
	* Create Bank payment
		...
		* Filling in the tabular part
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                       | 'Record type' | 'Period' | 'Resources' | 'Dimensions'   | ''                             | ''         | ''                 | ''        | ''                  | ''      | 'Attributes'           | ''                  |
			| ''                                       | ''            | ''       | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name'       | 'Partner' | 'Agreement'         | 'Basis' | 'Deferred calculation' | 'Vendors advances closing' |
			| ''                                       | 'Expense'     | '*'      | '1 883,2'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Veritas ' | 'Veritas' | 'Standard (Vendor)' | ''      | 'No'                   | ''                |
		And I close all client application windows
