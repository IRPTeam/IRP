	...
	* Create Sales invoice
		...
		* Check Sales invoice movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                        | 'Receipt'     | '*'      | '1 883,2'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
				| ''                                        | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
				| ''                                        | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
				| ''                                        | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
...
Scenario: _060203 create Cash receipt (partner term with Ar details by partner term) and check its movements
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                        | 'Record type' | 'Period' | 'Resources' | 'Dimensions'   | ''                             | ''         | ''                | ''                | ''                         | ''      | 'Attributes'           | ''                  |
			| ''                                        | ''            | ''       | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name'      | 'Partner'         | 'Agreement'                | 'Basis' | 'Deferred calculation' | 'Offset of advance' |
			| ''                                        | 'Expense'     | '*'      | '1 883,2'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
			| ''                                        | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
			| ''                                        | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
			| ''                                        | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | 'No'                |
		And I close all client application windows
...
Scenario: _060205 create Purchase invoice with Ap details by Partner terms and check its movements
	...
	* Check Purchase Invoice movements 
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                       | 'Record type' | 'Period' | 'Resources' | 'Dimensions'   | ''                             | ''         | ''                  | ''                 | ''                | ''      | 'Attributes'           | ''                  |
			| ''                                       | ''            | ''       | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name'        | 'Partner'          | 'Agreement'       | 'Basis' | 'Deferred calculation' | 'Offset of advance' |
			| ''                                       | 'Receipt'     | '*'      | '1 883,2'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
			| ''                                       | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
			| ''                                       | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
			| ''                                       | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
		And I close all client application windows
	...
	* Create Cash payment
		...
		* Filling in the tabular part
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                       | 'Record type' | 'Period' | 'Resources' | 'Dimensions'   | ''                             | ''         | ''                  | ''                 | ''                | ''      | 'Attributes'           | ''                  |
			| ''                                       | ''            | ''       | 'Amount'    | 'Company'      | 'Multi currency movement type' | 'Currency' | 'Legal name'        | 'Partner'          | 'Agreement'       | 'Basis' | 'Deferred calculation' | 'Offset of advance' |
			| ''                                       | 'Expense'     | '*'      | '1 883,2'   | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
			| ''                                       | 'Expense'     | '*'      | '11 000'    | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Partner Ferron 1' | 'Vendor Ferron 1' | ''      | 'No'                   | 'No'                |
