	...
	* Create Sales invoice
		...
		* Check Sales invoice movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                        | 'Receipt'     | '*'      | '1 883,2'   | 'Main Company' | '*'      | 'Reporting currency'           | 'USD'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
				| ''                                        | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | '*'      | 'Local currency'               | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
				| ''                                        | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | '*'      | 'TRY'                          | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
				| ''                                        | 'Receipt'     | '*'      | '11 000'    | 'Main Company' | '*'      | 'en description is empty'      | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
...
Scenario: _060203 create Cash receipt (partner term with Ar details by partner term) and check its movements
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                        | 'Record type' | 'Period' | 'Resources' | 'Dimensions'   | ''       | ''                             | ''         | ''                | ''                | ''                         | ''      | 'Attributes'           | ''                           |
			| ''                                        | ''            | ''       | 'Amount'    | 'Company'      | 'Branch' | 'Multi currency movement type' | 'Currency' | 'Legal name'      | 'Partner'         | 'Agreement'                | 'Basis' | 'Deferred calculation' | 'Customers advances closing' |
			| ''                                        | 'Expense'     | '*'      | '1 883,2'   | 'Main Company' | '*'      | 'Reporting currency'           | 'USD'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
			| ''                                        | 'Expense'     | '*'      | '11 000'    | 'Main Company' | '*'      | 'Local currency'               | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
			| ''                                        | 'Expense'     | '*'      | '11 000'    | 'Main Company' | '*'      | 'TRY'                          | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
			| ''                                        | 'Expense'     | '*'      | '11 000'    | 'Main Company' | '*'      | 'en description is empty'      | 'TRY'      | 'Company Kalipso' | 'Partner Kalipso' | 'Partner Kalipso Customer' | ''      | 'No'                   | ''                           |
		And I close all client application windows
