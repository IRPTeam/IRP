...
Scenario: _018019 check the output of the document movement report for Purchase Invoice
	...
	* Check the report generation
		...
		| ''                                     | '*'           | '100'       | '20 000'        | '16 949,15'    | 'Main Company'        | 'Purchase invoice 1*' | 'TRY'               | 'M/White'            | '*'                       | 'en description is empty.' | 'No'                   | ''                         | ''                     |
		...
		| ''                                     | '*'           | '200'       | '42 000'        | '35 593,22'    | 'Main Company'        | 'Purchase invoice 1*' | 'TRY'               | 'L/Green'            | '*'                       | 'en description is empty.' | 'No'                   | ''                         | ''                     |
		...
		| ''                                     | '*'           | '300'       | '75 000'        | '63 559,32'    | 'Main Company'        | 'Purchase invoice 1*' | 'TRY'               | '36/Yellow'          | '*'                       | 'en description is empty.' | 'No'                   | ''                         | ''                     |
		...
		| ''                                     | '*'           | '3 050,85'  | '3 050,85'      | '16 949,15'    | 'Purchase invoice 1*' | 'VAT'                 | ''                  | '18%'                | 'Yes'                     | '*'                        | 'TRY'                  | 'en description is empty.' | 'No'                   |
		...
		| ''                                     | '*'           | '6 406,78'  | '6 406,78'      | '35 593,22'    | 'Purchase invoice 1*' | 'VAT'                 | ''                  | '18%'                | 'Yes'                     | '*'                        | 'TRY'                  | 'en description is empty.' | 'No'                   |
		...
		| ''                                     | '*'           | '11 440,68' | '11 440,68'     | '63 559,32'    | 'Purchase invoice 1*' | 'VAT'                 | ''                  | '18%'                | 'Yes'                     | '*'                        | 'TRY'                  | 'en description is empty.' | 'No'                   |
		...
		| ''                                     | 'Receipt'     | '*'         | '137 000'       | 'Main Company' | 'Purchase invoice 1*' | 'Ferron BP'           | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'TRY'                     | 'en description is empty.' | 'No'                   | ''                         | ''                     |
...
Scenario: _022011 check the output of the document movement report for Purchase return order
	...
	* Check the report generation
		...
		| ''                               | '*'           | '-2'        | '-80'       | ''           | 'Main Company'             | 'Purchase invoice 2*' | 'USD'      | 'L/Green'  | '*'       | 'en description is empty.' | 'No'                   |
...
Scenario: _024043 check the output of the document movement report for Sales Invoice
	...
	* Check the report generation
		...
		| ''                                           | 'Receipt'     | '*'         | '4 350'         | 'Main Company'  | 'Sales invoice 1*'  | 'Ferron BP'    | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'TRY'                      | 'en description is empty.' | 'No'                       | ''                         | ''                     |
		...
		| ''                                           | '*'           | '244,07'    | '244,07'        | '1 355,93'      | 'Sales invoice 1*'  | 'VAT'          | ''                  | '18%'                   | 'Yes'                      | '*'                        | 'TRY'                      | 'en description is empty.' | 'No'                   |
		...
		| ''                                           | '*'           | '419,49'    | '419,49'        | '2 330,51'      | 'Sales invoice 1*'  | 'VAT'          | ''                  | '18%'                   | 'Yes'                      | '*'                        | 'TRY'                      | 'en description is empty.' | 'No'                   |
		...
		| ''                                           | '*'           | '4'         | '1 600'         | '1 355,93'      | ''                  | 'Main Company' | 'Sales invoice 1*'  | 'TRY'                   | '36/Yellow'                | '*'                        | 'en description is empty.' | 'No'                       | ''                     |
		...
		| ''                                           | '*'           | '5'         | '2 750'         | '2 330,51'      | ''                  | 'Main Company' | 'Sales invoice 1*'  | 'TRY'                   | 'L/Green'                  | '*'                        | 'en description is empty.' | 'No'                       | ''                     |
...
Scenario: _028013 check the output of the document movement report for Sales Return Order
	...
	* Check the report generation
		...
		| ''                               | 'Period'      | 'Resources' | ''          | ''           | ''                      | 'Dimensions'   | ''                 | ''         | ''         | ''        | ''                         | 'Attributes'           |
		| ''                               | ''            | 'Quantity'  | 'Amount'    | 'Net amount' | 'Offers amount'         | 'Company'      | 'Sales invoice'    | 'Currency' | 'Item key' | 'Row key' | 'Multi currency movement type'   | 'Deferred calculation' |
		| ''                               | '*'           | '-1'        | '-550'      | ''           | ''                      | 'Main Company' | 'Sales invoice 2*' | 'TRY'      | 'L/Green'  | '*'       | 'en description is empty.' | 'No'                   |
...
Scenario: _023023 check the output of the document movement report for Sales Order
	...
	* Check the report generation
		...
		| ''                                           | '*'           | '4'         | '1 600'     | 'Main Company' | 'Sales order 1*' | 'TRY'       | '36/Yellow' | '*'       | 'en description is empty.' | 'No'                   |
		...
		| ''                                           | '*'           | '5'         | '2 750'     | 'Main Company' | 'Sales order 1*' | 'TRY'       | 'L/Green'   | '*'       | 'en description is empty.' | 'No'                   |
