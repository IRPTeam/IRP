	...
	* Сhange the quantity and check that the quantity of the serial lot numbers matches the quantity in the document
		...
		* Delete 1 serial lot number
			...
			And "ItemList" table became equal
				...
				| '1' | 'Retail sales receipt 1 dated 26.08.2022 11:21:53' | 'Trousers' | ''             | ''                   | '38/Yellow' | 'No'                 | '99098809009998'     | 'pcs'  | '122,03'     | '2,000'    | '400,00' | '677,97'     | '800,00'       | ''                    | 'Store 01' | ''              | ''             | ''       | '18%' | ''              | ''            |
				| '2' | 'Retail sales receipt 1 dated 26.08.2022 11:21:53' | 'Boots'    | ''             | ''                   | '38/18SD'   | 'No'                 | ''                   | 'pcs'  | '99,15'      | '1,000'    | '650,00' | '550,85'     | '650,00'       | ''                    | 'Store 01' | ''              | ''             | ''       | '18%' | ''              | ''            |
				| '3' | 'Retail sales receipt 1 dated 26.08.2022 11:21:53' | 'Boots'    | ''             | ''                   | '37/18SD'   | 'No'                 | ''                   | 'pcs'  | '106,78'     | '1,000'    | '700,00' | '593,22'     | '700,00'       | ''                    | 'Store 01' | ''              | ''             | ''       | '18%' | ''              | ''            |	
		* Change serial/lot numbers quantity to 3
			And I go to line in "ItemList" table
				| 'Item'     | 'Item key'  |
				| 'Trousers' | '38/Yellow' |
	...
	* Сhange the quantity and check that the quantity of the serial lot numbers matches the quantity in the document
		...
		* Delete 1 serial lot number
			...
			And "ItemList" table became equal
				...
				| '1' | 'Trousers' | '38/Yellow' | ''                   | 'No'                 | '122,03'     | 'pcs'  | '99098809009911'     | '2,000'    | 'Sales invoice 1 030 dated 26.08.2022 11:31:52' | '400,00' | '677,97'     | 'No'                | '800,00'       | ''                    | 'Store 01' | ''                   | ''              | ''             | '18%' | ''              | ''            | ''             |
				| '2' | 'Boots'    | '38/18SD'   | ''                   | 'No'                 | '105,59'     | 'pcs'  | ''                   | '1,000'    | 'Sales invoice 1 030 dated 26.08.2022 11:31:52' | '650,00' | '544,41'     | 'No'                | '650,00'       | ''                    | 'Store 01' | ''                   | ''              | ''             | '18%' | ''              | ''            | ''             |
				| '3' | 'Boots'    | '37/18SD'   | ''                   | 'No'                 | '113,71'     | 'pcs'  | ''                   | '1,000'    | 'Sales invoice 1 030 dated 26.08.2022 11:31:52' | '700,00' | '586,29'     | 'No'                | '700,00'       | ''                    | 'Store 01' | ''                   | ''              | ''             | '18%' | ''              | ''            | ''             |	
		* Change serial/lot numbers quantity to 3
			And I go to line in "ItemList" table
				| 'Item'     | 'Item key'  |
				| 'Trousers' | '38/Yellow' |
...
Scenario: _092008 check serial lot number in the Opening entry
	...
	* Post Opening entry and check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period'                     | 'Resources' | 'Dimensions'   | ''       | ''          | ''          | ''                  |
			| ''                                     | ''            | ''                           | 'Quantity'  | 'Company'      | 'Branch' | 'Store'     | 'Item key'  | 'Serial lot number' |
			| ''                                     | 'Receipt'     | '$$DateOpeningEntry092008$$' | '1'         | 'Main Company' | '*'      | 'Store 01'  | '38/Yellow' | '99098809009999'    |
		And I close current window
	...
	* Change quantity, post document and check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period'                     | 'Resources' | 'Dimensions'   | ''       | ''         | ''          | ''                  |
			| ''                                     | ''            | ''                           | 'Quantity'  | 'Company'      | 'Branch' | 'Store'    | 'Item key'  | 'Serial lot number' |
			| ''                                     | 'Receipt'     | '$$DateOpeningEntry092008$$' | '5'         | 'Main Company' | '*'      | 'Store 01' | '38/Yellow' | '99098809009999'    |
		And I close current window
	* Add one more string with the same item and different Serial lot number
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | ''            | ''                           | 'Quantity'  | 'Company'      | 'Branch' | 'Store'    | 'Item key'  | 'Serial lot number' |
			| ''                                     | 'Receipt'     | '$$DateOpeningEntry092008$$' | '5'         | 'Main Company' | '*'      | 'Store 01' | '38/Yellow' | '99098809009999'    |
			| ''                                     | 'Receipt'     | '$$DateOpeningEntry092008$$' | '8'         | 'Main Company' | '*'      | 'Store 01' | '38/Yellow' | '99098809009910'    |
		And I close all client application windows
