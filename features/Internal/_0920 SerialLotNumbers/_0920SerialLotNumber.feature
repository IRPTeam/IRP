	...
	* Сhange the quantity and check that the quantity of the serial lot numbers matches the quantity in the document
		...
		* Add one more serial lot number
			...
			* Create serial lot number for item
			...
			And I click "Ok" button
			And "ItemList" table became equal
				| '#'    | 'Revenue type'    | 'Price type'           | 'Item'        | 'Item key'     | 'Profit loss center'    | 'Dont calculate row'    | 'Tax amount'    | 'Serial lot numbers'                | 'Unit'    | 'Quantity'    | 'Price'     | 'VAT'    | 'Offers amount'    | 'Net amount'    | 'Total amount'    | 'Other period revenue type'   | 'Additional analytic'    | 'Store'       | 'Delivery date'    | 'Use shipment confirmation'    | 'Detail'    | 'Sales order'    | 'Sales person'     |
				| '1'    | ''                | 'Basic Price Types'    | 'Trousers'    | '38/Yellow'    | ''                      | 'No'                    | '244,07'        | '99098809009910; 99098809009911'    | 'pcs'     | '4,000'       | '400,00'    | '18%'    | ''                 | '1 355,93'      | '1 600,00'        | ''                     | ''                       | 'Store 01'    | ''                 | 'No'                           | ''          | ''               | ''                 |
				| '2'    | ''                | 'Basic Price Types'    | 'Boots'       | '38/18SD'      | ''                      | 'No'                    | '99,15'         | ''                                  | 'pcs'     | '1,000'       | '650,00'    | '18%'    | ''                 | '550,85'        | '650,00'          | ''                     | ''                       | 'Store 01'    | ''                 | 'No'                           | ''          | ''               | ''                 |
		* Change serial/lot numbers quantity to 3
			And I go to line in "ItemList" table
				| 'Item'        | 'Item key'      |
				| 'Trousers'    | '38/Yellow'     |
		...
		* Add one more serial lot number
			...
			* Create serial lot number for item
			...
			And "ItemList" table became equal
				...
				| '1'    | 'en description is empty'    | 'Trousers'    | '38/Yellow'    | ''                      | 'No'                    | '244,07'        | 'pcs'     | '990988090099992; 99098809009908'   | '400,00'    | '18%'    | ''                 | '1 600,00'        | ''                       | ''                           | 'Store 01'    | ''                 | '4,000'       | ''                            | ''                | ''                  | ''          | ''               | '1 355,93'      | 'No'                    |
				| '2'    | 'en description is empty'    | 'Boots'       | '38/18SD'      | ''                      | 'No'                    | '106,78'        | 'pcs'     | ''                                  | '700,00'    | '18%'    | ''                 | '700,00'          | ''                       | ''                           | 'Store 01'    | ''                 | '1,000'       | ''                            | ''                | ''                  | ''          | ''               | '593,22'        | 'No'                    |
		* Change serial/lot numbers quantity to 3
			And I go to line in "ItemList" table
				| 'Item'        | 'Item key'      |
				| 'Trousers'    | '38/Yellow'     |
