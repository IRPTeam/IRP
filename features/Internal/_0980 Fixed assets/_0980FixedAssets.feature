...
Scenario: _9800035 check F0012_DepreciationStatement report
	...
	* Check
		Then "Result" spreadsheet document is equal
			...
			| 'Computer Servers'        | '985'                             | '1, 12.01.2024'    | '12.01.2024'         | 'Front office'            | 'Arina Brown'        | ''                  | 'Computer Hardware (with deprecation)'        | 'Straight line (36 months)'     | '5 000,00'     | '-416,67'         | ''                    | '-416,67'         |
			...
			| 'Office Furniture'        | '947'                             | '2, 03.02.2024'    | '03.02.2024'         | 'Front office'            | 'Arina Brown'        | ''                  | 'Furniture and Fixtures (with deprecation)'   | 'Declining balance (60 months)' | '7 000,00'     | '4 861,11'        | ''                    | '5 711,11'        |
			...
			| 'Office Furniture'        | '947'                             | '2, 03.02.2024'    | '03.02.2024'         | 'Distribution department' | 'Anna Petrova'       | ''                  | 'Furniture and Fixtures (with deprecation)'   | 'Declining balance (60 months)' | '7 000,00'     | '4 861,11'        | ''                    | '5 711,11'        |
