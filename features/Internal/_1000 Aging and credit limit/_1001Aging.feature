...
Scenario: _1000030 create Debit note without check Aging register movements
	* Create document
	...
	* Advance before invoice (Bank receipt without basis document)
		...
		* Check movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                    | 'Record type' | 'Period'                      | 'Resources' | 'Dimensions'   | ''                       | ''        | ''                | ''                                 | ''         | ''                             | 'Attributes'           |
				| ''                                    | ''            | ''                            | 'Amount'    | 'Company'      | 'Basis document'         | 'Partner' | 'Legal name'      | 'Partner term'                     | 'Currency' | 'Multi currency movement type' | 'Deferred calculation' |
				| ''                                    | 'Expense'     | '$$DateBankReceipt10000501$$' | '20,54'     | 'Main Company' | '$$SalesInvoice024016$$' | 'Kalipso' | 'Company Kalipso' | 'Basic Partner terms, without VAT' | 'USD'      | 'Reporting currency'           | 'No'                   |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                   | 'Record type' | 'Period'                      | 'Resources' | 'Dimensions'   | ''        | ''                | ''         | ''                        | ''                             | 'Attributes'           | '' |
				| ''                                   | ''            | ''                            | 'Amount'    | 'Company'      | 'Partner' | 'Legal name'      | 'Currency' | 'Receipt document'        | 'Multi currency movement type' | 'Deferred calculation' | '' |
				| ''                                   | 'Receipt'     | '$$DateBankReceipt10000501$$' | '94,16'     | 'Main Company' | 'Kalipso' | 'Company Kalipso' | 'USD'      | '$$BankReceipt10000501$$' | 'Reporting currency'           | 'No'                   | '' |
				...
				| ''                                   | 'Expense'     | '$$DateBankReceipt10000501$$' | '20,54'     | 'Main Company' | 'Kalipso' | 'Company Kalipso' | 'USD'      | '$$BankReceipt10000501$$' | 'Reporting currency'           | 'No'                   | '' |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                     | 'Record type' | 'Period'                      | 'Resources'            | 'Dimensions'     | ''                       | ''                                 | ''                             | 'Attributes'                       | ''                             | ''                             | ''                     |
				| ''                                     | ''            | ''                            | 'Amount'               | 'Company'        | 'Account'                | 'Currency'                         | 'Multi currency movement type' | 'Deferred calculation'             | ''                             | ''                             | ''                     |
				| ''                                     | 'Receipt'     | '$$DateBankReceipt10000501$$' | '94,16'                | 'Main Company'   | 'Bank account, TRY'      | 'USD'                              | 'Reporting currency'           | 'No'                               | ''                             | ''                             | ''                     |
	...
	* Create Sales invoice
		...
		* Check movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                    | 'Record type' | 'Period'                      | 'Resources' | 'Dimensions'   | ''                        | ''        | ''                | ''                                 | ''         | ''                             | 'Attributes'           | '' | '' |
				| ''                                    | ''            | ''                            | 'Amount'    | 'Company'      | 'Basis document'          | 'Partner' | 'Legal name'      | 'Partner term'                     | 'Currency' | 'Multi currency movement type' | 'Deferred calculation' | '' | '' |
				| ''                                    | 'Receipt'     | '$$DateSalesInvoice0240164$$' | '94,16'     | 'Main Company' | '$$SalesInvoice0240164$$' | 'Kalipso' | 'Company Kalipso' | 'Basic Partner terms, without VAT' | 'USD'      | 'Reporting currency'           | 'No'                   | '' | '' |
				...
				| ''                                    | 'Expense'     | '$$DateSalesInvoice0240164$$' | '73,62'     | 'Main Company' | '$$SalesInvoice0240164$$' | 'Kalipso' | 'Company Kalipso' | 'Basic Partner terms, without VAT' | 'USD'      | 'Reporting currency'           | 'No'                   | '' | '' |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                            | '$$DateSalesInvoice0240164$$' | '14,36'     | '14,36'         | '79,8'       | '$$SalesInvoice0240164$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'USD'      | 'Reporting currency'           | 'No'                   |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                            | '$$DateSalesInvoice0240164$$' | '1'         | '94,16'  | '79,8'       | ''              | 'Main Company' | '$$SalesInvoice0240164$$' | 'USD'      | 'L/Green'  | '*'       | 'Reporting currency'           | ''                  | 'No'                   |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                               | 'Period'                      | 'Resources' | 'Dimensions'   | ''              | ''             | ''         | ''         | ''                    | ''                             | 'Attributes'           | '' | '' | '' |
				| ''                               | ''                            | 'Amount'    | 'Company'      | 'Business unit' | 'Revenue type' | 'Item key' | 'Currency' | 'Additional analytic' | 'Multi currency movement type' | 'Deferred calculation' | '' | '' | '' |
				| ''                               | '$$DateSalesInvoice0240164$$' | '79,8'      | 'Main Company' | ''              | ''             | 'L/Green'  | 'USD'      | ''                    | 'Reporting currency'           | 'No'                   | '' | '' | '' |
	...
	* Create Cash receipt (advance + closed the remainder of the invoice)
		...
		* Check movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                    | 'Record type' | 'Period'                      | 'Resources' | 'Dimensions'   | ''                        | ''        | ''                | ''                                 | ''         | ''                             | 'Attributes'           |
				| ''                                    | ''            | ''                            | 'Amount'    | 'Company'      | 'Basis document'          | 'Partner' | 'Legal name'      | 'Partner term'                     | 'Currency' | 'Multi currency movement type' | 'Deferred calculation' |
				| ''                                    | 'Expense'     | '$$DateCashReceipt10000505$$' | '20,54'     | 'Main Company' | '$$SalesInvoice0240164$$' | 'Kalipso' | 'Company Kalipso' | 'Basic Partner terms, without VAT' | 'USD'      | 'Reporting currency'           | 'No'                   |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                   | 'Record type' | 'Period'                      | 'Resources' | 'Dimensions'   | ''        | ''                | ''         | ''                        | ''                             | 'Attributes'           | '' |
				| ''                                   | ''            | ''                            | 'Amount'    | 'Company'      | 'Partner' | 'Legal name'      | 'Currency' | 'Receipt document'        | 'Multi currency movement type' | 'Deferred calculation' | '' |
				| ''                                   | 'Receipt'     | '$$DateCashReceipt10000505$$' | '94,16'     | 'Main Company' | 'Kalipso' | 'Company Kalipso' | 'USD'      | '$$CashReceipt10000505$$' | 'Reporting currency'           | 'No'                   | '' |
				...
				| ''                                   | 'Expense'     | '$$DateCashReceipt10000505$$' | '20,54'     | 'Main Company' | 'Kalipso' | 'Company Kalipso' | 'USD'      | '$$CashReceipt10000505$$' | 'Reporting currency'           | 'No'                   | '' |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                     | 'Record type' | 'Period'                      | 'Resources'            | 'Dimensions'     | ''                        | ''                                 | ''                             | 'Attributes'                       | ''                             | ''                             | ''                     |
				| ''                                     | ''            | ''                            | 'Amount'               | 'Company'        | 'Account'                 | 'Currency'                         | 'Multi currency movement type' | 'Deferred calculation'             | ''                             | ''                             | ''                     |
				| ''                                     | 'Receipt'     | '$$DateCashReceipt10000505$$' | '94,16'                | 'Main Company'   | 'Cash desk №4'            | 'USD'                              | 'Reporting currency'           | 'No'                               | ''                             | ''                             | ''                     |
	...
	* Create Sales invoice
		...
		* Check movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                    | 'Record type' | 'Period'                      | 'Resources' | 'Dimensions'   | ''                        | ''        | ''                | ''                                 | ''         | ''                             | 'Attributes'           | '' | '' |
				| ''                                    | ''            | ''                            | 'Amount'    | 'Company'      | 'Basis document'          | 'Partner' | 'Legal name'      | 'Partner term'                     | 'Currency' | 'Multi currency movement type' | 'Deferred calculation' | '' | '' |
				| ''                                    | 'Receipt'     | '$$DateSalesInvoice0240165$$' | '94,16'     | 'Main Company' | '$$SalesInvoice0240165$$' | 'Kalipso' | 'Company Kalipso' | 'Basic Partner terms, without VAT' | 'USD'      | 'Reporting currency'           | 'No'                   | '' | '' |
				...
				| ''                                    | 'Expense'     | '$$DateSalesInvoice0240165$$' | '65,06'     | 'Main Company' | '$$SalesInvoice0240165$$' | 'Kalipso' | 'Company Kalipso' | 'Basic Partner terms, without VAT' | 'USD'      | 'Reporting currency'           | 'No'                   | '' | '' |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                            | 'Period'                      | 'Resources' | ''              | ''           | 'Dimensions'              | ''    | ''          | ''         | ''                        | ''        | ''         | ''                             | 'Attributes'           |
				| ''                            | ''                            | 'Amount'    | 'Manual amount' | 'Net amount' | 'Document'                | 'Tax' | 'Analytics' | 'Tax rate' | 'Include to total amount' | 'Row key' | 'Currency' | 'Multi currency movement type' | 'Deferred calculation' |
				| ''                            | '$$DateSalesInvoice0240165$$' | '14,36'     | '14,36'         | '79,8'       | '$$SalesInvoice0240165$$' | 'VAT' | ''          | '18%'      | 'Yes'                     | '*'       | 'USD'      | 'Reporting currency'           | 'No'                   |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                            | 'Period'                      | 'Resources' | ''       | ''           | ''              | 'Dimensions'   | ''                        | ''         | ''         | ''        | ''                             | ''                  | 'Attributes'           |
				| ''                            | ''                            | 'Quantity'  | 'Amount' | 'Net amount' | 'Offers amount' | 'Company'      | 'Sales invoice'           | 'Currency' | 'Item key' | 'Row key' | 'Multi currency movement type' | 'Serial lot number' | 'Deferred calculation' |
				| ''                            | '$$DateSalesInvoice0240165$$' | '1'         | '94,16'  | '79,8'       | ''              | 'Main Company' | '$$SalesInvoice0240165$$' | 'USD'      | 'L/Green'  | '*'       | 'Reporting currency'           | ''                  | 'No'                   |
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                               | 'Period'                      | 'Resources' | 'Dimensions'   | ''              | ''             | ''         | ''         | ''                    | ''                             | 'Attributes'           | '' | '' | '' |
				| ''                               | ''                            | 'Amount'    | 'Company'      | 'Business unit' | 'Revenue type' | 'Item key' | 'Currency' | 'Additional analytic' | 'Multi currency movement type' | 'Deferred calculation' | '' | '' | '' |
				| ''                               | '$$DateSalesInvoice0240165$$' | '79,8'      | 'Main Company' | ''              | ''             | 'L/Green'  | 'USD'      | ''                    | 'Reporting currency'           | 'No'                   | '' | '' | '' |
