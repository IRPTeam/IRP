...
Scenario: _1000057 create BR based on SO (Prepaid)
	...
	* Create BR based on SO
		...
		And "PaymentList" table became equal
			| 'Partner' | '#' | 'Commission' | 'LegalName'           | 'Partner term'                     | 'Legal name contract' | 'Basis document' | 'Order'                                       | 'Total amount' | 'Financial movement type' | 'Profit loss center' | 'Cash flow center' | 'Planning transaction basis' | 'Additional analytic' | 'Commission percent' | 'Expense type' |
