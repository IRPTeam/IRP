...
Scenario: _1200057 create BP based on PO (Prepaid)
	...
	* Create BP based on PO
		...
		And "PaymentList" table became equal
			| '#' | 'Partner'   | 'LegalName'             | 'Partner term'       | 'Legal name contract' | 'Basis document' | 'Order'                                          | 'Total amount' | 'Financial movement type' | 'Profit loss center' | 'Cash flow center' | 'Planning transaction basis' | 'Additional analytic' | 'Expense type' |
