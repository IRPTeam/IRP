...
Scenario: _1002008 check PI closing by advance (Ap-Ar by partner term, payment first)
	...
	And "List" table contains lines
		...
		| '28.04.2021 21:50:00' | 'Debit note 21 dated 28.04.2021 21:50:00'        | 'TRY'      | 'Main Company' | 'Front office' | 'DFC'     | '90,00'  | 'Local currency'               | 'DFC'        | 'Debit note 21 dated 28.04.2021 21:50:00'   | 'No'                   | ''                                                     |
		| '28.04.2021 21:50:00' | 'Debit note 21 dated 28.04.2021 21:50:00'        | 'USD'      | 'Main Company' | 'Front office' | 'DFC'     | '15,41'  | 'Reporting currency'           | 'DFC'        | 'Debit note 21 dated 28.04.2021 21:50:00'   | 'No'                   | ''                                                     |
		| '28.04.2021 21:50:00' | 'Debit note 21 dated 28.04.2021 21:50:00'        | 'TRY'      | 'Main Company' | 'Front office' | 'DFC'     | '90,00'  | 'en description is empty'      | 'DFC'        | 'Debit note 21 dated 28.04.2021 21:50:00'   | 'No'                   | ''                                                     |
	And I close all client application windows
