...
Scenario: _1002003 check PI closing by advance (Ap-Ar by documents, payment first)
	...
	And "List" table contains lines
		...
		| '12.02.2021 14:00:00' | 'Credit note 11 dated 12.02.2021 14:00:00'       | 'Main Company' | 'Front office' | 'TRY'                          | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Credit note 11 dated 12.02.2021 14:00:00'       | ''                                             | ''        | '170,00'    | 'No'                   | ''                                                     |
...
Scenario: _1002012 check PI closing by advance (Ap-Ar by documents, invoice first)
	...
	And "List" table contains lines
		...
		| '30.04.2021 12:00:00' | 'Bank payment 14 dated 30.04.2021 12:00:00'      | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Maxim' | 'Maxim'   | ''      | 'Partner term Maxim' | ''        | '56,28'   | 'No'                   | ''                                                     |
		| '30.04.2021 12:00:00' | 'Bank payment 14 dated 30.04.2021 12:00:00'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'USD'                  | 'Company Maxim' | 'Maxim'   | ''      | 'Partner term Maxim' | ''        | '10,00'   | 'No'                   | ''                                                     |
		| '30.04.2021 12:00:00' | 'Bank payment 14 dated 30.04.2021 12:00:00'      | 'Main Company' | 'Front office' | 'en description is empty'      | 'USD'      | 'USD'                  | 'Company Maxim' | 'Maxim'   | ''      | 'Partner term Maxim' | ''        | '10,00'   | 'No'                   | ''                                                     |
	And I close all client application windows
