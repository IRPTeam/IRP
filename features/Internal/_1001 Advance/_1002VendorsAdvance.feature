...
Scenario: _1002003 check PI closing by advance (Ap-Ar by documents, payment first)
	...
	And "List" table contains lines
		...
		| '12.02.2021 15:13:56' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''        | '811,00'   | 'No'                   | 'Vendors advances closing 1 dated 12.02.2021 22:00:00' |
		| '12.02.2021 15:13:56' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''        | '138,84'   | 'No'                   | 'Vendors advances closing 1 dated 12.02.2021 22:00:00' |
		| '12.02.2021 15:13:56' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''        | '811,00'   | 'No'                   | 'Vendors advances closing 1 dated 12.02.2021 22:00:00' |
		...
		| '28.04.2021 00:00:00' | 'Cash payment 22 dated 28.04.2021 00:00:00'      | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''        | '1 489,00' | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:00' | 'Cash payment 22 dated 28.04.2021 00:00:00'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''        | '254,92'   | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:00' | 'Cash payment 22 dated 28.04.2021 00:00:00'      | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 119 dated 12.02.2021 16:21:23' | ''                                             | ''        | '1 011,00' | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:00' | 'Cash payment 22 dated 28.04.2021 00:00:00'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 119 dated 12.02.2021 16:21:23' | ''                                             | ''        | '173,08'   | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:00' | 'Cash payment 22 dated 28.04.2021 00:00:00'      | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''        | '1 489,00' | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:00' | 'Cash payment 22 dated 28.04.2021 00:00:00'      | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 119 dated 12.02.2021 16:21:23' | ''                                             | ''        | '1 011,00' | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:01' | 'Cash payment 23 dated 28.04.2021 00:00:01'      | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 119 dated 12.02.2021 16:21:23' | ''                                             | ''        | '589,00'   | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:01' | 'Cash payment 23 dated 28.04.2021 00:00:01'      | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 119 dated 12.02.2021 16:21:23' | ''                                             | ''        | '100,84'   | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
		| '28.04.2021 00:00:01' | 'Cash payment 23 dated 28.04.2021 00:00:01'      | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 119 dated 12.02.2021 16:21:23' | ''                                             | ''        | '589,00'   | 'No'                   | 'Vendors advances closing 4 dated 28.04.2021 22:00:00' |
	...
	And "List" table contains lines
		...
		| '12.02.2021 15:12:15' | 'Purchase invoice 117 dated 12.02.2021 15:12:15' | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | ''        | '4 470,00' | 'No'                   | 'Vendors advances closing 1 dated 12.02.2021 22:00:00' |
		| '12.02.2021 15:13:37' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | ''        | '2 300,00' | 'No'                   | 'Vendors advances closing 1 dated 12.02.2021 22:00:00' |
		| '12.02.2021 15:13:37' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'Main Company' | 'Front office' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | ''        | '393,76'   | 'No'                   | 'Vendors advances closing 1 dated 12.02.2021 22:00:00' |
		| '12.02.2021 15:13:37' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'Main Company' | 'Front office' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Vendor Ferron, TRY' | ''        | '2 300,00' | 'No'                   | 'Vendors advances closing 1 dated 12.02.2021 22:00:00' |
		...
		| "28.04.2021 00:00:01" | "Cash payment 23 dated 28.04.2021 00:00:01"      | "Main Company" | "Front office" | "Local currency"               | "TRY"      | "TRY"                  | "Company Ferron BP" | "Ferron BP" | ""      | "Vendor Ferron, TRY" | ""        | "589,00"   | "No"                   | "Vendors advances closing 4 dated 28.04.2021 22:00:00" |
		| "28.04.2021 00:00:01" | "Cash payment 23 dated 28.04.2021 00:00:01"      | "Main Company" | "Front office" | "Reporting currency"           | "USD"      | "TRY"                  | "Company Ferron BP" | "Ferron BP" | ""      | "Vendor Ferron, TRY" | ""        | "100,84"   | "No"                   | "Vendors advances closing 4 dated 28.04.2021 22:00:00" |
		| "28.04.2021 00:00:01" | "Cash payment 23 dated 28.04.2021 00:00:01"      | "Main Company" | "Front office" | "en description is empty"      | "TRY"      | "TRY"                  | "Company Ferron BP" | "Ferron BP" | ""      | "Vendor Ferron, TRY" | ""        | "589,00"   | "No"                   | "Vendors advances closing 4 dated 28.04.2021 22:00:00" |
	And I close all client application windows
	...
	* Check VendorsAdvancesClosing movements
		* T2010S Offset of advances
			...
			Then "ResultTable" spreadsheet document is equal
				...
				| ''                                                     | '12.02.2021 14:00:00' | 'Main Company' | 'Front office' | 'Credit note 11 dated 12.02.2021 14:00:00'       | 'Expense'     | 'No'                 | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Credit note 11 dated 12.02.2021 14:00:00'       | ''                             | ''                         | ''              | ''                                             | ''                        | ''                          | ''                            | ''                      | ''                | ''                    | '*'                                    | '170'    |
				...
				| ''                                                     | '12.02.2021 15:13:37' | 'Main Company' | 'Front office' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'Expense'     | 'No'                 | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | ''                             | ''                         | ''              | 'Purchase order 116 dated 12.02.2021 12:44:59' | ''                        | ''                          | ''                            | ''                      | ''                | ''                    | '                                    ' | '2 300'  |
				| ''                                                     | '12.02.2021 15:13:56' | 'Main Company' | 'Front office' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Expense'     | 'No'                 | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | ''                             | ''                         | ''              | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''                        | ''                          | ''                            | ''                      | ''                | ''                    | '                                    ' | '811'    |
		* TM1020 Advances key
			...
			Then "ResultTable" spreadsheet document is equal
				...
				| ''                                                     | '12.02.2021 15:13:37' | 'Expense'    | ''                   | 'Main Company' | 'Front office' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | ''      | ''        | 'Yes'               | 'No'                  | '2 300'  |
				| ''                                                     | '12.02.2021 15:13:56' | 'Expense'    | ''                   | 'Main Company' | 'Front office' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY' | ''      | ''        | 'Yes'               | 'No'                  | '811'    |			
		* TM1030 Transactions key
			...
			Then "ResultTable" spreadsheet document is equal
				...
				| ''                                                     | '12.02.2021 15:13:37' | 'Expense'    | ''                       | 'Main Company' | 'Front office' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY'          | 'Purchase invoice 116 dated 12.02.2021 15:13:37' | 'Purchase order 116 dated 12.02.2021 12:44:59' | ''        | 'Yes'                   | 'No'                      | '2 300'  |
				...
				| ''                                                     | '12.02.2021 15:13:56' | 'Expense'    | ''                       | 'Main Company' | 'Front office' | 'TRY'      | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, TRY'          | 'Purchase invoice 115 dated 12.02.2021 15:13:56' | 'Purchase order 115 dated 12.02.2021 12:44:43' | ''        | 'Yes'                   | 'No'                      | '811'    |
