...
Scenario: _1003003 check SI closing by advance (Ap-Ar by documents, payment first)
	...
	And "List" table contains lines
		...
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales return 12 dated 27.01.2021 19:50:46' | ''                                        | ''        | '-500,00'   | 'No'                   | 'Customers advance closing 23 dated 27.01.2021 12:00:00' |
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales return 12 dated 27.01.2021 19:50:46' | ''                                        | ''        | '-85,60'    | 'No'                   | 'Customers advance closing 23 dated 27.01.2021 12:00:00' |
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales return 12 dated 27.01.2021 19:50:46' | ''                                        | ''        | '-500,00'   | 'No'                   | 'Customers advance closing 23 dated 27.01.2021 12:00:00' |
