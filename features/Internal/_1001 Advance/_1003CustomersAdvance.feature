...
Scenario: _1003014 check SI, Debit note closing by advance (Ap-Ar by partner term, invoice first)
	...
	And "List" table contains lines	
		...
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'TRY'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '900,00'   | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'TRY'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '900,00'   | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'USD'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '154,08'   | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'TRY'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '900,00'   | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
