...
Scenario: _1003003 check SI closing by advance (Ap-Ar by documents, payment first)
	...
	And "List" table contains lines
		...
		| '27.04.2021 11:31:10' | 'Distribution department' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '986,00'    | 'Local currency'               | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | 'No'                   |
		| '27.04.2021 11:31:10' | 'Distribution department' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'USD'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '168,80'    | 'Reporting currency'           | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | 'No'                   |
		| '27.04.2021 11:31:10' | 'Distribution department' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '986,00'    | 'TRY'                          | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | 'No'                   |
		...
		| '27.04.2021 11:31:10' | 'Distribution department' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '986,00'    | 'en description is empty'      | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | 'No'                   |
		...
		| '28.04.2021 21:50:03' | 'Distribution department' | 'Bank receipt 13 dated 28.04.2021 21:50:03' | 'TRY'      | 'Customers advance closing 6 dated 28.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '95,00'     | 'en description is empty'      | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | ''                                        | 'No'                   |
		| '28.04.2021 21:50:03' | 'Distribution department' | 'Bank receipt 13 dated 28.04.2021 21:50:03' | 'TRY'      | 'Customers advance closing 6 dated 28.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '2 809,00'  | 'en description is empty'      | 'Company Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | 'No'                   |
	...
	And "List" table contains lines
		...
		| '27.04.2021 11:31:10' | 'Distribution department' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '986,00'    | 'Local currency'               | 'Company Ferron BP' | ''      | 'No'                   |
		| '27.04.2021 11:31:10' | 'Distribution department' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'USD'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '168,80'    | 'Reporting currency'           | 'Company Ferron BP' | ''      | 'No'                   |
		...
		| '27.04.2021 11:31:10' | 'Distribution department' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '986,00'    | 'en description is empty'      | 'Company Ferron BP' | ''      | 'No'                   |
		...
		| '28.04.2021 21:50:03' | 'Distribution department' | 'Bank receipt 13 dated 28.04.2021 21:50:03' | 'TRY'      | 'Customers advance closing 6 dated 28.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '95,00'     | 'en description is empty'      | 'Company Ferron BP' | ''      | 'No'                   |
		| '28.04.2021 21:50:03' | 'Distribution department' | 'Bank receipt 13 dated 28.04.2021 21:50:03' | 'TRY'      | 'Customers advance closing 6 dated 28.04.2021 12:00:00' | 'Main Company' | 'Ferron BP' | '2 809,00'  | 'en description is empty'      | 'Company Ferron BP' | ''      | 'No'                   |
...
Scenario: _1003004 check SI movements when unpost document and post it back (closing by advance)
	* Check movements
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                          | 'Expense'     | '28.01.2021 18:48:53' | '667,68'    | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'Sales order 1 dated 27.01.2021 19:50:45' | 'No'                   | 'Customers advance closing 9 dated 28.01.2021 12:00:00' |
			| ''                                          | 'Expense'     | '28.01.2021 18:48:53' | '3 900'     | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'Sales order 1 dated 27.01.2021 19:50:45' | 'No'                   | 'Customers advance closing 9 dated 28.01.2021 12:00:00' |
			| ''                                          | 'Expense'     | '28.01.2021 18:48:53' | '3 900'     | 'Main Company' | 'Distribution department' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'Sales order 1 dated 27.01.2021 19:50:45' | 'No'                   | 'Customers advance closing 9 dated 28.01.2021 12:00:00' |
			| ''                                          | 'Expense'     | '28.01.2021 18:48:53' | '3 900'     | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 1 dated 28.01.2021 18:48:53' | 'Sales order 1 dated 27.01.2021 19:50:45' | 'No'                   | 'Customers advance closing 9 dated 28.01.2021 12:00:00' |
		And I close all client application windows
	* Unpost SI
		Given I open hyperlink "e1cib/list/Document.SalesInvoice"
		And I go to line in "List" table
...
Scenario: _1003014 check SI, Debit note closing by advance (Ap-Ar by partner term, invoice first)
	Given I open hyperlink "e1cib/list/AccumulationRegister.R2021B_CustomersTransactions"
	And "List" table contains lines	
		| 'Period'              | 'Branch'                  | 'Recorder'                                   | 'Line number' | 'Currency' | 'Customers advances closing'                             | 'Company'      | 'Partner'         | 'Amount'   | 'Multi currency movement type' | 'Legal name'      | 'Agreement'                | 'Basis' | 'Order' | 'Deferred calculation' |
		| '28.01.2021 18:52:07' | 'Distribution department' | 'Sales invoice 12 dated 28.01.2021 18:52:07' | '1'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '1 000,00' | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '28.01.2021 18:52:07' | 'Distribution department' | 'Sales invoice 12 dated 28.01.2021 18:52:07' | '2'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '1 000,00' | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '28.01.2021 18:52:07' | 'Distribution department' | 'Sales invoice 12 dated 28.01.2021 18:52:07' | '3'           | 'USD'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '171,20'   | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '28.01.2021 18:52:07' | 'Distribution department' | 'Sales invoice 12 dated 28.01.2021 18:52:07' | '4'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '1 000,00' | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | '1'           | 'TRY'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '900,00'   | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | '2'           | 'TRY'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '900,00'   | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | '3'           | 'USD'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '154,08'   | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 00:00:00' | 'Distribution department' | 'Credit note 12 dated 16.02.2021 00:00:00'   | '4'           | 'TRY'      | 'Customers advance closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Partner Kalipso' | '900,00'   | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 12:14:53' | 'Distribution department' | 'Sales invoice 13 dated 16.02.2021 12:14:53' | '1'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '2 000,00' | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 12:14:53' | 'Distribution department' | 'Sales invoice 13 dated 16.02.2021 12:14:53' | '2'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '2 000,00' | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 12:14:53' | 'Distribution department' | 'Sales invoice 13 dated 16.02.2021 12:14:53' | '3'           | 'USD'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '342,40'   | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '16.02.2021 12:14:53' | 'Distribution department' | 'Sales invoice 13 dated 16.02.2021 12:14:53' | '4'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '2 000,00' | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '1'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '800,00'   | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '2'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '800,00'   | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '3'           | 'USD'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '136,96'   | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '4'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '800,00'   | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '5'           | 'TRY'      | 'Customers advance closing 3 dated 15.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '200,00'   | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '6'           | 'TRY'      | 'Customers advance closing 3 dated 15.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '200,00'   | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '7'           | 'USD'      | 'Customers advance closing 3 dated 15.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '34,24'    | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '15.04.2021 14:53:06' | 'Distribution department' | 'Cash receipt 7 dated 15.04.2021 14:53:06'   | '8'           | 'TRY'      | 'Customers advance closing 3 dated 15.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '200,00'   | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '27.04.2021 11:32:10' | 'Distribution department' | 'Cash receipt 5 dated 27.04.2021 11:32:10'   | '1'           | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '1 100,00' | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '27.04.2021 11:32:10' | 'Distribution department' | 'Cash receipt 5 dated 27.04.2021 11:32:10'   | '2'           | 'USD'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '188,32'   | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '27.04.2021 11:32:10' | 'Distribution department' | 'Cash receipt 5 dated 27.04.2021 11:32:10'   | '3'           | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '1 100,00' | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '27.04.2021 11:32:10' | 'Distribution department' | 'Cash receipt 5 dated 27.04.2021 11:32:10'   | '7'           | 'TRY'      | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  | 'Main Company' | 'Partner Kalipso' | '1 100,00' | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '1'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '200,00'   | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '2'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '200,00'   | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '3'           | 'USD'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '34,24'    | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '4'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '200,00'   | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '5'           | 'TRY'      | 'Customers advance closing 12 dated 14.05.2021 12:45:05' | 'Main Company' | 'Partner Kalipso' | '100,00'   | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '6'           | 'TRY'      | 'Customers advance closing 12 dated 14.05.2021 12:45:05' | 'Main Company' | 'Partner Kalipso' | '100,00'   | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '7'           | 'USD'      | 'Customers advance closing 12 dated 14.05.2021 12:45:05' | 'Main Company' | 'Partner Kalipso' | '17,12'    | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '14.05.2021 10:35:27' | 'Distribution department' | 'Debit note 22 dated 14.05.2021 10:35:27'    | '8'           | 'TRY'      | 'Customers advance closing 12 dated 14.05.2021 12:45:05' | 'Main Company' | 'Partner Kalipso' | '100,00'   | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '24.05.2021 00:00:00' | 'Distribution department' | 'Debit note 23 dated 24.05.2021 00:00:00'    | '1'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '50,00'    | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '24.05.2021 00:00:00' | 'Distribution department' | 'Debit note 23 dated 24.05.2021 00:00:00'    | '2'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '50,00'    | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '24.05.2021 00:00:00' | 'Distribution department' | 'Debit note 23 dated 24.05.2021 00:00:00'    | '3'           | 'USD'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '8,56'     | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '24.05.2021 00:00:00' | 'Distribution department' | 'Debit note 23 dated 24.05.2021 00:00:00'    | '4'           | 'TRY'      | ''                                                       | 'Main Company' | 'Partner Kalipso' | '50,00'    | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '25.05.2021 09:27:13' | 'Distribution department' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | '1'           | 'TRY'      | 'Customers advance closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Partner Kalipso' | '150,00'   | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '25.05.2021 09:27:13' | 'Distribution department' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | '2'           | 'USD'      | 'Customers advance closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Partner Kalipso' | '25,68'    | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '25.05.2021 09:27:13' | 'Distribution department' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | '3'           | 'TRY'      | 'Customers advance closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Partner Kalipso' | '150,00'   | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |
		| '25.05.2021 09:27:13' | 'Distribution department' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | '4'           | 'TRY'      | 'Customers advance closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Partner Kalipso' | '150,00'   | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer' | ''      | ''      | 'No'                   |		
	Given I open hyperlink "e1cib/list/AccumulationRegister.R2020B_AdvancesFromCustomers"
	And "List" table contains lines
		| 'Period'              | 'Recorder'                                  | 'Currency' | 'Customers advances closing'                             | 'Company'      | 'Branch'                  | 'Partner'         | 'Amount'     | 'Multi currency movement type' | 'Legal name'      | 'Deferred calculation' |
