...
Scenario: _1003012 check SI closing by advance (Ap-Ar by documents, invoice first)
	...
	And "List" table contains lines	
		...
		| '17.02.2021 10:33:31' | 'Sales invoice 5 dated 17.02.2021 10:33:31'  | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | 'Sales invoice 5 dated 17.02.2021 10:33:31'  | 'Sales order 10 dated 01.02.2021 12:00:00' | ''        | '26 400,00' | 'No'                   | ''                                                      |
		| '17.02.2021 10:43:29' | 'Sales invoice 6 dated 17.02.2021 10:43:29'  | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | 'Sales invoice 6 dated 17.02.2021 10:43:29'  | 'Sales order 8 dated 01.02.2021 12:00:00'  | ''        | '26 400,00' | 'No'                   | ''                                                      |
		...
		| '15.04.2021 10:21:22' | 'Bank receipt 5 dated 15.04.2021 10:21:22'   | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | 'Sales invoice 14 dated 16.02.2021 12:14:54' | ''                                         | ''        | '12 400,00' | 'No'                   | 'Customers advance closing 3 dated 15.04.2021 12:00:00' |
		| '15.04.2021 10:21:22' | 'Bank receipt 5 dated 15.04.2021 10:21:22'   | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Lomaniti' | 'Lomaniti' | 'Basic Partner terms, TRY' | 'Sales invoice 5 dated 17.02.2021 10:33:31'  | 'Sales order 10 dated 01.02.2021 12:00:00' | ''        | '26 400,00' | 'No'                   | 'Customers advance closing 3 dated 15.04.2021 12:00:00' |
