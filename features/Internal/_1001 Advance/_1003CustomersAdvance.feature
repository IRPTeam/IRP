...
Scenario: _1003003 check SI closing by advance (Ap-Ar by documents, payment first)
	...
	And "List" table contains lines
		...
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales return 12 dated 27.01.2021 19:50:46' | ''                                        | ''        | '-500,00'   | 'No'                   | 'Customers advance closing $$NumberCustomersAdvancesClosing27012021$$ dated 27.01.2021 12:00:00' |
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales return 12 dated 27.01.2021 19:50:46' | ''                                        | ''        | '-85,60'    | 'No'                   | 'Customers advance closing $$NumberCustomersAdvancesClosing27012021$$ dated 27.01.2021 12:00:00' |
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales return 12 dated 27.01.2021 19:50:46' | ''                                        | ''        | '-500,00'   | 'No'                   | 'Customers advance closing $$NumberCustomersAdvancesClosing27012021$$ dated 27.01.2021 12:00:00' |
		...
		| '28.01.2021 18:49:39' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | ''        | '486,00'    | 'No'                   | 'Customers advance closing 9 dated 28.01.2021 12:00:00'  |
		| '28.01.2021 18:49:39' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | ''        | '83,20'     | 'No'                   | 'Customers advance closing 9 dated 28.01.2021 12:00:00'  |
		...
		| '27.04.2021 11:31:10' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | ''                                        | ''        | '95,00'     | 'No'                   | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  |
		| '27.04.2021 11:31:10' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | ''                                        | ''        | '16,26'     | 'No'                   | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  |
		| '27.04.2021 11:31:10' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | ''        | '905,00'    | 'No'                   | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  |
		| '27.04.2021 11:31:10' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | 'Sales order 2 dated 27.01.2021 19:50:45' | ''        | '154,94'    | 'No'                   | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  |
		| '27.04.2021 11:31:10' | 'Cash receipt 4 dated 27.04.2021 11:31:10'  | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 2 dated 28.01.2021 18:49:39' | ''                                        | ''        | '95,00'     | 'No'                   | 'Customers advance closing 5 dated 27.04.2021 12:00:00'  |
	...
	And "List" table contains lines
		...
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | '4'           | 'Main Company' | 'Distribution department' | 'Local currency'               | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY'         | ''        | '-500,00'  | 'No'                   | 'Customers advance closing $$NumberCustomersAdvancesClosing27012021$$ dated 27.01.2021 12:00:00' |
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | '5'           | 'Main Company' | 'Distribution department' | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY'         | ''        | '-85,60'   | 'No'                   | 'Customers advance closing $$NumberCustomersAdvancesClosing27012021$$ dated 27.01.2021 12:00:00' |
		| '27.01.2021 19:50:47' | 'Cash receipt 6 dated 27.01.2021 19:50:47'  | '6'           | 'Main Company' | 'Distribution department' | 'en description is empty'      | 'TRY'      | 'TRY'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | 'Basic Partner terms, TRY'         | ''        | '-500,00'  | 'No'                   | 'Customers advance closing $$NumberCustomersAdvancesClosing27012021$$ dated 27.01.2021 12:00:00' |
