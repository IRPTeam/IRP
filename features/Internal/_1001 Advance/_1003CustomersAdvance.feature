...
Scenario: _1003014 check SI, Debit note closing by advance (Ap-Ar by partner term, invoice first)
	...
	And "List" table contains lines	
		...
		| '16.02.2021 00:00:00' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'TRY'      | 'Customers advances closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '900,00'     | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | '*'                    |
		| '16.02.2021 00:00:00' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'TRY'      | 'Customers advances closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '900,00'     | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | '*'                    |
		| '16.02.2021 00:00:00' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'USD'      | 'Customers advances closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '154,08'     | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | '*'                    |
		| '16.02.2021 00:00:00' | 'Credit note 12 dated 16.02.2021 00:00:00'   | 'TRY'      | 'Customers advances closing 10 dated 16.02.2021 12:00:00' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '900,00'     | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | '*'                    |
		...
		| '25.05.2021 09:27:13' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | 'TRY'      | 'Customers advances closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '200,00'     | 'Local currency'               | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | 'No'                   |
		| '25.05.2021 09:27:13' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | 'USD'      | 'Customers advances closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '34,24'      | 'Reporting currency'           | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | 'No'                   |
		| '25.05.2021 09:27:13' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | 'TRY'      | 'Customers advances closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '200,00'     | 'TRY'                          | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | 'No'                   |
		| '25.05.2021 09:27:13' | 'Bank receipt 14 dated 25.05.2021 09:27:13'  | 'TRY'      | 'Customers advances closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Distribution department' | 'Partner Kalipso' | '200,00'     | 'en description is empty'      | 'Company Kalipso' | 'Partner Kalipso Customer'  | ''                                          | 'No'                   |
	Given I open hyperlink "e1cib/list/AccumulationRegister.R2020B_AdvancesFromCustomers"
	And "List" table contains lines
		| 'Period'              | 'Recorder'                                  | 'Currency' | 'Customers advances closing'                              | 'Company'      | 'Branch'                   | 'Partner'         | 'Amount'     | 'Multi currency movement type' | 'Legal name'      | 'Basis'                                     | 'Deferred calculation' |
		...
		| '25.05.2021 09:27:13' | 'Bank receipt 14 dated 25.05.2021 09:27:13' | 'TRY'      | 'Customers advances closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Distribution department'  | 'Partner Kalipso' | '200,00'     | 'Local currency'               | 'Company Kalipso' | 'Bank receipt 14 dated 25.05.2021 09:27:13' | 'No'                   |
		| '25.05.2021 09:27:13' | 'Bank receipt 14 dated 25.05.2021 09:27:13' | 'USD'      | 'Customers advances closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Distribution department'  | 'Partner Kalipso' | '34,24'      | 'Reporting currency'           | 'Company Kalipso' | 'Bank receipt 14 dated 25.05.2021 09:27:13' | 'No'                   |
		| '25.05.2021 09:27:13' | 'Bank receipt 14 dated 25.05.2021 09:27:13' | 'TRY'      | 'Customers advances closing 17 dated 25.05.2021 09:49:46' | 'Main Company' | 'Distribution department'  | 'Partner Kalipso' | '200,00'     | 'en description is empty'      | 'Company Kalipso' | 'Bank receipt 14 dated 25.05.2021 09:27:13' | 'No'                   |
	And I close all client application windows
