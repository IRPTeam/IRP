...
Scenario: _10342 check movements Production (Repacking)
	...
	* T6020 Batch keys info
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                  | '$$DateProduction1041$$' | '2'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                             | ''                             | ''                             | 'Main Company' | ''       | 'Store 02' | 'Стремянка номер 5 ступенчатая' | 'Receipt'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''                          | 'No'                        | ''                          |
			| ''                                  | '$$DateProduction1041$$' | '2'         | ''               | ''                   | ''                     | ''                         | ''                           | ''                               | ''                         | ''                             | ''                      | ''                          | ''                         | ''                             | ''                             | ''                             | ''                             | 'Main Company' | ''       | 'Store 03' | 'Стремянка номер 8'             | 'Expense'   | ''                       | ''         | ''               | ''              | '                                    ' | ''                   | ''             | ''     | ''           | ''                       | ''                  | ''                 | ''                    | ''                          | ''                          | 'No'                        | ''                          |
