...
Scenario: _3050 create production planning correction and check it movements (quantity)
	...
	* Create document
		...
		And "Productions" table contains lines
			...
			| 'Стремянка номер 5 ступенчатая' | 'Стремянка номер 5 ступенчатая' | 'pcs'  | '1,000' | '250,000'   | 'Стремянка номер 5 ступенчатая' |
		...
		And "Productions" table contains lines
			| 'Item'                               | 'Item key'                           | 'Unit' | 'Q'     | 'Current Q' | 'Bill of materials'                  |
			| 'Стремянка номер 6 ступенчатая' | 'Стремянка номер 6 ступенчатая' | 'pcs'  | '1,000' | '100,000'   | 'Стремянка номер 6 ступенчатая' |
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines by template:
			...
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-150'      | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 6 ступенчатая'      | 'Заклепка 6х47 полупустотелая'            | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-100'      | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 6 ступенчатая'      | 'Скобы 3515 (Упаковочные)'                | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-50'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 6 ступенчатая'      | 'Втулка на стремянки Класс 10 мм, черный' | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			...
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-20'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 6 ступенчатая'      | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-20'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 6 ступенчатая'      | 'Копыта на стремянки Класс 30х20, черный' | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-20'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 6 ступенчатая'      | 'Катанка Ст3сп 6,5'                       | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-20'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 6 ступенчатая'      | 'труба электросварная круглая 10х1х5660'  | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			...
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-10'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 6 ступенчатая'      | 'Краска порошковая серая 9006'            | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '-10'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 6 ступенчатая'      | 'Коврик для стремянок Класс, черный'      | 'Plan adjustment' | 'First month'     | 'Стремянка номер 6 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '10'        | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Краска порошковая серая 9006'            | 'Plan adjustment' | 'First month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '19,6'      | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Копыта на стремянки Класс 20х20, черный' | 'ПВД 158'                                 | 'Plan adjustment' | 'First month'     | '01 Копыта на стремянки Класс 20х20'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '20'        | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 5 ступенчатая'      | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'First month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '20'        | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Катанка Ст3сп 6,5'                       | 'Plan adjustment' | 'First month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '20'        | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'труба электросварная круглая 10х1х5660'  | 'Plan adjustment' | 'First month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '50'        | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Втулка на стремянки Класс 10 мм, черный' | 'Plan adjustment' | 'First month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '100'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Скобы 3515 (Упаковочные)'                | 'Plan adjustment' | 'First month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | '150'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Заклепка 6х47 полупустотелая'            | 'Plan adjustment' | 'First month'     | 'Стремянка номер 5 ступенчатая'         |
		...
		And "ResultTable" spreadsheet document contains lines by template:
			...
			| ''                                     | '$$DateProductionPlanningCorrection01$$' | '-10'       | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 01' | 'Стремянка номер 6 ступенчатая'      | 'Plan adjustment' | 'First month'     | 'Product'         | 'Стремянка номер 6 ступенчатая'         |
			| ''                                     | '$$DateProductionPlanningCorrection01$$' | '10'        | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 01' | 'Стремянка номер 5 ступенчатая'      | 'Plan adjustment' | 'First month'     | 'Product'         | 'Стремянка номер 5 ступенчатая'         |
			| ''                                     | '$$DateProductionPlanningCorrection01$$' | '20'        | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | 'Store 01' | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'First month'     | 'Semiproduct'     | '01 Копыта на стремянки Класс 20х20'         |
		...
		And "ResultTable" spreadsheet document contains lines by template:
			...
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | 'Стремянка номер 5 ступенчатая'         | 'pcs'  | '260'      | 'pcs'        | '260'            | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | ''         | '*'         | '*'         | 'Store 01'      | ''               | 'Стремянка номер 5 ступенчатая'      | 'Yes'        | 'No'             | 'No'          | 'No'         | 'First month'     |
			| ''                                    | '$$DateProductionPlanningCorrection01$$' | 'Стремянка номер 6 ступенчатая'         | 'pcs'  | '90'       | 'pcs'        | '90'             | 'Main Company' | 'Production planning 1*' | 'Склад производства 05' | ''         | '*'         | '*'         | 'Store 01'      | ''               | 'Стремянка номер 6 ступенчатая'      | 'Yes'        | 'No'             | 'No'          | 'No'         | 'First month'     |
...
Scenario: _3060 create production planning correction and check it movements (change bill of material+product that is not in the planning)
	...
	* Create document
		...
		And "Productions" table contains lines
			| 'Item'                               | 'Item key'                           | 'Unit' | 'Q'     | 'Current Q' | 'Bill of materials'                  |
			| 'Стремянка номер 5 ступенчатая' | 'Стремянка номер 5 ступенчатая' | 'pcs'  | '1,000' | ''          | 'Стремянка номер 5 ступенчатая' |
		And I activate "Q" field in "Productions" table
		And I select current line in "Productions" table
		...
		And "Productions" table contains lines
			| 'Item'                   | 'Item key'               | 'Unit' | 'Q'     | 'Current Q' | 'Bill of materials' |
			| 'Стремянка номер 8' | 'Стремянка номер 8' | 'pcs'  | '1,000' | ''          | ''                  |
		And I go to line in "Productions" table
			| 'Item'                   |
			| 'Стремянка номер 8' |
		...
		And "Productions" table contains lines
			| 'Item'                   | 'Item key'               | 'Unit' | 'Q'       | 'Current Q' | 'Bill of materials'                |
			| 'Стремянка номер 8' | 'Стремянка номер 8' | 'pcs'  | '131,000' | ''          | 'Стремянка номер 8 (премиум)' |
		And I move to "Other" tab
		And I click the button named "FormPost"
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines by template:
			...
			| ''                                    | 'Period'                                 | 'Resources' | 'Dimensions'   | ''                       | ''                      | ''         | ''                                        | ''                                        | ''                | ''                | ''                                           |
			| ''                                    | ''                                       | 'Quantity'  | 'Company'      | 'Planning document'      | 'Business unit'         | 'Store'    | 'Production'                              | 'Item key'                                | 'Planning type'   | 'Planning period' | 'Bill of materials'                          |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '-1 310'    | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Заклепка 6х47 полупустотелая'            | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (основная)'          |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '-1 310'    | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Скобы 3515 (Упаковочные)'                | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (основная)'          |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '-655'      | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Втулка на стремянки Класс 10 мм, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (основная)'          |
			...
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '-262'      | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 8'                  | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (основная)'          |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '-262'      | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 8'                  | 'Копыта на стремянки Класс 30х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (основная)'          |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '-262'      | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Катанка Ст3сп 6,5'                       | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (основная)'          |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '-262'      | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'труба электросварная круглая 10х1х5660'  | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (основная)'          |
			...
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '10'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Краска порошковая серая 9006'            | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			...
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '20'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 5 ступенчатая'      | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '20'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Катанка Ст3сп 6,5'                       | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '20'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'труба электросварная круглая 10х1х5660'  | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '50'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Втулка на стремянки Класс 10 мм, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '100'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Скобы 3515 (Упаковочные)'                | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '131'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Коврик для стремянок Класс, черный'      | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '150'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Заклепка 6х47 полупустотелая'            | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '256,76'    | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Копыта на стремянки Класс 20х20, черный' | 'ПВД 158'                                 | 'Plan adjustment' | 'Third month'     | '01 Копыта на стремянки Класс 20х20'         |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '262'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 8'                  | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '262'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 8'                  | 'Копыта на стремянки Класс 30х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '262'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Катанка Ст3сп 6,5'                       | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '262'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'труба электросварная круглая 10х1х5660'  | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '497,8'     | 'Main Company' | 'Production planning 3*' | 'Цех 06'                | 'Store 02' | 'Копыта на стремянки Класс 30х20, черный' | 'ПВД 158'                                 | 'Plan adjustment' | 'Third month'     | '01 Копыта на стремянки Класс 30х20, черный' |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '655'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Втулка на стремянки Класс 10 мм, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '1 310'     | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Заклепка 6х47 полупустотелая'            | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | '1 310'     | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Скобы 3515 (Упаковочные)'                | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
		And I select "R7030 Production planning" exact value from "Register" drop-down list
		And I click "Generate report" button	
		And "ResultTable" spreadsheet document contains lines by template:	
			| '$$ProductionPlanningCorrection02$$'    | ''                                       | ''          | ''             | ''                       | ''                      | ''         | ''                                        | ''                | ''                | ''                | ''                                           |
			...
			| ''                                      | '$$DateProductionPlanningCorrection02$$' | '-131'      | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 01' | 'Стремянка номер 8'                  | 'Plan adjustment' | 'Third month'     | 'Product'         | 'Стремянка номер 8 (основная)'          |
			| ''                                      | '$$DateProductionPlanningCorrection02$$' | '10'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 01' | 'Стремянка номер 5 ступенчатая'      | 'Plan adjustment' | 'Third month'     | 'Product'         | 'Стремянка номер 5 ступенчатая'         |
			...
			| ''                                      | '$$DateProductionPlanningCorrection02$$' | '131'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 01' | 'Стремянка номер 8'                  | 'Plan adjustment' | 'Third month'     | 'Product'         | 'Стремянка номер 8 (премиум)'           |
			| ''                                      | '$$DateProductionPlanningCorrection02$$' | '262'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 01' | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'Third month'     | 'Semiproduct'     | '01 Копыта на стремянки Класс 20х20'         |
			| ''                                      | '$$DateProductionPlanningCorrection02$$' | '262'       | 'Main Company' | 'Production planning 3*' | 'Цех 06'                | 'Store 01' | 'Копыта на стремянки Класс 30х20, черный' | 'Plan adjustment' | 'Third month'     | 'Semiproduct'     | '01 Копыта на стремянки Класс 30х20, черный' |
		And I select "T7010 Bill of materials" exact value from "Register" drop-down list
		And I click "Generate report" button	
		And "ResultTable" spreadsheet document contains lines by template:
			...
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | 'Стремянка номер 5 ступенчатая'         | 'pcs'  | '10'       | 'pcs'        | '10'             | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | ''         | '*'         | '*'         | 'Store 01'      | ''               | 'Стремянка номер 5 ступенчатая'      | 'Yes'        | 'No'             | 'No'          | 'No'         | 'Third month'     |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | 'Стремянка номер 8 (основная)'          | 'pcs'  | ''         | 'pcs'        | ''               | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | ''         | '*'         | '*'         | 'Store 01'      | ''               | 'Стремянка номер 8'                  | 'Yes'        | 'No'             | 'No'          | 'No'         | 'Third month'     |
			| ''                                    | '$$DateProductionPlanningCorrection02$$' | 'Стремянка номер 8 (премиум)'           | 'pcs'  | '131'      | 'pcs'        | '131'            | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | ''         | '*'         | '*'         | 'Store 01'      | ''               | 'Стремянка номер 8'                  | 'Yes'        | 'No'             | 'No'          | 'No'         | 'Third month'     |
...
Scenario: _3070 create second production planning correction and check it movements (for one planning period)
	...
	* Create document
		...
		And "Productions" table contains lines
			| 'Item'                               | 'Item key'                           | 'Unit' | 'Q'     | 'Current Q' | 'Bill of materials'                  |
			| 'Стремянка номер 5 ступенчатая' | 'Стремянка номер 5 ступенчатая' | 'pcs'  | '1,000' | '10,000'    | 'Стремянка номер 5 ступенчатая' |
		And I activate "Q" field in "Productions" table
		And I select current line in "Productions" table
		...
		And "Productions" table contains lines
			| 'Item'                   | 'Item key'               | 'Unit' | 'Q'       | 'Current Q' | 'Bill of materials'                |
			| 'Стремянка номер 8' | 'Стремянка номер 8' | 'pcs'  | '130,000' | '131,000'   | 'Стремянка номер 8 (премиум)' |
		And I click the button named "FormPost"
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines by template:
			...
			| ''                                    | 'Period'                                         | 'Resources' | 'Dimensions'   | ''                       | ''                      | ''         | ''                                        | ''                                        | ''                | ''                | ''                                           |
			| ''                                    | ''                                               | 'Quantity'  | 'Company'      | 'Planning document'      | 'Business unit'         | 'Store'    | 'Production'                              | 'Item key'                                | 'Planning type'   | 'Planning period' | 'Bill of materials'                          |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-75'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Заклепка 6х47 полупустотелая'            | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-50'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Скобы 3515 (Упаковочные)'                | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-25'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Втулка на стремянки Класс 10 мм, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-10'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 5 ступенчатая'      | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-10'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Катанка Ст3сп 6,5'                       | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-10'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'труба электросварная круглая 10х1х5660'  | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-10'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Заклепка 6х47 полупустотелая'            | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-10'       | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Скобы 3515 (Упаковочные)'                | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			...
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-5'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 5 ступенчатая'      | 'Краска порошковая серая 9006'            | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 5 ступенчатая'         |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-5'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Втулка на стремянки Класс 10 мм, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			...
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-2'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 8'                  | 'Копыта на стремянки Класс 20х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-2'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 04' | 'Стремянка номер 8'                  | 'Копыта на стремянки Класс 30х20, черный' | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-2'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Катанка Ст3сп 6,5'                       | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-2'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'труба электросварная круглая 10х1х5660'  | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
			...
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | '-1'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 07' | 'Стремянка номер 8'                  | 'Коврик для стремянок Класс, черный'      | 'Plan adjustment' | 'Third month'     | 'Стремянка номер 8 (премиум)'           |
		And I select "R7030 Production planning" exact value from "Register" drop-down list
		And I click "Generate report" button
		And "ResultTable" spreadsheet document contains lines by template:
			| '$$ProductionPlanningCorrection03$$'    | ''                                               | ''          | ''             | ''                       | ''                      | ''         | ''                                         | ''                | ''                | ''                | ''                                           |
			...
			| ''                                      | '$$ApprovedDateProductionPlanningCorrection03$$' | '-5'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 01' | 'Стремянка номер 5 ступенчатая'       | 'Plan adjustment' | 'Third month'     | 'Product'         | 'Стремянка номер 5 ступенчатая'         |
			...
			| ''                                      | '$$ApprovedDateProductionPlanningCorrection03$$' | '-1'        | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | 'Store 01' | 'Стремянка номер 8'                   | 'Plan adjustment' | 'Third month'     | 'Product'         | 'Стремянка номер 8 (премиум)'           |
		And I select "T7010 Bill of materials" exact value from "Register" drop-down list
		And I click "Generate report" button
		And "ResultTable" spreadsheet document contains lines by template:
			| '$$ProductionPlanningCorrection03$$'  | ''                                               | ''                                           | ''     | ''         | ''           | ''               | ''             | ''                       | ''                      | ''                                                | ''                                                | ''                                                                          | ''              | ''               | ''                                        | ''           | ''               | ''            | ''           | ''                |
			...
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | 'Стремянка номер 5 ступенчатая'         | 'pcs'  | '5'        | 'pcs'        | '5'              | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | ''                                                | '4C EB F9 EF E8 C6 08 5C F3 89 54 C1 60 EC 8A 77' | '2b45dcf0-1f6d-11eb-bb8d-0050560061d6-c6358736-5cca-11eb-b760-b47469bcb0d7' | 'Store 01'      | ''               | 'Стремянка номер 5 ступенчатая'      | 'Yes'        | 'No'             | 'No'          | 'No'         | 'Third month'     |
			| ''                                    | '$$ApprovedDateProductionPlanningCorrection03$$' | 'Стремянка номер 8 (премиум)'           | 'pcs'  | '130'      | 'pcs'        | '130'            | 'Main Company' | 'Production planning 3*' | 'Склад производства 05' | ''                                                | '77 F7 D4 84 F5 B3 70 41 B1 C4 17 9B 4D B4 F2 DA' | 'f431e8c8-22a2-11eb-bb8d-0050560061d6-c6358739-5cca-11eb-b760-b47469bcb0d7' | 'Store 01'      | ''               | 'Стремянка номер 8'                  | 'Yes'        | 'No'             | 'No'          | 'No'         | 'Third month'     |
		And I select "R7010 Detailing supplies" exact value from "Register" drop-down list
		And I click "Generate report" button	
		And "ResultTable" spreadsheet document contains lines by template:	
			| '$$ProductionPlanningCorrection03$$'   | ''                                               | ''                      | ''                          | ''                        | ''                          | ''                          | ''                             | ''                             | ''                        | ''                            | ''                        | ''                            | ''             | ''                      | ''         | ''                | ''                                        |
