...
// 			| ''                                  | 'Expense'     | '$$DatePlannedReceiptReservation4001$$' | '45'        | 'Склад готовой продукции' | 'Perilla'  | 'Production planning 12 dated 01.01.2021 16:47:36' |
...
// 			| ''                                           | 'Receipt'     | '$$DatePlannedReceiptReservation4001$$' | '45'        | 'Дистрибьюция'   | 'Дистрибьюция'    | 'Perilla'  | 'Production planning 12 dated 01.01.2021 16:47:36' | 'Sales order 12 dated 10.02.2021 17:38:12' |	
// 	And I close all client application windows
// 	When Create document Production objects
// 	And I execute 1C:Enterprise script at server
// 		| "Doc = Documents.MF_Production.FindByNumber(12).GetObject();" |
// 		| "Doc.Date = CurrentDate();" |
// 		| "Doc.Write(DocumentWriteMode.Posting);" |
// 	* Check MF_Production movements
// 		Given I open hyperlink "e1cib/data/Document.MF_Production?ref=b76197e183b782dc11eb6c43c5882ddc"
...
// 				| ''                               | 'Receipt'     | '$$DateProduction4001$$' | '40'        | 'Склад готовой продукции' | 'Perilla'     |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '40'        | 'Склад готовой продукции' | 'Perilla'     |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '80'        | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '80'        | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '160'       | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '160'       | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '160'       | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '160'       | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '400'       | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '800'       | 'Склад производства 05'   | 'Стандартный' |
// 				| ''                               | 'Expense'     | '$$DateProduction4001$$' | '1 200'     | 'Склад производства 05'   | 'Стандартный' |
...
// 				| ''                                    | 'Record type' | 'Period'                 | 'Resources' | 'Dimensions'              | ''         | ''                                                 |
// 				| ''                                    | ''            | ''                       | 'Quantity'  | 'Store'                   | 'Item key' | 'Order'                                            |
// 				| ''                                    | 'Receipt'     | '$$DateProduction4001$$' | '40'        | 'Склад готовой продукции' | 'Perilla'  | 'Production planning 12 dated 01.01.2021 16:47:36' |
// 		* R4036 Incoming stock requested
// 			And I select "R4036 Incoming stock requested" exact value from "Register" drop-down list		
// 			And I click "Generate report" button
// 			Then "ResultTable" spreadsheet document is equal
...
// 				| ''                                           | 'Record type' | 'Period'                 | 'Resources' | 'Dimensions'              | ''                        | ''         | ''                                                 | ''                                         |
// 				| ''                                           | ''            | ''                       | 'Quantity'  | 'Incoming store'          | 'Requester store'         | 'Item key' | 'Order'                                            | 'Requester'                                |
// 				| ''                                           | 'Expense'     | '$$DateProduction4001$$' | '40'        | 'Склад готовой продукции' | 'Склад готовой продукции' | 'Perilla'  | 'Production planning 12 dated 01.01.2021 16:47:36' | 'Sales order 12 dated 10.02.2021 17:38:12' |
// 		And I close all client application windows
...
// 			| ''                                    | 'Record type' | 'Period'                        | 'Resources' | 'Dimensions'              | ''         | ''                                                 |
// 			| ''                                    | ''            | ''                              | 'Quantity'  | 'Store'                   | 'Item key' | 'Order'                                            |
// 			| ''                                    | 'Expense'     | '$$DateInventoryTransfer4001$$' | '40'        | 'Склад готовой продукции' | 'Perilla'  | 'Production planning 12 dated 01.01.2021 16:47:36' |
// 		And I close all client application windows
...
// 				| ''                                           | 'Record type' | 'Period'                   | 'Resources' | 'Dimensions'     | ''                | ''         | ''                                                 | ''                                         |
// 				| ''                                           | ''            | ''                         | 'Quantity'  | 'Incoming store' | 'Requester store' | 'Item key' | 'Order'                                            | 'Requester'                                |
// 				| ''                                           | 'Expense'     | '$$DateGoodsReceipt4001$$' | '40'        | 'Дистрибьюция'   | 'Дистрибьюция'    | 'Perilla'  | 'Production planning 12 dated 01.01.2021 16:47:36' | 'Sales order 12 dated 10.02.2021 17:38:12' |
// 		* R4011 Free stocks
// 			And I select "R4011 Free stocks" exact value from "Register" drop-down list
// 			And I click "Generate report" button
// 			Then "ResultTable" spreadsheet document contains lines
...
// 				| ''                               | 'Record type' | 'Period'                   | 'Resources' | 'Dimensions'   | ''         |
// 				| ''                               | ''            | ''                         | 'Quantity'  | 'Store'        | 'Item key' |
// 				| ''                               | 'Receipt'     | '$$DateGoodsReceipt4001$$' | '40'        | 'Дистрибьюция' | 'Perilla'  |
// 				| ''                               | 'Expense'     | '$$DateGoodsReceipt4001$$' | '40'        | 'Дистрибьюция' | 'Perilla'  |
// 		* R4012 Stock Reservation
// 			And I select "R4012 Stock Reservation" exact value from "Register" drop-down list
// 			And I click "Generate report" button
// 			Then "ResultTable" spreadsheet document contains lines
...
// 				| ''                                    | 'Record type' | 'Period'                   | 'Resources' | 'Dimensions'   | ''         | ''                                         |
// 				| ''                                    | ''            | ''                         | 'Quantity'  | 'Store'        | 'Item key' | 'Order'                                    |
// 				| ''                                    | 'Receipt'     | '$$DateGoodsReceipt4001$$' | '40'        | 'Дистрибьюция' | 'Perilla'  | 'Sales order 12 dated 10.02.2021 17:38:12' |
// 		And I close all client application windows
