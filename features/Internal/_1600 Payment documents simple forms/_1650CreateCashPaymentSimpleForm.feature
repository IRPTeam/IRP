...
Feature: create Cash payment simple form
...
Scenario: _165000 preparation (Cash payment simple form)
...
Scenario: _1650001 check preparation
	When check preparation	

Scenario: _165001 create Cash payment based on Purchase invoice - Payment to the vendor (simple form)
	...
	* Reselect basis document
		...
		And I go to line in "List" table
			| "Amount"   | "Document"                                     |
			| "4 535,00" | "Purchase invoice 5 dated 02.12.2023 12:30:00" |
		And I select current line in "List" table
...
Scenario: _165002 create Cash payment based on Sales return - Return to customer (simple form)
		And I close all client application windows
	* Select Sales return
		Given I open hyperlink "e1cib/list/Document.SalesReturn"
		And I go to line in "List" table
	...
	* Reselect basis document
		...
		And I go to line in "List" table
			| "Amount" | "Document"                                 |
			| "390,00" | "Sales return 6 dated 21.08.2023 12:00:00" |
		And I select current line in "List" table
	...
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberCashPayment2$$" variable
		And I delete "$$CashPayment2$$" variable
		And I save the value of "Number" field as "$$NumberCashPayment2$$"
		And I save the window as "$$CashPayment2$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.CashPayment"		
		And "List" table contains lines
			| 'Number'                 |
...
Scenario: _1650012 create Cash payment - Salary payment (simple form)
	And I close all client application windows
	* Create Cash payment
		Given I open hyperlink "e1cib/list/Document.CashPayment"
	...
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberCashPayment4$$" variable
		And I delete "$$CashPayment4$$" variable
		And I save the value of "Number" field as "$$NumberCashPayment4$$"
		And I save the window as "$$CashPayment4$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.CashPayment"		
		And "List" table contains lines
			| 'Number'                 |
...
Scenario: _1650013 create Cash payment - Other partner (simple form)
	And I close all client application windows
	* Create Cash payment 
		Given I open hyperlink "e1cib/list/Document.CashPayment"
		And I click the button named "FormCreate"
	...
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberCashPayment5$$" variable
		And I delete "$$CashPayment5$$" variable
		And I save the value of "Number" field as "$$NumberCashPayment5$$"
		And I save the window as "$$CashPayment5$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.CashPayment"		
		And "List" table contains lines
			| 'Number'                 |
...
Scenario: _165014 create Cash payment based on Employee cash advance - Employee cash advance (simple form)
		And I close all client application windows		
	...
	* Post document and check saving
		...
		And I delete "$$CashPayment6$$" variable
		And I save the value of "Number" field as "$$NumberCashPayment6$$"
		And I save the window as "$$CashPayment6$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.CashPayment"
		And "List" table contains lines
			| 'Number'                 |
...
Scenario: _165025 Prevent negative refund transactions in Cash payment (simple form)
	And I close all client application windows
	* Open CP
		Given I open hyperlink "e1cib/list/Document.CashPayment"
		And I click the button named "FormCreate"
