...
Feature: create Bank receipt simple form
...
Scenario: _170000 preparation (Bank receipt simple form)
...
Scenario: _1700001 check preparation
	When check preparation	

Scenario: _170001 create Bank receipt based on Sales invoice - Payment from customer (simple form)
	...
	* Reselect basis document
		And I input "" text in "Basis document" field	
		And I click Choice button of the field named "PaymentListBasisDocumentNoSplits"
		And I go to line in "List" table
			| "Amount"   | "Document"                                  |
			| "1 400,00" | "Sales invoice 5 dated 10.05.2023 12:00:00" |
		And I select current line in "List" table
		Then the form attribute named "PaymentListBasisDocumentNoSplits" became equal to "Sales invoice 5 dated 10.05.2023 12:00:00"	
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberBankReceipt1$$" variable
		And I delete "$$BankReceipt1$$" variable
		And I save the value of "Number" field as "$$NumberBankReceipt1$$"
		And I save the window as "$$BankReceipt1$$"
...
Scenario: _170002 create Bank receipt based on Purchase return - Return from vendor (simple form)
		And I close all client application windows
	...
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberBankReceipt2$$" variable
		And I delete "$$BankReceipt2$$" variable
		And I save the value of "Number" field as "$$NumberBankReceipt2$$"
		And I save the window as "$$BankReceipt2$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.BankReceipt"		
		And "List" table contains lines
			| 'Number'                 |
...
Scenario: _1700011 create Bank receipt - Other income (simple form)
	And I close all client application windows
	* Create Bank receipt 
		Given I open hyperlink "e1cib/list/Document.BankReceipt"
	...
	* Filling main details
		...
		And I select from the drop-down list named "PaymentListProfitLossCenterNoSplits" by "Business unit 2" string
	...
	* Check
		...
		Then the form attribute named "PaymentListCashFlowCenterNoSplits" became equal to "Business unit 1"
		Then the form attribute named "PaymentListProfitLossCenterNoSplits" became equal to "Business unit 2"
		...
		Then the form attribute named "PaymentListFinancialMovementTypeNoSplits" became equal to "Other income from current operations"		
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberBankReceipt3$$" variable
		And I delete "$$BankReceipt3$$" variable
		And I save the value of "Number" field as "$$NumberBankReceipt3$$"
		And I save the window as "$$BankReceipt3$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.BankReceipt"		
		And "List" table contains lines
			| 'Number'                 |
...
Scenario: _1700012 create Bank receipt - Salary return (simple form)
	And I close all client application windows
	* Create Bank receipt 
		Given I open hyperlink "e1cib/list/Document.BankReceipt"
		And I click the button named "FormCreate"
	...
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberBankReceipt4$$" variable
		And I delete "$$BankReceipt4$$" variable
		And I save the value of "Number" field as "$$NumberBankReceipt4$$"
		And I save the window as "$$BankReceipt4$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.BankReceipt"		
		And "List" table contains lines
			| 'Number'                 |
...
Scenario: _1700013 create Bank receipt - Other partner (simple form)
	And I close all client application windows
	* Create Bank receipt 
		Given I open hyperlink "e1cib/list/Document.BankReceipt"
		And I click the button named "FormCreate"
	...
	* Post document and check saving
		And I click the button named "FormPost"
		And I delete "$$NumberBankReceipt5$$" variable
		And I delete "$$BankReceipt5$$" variable
		And I save the value of "Number" field as "$$NumberBankReceipt5$$"
		And I save the window as "$$BankReceipt5$$"
		And I click the button named "FormPostAndClose"
		Given I open hyperlink "e1cib/list/Document.BankReceipt"		
		And "List" table contains lines
			| 'Number'                 |
