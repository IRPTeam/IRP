...
Scenario: _090323 create one Purchase order - several Goods receipt - one Purchase invoice
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                         | 'Receipt'       | '$$DatePurchaseInvoice090323$$'   | '14 500'      | 'Main Company'   | ''         | 'TRY'                            | 'TRY'        | 'TRY'                    | 'Company Ferron BP'   | 'Ferron BP'   | 'Vendor Ferron, TRY'   | '$$PurchaseInvoice090323$$'   | '$$PurchaseOrder090323$$'   | 'No'                     | ''                            |
