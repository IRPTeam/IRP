...
Scenario: _090323 create one Purchase order - several Goods receipt - one Purchase invoice
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                       | 'Receipt'     | '$$DatePurchaseInvoice090323$$' | '2 482,4'   | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | '$$PurchaseInvoice090323$$' | '$$PurchaseOrder090323$$' | 'No'                   | ''                         |
			| ''                                       | 'Receipt'     | '$$DatePurchaseInvoice090323$$' | '14 500'    | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | '$$PurchaseInvoice090323$$' | '$$PurchaseOrder090323$$' | 'No'                   | ''                         |
			| ''                                       | 'Receipt'     | '$$DatePurchaseInvoice090323$$' | '14 500'    | 'Main Company' | ''       | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | '$$PurchaseInvoice090323$$' | '$$PurchaseOrder090323$$' | 'No'                   | ''                         |
			| ''                                       | 'Receipt'     | '$$DatePurchaseInvoice090323$$' | '14 500'    | 'Main Company' | ''       | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, TRY' | '$$PurchaseInvoice090323$$' | '$$PurchaseOrder090323$$' | 'No'                   | ''                         |
