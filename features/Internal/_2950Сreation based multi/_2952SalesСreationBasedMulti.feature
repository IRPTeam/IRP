...
Scenario: _090408 create one Sales order - several Shipment confirmation - one Sales invoice
	...
	* Create Sales invoice for 3 Shipment Confirmation
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice0904083$$' | '5 718,08'  | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | '$$SalesInvoice0904083$$' | '$$SalesOrder090408$$' | 'No'                   | ''                           |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice0904083$$' | '33 400'    | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | '$$SalesInvoice0904083$$' | '$$SalesOrder090408$$' | 'No'                   | ''                           |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice0904083$$' | '33 400'    | 'Main Company' | ''       | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | '$$SalesInvoice0904083$$' | '$$SalesOrder090408$$' | 'No'                   | ''                           |
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice0904083$$' | '33 400'    | 'Main Company' | ''       | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | '$$SalesInvoice0904083$$' | '$$SalesOrder090408$$' | 'No'                   | ''                           |
		And I close all client application windows