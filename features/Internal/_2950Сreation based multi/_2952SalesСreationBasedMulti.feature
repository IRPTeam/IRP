...
Scenario: _090408 create one Sales order - several Shipment confirmation - one Sales invoice
	...
	* Create Sales invoice for 3 Shipment Confirmation
		...
		And "ResultTable" spreadsheet document contains lines:
			| 'Sales invoice 338 dated 28.04.2021 15:43:11' | ''            | ''                    | ''          | ''             | ''                             | ''         | ''                  | ''          | ''                         | ''                                            | ''                     | ''                  |
			...
			| ''                                            | 'Receipt'     | '28.04.2021 15:43:11' | '17 154,24' | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 338 dated 28.04.2021 15:43:11' | 'No'                   | 'No'                |
			| ''                                            | 'Receipt'     | '28.04.2021 15:43:11' | '100 200'   | 'Main Company' | 'Local currency'               | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 338 dated 28.04.2021 15:43:11' | 'No'                   | 'No'                |
			| ''                                            | 'Receipt'     | '28.04.2021 15:43:11' | '100 200'   | 'Main Company' | 'TRY'                          | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 338 dated 28.04.2021 15:43:11' | 'No'                   | 'No'                |
			| ''                                            | 'Receipt'     | '28.04.2021 15:43:11' | '100 200'   | 'Main Company' | 'en description is empty'      | 'TRY'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | 'Sales invoice 338 dated 28.04.2021 15:43:11' | 'No'                   | 'No'                |
		And I close all client application windows