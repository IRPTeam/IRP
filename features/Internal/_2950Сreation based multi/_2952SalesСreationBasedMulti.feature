...
Scenario: _090408 create one Sales order - several Shipment confirmation - one Sales invoice
	...
	* Create Sales invoice for 3 Shipment Confirmation
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                        | 'Receipt'     | '$$DateSalesInvoice0904083$$' | '5 719,17'  | 'Main Company' | 'Reporting currency'           | 'USD'      | 'Company Ferron BP' | 'Ferron BP' | 'Basic Partner terms, TRY' | '$$SalesInvoice0904083$$' | 'No'                   | ''                |
