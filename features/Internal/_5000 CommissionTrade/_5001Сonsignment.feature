...
Scenario: _050003 create SI (Shipment to trade agent)
	...
	* Add items
		...
		And I go to line in "ItemList" table
			| '#'   | 'Dont calculate row'   | 'Other period revenue type'   | 'Item'                 | 'Item key'   | 'Price type'          | 'Quantity'   | 'Serial lot numbers'       | 'Store'      | 'Unit'   | 'Use shipment confirmation'   | 'Use work sheet'   | 'VAT'    |
			| '1'   | 'No'                   | ''                     | 'Product 1 with SLN'   | 'PZU'        | 'Basic Price Types'   | '4,000'      | '8908899879; 8908899877'   | 'Store 02'   | 'pcs'    | 'Yes'                         | 'No'               | '18%'    |
		And I select current line in "ItemList" table
	...
	* Check item tab
		And "ItemList" table became equal
			...
			| 'en description is empty'   | 'Product 1 with SLN'   | 'PZU'        | ''                     | 'No'                   | '61,02'        | 'pcs'    | '8908899879; 8908899877'   | '4,000'      | '100,00'   | '18%'   | ''                | '338,98'       | '400,00'         | ''                     | ''                      | 'Store 01'   | ''                | 'No'                          | ''         | ''              | ''               | ''                |
			| 'en description is empty'   | 'Product 4 with SLN'   | 'UNIQ'       | ''                     | 'No'                   | '61,02'        | 'pcs'    | '899007790088'             | '2,000'      | '200,00'   | '18%'   | ''                | '338,98'       | '400,00'         | ''                     | ''                      | 'Store 01'   | ''                | 'No'                          | ''         | ''              | ''               | ''                |
			| 'Basic Price Types'         | 'Dress'                | 'XS/Blue'    | ''                     | 'No'                   | '317,29'       | 'pcs'    | ''                         | '4,000'      | '520,00'   | '18%'   | ''                | '1 762,71'     | '2 080,00'       | ''                     | ''                      | 'Store 01'   | ''                | 'No'                          | ''         | ''              | ''               | ''                |
			| 'Basic Price Types'         | 'Boots'                | '37/18SD'    | ''                     | 'No'                   | '106,78'       | 'pcs'    | ''                         | '1,000'      | '700,00'   | '18%'   | ''                | '593,22'       | '700,00'         | ''                     | ''                      | 'Store 01'   | ''                | 'No'                          | ''         | ''              | ''               | ''                |
...
Scenario: _050006 creare SR (Return from trade agent)
	...
	* Check item tab
		And "ItemList" table became equal
			...
			| '1'   | 'Product 1 with SLN'   | 'PZU'        | ''                     | 'No'                   | '61,02'        | 'pcs'    | '8908899877; 8908899879'   | '4,000'      | '$$SI050003$$'    | '100,00'   | '338,98'       | 'No'                  | '400,00'         | ''                      | 'Store 01'   | ''                     | ''                | ''               | '18%'   | ''                | ''              | ''                |
...
Scenario: _050021 check Purchase invoice generate for concignor fee (based on SalesReportFromTradeAgent)
	...
	* Create PI
		...
		Then the form attribute named "Store" became equal to "Store 02"
		And "ItemList" table became equal
			| '#'   | 'Price type'          | 'Item'   | 'Item key'   | 'Profit loss center'        | 'Dont calculate row'   | 'Tax amount'   | 'Unit'   | 'Serial lot numbers'   | 'Price'    | 'VAT'   | 'Offers amount'   | 'Total amount'   | 'Additional analytic'   | 'Internal supply request'   | 'Store'   | 'Delivery date'   | 'Quantity'   | 'Other period expense type'   | 'Expense type'   | 'Purchase order'   | 'Detail'   | 'Sales order'   | 'Net amount'   | 'Use goods receipt'    |
			| '1'   | 'Basic Price Types'   | 'Fee'    | 'Fee'        | 'Distribution department'   | 'No'                   | '22,27'        | 'pcs'    | ''                     | '146,00'   | '18%'   | ''                | '146,00'         | ''                      | ''                          | ''        | ''                | '1,000'      | ''                            | 'Revenue'        | ''                 | ''         | ''              | '123,73'       | 'No'                   |
