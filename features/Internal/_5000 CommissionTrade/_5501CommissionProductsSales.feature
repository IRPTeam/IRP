	...
	* Create Sales report co consignor for Concignor 1
		...
		* Filling sales (previous period return and sale)
			...
			And "ItemList" table contains lines
				...
				| 'en description is empty' | 'Product 11 with SLN (Main Company - Consignor 1)'                         | 'UNIQ'     | '100,00'          | 'No'                 | '11111111111111'     | 'pcs'  | '-61,02'     | 'Source of origin 909' | 'Sales invoice 194 dated 04.11.2022 16:33:38' | '-2,000'   | '10,00'                   | '-40,00'                 | '200,00' | '18%' | 'Purchase invoice 195 dated 02.11.2022 16:31:38' | '-400,00'    | '-400,00'      |
				| 'en description is empty' | 'Product 11 with SLN (Main Company - Consignor 1)'                         | 'UNIQ'     | '100,00'          | 'No'                 | '11111111111111'     | 'pcs'  | '54,92'      | ''                     | '$$SI10$$'                                    | '3,000'    | '10,00'                   | '36,00'                  | '120,00' | '18%' | '$$PI3$$'                                        | '305,09'     | '360,00'       |
		...
		* Update sales
			...
			And "Sales" table contains lines
				...
				| 'No'  | 'Product 11 with SLN (Main Company - Consignor 1)'                         | 'UNIQ'     | '11111111111111'    | ''                     | '3,000'    | 'en description is empty' | 'pcs'  | '100,00'          | '120,00' | '305,09'     | '360,00'       | '$$PI3$$'                                        | '$$SI10$$'                                    |
			...
			And "Sales" table contains lines
				...
				| 'Yes' | 'Product 11 with SLN (Main Company - Consignor 1)'                         | 'UNIQ'     | '11111111111111'    | 'Source of origin 909' | '-2,000'   | 'en description is empty' | 'pcs'  | '100,00'          | '200,00' | '-400,00'    | '-400,00'      | 'Purchase invoice 195 dated 02.11.2022 16:31:38' | 'Sales invoice 194 dated 04.11.2022 16:33:38' |
				| 'Yes' | 'Product 11 with SLN (Main Company - Consignor 1)'                         | 'UNIQ'     | '11111111111111'    | ''                     | '3,000'    | 'en description is empty' | 'pcs'  | '100,00'          | '120,00' | '305,09'     | '360,00'       | '$$PI3$$'                                        | '$$SI10$$'                                    |
		...
		* Check currency form
			...
			And "CurrenciesTable" table became equal
				...
				| 'Reporting currency' | 'Reporting'    | 'USD' | 'TRY'  | '1'            | '0,171200' | '324,60' |
				| 'Local currency'     | 'Legal'        | 'TRY' | 'TRY'  | '1'            | '1'        | '1 896'  |
				| 'TRY'                | 'Partner term' | 'TRY' | 'TRY'  | '1'            | '1'        | '1 896'  |
			And I click "Ok" button	
		* Post
			And I click "Post" button
		...
		* Check filling
			...
			Then the form attribute named "ItemListTotalTradeAgentFeeAmount" became equal to "189,60"
			Then the form attribute named "ItemListTotalNetAmount" became equal to "1 545,77"
			Then the form attribute named "ItemListTotalTaxAmount" became equal to "289,22"
			Then the form attribute named "ItemListTotalTotalAmount" became equal to "1 896,00"
