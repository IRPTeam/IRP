...
Scenario: _05805 transfer of goods on commission from Second company to the Main company (SI and PI)
	...
	* Check filling
		And "ItemList" table contains lines
			| 'Inventory origin'   | 'Price type'                | 'Item'                 | 'Item key'   | 'Dont calculate row'   | 'Tax amount'   | 'Unit'   | 'Serial lot numbers'   | 'Quantity'   | 'Price'    | 'VAT'           | 'Net amount'   | 'Total amount'   | 'Use work sheet'   | 'Other revenue type'   | 'Store'       |
