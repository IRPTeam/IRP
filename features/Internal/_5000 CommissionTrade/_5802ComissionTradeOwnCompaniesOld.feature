...
Scenario: _05818 create Bank payment based on Sales report to consignors
	...
	* Check
		...
		And "PaymentList" table became equal
			| '#'   | 'Partner'                  | 'Commission'   | 'LegalName'            | 'Partner term'               | 'Legal name contract'   | 'Basis document'   | 'Order'   | 'Total amount'   | 'Financial movement type'   | 'Planning transaction basis'    |
...
Scenario: _05819 create Cash payment based on Sales report to consignors
	...
	* Check
		...
		Then the form attribute named "Currency" became equal to "TRY"
		And "PaymentList" table became equal
			| '#'   | 'Partner'                  | 'LegalName'            | 'Partner term'               | 'Legal name contract'   | 'Basis document'   | 'Order'   | 'Total amount'   | 'Financial movement type'   | 'Planning transaction basis'    |
