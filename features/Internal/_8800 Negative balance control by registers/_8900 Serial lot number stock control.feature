...
Feature: serial lot number stock control
...
Scenario:_890000 preparation (serial lot number stock control)
	...
	* Stock remaining settings
		...
		When Create information register UserSettings records (R4014B_SerialLotNumber control)
	* Load documents
...
Scenario:_8900201 check preparation (serial lot number stock control)
	When check preparation 

Scenario:_890021 check serial lot number control in the Sales invoice 
...
Scenario:_890022 check remaining stock control in the Retail sales receipt					
		And I close all client application windows
