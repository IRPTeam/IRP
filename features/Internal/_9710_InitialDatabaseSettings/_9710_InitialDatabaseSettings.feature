...
Functionality: check Initial Database Settings
...
Scenario: _971001 filling in test data base
...
When Create catalog SystemAttributesSets objects (test data base)
When Create chart of characteristic types SystemAttributes objects (test data base)
* Tax settings
