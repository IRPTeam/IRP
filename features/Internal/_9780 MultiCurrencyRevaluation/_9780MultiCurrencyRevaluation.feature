...
Scenario: _0978008 check ForeignCurrencyRevaluation by the Register  "R2020 Advances from customer"
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '1,91'      | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | ''        | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '1,91'      | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | ''        | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '3,82'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | ''        | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '3,82'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | ''        | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '5,56'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''                         | ''        | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '6,96'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''                         | ''        | 'No'                   | ''                           |
