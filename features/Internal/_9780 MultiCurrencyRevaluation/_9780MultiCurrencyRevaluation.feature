...
Scenario: _0978015 Sales (SI) and payment (BR) on the same date - no exchange difference - (R3010 Cash on hand)
	And I close all client application windows	
	* Select Foreign currency revaluation
		Given I open hyperlink "e1cib/list/Document.ForeignCurrencyRevaluation"
		And I go to line in "List" table
...
Scenario: _0978038 revaluation of currency balance - (R3021 Cash in transit (incoming)) 
	...
	* Check movements by the Register  "R3021 Cash in transit (incoming)" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                         | '05.02.2023 23:59:00' | 'Receipt'    | 'Main Company' | 'Front office' | 'Bank account, USD' | 'Reporting currency Euro'      | 'EUR'      | 'USD'                  | 'Opening entry 1 dated 02.02.2023 12:00:00' | '1'      | 'No'                   |
			| ''                                                         | '05.02.2023 23:59:00' | 'Expense'    | 'Main Company' | 'Front office' | 'Bank account, USD' | 'Local currency'               | 'TRY'      | 'USD'                  | 'Opening entry 1 dated 02.02.2023 12:00:00' | '6,88'   | 'No'                   |		
		And I close all client application windows
