...
Scenario: _09780112 check ForeignCurrencyRevaluation by the Register  "R5020 Partners balance"
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                   | 'Receipt'     | '08.02.2023 23:59:59' | '-12,52'    | ''                     | '-12,52'           | ''                   | ''               | ''                  | 'Main Company' | ''       | 'Ferron BP'       | 'Company Ferron BP' | ''                         | ''                                            | 'TRY'      | 'Local currency'               | 'USD'                  | ''                 |
			...
			| ''                                   | 'Receipt'     | '08.02.2023 23:59:59' | '-7,64'     | ''                     | '-7,64'            | ''                   | ''               | ''                  | 'Main Company' | ''       | 'Big foot'        | 'Big foot'          | ''                         | ''                                            | 'TRY'      | 'Local currency'               | 'USD'                  | ''                 |
			| ''                                   | 'Receipt'     | '08.02.2023 23:59:59' | '-3,82'     | ''                     | '-3,82'            | ''                   | ''               | ''                  | 'Main Company' | ''       | 'Big foot'        | 'Big foot'          | ''                         | ''                                            | 'USD'      | 'Reporting currency'           | 'TRY'                  | ''                 |
			...
			| ''                                   | 'Receipt'     | '08.02.2023 23:59:59' | '-1,74'     | ''                     | '-1,74'            | ''                   | ''               | ''                  | 'Main Company' | ''       | 'Lomaniti'        | 'Company Lomaniti'  | ''                         | ''                                            | 'TRY'      | 'Local currency'               | 'USD'                  | ''                 |
			...
			| ''                                   | 'Receipt'     | '08.02.2023 23:59:59' | '1,91'      | ''                     | ''                 | ''                   | '1,91'           | ''                  | 'Main Company' | ''       | 'DFC'             | 'DFC'               | ''                         | ''                                            | 'TRY'      | 'Local currency'               | 'USD'                  | ''                 |
			...
			| ''                                   | 'Receipt'     | '08.02.2023 23:59:59' | '5 750,07'  | ''                     | ''                 | ''                   | '5 750,07'       | ''                  | 'Main Company' | ''       | 'DFC'             | 'DFC'               | ''                         | ''                                            | 'USD'      | 'Reporting currency'           | 'EUR'                  | ''                 |
			| ''                                   | 'Expense'     | '08.02.2023 23:59:59' | '55,56'     | ''                     | ''                 | ''                   | '55,56'          | ''                  | 'Main Company' | ''       | 'DFC'             | 'DFC'               | ''                         | ''                                            | 'TRY'      | 'Local currency'               | 'EUR'                  | ''                 |
	And I close all client application windows