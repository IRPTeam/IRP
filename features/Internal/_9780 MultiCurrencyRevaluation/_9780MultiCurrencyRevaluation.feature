...
Scenario: _0978007 check ForeignCurrencyRevaluation by the Register  "R1020 Advances to vendors"
	...
	* Check movements by the Register  "R1020 Advances to vendors" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                      | 'Receipt'     | '08.02.2023 23:59:59' | '1,91'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'DFC'        | 'DFC'     | ''      | ''          | 'Bank payment 811 dated 01.02.2023 12:00:00' | 'No'                   | ''                         |
			| ''                                      | 'Receipt'     | '08.02.2023 23:59:59' | '5 750,07'  | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'EUR'                  | 'DFC'        | 'DFC'     | ''      | ''          | 'Bank payment 812 dated 03.02.2022 12:00:00' | 'No'                   | ''                         |
			| ''                                      | 'Expense'     | '08.02.2023 23:59:59' | '55,56'     | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'EUR'                  | 'DFC'        | 'DFC'     | ''      | ''          | 'Bank payment 812 dated 03.02.2022 12:00:00' | 'No'                   | ''                         |
	And I close all client application windows
...
Scenario: _0978008 check ForeignCurrencyRevaluation by the Register  "R2020 Advances from customer"
	...
	* Check movements by the Register  "R2020 Advances from customer" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '1,74'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Lomaniti'  | 'Lomaniti'  | ''      | ''                         | 'Bank receipt 813 dated 04.02.2023 15:54:07'  | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '1,91'      | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | 'Opening entry 811 dated 01.02.2023 00:00:00' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '1,91'      | 'Main Company' | ''       | 'Reporting currency'           | 'USD'      | 'TRY'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | 'Opening entry 812 dated 01.02.2023 12:00:00' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '3,82'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | 'Opening entry 811 dated 01.02.2023 00:00:00' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '3,82'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Big foot'          | 'Big foot'  | ''      | ''                         | 'Opening entry 812 dated 01.02.2023 12:00:00' | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '5,56'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''                         | 'Bank receipt 812 dated 06.02.2023 00:00:00'  | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '6,96'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Ferron BP' | 'Ferron BP' | ''      | ''                         | 'Bank receipt 813 dated 04.02.2023 15:54:07'  | 'No'                   | ''                           |
			| ''                                         | 'Receipt'     | '08.02.2023 23:59:59' | '9,55'      | 'Main Company' | ''       | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Kalipso'   | 'Kalipso'   | ''      | 'Basic Partner terms, TRY' | 'Bank receipt 811 dated 01.02.2023 14:51:44'  | 'No'                   | ''                           |			
	And I close all client application windows
...
Scenario: _09780114 check ForeignCurrencyRevaluation by the Register  "R5021 Revenues"
	...
	* Check movements by the Register  "R5021 Revenues" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                  | '08.02.2023 23:59:59'   | '-2,78'       | ''                    | 'Main Company'   | ''         | 'Front office'         | 'Revenue'        | ''           | 'TRY'        | ''                      | 'TRY'                             |
			| ''                                  | '08.02.2023 23:59:59'   | '-1,39'       | ''                    | 'Main Company'   | ''         | 'Front office'         | 'Revenue'        | ''           | 'TRY'        | ''                      | 'Local currency'                  |
			| ''                                  | '08.02.2023 23:59:59'   | '-1,39'       | ''                    | 'Main Company'   | ''         | 'Front office'         | 'Revenue'        | ''           | 'TRY'        | ''                      | 'TRY'                             |
			...
			| ''                                  | '08.02.2023 23:59:59'   | '38,2'        | ''                    | 'Main Company'   | ''         | 'Front office'         | 'Revenue'        | ''           | 'TRY'        | ''                      | 'TRY'                             |
...
Scenario: _09780111 check ForeignCurrencyRevaluation by the Register  "R5022 Expenses"
	...
	* Check movements by the Register  "R5022 Expenses" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                | ''                    | 'Amount'    | 'Amount with taxes' | 'Amount cost' | 'Company'      | 'Branch' | 'Profit loss center' | 'Expense type' | 'Item key' | 'Fixed asset' | 'Ledger type' | 'Currency' | 'Additional analytic' | 'Multi currency movement type' | 'Calculation movement cost' |
			...
			| ''                                | '08.02.2023 23:59:59' | '1,91'      | ''                  | ''            | 'Main Company' | ''       | 'Front office'       | 'Expense'      | ''         | ''            | ''            | 'USD'      | ''                    | 'Reporting currency'           | ''                          |
			| ''                                | '08.02.2023 23:59:59' | '1,91'      | ''                  | ''            | 'Main Company' | ''       | 'Front office'       | 'Expense'      | ''         | ''            | ''            | 'USD'      | ''                    | 'Reporting currency'           | ''                          |
			| ''                                | '08.02.2023 23:59:59' | '3,82'      | ''                  | ''            | 'Main Company' | ''       | 'Front office'       | 'Expense'      | ''         | ''            | ''            | 'TRY'      | ''                    | 'Local currency'               | ''                          |
			| ''                                | '08.02.2023 23:59:59' | '3,82'      | ''                  | ''            | 'Main Company' | ''       | 'Front office'       | 'Expense'      | ''         | ''            | ''            | 'TRY'      | ''                    | 'Local currency'               | ''                          |
			| ''                                | '08.02.2023 23:59:59' | '5,56'      | ''                  | ''            | 'Main Company' | ''       | 'Front office'       | 'Expense'      | ''         | ''            | ''            | 'TRY'      | ''                    | 'Local currency'               | ''                          |
			| ''                                | '08.02.2023 23:59:59' | '6,96'      | ''                  | ''            | 'Main Company' | ''       | 'Front office'       | 'Expense'      | ''         | ''            | ''            | 'TRY'      | ''                    | 'Local currency'               | ''                          |
