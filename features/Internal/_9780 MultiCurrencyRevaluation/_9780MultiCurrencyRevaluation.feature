...
Scenario: _0978021 revaluation of currency balance (vendor) - exchange rate decreased 
	...
	* Check currency revaluation
		Then "Result" spreadsheet document contains lines:
			...
			| 'Partner terms'        | 'Opening'                                                               | 'Receipt'   | 'Expense'   | 'Balance'    | 'Opening'            | 'Receipt'  | 'Expense'  | 'Balance'   | 'Opening'                 | 'Receipt'  | 'Expense'  | 'Balance'   | 'Opening'                 | 'Receipt'  | 'Expense'  | 'Balance'   |
			| 'Basis'                | ''                                                                      | ''          | ''          | ''           | ''                   | ''         | ''         | ''          | ''                        | ''         | ''         | ''          | ''                        | ''         | ''         | ''          |
			| 'Total'                | ''                                                                      | '16 949,15' | '58 965,96' | '-42 016,81' | ''                   | '2 000,00' | '7 000,00' | '-5 000,00' | ''                        | '1 840,00' | '6 440,00' | '-4 600,00' | ''                        | ''         | ''         | ''          |
			| 'USD'                  | ''                                                                      | '16 949,15' | '58 965,96' | '-42 016,81' | ''                   | '2 000,00' | '7 000,00' | '-5 000,00' | ''                        | '1 840,00' | '6 440,00' | '-4 600,00' | ''                        | '2 000,00' | '7 000,00' | '-5 000,00' |
			| 'Ferron BP'            | ''                                                                      | '16 949,15' | '58 965,96' | '-42 016,81' | ''                   | '2 000,00' | '7 000,00' | '-5 000,00' | ''                        | '1 840,00' | '6 440,00' | '-4 600,00' | ''                        | '2 000,00' | '7 000,00' | '-5 000,00' |
			| 'Vendor Ferron, USD'   | ''                                                                      | '16 949,15' | '58 965,96' | '-42 016,81' | ''                   | '2 000,00' | '7 000,00' | '-5 000,00' | ''                        | '1 840,00' | '6 440,00' | '-4 600,00' | ''                        | '2 000,00' | '7 000,00' | '-5 000,00' |
			| ''                     | ''                                                                      | '16 949,15' | '58 965,96' | '-42 016,81' | ''                   | '2 000,00' | '7 000,00' | '-5 000,00' | ''                        | '1 840,00' | '6 440,00' | '-4 600,00' | ''                        | '2 000,00' | '7 000,00' | '-5 000,00' |	
		And I close all client application windows
...
Scenario: _0978022 revaluation of currency balance - USD to TRY falls, USD to EUR rise - (R1021 Vendors transactions) 
	...
	* Check movements by the Register  "R1021 Vendors transactions" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                         | '03.02.2023 23:59:00' | 'Expense'    | 'Main Company' | 'Front office' | 'Local currency'               | 'TRY'      | 'USD'                  | 'Company Ferron BP' | 'Ferron BP' | 'Vendor Ferron, USD' | ''      | ''      | ''        | '142,43' | 'No'                   | ''                         |	
		And I close all client application windows
...
Scenario: _0978025 revaluation of currency balance - USD to TRY falls, USD to EUR rise - (R5020 Partners balance) 
	...
	* Check movements by the Register  "R5020 Partners balance" 
		...
		Then "ResultTable" spreadsheet document is equal
			...
			| ''                                                         | '03.02.2023 23:59:00' | 'Receipt'    | 'Main Company' | 'Front office' | 'Ferron BP' | 'Company Ferron BP' | 'Vendor Ferron, USD'        | ''                                          | 'TRY'      | 'Local currency'               | 'USD'                  | '142,43' | ''                     | ''                 | '142,43'             | ''               | ''                  | ''                 |
