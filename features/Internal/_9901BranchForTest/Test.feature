...
Сценарий: Подготовка данных
	...
	Сценарий: _1230 Добавление штрих-кода (Barcodes) по номенклатуре
		...
		И в таблице "List" я перехожу к строке:
			| 'Code' | 'Description'                       | 'Item type'                  |  
			| '1'    | 'Товар с характеристиками (Item)'   | 'Товар (есть размер и цвет)' | 
		И в таблице "List" я выбираю текущую строку
		Тогда открылось окно "Item0 (item)"
		...
		* Создание тестового серийного номера
			...
			Когда открылось окно 'Select data type'
