...
Сценарий: Подготовить данные по номеру серийному
...
* Проверка создания копии
	...
	И я нажимаю на кнопку с именем 'FormWriteAndClose'
	И у элемента с именем 'ErrorInfo' я жду значения 'Запись с такими ключевыми полями существует! : Item barcode: 111 (Регистр сведений: Item barcodes)' в течение 30 секунд		
