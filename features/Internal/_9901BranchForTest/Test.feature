...
Сценарий: _1229 Проверка заполнения справочника Items
	*Открытие справочника
		...
		*Заполнение полей
			И в поле с именем 'Description_en' я ввожу текст 'Товар Тест'
			И в поле с именем 'ItemID' я ввожу текст '112233'
		...
		И я жду закрытия окна 'Товар Тест (Item)' в течение 20 секунд
				
	*Проверка созданного объекта
		И таблица "List" содержит строки:
			| 'Code'   | 'Description'              | 'Item type'                  |
			| '$Code$' | 'Товар Тест'               | 'Товар (есть размер и цвет)' |