...
Сценарий: добавление штрихкода в элемент справочника "Items" 
...
* Добавление штрихкода	
	...
	И в поле с именем 'Barcode' я ввожу текст '123456789009845'
	И я нажимаю кнопку выбора у поля с именем "Unit"
	И в таблице "List" я перехожу к строке:
		| 'Code' | 'Description' |
		| '1'    | 'шт'          |
	И в таблице "List" я выбираю текущую строку
	И в поле с именем 'Presentation' я ввожу текст 'Тестовый штрихкод'
	И я нажимаю на кнопку с именем 'FormWriteAndClose'
	И я жду закрытия окна 'Item barcode *' в течение 20 секунд
* Проверка добавления штрихкода
