...
Scenario: _0991093 check Sales return accounting movements (product)
	...
	* Check JE
		...
		And "RegisterRecords" table became equal
			| '#' | 'Activity' | 'Account Dr' | 'Ext. Dim. Debit'    | 'Extra dimension2 Dr' | 'Extra dimension3 Dr'        | 'Debit currency' | 'Debit amount' | 'DebitQuantity' | 'Account Cr' | 'Ext. Dim. Credit'            | 'Extra dimension2 Cr'                         | 'Extra dimension3 Cr' | 'Credit currency' | 'Credit amount' | 'Credit quantity' | 'Amount' | 'Operation'                                                               |
			| '1' | 'Yes'      | '9100'       | 'Business unit 1'    | ''                    | ''                           | 'TRY'            | '158,33'       | ''              | '4010'       | 'Customer 2 (2 partner term)' | 'Individual partner term 1 (by partner term)' | 'Business unit 1'     | 'TRY'             | '158,33'        | ''                | '158,33' | 'SalesReturn DR (R5021T_Revenues) CR (R2021B_CustomersTransactions)'      |
...
Scenario: _0991094 check Sales return accounting movements (service)
	...
	* Check JE
		...
		And "RegisterRecords" table became equal
			| "Account Dr" | "Amount" | "DebitQuantity" | "Activity" | "Credit currency" | "Ext. Dim. Debit" | "Debit amount" | "Extra dimension2 Dr" | "Credit quantity" | "Extra dimension3 Dr" | "Debit currency" | "Account Cr" | "Ext. Dim. Credit"            | "Operation"                                                               | "Extra dimension2 Cr"                         | "Credit amount" | "Extra dimension3 Cr" |
			| "9100"       | "8,33"   | ""              | "Yes"      | "TRY"             | "Business unit 2" | "8,33"         | ""                    | ""                | ""                    | "TRY"            | "4010"       | "Customer 2 (2 partner term)" | "SalesReturn DR (R5021T_Revenues) CR (R2021B_CustomersTransactions)"      | "Individual partner term 1 (by partner term)" | "8,33"          | "Business unit 2"     |
...
Scenario: _0991142 check Debit note accounting movements (Other)
	...
	* Check JE
		...
		And "RegisterRecords" table became equal
			| 'Account Dr' | '#' | 'Amount' | 'DebitQuantity' | 'Activity' | 'Credit currency' | 'Ext. Dim. Debit' | 'Debit amount' | 'Extra dimension2 Dr' | 'Credit quantity' | 'Extra dimension3 Dr' | 'Debit currency' | 'Account Cr' | 'Ext. Dim. Credit' | 'Operation'                                                           | 'Extra dimension2 Cr' | 'Credit amount' | 'Extra dimension3 Cr' |
			| '9200'       | '1' | '150,00' | ''              | 'Yes'      | 'TRY'             | 'Business unit 3' | '150'          | 'Other partner 2'     | ''                | 'Other partner 2'     | 'TRY'            | '9100'       | 'Business unit 3'  | 'DebitNote DR (R5015B_OtherPartnersTransactions) CR (R5021_Revenues)' | 'Other partner 2'     | '150'           | ''                    |
	And I close all client application windows
...
Scenario: _0991147 check Credit note accounting movements (Other)
	...
	* Check JE
		...
		And "RegisterRecords" table became equal
			| '#' | 'Activity' | 'Account Dr' | 'Ext. Dim. Debit' | 'Extra dimension2 Dr' | 'Extra dimension3 Dr' | 'Debit currency' | 'Debit amount' | 'DebitQuantity' | 'Account Cr' | 'Ext. Dim. Credit' | 'Extra dimension2 Cr' | 'Extra dimension3 Cr' | 'Credit currency' | 'Credit amount' | 'Credit quantity' | 'Amount' | 'Operation'                                                             |
			| '1' | 'Yes'      | '420.2'      | 'Other partner'   | 'Business unit 1'     | 'Other expence'       | 'TRY'            | '100'          | ''              | '9200'       | 'Business unit 1'  | 'Other partner'       | 'Other partner'       | 'TRY'             | '100'           | ''                | '100,00' | 'CreditNote DR (R5022T_Expenses) CR (R5015B_OtherPartnersTransactions)' |
	And I close all client application windows
...
Scenario: _0991195 check Payroll accounting movements (acruals, deductions, taxes)
	...
	* Check accounting movements
		...
		And "RegisterRecords" table became equal
			...
			| '3'  | 'Yes'      | '420.3'      | 'Employee 2'      | 'Business unit 2'     | 'Salary (expense)'      | 'TRY'            | '3 272,73'     | ''              | '9200'       | 'Business unit 2'             | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '3 272,73'      | ''                | '3 272,73'  | 'Payroll DR (R5022T_Expenses) CR (R5015B_OtherPartnersTransactions) (Taxes)'        |
			...
			| '9'  | 'Yes'      | '420.3'      | 'Employee 1'      | 'Business unit 2'     | 'Salary (expense)'      | 'TRY'            | '3 660,36'     | ''              | '9200'       | 'Business unit 2'             | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '3 660,36'      | ''                | '3 660,36'  | 'Payroll DR (R5022T_Expenses) CR (R5015B_OtherPartnersTransactions) (Taxes)'        |
...
Scenario: _0991196 check Payroll accounting movements (cash advance deduction)
	...
	* Check JE
		...
		And "RegisterRecords" table became equal
			| '#'  | 'Activity' | 'Account Dr' | 'Ext. Dim. Debit' | 'Extra dimension2 Dr' | 'Extra dimension3 Dr'   | 'Debit currency' | 'Debit amount' | 'DebitQuantity' | 'Account Cr' | 'Ext. Dim. Credit' | 'Extra dimension2 Cr' | 'Extra dimension3 Cr' | 'Credit currency' | 'Credit amount' | 'Credit quantity' | 'Amount'    | 'Operation'                                                                         |
			| '1'  | 'Yes'      | '5401'       | ''                | ''                    | ''                      | 'TRY'            | '3 100'        | ''              | '9200'       | ''                 | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '3 100'         | ''                | '3 100,00'  | 'Payroll DR (R9510B_SalaryPayment) CR (R5015B_OtherPartnersTransactions) (Taxes)'   |
			| '2'  | 'Yes'      | '420.3'      | 'Employee 1'      | 'Business unit 2'     | 'Expence and revenue 1' | 'TRY'            | '-100'         | ''              | '5401'       | ''                 | ''                    | ''                    | 'TRY'             | '-100'          | ''                | '-100,00'   | 'Payroll DR (R5022T_Expenses) CR (R9510B_SalaryPayment) (Deduction Is Not Revenue)' |
			...
			| '4'  | 'Yes'      | '420.3'      | 'Employee 2'      | 'Business unit 2'     | 'Salary (expense)'      | 'TRY'            | '3 600'        | ''              | '9200'       | 'Business unit 2'  | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '3 600'         | ''                | '3 600,00'  | 'Payroll DR (R5022T_Expenses) CR (R5015B_OtherPartnersTransactions) (Taxes)'        |
			...
			| '7'  | 'Yes'      | '5401'       | ''                | ''                    | ''                      | 'TRY'            | '2 050'        | ''              | '9200'       | ''                 | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '2 050'         | ''                | '2 050,00'  | 'Payroll DR (R9510B_SalaryPayment) CR (R5015B_OtherPartnersTransactions) (Taxes)'   |
			| '8'  | 'Yes'      | '5401'       | ''                | ''                    | ''                      | 'TRY'            | '2 400'        | ''              | '9200'       | ''                 | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '2 400'         | ''                | '2 400,00'  | 'Payroll DR (R9510B_SalaryPayment) CR (R5015B_OtherPartnersTransactions) (Taxes)'   |
			| '9'  | 'Yes'      | '420.3'      | 'Employee 1'      | 'Business unit 2'     | 'Salary (expense)'      | 'TRY'            | '4 100'        | ''              | '9200'       | 'Business unit 2'  | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '4 100'         | ''                | '4 100,00'  | 'Payroll DR (R5022T_Expenses) CR (R5015B_OtherPartnersTransactions) (Taxes)'        |
			...
			| '11' | 'Yes'      | '5401'       | ''                | ''                    | ''                      | 'TRY'            | '1 600'        | ''              | '9200'       | ''                 | 'Tax authority'       | 'Tax authority'       | 'TRY'             | '1 600'         | ''                | '1 600,00'  | 'Payroll DR (R9510B_SalaryPayment) CR (R5015B_OtherPartnersTransactions) (Taxes)'   |
		Then the number of "RegisterRecords" table lines is "равно" "11"
		And I close all client application windows
