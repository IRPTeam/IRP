...
Scenario: _099200 preparation (accountant automated workplace)
	...
	* Set important attributes for Purchase invoice
		// set at server on purpose: the shared auto filling fixture ends with a click on
		// the List button, and in this tag it runs after _0991230, whose failure can leave
		// an error window open - the click then has nothing to hit
