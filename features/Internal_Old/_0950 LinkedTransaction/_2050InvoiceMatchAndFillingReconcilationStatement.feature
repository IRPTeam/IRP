...
Scenario: _2050005 check the movements of the Invoice match document with the vendor in advance (manual filling)
	...
	* Check movements
		...
		| ''                                    | 'Expense'     | '*'      | '171,2'    | 'Main Company' | '$$PurchaseInvoice2040005$$' | 'Crystal'      | 'Company Adel' | 'Vendor, TRY'            | 'USD'                          | 'Reporting currency'           | 'No'                   |
...
Scenario: _2050006 check the movements of the Invoice match document with the customer in advance (manual filling)
	...
	* Check movements
		...
		| ''                                    | 'Expense'     | '*'      | '171,2'    | 'Main Company' | 'Crystal'                  | 'Company Adel' | 'USD'          | '$$BankReceipt2050001$$'  | 'Reporting currency'           | 'No'                           | ''                     |
