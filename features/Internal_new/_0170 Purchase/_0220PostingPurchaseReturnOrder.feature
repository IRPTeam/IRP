...
Scenario: _022011 check the output of the document movement report for Purchase return order
	...
	* Check the report generation
		...
		| ''                               | '*'           | '-2'        | '-80'       | '67,80'      | 'Main Company'                  | '$$PurchaseInvoice018006$$' | 'USD'      | 'L/Green'  | '*'       | 'en description is empty'      | 'No'                   |
		| ''                               | '*'           | '-2'        | '-80'       | '67,80'      | 'Main Company'                  | '$$PurchaseInvoice018006$$' | 'USD'      | 'L/Green'  | '*'       | 'Reporting currency'           | 'No'                   |
		| ''                               | '*'           | '-2'        | '-80'       | '67,80'      | 'Main Company'                  | '$$PurchaseInvoice018006$$' | 'USD'      | 'L/Green'  | '*'       | 'USD'                          | 'No'                   |
		| ''                               | ''            | ''          | ''          | ''           | ''                              | ''                          | ''         | ''         | ''        | ''                             | ''                     |
		| 'Register  "Order reservation"'  | ''            | ''          | ''          | ''           | ''                              | ''                          | ''         | ''         | ''        | ''                             | ''                     |
		| ''                               | 'Record type' | 'Period'    | 'Resources' | 'Dimensions' | ''                              | ''                          | ''         | ''         | ''        | ''                             | ''                     |
		| ''                               | ''            | ''          | 'Quantity'  | 'Store'      | 'Item key'                      | ''                          | ''         | ''         | ''        | ''                             | ''                     |
