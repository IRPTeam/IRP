	...
	* Check tax recalculation when uncheck/re-check Price include Tax
		...
		* Check retail sales receipt movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                               | '*'           | '13,58'     | '13,58'         | '75,46'         | '$$RetailSalesReceipt015413$$' | 'VAT'           | ''                              | '18%'                  | 'Yes'                          | '*'                    | 'USD'                          | 'Reporting currency'           | 'No'                   |
				| ''                               | '*'           | '14,37'     | '14,37'         | '79,81'         | '$$RetailSalesReceipt015413$$' | 'VAT'           | ''                              | '18%'                  | 'Yes'                          | '*'                    | 'USD'                          | 'Reporting currency'           | 'No'                   |
				| ''                               | '*'           | '18,28'     | '18,28'         | '101,58'        | '$$RetailSalesReceipt015413$$' | 'VAT'           | ''                              | '18%'                  | 'Yes'                          | '*'                    | 'USD'                          | 'Reporting currency'           | 'No'                   |
				...
				| ''                               | '*'           | '1'         | '89,04'         | '75,46'         | ''                              | 'Main Company'  | '$$RetailSalesReceipt015413$$' | 'USD'                  | 'XS/Blue'                      | '*'                    | 'Reporting currency'           | ''                             | 'No'                   |
				| ''                               | '*'           | '1'         | '94,18'         | '79,81'         | ''                              | 'Main Company'  | '$$RetailSalesReceipt015413$$' | 'USD'                  | 'L/Green'                      | '*'                    | 'Reporting currency'           | ''                             | 'No'                   |
				...
				| ''                               | '*'           | '2'         | '119,86'        | '101,58'        | ''                              | 'Main Company'  | '$$RetailSalesReceipt015413$$' | 'USD'                  | '38/Black'                     | '*'                    | 'Reporting currency'           | ''                             | 'No'                   |
				...
				| ''                               | '*'           | '75,46'     | 'Main Company'  | 'Shop 01'       | ''                              | 'XS/Blue'       | 'USD'                           | ''                     | 'Reporting currency'           | 'No'                   | ''                             | ''                             | ''                     |
				| ''                               | '*'           | '79,81'     | 'Main Company'  | 'Shop 01'       | ''                              | 'L/Green'       | 'USD'                           | ''                     | 'Reporting currency'           | 'No'                   | ''                             | ''                             | ''                     |
				| ''                               | '*'           | '101,58'    | 'Main Company'  | 'Shop 01'       | ''                              | '38/Black'      | 'USD'                           | ''                     | 'Reporting currency'           | 'No'                   | ''                             | ''                             | ''                     |
				...
				| ''                               | 'Receipt'     | '*'         | '220,89'        | 'Main Company'  | 'Transit Main'                  | 'USD'           | 'Reporting currency'            | 'No'                   | ''                             | ''                     | ''                             | ''                             | ''                     |
...
Scenario: _0154136 create document Retail Return Receipt based on RetailSalesReceipt
	...
	* Check retail sales receipt movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                   | '*'           | '-1'        | '-94,18'    | 'Main Company' | '$$RetailSalesReceipt015413$$' | 'USD'           | 'L/Green'                      | '*'                    | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			| ''                                   | '*'           | '-1'        | '-59,93'    | 'Main Company' | '$$RetailSalesReceipt015413$$' | 'USD'           | '38/Black'                     | '*'                    | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			| ''                                   | ''            | ''          | ''          | ''             | ''                             | ''              | ''                             | ''                     | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Retail sales"'           | ''            | ''          | ''          | ''             | ''                             | ''              | ''                             | ''                     | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                   | 'Record type' | 'Period'    | 'Resources' | ''             | ''                             | ''              | 'Dimensions'                   | ''                     | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                   | ''            | ''          | 'Quantity'  | 'Amount'       | 'Net amount'                   | 'Offers amount' | 'Company'                      | 'Business unit'        | 'Store'                        | 'Retail sales receipt'         | 'Item key'                     | 'Serial lot number' | 'Row key'              |
			...
			| ''                                   | '*'           | '-1'        | '-94,18'    | '-79,81'       | ''                             | 'Main Company'  | '$$RetailSalesReceipt015413$$' | 'USD'                  | 'L/Green'                      | '*'                            | 'Reporting currency'           | ''                  | 'No'                   |
			| ''                                   | '*'           | '-1'        | '-59,93'    | '-50,79'       | ''                             | 'Main Company'  | '$$RetailSalesReceipt015413$$' | 'USD'                  | '38/Black'                     | '*'                            | 'Reporting currency'           | ''                  | 'No'                   |
			| ''                                   | ''            | ''          | ''          | ''             | ''                             | ''              | ''                             | ''                     | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Account balance"'        | ''            | ''          | ''          | ''             | ''                             | ''              | ''                             | ''                     | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                   | 'Record type' | 'Period'    | 'Resources' | 'Dimensions'   | ''                             | ''              | ''                             | 'Attributes'           | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                   | ''            | ''          | 'Amount'    | 'Company'      | 'Account'                      | 'Currency'      | 'Multi currency movement type' | 'Deferred calculation' | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                   | 'Expense'     | '*'         | '154,11'    | 'Main Company' | 'Transit Main'                 | 'USD'           | 'Reporting currency'           | 'No'                   | ''                             | ''                             | ''                             | ''                  | ''                     |
