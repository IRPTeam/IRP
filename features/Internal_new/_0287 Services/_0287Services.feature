...
Scenario: _029115 create a Sales invoice for service and product (Store doesn't use Shipment confirmation, based on $$SalesOrder029107$$)
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                        | ''               | ''                        | ''                         | ''                             | ''                             | 'Attributes'                   | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'          | 'Partner'        | 'Legal name'              | 'Partner term'             | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation'         | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '1 215,75'             | 'Main Company'   | '$$SalesInvoice029115$$' | 'Ferron BP'      | 'Company Ferron BP'       | 'Basic Partner terms, TRY' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                             | ''                     |
			...
			| ''                                           | '*'           | '182,84'    | '182,84'               | '1 015,79'       | '$$SalesInvoice029115$$' | 'VAT'            | ''                        | '18%'                      | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | '*'           | '10'        | '1 198,63'             | '1 015,79'       | ''                        | 'Main Company'   | '$$SalesInvoice029115$$' | 'USD'                      | 'Table'                        | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			...
			| ''                                           | '*'           | '1 015,79'  | 'Main Company'         | ''               | ''                        | 'Table'          | 'USD'                     | ''                         | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
...
Scenario: _029117 create a Sales invoice for service and product (Store use Shipment confirmation, based on $$SalesOrder029107$$)
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                       | ''                                 | ''                             | ''                             | 'Attributes'                   | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'         | 'Partner'        | 'Legal name'             | 'Partner term'                     | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation'         | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '1 329,82'             | 'Main Company'   | '$$SalesInvoice029117$$' | 'Ferron BP'      | 'Company Ferron BP'      | 'Basic Partner terms, without VAT' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                             | ''                     |
			...
			| ''                                           | '*'           | '199,77'    | '199,77'               | '1 109,85'       | '$$SalesInvoice029117$$' | 'VAT'            | ''                       | '18%'                              | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | 'Period'      | 'Resources' | ''                     | ''               | ''                       | 'Dimensions'     | ''                       | ''                                 | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                                           | ''            | 'Quantity'  | 'Amount'               | 'Net amount'     | 'Offers amount'          | 'Company'        | 'Sales invoice'          | 'Currency'                         | 'Item key'                     | 'Row key'                      | 'Multi currency movement type' | 'Serial lot number'            | 'Deferred calculation' |
			| ''                                           | '*'           | '1'         | '20,21'                | '17,12'          | ''                       | 'Main Company'   | '$$SalesInvoice029117$$' | 'USD'                              | 'Rent'                         | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			...
			| ''                                           | '*'           | '10'        | '1 309,62'             | '1 109,85'       | ''                       | 'Main Company'   | '$$SalesInvoice029117$$' | 'USD'                              | 'Table'                        | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			...
			| ''                                           | '*'           | '1 109,85'  | 'Main Company'         | ''               | ''                       | 'Table'          | 'USD'                    | ''                                 | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
...
Scenario: _029119 create a Sales invoice for service and product (Store doesn't use Shipment confirmation, based on $$NumberSalesOrder029109$$)
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'           | ''                       | ''               | ''                       | ''                         | ''                             | ''                             | 'Attributes'                   | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'              | 'Basis document'         | 'Partner'        | 'Legal name'             | 'Partner term'             | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation'         | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '1 215,75'             | 'Main Company'         | '$$SalesInvoice029119$$' | 'Ferron BP'      | 'Company Ferron BP'      | 'Basic Partner terms, TRY' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                             | ''                     |
			...
			| ''                                           | '*'           | '182,84'    | '182,84'               | '1 015,79'             | '$$SalesInvoice029119$$' | 'VAT'            | ''                       | '18%'                      | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | '*'           | '10'        | '1 198,63'             | '1 015,79'             | ''                       | 'Main Company'   | '$$SalesInvoice029119$$' | 'USD'                      | 'Table'                        | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
...
Scenario: _029121 create a Sales invoice for service and product (Store use Shipment confirmation, based on $$NumberSalesOrder029110$$)
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'           | ''                               | ''               | ''                       | ''                                 | ''                             | ''                             | 'Attributes'                   | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'              | 'Basis document'                 | 'Partner'        | 'Legal name'             | 'Partner term'                     | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation'         | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '1 329,82'             | 'Main Company'         | '$$SalesInvoice029121$$'         | 'Ferron BP'      | 'Company Ferron BP'      | 'Basic Partner terms, without VAT' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                             | ''                     |
			...
			| ''                                           | '*'           | '199,77'    | '199,77'               | '1 109,85'             | '$$SalesInvoice029121$$'         | 'VAT'            | ''                       | '18%'                              | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | 'Period'      | 'Resources' | ''                     | ''                     | ''                               | 'Dimensions'     | ''                       | ''                                 | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                                           | ''            | 'Quantity'  | 'Amount'               | 'Net amount'           | 'Offers amount'                  | 'Company'        | 'Sales invoice'          | 'Currency'                         | 'Item key'                     | 'Row key'                      | 'Multi currency movement type' | 'Serial lot number'            | 'Deferred calculation' |
			| ''                                           | '*'           | '1'         | '20,21'                | '17,12'                | ''                               | 'Main Company'   | '$$SalesInvoice029121$$' | 'USD'                              | 'Rent'                         | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			...
			| ''                                           | '*'           | '10'        | '1 309,62'             | '1 109,85'             | ''                               | 'Main Company'   | '$$SalesInvoice029121$$' | 'USD'                              | 'Table'                        | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
...
Scenario: _029130 create Retail sales receipt for service and product
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                               | 'Period'      | 'Resources' | ''              | ''              | 'Dimensions'                   | ''              | ''                             | ''                    | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                               | ''            | 'Amount'    | 'Manual amount' | 'Net amount'    | 'Document'                     | 'Tax'           | 'Analytics'                    | 'Tax rate'            | 'Include to total amount'      | 'Row key'                      | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                               | '*'           | '1,31'      | '1,31'          | '7,26'          | '$$RetailSalesReceipt029130$$' | 'VAT'           | ''                             | '18%'                 | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                               | 'Period'      | 'Resources' | ''              | ''              | ''                             | 'Dimensions'    | ''                             | ''                    | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                               | ''            | 'Quantity'  | 'Amount'        | 'Net amount'    | 'Offers amount'                | 'Company'       | 'Sales invoice'                | 'Currency'            | 'Item key'                     | 'Row key'                      | 'Multi currency movement type' | 'Serial lot number'            | 'Deferred calculation' |
			| ''                               | '*'           | '1'         | '8,56'          | '7,26'          | ''                             | 'Main Company'  | '$$RetailSalesReceipt029130$$' | 'USD'                 | 'Interner'                     | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			| ''                               | '*'           | '1'         | '34,25'         | '29,02'         | ''                             | 'Main Company'  | '$$RetailSalesReceipt029130$$' | 'USD'                 | 'Table'                        | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			...
			| ''                               | 'Period'      | 'Resources' | 'Dimensions'    | ''              | ''                             | ''              | ''                             | ''                    | ''                             | 'Attributes'                   | ''                             | ''                             | ''                     |
			| ''                               | ''            | 'Amount'    | 'Company'       | 'Business unit' | 'Revenue type'                 | 'Item key'      | 'Currency'                     | 'Additional analytic' | 'Multi currency movement type' | 'Deferred calculation'         | ''                             | ''                             | ''                     |
			| ''                               | '*'           | '7,26'      | 'Main Company'  | ''              | ''                             | 'Interner'      | 'USD'                          | ''                    | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
			| ''                               | '*'           | '58,04'     | 'Main Company'  | ''              | ''                             | 'Table'         | 'USD'                          | ''                    | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
...
Scenario: _029140 create PurchaseReturn for service and product (based on $$PurchaseInvoice029106$$)
	...
	And "ResultTable" spreadsheet document contains lines:
		...
		| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                          | ''                          | ''                  | ''                   | ''                             | ''                             | 'Attributes'           |
		| ''                                      | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'            | 'Partner'                   | 'Legal name'        | 'Partner term'       | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation' |
		| ''                                      | 'Receipt'     | '*'         | '51,37'                | 'Main Company'   | '$$PurchaseReturn029140$$'  | 'Ferron BP'                 | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'USD'                          | 'Reporting currency'           | 'No'                   |
		...
		| ''                                      | '*'           | '-1'        | '-34,25'               | 'Main Company'   | '$$PurchaseInvoice029106$$' | 'USD'                       | 'Router'            | '*'                  | 'Reporting currency'           | 'No'                           | ''                     |
...
Scenario: _029141 create Purchase return order/Purchase return for service and product (based on $$PurchaseInvoice029106$$)
	...
	And "ResultTable" spreadsheet document contains lines:
		...
		| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                              | ''               | ''                  | ''                   | ''                             | ''                             | 'Attributes'           |
		| ''                                      | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'                | 'Partner'        | 'Legal name'        | 'Partner term'       | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation' |
		| ''                                      | 'Receipt'     | '*'         | '51,37'                | 'Main Company'   | '$$PurchaseReturn029141$$'      | 'Ferron BP'      | 'Company Ferron BP' | 'Vendor Ferron, TRY' | 'USD'                          | 'Reporting currency'           | 'No'                   |
...
Scenario: _029142 create Purchase return for service and product without Purchase invoice
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | 'Attributes'           |
			| ''                                      | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'           | 'Partner'          | 'Legal name'   | 'Partner term'            | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                      | 'Receipt'     | '*'         | '50,51'                | 'Main Company'   | '$$PurchaseReturn029142$$' | 'DFC'              | 'DFC'          | 'Partner term vendor DFC' | 'USD'                          | 'Reporting currency'           | 'No'                   |
			| ''                                      | 'Receipt'     | '*'         | '295'                  | 'Main Company'   | '$$PurchaseReturn029142$$' | 'DFC'              | 'DFC'          | 'Partner term vendor DFC' | 'TRY'                          | 'Local currency'               | 'No'                   |
			| ''                                      | 'Receipt'     | '*'         | '295'                  | 'Main Company'   | '$$PurchaseReturn029142$$' | 'DFC'              | 'DFC'          | 'Partner term vendor DFC' | 'TRY'                          | 'TRY'                          | 'No'                   |
			| ''                                      | 'Receipt'     | '*'         | '295'                  | 'Main Company'   | '$$PurchaseReturn029142$$' | 'DFC'              | 'DFC'          | 'Partner term vendor DFC' | 'TRY'                          | 'en description is empty'      | 'No'                   |
			| ''                                      | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| 'Register  "Purchase return turnovers"' | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | 'Period'      | 'Resources' | ''                     | 'Dimensions'     | ''                         | ''                 | ''             | ''                        | ''                             | 'Attributes'                   | ''                     |
			| ''                                      | ''            | 'Quantity'  | 'Amount'               | 'Company'        | 'Purchase invoice'         | 'Currency'         | 'Item key'     | 'Row key'                 | 'Multi currency movement type' | 'Deferred calculation'         | ''                     |
			| ''                                      | '*'           | '-1'        | '-236'                 | 'Main Company'   | ''                         | 'TRY'              | 'Table'        | '*'                       | 'Local currency'               | 'No'                           | ''                     |
			| ''                                      | '*'           | '-1'        | '-236'                 | 'Main Company'   | ''                         | 'TRY'              | 'Table'        | '*'                       | 'TRY'                          | 'No'                           | ''                     |
			| ''                                      | '*'           | '-1'        | '-236'                 | 'Main Company'   | ''                         | 'TRY'              | 'Table'        | '*'                       | 'en description is empty'      | 'No'                           | ''                     |
			| ''                                      | '*'           | '-1'        | '-59'                  | 'Main Company'   | ''                         | 'TRY'              | 'Interner'     | '*'                       | 'Local currency'               | 'No'                           | ''                     |
			| ''                                      | '*'           | '-1'        | '-59'                  | 'Main Company'   | ''                         | 'TRY'              | 'Interner'     | '*'                       | 'TRY'                          | 'No'                           | ''                     |
			| ''                                      | '*'           | '-1'        | '-59'                  | 'Main Company'   | ''                         | 'TRY'              | 'Interner'     | '*'                       | 'en description is empty'      | 'No'                           | ''                     |
			| ''                                      | '*'           | '-1'        | '-40,41'               | 'Main Company'   | ''                         | 'USD'              | 'Table'        | '*'                       | 'Reporting currency'           | 'No'                           | ''                     |
			| ''                                      | '*'           | '-1'        | '-10,1'                | 'Main Company'   | ''                         | 'USD'              | 'Interner'     | '*'                       | 'Reporting currency'           | 'No'                           | ''                     |
			| ''                                      | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| 'Register  "Inventory balance"'         | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | ''            | ''          | 'Quantity'             | 'Company'        | 'Item key'                 | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			...
			| ''                                      | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'               | ''                 | ''             | ''                        | ''                             | ''                             | 'Attributes'           |
			| ''                                      | ''            | 'Quantity'  | 'Amount'               | 'Net amount'     | 'Company'                  | 'Purchase invoice' | 'Currency'     | 'Item key'                | 'Row key'                      | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                      | '*'           | '-1'        | '-236'                 | '-200'           | 'Main Company'             | ''                 | 'TRY'          | 'Table'                   | '*'                            | 'Local currency'               | 'No'                   |
			| ''                                      | '*'           | '-1'        | '-236'                 | '-200'           | 'Main Company'             | ''                 | 'TRY'          | 'Table'                   | '*'                            | 'TRY'                          | 'No'                   |
			| ''                                      | '*'           | '-1'        | '-236'                 | '-200'           | 'Main Company'             | ''                 | 'TRY'          | 'Table'                   | '*'                            | 'en description is empty'      | 'No'                   |
			| ''                                      | '*'           | '-1'        | '-59'                  | '-50'            | 'Main Company'             | ''                 | 'TRY'          | 'Interner'                | '*'                            | 'Local currency'               | 'No'                   |
			| ''                                      | '*'           | '-1'        | '-59'                  | '-50'            | 'Main Company'             | ''                 | 'TRY'          | 'Interner'                | '*'                            | 'TRY'                          | 'No'                   |
			| ''                                      | '*'           | '-1'        | '-59'                  | '-50'            | 'Main Company'             | ''                 | 'TRY'          | 'Interner'                | '*'                            | 'en description is empty'      | 'No'                   |
			| ''                                      | '*'           | '-1'        | '-40,41'               | '-34,25'         | 'Main Company'             | ''                 | 'USD'          | 'Table'                   | '*'                            | 'Reporting currency'           | 'No'                   |
			| ''                                      | '*'           | '-1'        | '-10,1'                | '-8,56'          | 'Main Company'             | ''                 | 'USD'          | 'Interner'                | '*'                            | 'Reporting currency'           | 'No'                   |
			| ''                                      | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| 'Register  "Accounts statement"'        | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | 'Record type' | 'Period'    | 'Resources'            | ''               | ''                         | ''                 | 'Dimensions'   | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | ''            | ''          | 'Advance to suppliers' | 'Transaction AP' | 'Advance from customers'   | 'Transaction AR'   | 'Company'      | 'Partner'                 | 'Legal name'                   | 'Basis document'               | 'Currency'             |
			| ''                                      | 'Receipt'     | '*'         | ''                     | '-295'           | ''                         | ''                 | 'Main Company' | 'DFC'                     | 'DFC'                          | '$$PurchaseReturn029142$$'     | 'TRY'                  |
			| ''                                      | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| 'Register  "Stock reservation"'         | ''            | ''          | ''                     | ''               | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | ''            | ''          | 'Quantity'             | 'Store'          | 'Item key'                 | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			...
			| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                         | ''                 | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | ''            | ''          | 'Amount'               | 'Company'        | 'Legal name'               | 'Currency'         | ''             | ''                        | ''                             | ''                             | ''                     |
			| ''                                      | 'Receipt'     | '*'         | '295'                  | 'Main Company'   | 'DFC'                      | 'TRY'              | ''             | ''                        | ''                             | ''                             | ''                     |
		Given I open hyperlink "e1cib/list/AccumulationRegister.StockReservation"
		And "List" table does not contain lines
			| 'Recorder'                     | 'Item key' |
...
Scenario: _029150 create Retail return receipt for service and product
	* Create Retail return receipt based on Retail sales receipt
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                   | '*'           | '-1'        | '-34,25'    | 'Main Company' | '$$RetailSalesReceipt029130$$' | 'USD'           | 'Table'                        | '*'                    | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			...
			| ''                                   | 'Expense'     | '*'         | '77,05'     | 'Main Company' | 'Cash desk №4'                 | 'USD'           | 'Reporting currency'           | 'No'                   | ''                             | ''                             | ''                             | ''                  | ''                     |
	...
	* Create Retail return receipt without Retail sales receipt
		...
		* Check movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                   | '*'           | '-1'        | '-34,25'    | 'Main Company' | '$$RetailReturnReceipt029150$$' | 'USD'           | 'Table'                         | '*'                    | 'Reporting currency'           | 'No'                            | ''                             | ''                  | ''                     |
				...
				| ''                                   | '*'           | '-1'        | '-34,25'    | '-29,02'       | ''                              | 'Main Company'  | '$$RetailReturnReceipt029150$$' | 'USD'                  | 'Table'                        | '*'                             | 'Reporting currency'           | ''                  | 'No'                   |
				| ''                                   | '*'           | '-1'        | '-8,56'     | '-7,26'        | ''                              | 'Main Company'  | '$$RetailReturnReceipt029150$$' | 'USD'                  | 'Interner'                     | '*'                             | 'Reporting currency'           | ''                  | 'No'                   |
				| ''                                   | ''            | ''          | ''          | ''             | ''                              | ''              | ''                              | ''                     | ''                             | ''                              | ''                             | ''                  | ''                     |
				| 'Register  "Account balance"'        | ''            | ''          | ''          | ''             | ''                              | ''              | ''                              | ''                     | ''                             | ''                              | ''                             | ''                  | ''                     |
				| ''                                   | 'Record type' | 'Period'    | 'Resources' | 'Dimensions'   | ''                              | ''              | ''                              | 'Attributes'           | ''                             | ''                              | ''                             | ''                  | ''                     |
				| ''                                   | ''            | ''          | 'Amount'    | 'Company'      | 'Account'                       | 'Currency'      | 'Multi currency movement type'  | 'Deferred calculation' | ''                             | ''                              | ''                             | ''                  | ''                     |
				| ''                                   | 'Expense'     | '*'         | '42,81'     | 'Main Company' | 'Cash desk №4'                  | 'USD'           | 'Reporting currency'            | 'No'                   | ''                             | ''                              | ''                             | ''                  | ''                     |
...
Scenario: _029160 create Sales return for service and product (Store use Shipment confirmation, based on $$NumberSalesInvoice029121$$)
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                      | '*'           | '-10'       | '-1 309,62'            | 'Main Company'   | '$$SalesInvoice029121$$' | 'USD'            | 'Table'                  | '*'                                | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			...
			| ''                                      | '*'           | '-1'        | '-20,21'               | 'Main Company'   | '$$SalesInvoice029121$$' | 'USD'            | 'Rent'                   | '*'                                | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			| ''                                      | ''            | ''          | ''                     | ''               | ''                       | ''               | ''                       | ''                                 | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Goods in transit incoming"' | ''            | ''          | ''                     | ''               | ''                       | ''               | ''                       | ''                                 | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                       | ''                                 | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                      | ''            | ''          | 'Quantity'             | 'Store'          | 'Receipt basis'          | 'Item key'       | 'Row key'                | ''                                 | ''                             | ''                             | ''                             | ''                  | ''                     |
			...
			| ''                                      | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                       | ''                                 | ''                             | ''                             | 'Attributes'                   | ''                  | ''                     |
			| ''                                      | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'         | 'Partner'        | 'Legal name'             | 'Partner term'                     | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation'         | ''                  | ''                     |
			| ''                                      | 'Receipt'     | '*'         | '1 329,82'             | 'Main Company'   | '$$SalesReturn29160$$'   | 'Ferron BP'      | 'Company Ferron BP'      | 'Basic Partner terms, without VAT' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                  | ''                     |
...
Scenario: _029161 create Sales return for service and product (Store doesn't use Shipment confirmation, based on $$NumberSalesInvoice029109$$)
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:	
			...
			| ''                                     | '*'           | '-10'       | '-1 198,63'            | 'Main Company'   | '$$SalesInvoice029119$$' | 'USD'            | 'Table'                  | '*'                        | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			...
			| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                       | ''                         | ''                             | ''                             | 'Attributes'                   | ''                  | ''                     |
			| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'         | 'Partner'        | 'Legal name'             | 'Partner term'             | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation'         | ''                  | ''                     |
			| ''                                     | 'Receipt'     | '*'         | '1 215,75'             | 'Main Company'   | '$$SalesReturn29161$$'   | 'Ferron BP'      | 'Company Ferron BP'      | 'Basic Partner terms, TRY' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                  | ''                     |
...
Scenario: _029162 create Sales return without Sales invoice
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | '*'           | '-1'        | '-34,25'               | 'Main Company'   | '$$SalesReturn029162$$'   | 'USD'             | 'Table'                   | '*'                   | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			| ''                                     | '*'           | '-1'        | '-8,56'                | 'Main Company'   | '$$SalesReturn029162$$'   | 'USD'             | 'Interner'                | '*'                   | 'Reporting currency'           | 'No'                           | ''                             | ''                  | ''                     |
			| ''                                     | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Accounts statement"'       | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | 'Record type' | 'Period'    | 'Resources'            | ''               | ''                        | ''                | 'Dimensions'              | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | ''            | ''          | 'Advance to suppliers' | 'Transaction AP' | 'Advance from customers'  | 'Transaction AR'  | 'Company'                 | 'Partner'             | 'Legal name'                   | 'Basis document'               | 'Currency'                     | ''                  | ''                     |
			| ''                                     | 'Receipt'     | '*'         | ''                     | ''               | ''                        | '-250'            | 'Main Company'            | 'Retail customer'     | 'Company Retail customer'      | '$$SalesReturn029162$$'        | 'TRY'                          | ''                  | ''                     |
			| ''                                     | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Stock reservation"'        | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | ''            | ''          | 'Quantity'             | 'Store'          | 'Item key'                | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			...
			| ''                                     | '*'           | '-1'        | '-34,25'               | '-29,02'         | ''                        | 'Main Company'    | '$$SalesReturn029162$$'   | 'USD'                 | 'Table'                        | '*'                            | 'Reporting currency'           | ''                  | 'No'                   |
			| ''                                     | '*'           | '-1'        | '-8,56'                | '-7,26'          | ''                        | 'Main Company'    | '$$SalesReturn029162$$'   | 'USD'                 | 'Interner'                     | '*'                            | 'Reporting currency'           | ''                  | 'No'                   |
			| ''                                     | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Reconciliation statement"' | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Legal name'              | 'Currency'        | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | 'Expense'     | '*'         | '250'                  | 'Main Company'   | 'Company Retail customer' | 'TRY'             | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Partner AP transactions"'  | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | 'Attributes'                   | ''                  | ''                     |
			| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'          | 'Partner'         | 'Legal name'              | 'Partner term'        | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation'         | ''                  | ''                     |
			| ''                                     | 'Receipt'     | '*'         | '42,81'                | 'Main Company'   | '$$SalesReturn029162$$'   | 'Retail customer' | 'Company Retail customer' | 'Retail partner term' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                  | ''                     |
			| ''                                     | 'Receipt'     | '*'         | '250'                  | 'Main Company'   | '$$SalesReturn029162$$'   | 'Retail customer' | 'Company Retail customer' | 'Retail partner term' | 'TRY'                          | 'Local currency'               | 'No'                           | ''                  | ''                     |
			| ''                                     | 'Receipt'     | '*'         | '250'                  | 'Main Company'   | '$$SalesReturn029162$$'   | 'Retail customer' | 'Company Retail customer' | 'Retail partner term' | 'TRY'                          | 'TRY'                          | 'No'                           | ''                  | ''                     |
			| ''                                     | 'Receipt'     | '*'         | '250'                  | 'Main Company'   | '$$SalesReturn029162$$'   | 'Retail customer' | 'Company Retail customer' | 'Retail partner term' | 'TRY'                          | 'en description is empty'      | 'No'                           | ''                  | ''                     |
			| ''                                     | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| 'Register  "Stock balance"'            | ''            | ''          | ''                     | ''               | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                        | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
			| ''                                     | ''            | ''          | 'Quantity'             | 'Store'          | 'Item key'                | ''                | ''                        | ''                    | ''                             | ''                             | ''                             | ''                  | ''                     |
