...
Scenario: _060002 create Sales invoice with the type of settlements under standard Partner terms and check its movements
	* Create Sales invoice
		...
		* Check Sales invoice movements
			...
			| ''                                           | 'Receipt'     | '*'         | '1 883,56'             | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'      | 'Standard'            | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '11 000'               | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'      | 'Standard'            | 'TRY'                          | 'Local currency'               | 'No'                           | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '11 000'               | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'      | 'Standard'            | 'TRY'                          | 'TRY'                          | 'No'                           | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '11 000'               | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'      | 'Standard'            | 'TRY'                          | 'en description is empty'      | 'No'                           | ''                             | ''                     |
			| ''                                           | ''            | ''          | ''                     | ''               | ''                       | ''               | ''                       | ''                    | ''                             | ''                             | ''                             | ''                             | ''                     |
			...
			| ''                                           | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$SalesInvoice060002$$' | 'VAT'            | ''                       | '18%'                 | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | '*'           | '20'        | '1 883,56'             | '1 596,24'       | ''                       | 'Main Company'   | '$$SalesInvoice060002$$' | 'USD'                 | 'L/Green'                      | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			...
			| ''                                           | '*'           | '1 596,24'  | 'Main Company'         | ''               | ''                       | 'L/Green'        | 'USD'                    | ''                    | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
...
Scenario: _060003 create Cash receipt with the type of settlements under standard Partner terms and check its movements
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | ''                     | ''                  | ''                             | 'Attributes'           |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Basis document'         | 'Partner'        | 'Legal name'                   | 'Partner term'         | 'Currency'          | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                     | 'Expense'     | '*'      | '1 883,56'             | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'            | 'Standard'             | 'USD'               | 'Reporting currency'           | 'No'                   |
			| ''                                     | 'Expense'     | '*'      | '11 000'               | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'            | 'Standard'             | 'TRY'               | 'Local currency'               | 'No'                   |
			| ''                                     | 'Expense'     | '*'      | '11 000'               | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'            | 'Standard'             | 'TRY'               | 'TRY'                          | 'No'                   |
			| ''                                     | 'Expense'     | '*'      | '11 000'               | 'Main Company'   | ''                       | 'Nicoletta'      | 'Company Nicoletta'            | 'Standard'             | 'TRY'               | 'en description is empty'      | 'No'                   |
			| ''                                     | ''            | ''       | ''                     | ''               | ''                       | ''               | ''                             | ''                     | ''                  | ''                             | ''                     |
			| 'Register  "Reconciliation statement"' | ''            | ''       | ''                     | ''               | ''                       | ''               | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Legal name'             | 'Currency'       | ''                             | ''                     | ''                  | ''                             | ''                     |
			...
			| ''                                     | 'Receipt'     | '*'      | '1 883,56'             | 'Main Company'   | 'Cash desk №2'           | 'USD'            | 'Reporting currency'           | 'No'                   | ''                  | ''                             | ''                     |
...
Scenario: _0600031 create Bank receipt with the type of settlements under standard Partner terms and check its movements
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | 'Attributes'           | ''                  | ''                             | ''                     |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Account'                | 'Currency'       | 'Multi currency movement type' | 'Deferred calculation' | ''                  | ''                             | ''                     |
			| ''                                     | 'Receipt'     | '*'      | '1 883,56'             | 'Main Company'   | 'Bank account, TRY'      | 'USD'            | 'Reporting currency'           | 'No'                   | ''                  | ''                             | ''                     |
...
Scenario: _060004 check the offset of the advance for Sales invoice with the type of settlement under standard Partner terms and check its movements
	...
	* Check Bank Receipt movements 
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Receipt'     | '*'      | '2 054,79'             | 'Main Company'   | 'Nicoletta'              | 'Company Nicoletta' | 'USD'                          | '$$BankReceipt060004$$' | 'Reporting currency'           | 'No'                   | ''         |
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''                  | ''                             | 'Attributes'            | ''                             | ''                     | ''         |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Account'                | 'Currency'          | 'Multi currency movement type' | 'Deferred calculation'  | ''                             | ''                     | ''         |
			| ''                                     | 'Receipt'     | '*'      | '2 054,79'             | 'Main Company'   | 'Bank account, TRY'      | 'USD'               | 'Reporting currency'           | 'No'                    | ''                             | ''                     | ''         |
	...
	* Check SalesInvoice movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                           | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'             | ''                  | ''                       | ''                      | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                                           | ''            | 'Amount'    | 'Manual amount'        | 'Net amount'     | 'Document'               | 'Tax'               | 'Analytics'              | 'Tax rate'              | 'Include to total amount'      | 'Row key'                      | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                           | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$SalesInvoice060004$$' | 'VAT'               | ''                       | '18%'                   | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | 'Period'      | 'Resources' | ''                     | ''               | ''                       | 'Dimensions'        | ''                       | ''                      | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                                           | ''            | 'Quantity'  | 'Amount'               | 'Net amount'     | 'Offers amount'          | 'Company'           | 'Sales invoice'          | 'Currency'              | 'Item key'                     | 'Row key'                      | 'Multi currency movement type' | 'Serial lot number'            | 'Deferred calculation' |
			| ''                                           | '*'           | '20'        | '1 883,56'             | '1 596,24'       | ''                       | 'Main Company'      | '$$SalesInvoice060004$$' | 'USD'                   | 'L/Green'                      | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			...
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''                  | ''                       | ''                      | ''                             | 'Attributes'                   | ''                             | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'        | 'Partner'                | 'Legal name'        | 'Currency'               | 'Receipt document'      | 'Multi currency movement type' | 'Deferred calculation'         | ''                             | ''                             | ''                     |
			| ''                                           | 'Expense'     | '*'         | '1 883,56'             | 'Main Company'   | 'Nicoletta'              | 'Company Nicoletta' | 'USD'                    | '$$BankReceipt060004$$' | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
...
Scenario: _060005 create Purchase invoice with the type of settlements under standard contracts and check its movements
	...
	* Check Purchase Invoice movements 
		...
		| ''                                     | '*'           | '20'        | '1 883,56'             | '1 596,24'       | 'Main Company'              | '$$PurchaseInvoice060005$$' | 'USD'              | 'L/Green'      | '*'                       | 'Reporting currency'           | 'No'                   | ''                             | ''                     |
		...
		| ''                                     | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'                | ''                          | ''                 | ''             | ''                        | ''                             | ''                     | ''                             | 'Attributes'           |
		| ''                                     | ''            | 'Amount'    | 'Manual amount'        | 'Net amount'     | 'Document'                  | 'Tax'                       | 'Analytics'        | 'Tax rate'     | 'Include to total amount' | 'Row key'                      | 'Currency'             | 'Multi currency movement type' | 'Deferred calculation' |
		| ''                                     | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$PurchaseInvoice060005$$' | 'VAT'                       | ''                 | '18%'          | 'Yes'                     | '*'                            | 'USD'                  | 'Reporting currency'           | 'No'                   |
		...
		| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                          | ''                          | ''                 | ''             | ''                        | ''                             | 'Attributes'           | ''                             | ''                     |
		| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'            | 'Partner'                   | 'Legal name'       | 'Partner term' | 'Currency'                | 'Multi currency movement type' | 'Deferred calculation' | ''                             | ''                     |
		| ''                                     | 'Receipt'     | '*'         | '1 883,56'             | 'Main Company'   | ''                          | 'Veritas'                   | 'Company Veritas ' | 'Standard'     | 'USD'                     | 'Reporting currency'           | 'No'                   | ''                             | ''                     |
		| ''                                     | 'Receipt'     | '*'         | '11 000'               | 'Main Company'   | ''                          | 'Veritas'                   | 'Company Veritas ' | 'Standard'     | 'TRY'                     | 'Local currency'               | 'No'                   | ''                             | ''                     |
		| ''                                     | 'Receipt'     | '*'         | '11 000'               | 'Main Company'   | ''                          | 'Veritas'                   | 'Company Veritas ' | 'Standard'     | 'TRY'                     | 'TRY'                          | 'No'                   | ''                             | ''                     |
		| ''                                     | 'Receipt'     | '*'         | '11 000'               | 'Main Company'   | ''                          | 'Veritas'                   | 'Company Veritas ' | 'Standard'     | 'TRY'                     | 'en description is empty'      | 'No'                   | ''                             | ''                     |
		| ''                                     | ''            | ''          | ''                     | ''               | ''                          | ''                          | ''                 | ''             | ''                        | ''                             | ''                     | ''                             | ''                     |
		| 'Register  "Stock balance"'            | ''            | ''          | ''                     | ''               | ''                          | ''                          | ''                 | ''             | ''                        | ''                             | ''                     | ''                             | ''                     |
		| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                          | ''                          | ''                 | ''             | ''                        | ''                             | ''                     | ''                             | ''                     |
		| ''                                     | ''            | ''          | 'Quantity'             | 'Store'          | 'Item key'                  | ''                          | ''                 | ''             | ''                        | ''                             | ''                     | ''                             | ''                     |
	...
	* Create Cash payment
		...
		* Filling in the tabular part
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | ''                     | ''                 | ''                             | 'Attributes'           |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Basis document'         | 'Partner'        | 'Legal name'                   | 'Partner term'         | 'Currency'         | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                     | 'Expense'     | '*'      | '1 883,56'             | 'Main Company'   | ''                       | 'Veritas'        | 'Company Veritas '             | 'Standard'             | 'USD'              | 'Reporting currency'           | 'No'                   |
			| ''                                     | 'Expense'     | '*'      | '11 000'               | 'Main Company'   | ''                       | 'Veritas'        | 'Company Veritas '             | 'Standard'             | 'TRY'              | 'Local currency'               | 'No'                   |
			| ''                                     | 'Expense'     | '*'      | '11 000'               | 'Main Company'   | ''                       | 'Veritas'        | 'Company Veritas '             | 'Standard'             | 'TRY'              | 'TRY'                          | 'No'                   |
			| ''                                     | 'Expense'     | '*'      | '11 000'               | 'Main Company'   | ''                       | 'Veritas'        | 'Company Veritas '             | 'Standard'             | 'TRY'              | 'en description is empty'      | 'No'                   |
			| ''                                     | ''            | ''       | ''                     | ''               | ''                       | ''               | ''                             | ''                     | ''                 | ''                             | ''                     |
			| 'Register  "Account balance"'          | ''            | ''       | ''                     | ''               | ''                       | ''               | ''                             | ''                     | ''                 | ''                             | ''                     |
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | 'Attributes'           | ''                 | ''                             | ''                     |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Account'                | 'Currency'       | 'Multi currency movement type' | 'Deferred calculation' | ''                 | ''                             | ''                     |
			| ''                                     | 'Expense'     | '*'      | '1 883,56'             | 'Main Company'   | 'Cash desk №2'           | 'USD'            | 'Reporting currency'           | 'No'                   | ''                 | ''                             | ''                     |
...
Scenario: _060007 check the offset of Purchase invoice advance with the type of settlement under standard contracts and check its movements
	...
	* Check Bank Payment movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Receipt'     | '*'      | '2 054,79'             | 'Main Company'   | 'Veritas'                | 'Company Veritas ' | 'USD'                          | '$$BankPayment060007$$' | 'Reporting currency'           | 'No'                   | ''         |
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''                 | ''                             | 'Attributes'            | ''                             | ''                     | ''         |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Account'                | 'Currency'         | 'Multi currency movement type' | 'Deferred calculation'  | ''                             | ''                     | ''         |
			| ''                                     | 'Expense'     | '*'      | '2 054,79'             | 'Main Company'   | 'Bank account, TRY'      | 'USD'              | 'Reporting currency'           | 'No'                    | ''                             | ''                     | ''         |
	...
	* Check movements PurchaseInvoice by register PartnerApTransactions
		...
		| ''                                     | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'                | ''                          | ''                 | ''                      | ''                             | ''                             | 'Attributes'           | ''                             | ''                     |
		| ''                                     | ''            | 'Quantity'  | 'Amount'               | 'Net amount'     | 'Company'                   | 'Purchase invoice'          | 'Currency'         | 'Item key'              | 'Row key'                      | 'Multi currency movement type' | 'Deferred calculation' | ''                             | ''                     |
		| ''                                     | '*'           | '20'        | '1 883,56'             | '1 596,24'       | 'Main Company'              | '$$PurchaseInvoice060007$$' | 'USD'              | 'L/Green'               | '*'                            | 'Reporting currency'           | 'No'                   | ''                             | ''                     |
		...
		| ''                                     | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'                | ''                          | ''                 | ''                      | ''                             | ''                             | ''                     | ''                             | 'Attributes'           |
		| ''                                     | ''            | 'Amount'    | 'Manual amount'        | 'Net amount'     | 'Document'                  | 'Tax'                       | 'Analytics'        | 'Tax rate'              | 'Include to total amount'      | 'Row key'                      | 'Currency'             | 'Multi currency movement type' | 'Deferred calculation' |
		| ''                                     | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$PurchaseInvoice060007$$' | 'VAT'                       | ''                 | '18%'                   | 'Yes'                          | '*'                            | 'USD'                  | 'Reporting currency'           | 'No'                   |
		...
		| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                          | ''                          | ''                 | ''                      | ''                             | 'Attributes'                   | ''                     | ''                             | ''                     |
		| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Partner'                   | 'Legal name'                | 'Currency'         | 'Payment document'      | 'Multi currency movement type' | 'Deferred calculation'         | ''                     | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '1 883,56'             | 'Main Company'   | 'Veritas'                   | 'Company Veritas '          | 'USD'              | '$$BankPayment060007$$' | 'Reporting currency'           | 'No'                           | ''                     | ''                             | ''                     |
	...
	* Create Bank payment
		...
		* Filling in the tabular part
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | 'Attributes'           | ''                 | ''                             | ''                     |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Account'                | 'Currency'       | 'Multi currency movement type' | 'Deferred calculation' | ''                 | ''                             | ''                     |
			| ''                                     | 'Expense'     | '*'      | '1 883,56'             | 'Main Company'   | 'Bank account, TRY'      | 'USD'            | 'Reporting currency'           | 'No'                   | ''                 | ''                             | ''                     |
