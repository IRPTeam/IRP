...
Scenario: _060202 create Sales invoice with Ar details by Partner terms and check its movements
	* Create Sales invoice
		...
		* Check Sales invoice movements
			...
			| ''                                           | 'Receipt'     | '*'         | '1 883,56'             | 'Main Company'   | ''                       | 'Partner Kalipso' | 'Company Kalipso'        | 'Partner Kalipso Customer' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                             | ''                     |
			...
			| ''                                           | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$SalesInvoice060202$$' | 'VAT'             | ''                       | '18%'                      | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | '*'           | '20'        | '1 883,56'             | '1 596,24'       | ''                       | 'Main Company'    | '$$SalesInvoice060202$$' | 'USD'                      | 'L/Green'                      | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			| ''                                           | '*'           | '20'        | '11 000'               | '9 322,03'       | ''                       | 'Main Company'    | '$$SalesInvoice060202$$' | 'TRY'                      | 'L/Green'                      | '*'                            | 'Local currency'               | ''                             | 'No'                   |
			| ''                                           | '*'           | '20'        | '11 000'               | '9 322,03'       | ''                       | 'Main Company'    | '$$SalesInvoice060202$$' | 'TRY'                      | 'L/Green'                      | '*'                            | 'TRY'                          | ''                             | 'No'                   |
			| ''                                           | '*'           | '20'        | '11 000'               | '9 322,03'       | ''                       | 'Main Company'    | '$$SalesInvoice060202$$' | 'TRY'                      | 'L/Green'                      | '*'                            | 'en description is empty'      | ''                             | 'No'                   |
			| ''                                           | ''            | ''          | ''                     | ''               | ''                       | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| 'Register  "Reconciliation statement"'       | ''            | ''          | ''                     | ''               | ''                       | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'        | 'Legal name'             | 'Currency'        | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| ''                                           | 'Receipt'     | '*'         | '11 000'               | 'Main Company'   | 'Company Kalipso'        | 'TRY'             | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| ''                                           | ''            | ''          | ''                     | ''               | ''                       | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
...
Scenario: _060203 create Cash receipt (partner term with Ar details by partner term) and check its movements
	...
	* Check movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | ''                     | ''                  | ''                             | 'Attributes'           |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Basis document'         | 'Partner'        | 'Legal name'                   | 'Partner term'         | 'Currency'          | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                     | 'Expense'     | '*'      | '1 883,56'             | 'Main Company'   | ''                       | 'Partner Kalipso'      | 'Company Kalipso'            | 'Partner Kalipso Customer'             | 'USD'               | 'Reporting currency'           | 'No'                   |
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''               | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Legal name'             | 'Currency'       | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | 'Expense'     | '*'      | '11 000'               | 'Main Company'   | 'Company Kalipso'      | 'TRY'            | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | ''            | ''       | ''                     | ''               | ''                       | ''               | ''                             | ''                     | ''                  | ''                             | ''                     |
...
Scenario: _060204 check the offset of the advance for Sales invoice with the type of settlement under Partner terms and check its movements
	...
	* Check Bank Receipt movements 
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''                | ''                             | ''                      | ''                             | ''                     | ''         |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Legal name'             | 'Currency'        | ''                             | ''                      | ''                             | ''                     | ''         |
			| ''                                     | 'Expense'     | '*'      | '12 000'               | 'Main Company'   | 'Company Kalipso'        | 'TRY'             | ''                             | ''                      | ''                             | ''                     | ''         |
			| ''                                     | ''            | ''       | ''                     | ''               | ''                       | ''                | ''                             | ''                      | ''                             | ''                     | ''         |
			...
			| ''                                     | 'Receipt'     | '*'      | '2 054,79'             | 'Main Company'   | 'Partner Kalipso'        | 'Company Kalipso' | 'USD'                          | '$$BankReceipt060204$$' | 'Reporting currency'           | 'No'                   | ''         |
	...
	* Check SalesInvoice movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                           | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'             | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                                           | ''            | 'Amount'    | 'Manual amount'        | 'Net amount'     | 'Document'               | 'Tax'             | 'Analytics'              | 'Tax rate'                 | 'Include to total amount'      | 'Row key'                      | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                           | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$SalesInvoice060204$$' | 'VAT'             | ''                       | '18%'                      | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
			...
			| ''                                           | 'Period'      | 'Resources' | ''                     | ''               | ''                       | 'Dimensions'      | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | 'Attributes'           |
			| ''                                           | ''            | 'Quantity'  | 'Amount'               | 'Net amount'     | 'Offers amount'          | 'Company'         | 'Sales invoice'          | 'Currency'                 | 'Item key'                     | 'Row key'                      | 'Multi currency movement type' | 'Serial lot number'            | 'Deferred calculation' |
			| ''                                           | '*'           | '20'        | '1 883,56'             | '1 596,24'       | ''                       | 'Main Company'    | '$$SalesInvoice060204$$' | 'USD'                      | 'L/Green'                      | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
			| ''                                           | '*'           | '20'        | '11 000'               | '9 322,03'       | ''                       | 'Main Company'    | '$$SalesInvoice060204$$' | 'TRY'                      | 'L/Green'                      | '*'                            | 'Local currency'               | ''                             | 'No'                   |
			| ''                                           | '*'           | '20'        | '11 000'               | '9 322,03'       | ''                       | 'Main Company'    | '$$SalesInvoice060204$$' | 'TRY'                      | 'L/Green'                      | '*'                            | 'TRY'                          | ''                             | 'No'                   |
			| ''                                           | '*'           | '20'        | '11 000'               | '9 322,03'       | ''                       | 'Main Company'    | '$$SalesInvoice060204$$' | 'TRY'                      | 'L/Green'                      | '*'                            | 'en description is empty'      | ''                             | 'No'                   |
			| ''                                           | ''            | ''          | ''                     | ''               | ''                       | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| 'Register  "Reconciliation statement"'       | ''            | ''          | ''                     | ''               | ''                       | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''                | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'        | 'Legal name'             | 'Currency'        | ''                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
			...
			| ''                                           | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                       | ''                | ''                       | ''                         | ''                             | 'Attributes'                   | ''                             | ''                             | ''                     |
			| ''                                           | ''            | ''          | 'Amount'               | 'Company'        | 'Partner'                | 'Legal name'      | 'Currency'               | 'Receipt document'         | 'Multi currency movement type' | 'Deferred calculation'         | ''                             | ''                             | ''                     |
			| ''                                           | 'Expense'     | '*'         | '1 883,56'             | 'Main Company'   | 'Partner Kalipso'        | 'Company Kalipso' | 'USD'                    | '$$BankReceipt060204$$'    | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
...
Scenario: _060205 create Purchase invoice with Ap details by Partner terms and check its movements
	...
	* Check Purchase Invoice movements 
		...
		| ''                                     | '*'           | '20'        | '1 883,56'             | '1 596,24'       | 'Main Company'              | '$$PurchaseInvoice060205$$' | 'USD'               | 'L/Green'                  | '*'                       | 'Reporting currency'           | 'No'                   | ''                             | ''                     |
		...
		| ''                                     | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'                | ''                          | ''                  | ''                         | ''                        | ''                             | ''                     | ''                             | 'Attributes'           |
		| ''                                     | ''            | 'Amount'    | 'Manual amount'        | 'Net amount'     | 'Document'                  | 'Tax'                       | 'Analytics'         | 'Tax rate'                 | 'Include to total amount' | 'Row key'                      | 'Currency'             | 'Multi currency movement type' | 'Deferred calculation' |
		| ''                                     | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$PurchaseInvoice060205$$' | 'VAT'                       | ''                  | '18%'                      | 'Yes'                     | '*'                            | 'USD'                  | 'Reporting currency'           | 'No'                   |
		...
		| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                          | ''                          | ''                  | ''                         | ''                        | ''                             | ''                     | ''                             | ''                     |
		| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Legal name'                | 'Currency'                  | ''                  | ''                         | ''                        | ''                             | ''                     | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '11 000'               | 'Main Company'   | 'Company Ferron BP'         | 'TRY'                       | ''                  | ''                         | ''                        | ''                             | ''                     | ''                             | ''                     |
		| ''                                     | ''            | ''          | ''                     | ''               | ''                          | ''                          | ''                  | ''                         | ''                        | ''                             | ''                     | ''                             | ''                     |
		...
		| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                          | ''                          | ''                  | ''                         | ''                        | ''                             | 'Attributes'           | ''                             | ''                     |
		| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Basis document'            | 'Partner'                   | 'Legal name'        | 'Partner term'             | 'Currency'                | 'Multi currency movement type' | 'Deferred calculation' | ''                             | ''                     |
		| ''                                     | 'Receipt'     | '*'         | '1 883,56'             | 'Main Company'   | ''                          | 'Partner Ferron 1'          | 'Company Ferron BP' | 'Vendor Ferron 1' | 'USD'                     | 'Reporting currency'           | 'No'                   | ''                             | ''                     |
	...
	* Create Cash payment
		...
		* Filling in the tabular part
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''                 | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Legal name'             | 'Currency'         | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | 'Receipt'     | '*'      | '11 000'               | 'Main Company'   | 'Company Ferron BP'      | 'TRY'              | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | ''            | ''       | ''                     | ''               | ''                       | ''                 | ''                             | ''                     | ''                  | ''                             | ''                     |
			| 'Register  "Partner AP transactions"'  | ''            | ''       | ''                     | ''               | ''                       | ''                 | ''                             | ''                     | ''                  | ''                             | ''                     |
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''                 | ''                             | ''                     | ''                  | ''                             | 'Attributes'           |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Basis document'         | 'Partner'          | 'Legal name'                   | 'Partner term'         | 'Currency'          | 'Multi currency movement type' | 'Deferred calculation' |
			| ''                                     | 'Expense'     | '*'      | '1 883,56'             | 'Main Company'   | ''                       | 'Partner Ferron 1' | 'Company Ferron BP'            | 'Vendor Ferron 1'      | 'USD'               | 'Reporting currency'           | 'No'                   |
...
Scenario: _060207 check the offset of the advance for Purchase invoice with the type of settlement under Partner terms and check its movements
	...
	* Check Bank Payment movements
		...
		And "ResultTable" spreadsheet document contains lines:
			...
			| ''                                     | 'Record type' | 'Period' | 'Resources'            | 'Dimensions'     | ''                       | ''                 | ''                             | ''                      | ''                             | ''                     | ''         |
			| ''                                     | ''            | ''       | 'Amount'               | 'Company'        | 'Legal name'             | 'Currency'         | ''                             | ''                      | ''                             | ''                     | ''         |
			| ''                                     | 'Receipt'     | '*'      | '12 000'               | 'Main Company'   | 'Company Ferron BP'       | 'TRY'              | ''                             | ''                      | ''                             | ''                     | ''         |
			| ''                                     | ''            | ''       | ''                     | ''               | ''                       | ''                 | ''                             | ''                      | ''                             | ''                     | ''         |
			...
			| ''                                     | 'Receipt'     | '*'      | '2 054,79'             | 'Main Company'   | 'Partner Ferron 1'                | 'Company Ferron BP' | 'USD'                          | '$$BankPayment060007$$' | 'Reporting currency'           | 'No'                   | ''         |
	...
	* Check movements PurchaseInvoice by register PartnerApTransactions
		...
		| ''                                     | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'                | ''                          | ''                  | ''                         | ''                             | ''                             | 'Attributes'           | ''                             | ''                     |
		| ''                                     | ''            | 'Quantity'  | 'Amount'               | 'Net amount'     | 'Company'                   | 'Purchase invoice'          | 'Currency'          | 'Item key'                 | 'Row key'                      | 'Multi currency movement type' | 'Deferred calculation' | ''                             | ''                     |
		| ''                                     | '*'           | '20'        | '1 883,56'             | '1 596,24'       | 'Main Company'              | '$$PurchaseInvoice060207$$' | 'USD'               | 'L/Green'                  | '*'                            | 'Reporting currency'           | 'No'                   | ''                             | ''                     |
		...
		| ''                                     | 'Period'      | 'Resources' | ''                     | ''               | 'Dimensions'                | ''                          | ''                  | ''                         | ''                             | ''                             | ''                     | ''                             | 'Attributes'           |
		| ''                                     | ''            | 'Amount'    | 'Manual amount'        | 'Net amount'     | 'Document'                  | 'Tax'                       | 'Analytics'         | 'Tax rate'                 | 'Include to total amount'      | 'Row key'                      | 'Currency'             | 'Multi currency movement type' | 'Deferred calculation' |
		| ''                                     | '*'           | '287,32'    | '287,32'               | '1 596,24'       | '$$PurchaseInvoice060207$$' | 'VAT'                       | ''                  | '18%'                      | 'Yes'                          | '*'                            | 'USD'                  | 'Reporting currency'           | 'No'                   |
		...
		| ''                                     | 'Record type' | 'Period'    | 'Resources'            | 'Dimensions'     | ''                          | ''                          | ''                  | ''                         | ''                             | 'Attributes'                   | ''                     | ''                             | ''                     |
		| ''                                     | ''            | ''          | 'Amount'               | 'Company'        | 'Partner'                   | 'Legal name'                | 'Currency'          | 'Payment document'         | 'Multi currency movement type' | 'Deferred calculation'         | ''                     | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '1 883,56'             | 'Main Company'   | 'Partner Ferron 1'          | 'Company Ferron BP'         | 'USD'               | '$$BankPayment060007$$'    | 'Reporting currency'           | 'No'                           | ''                     | ''                             | ''                     |
