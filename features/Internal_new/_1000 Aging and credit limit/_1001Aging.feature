	...
	* Advance after invoice (Bank receipt without basis document)
		...
		* Check movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                     | 'Record type' | 'Period'                     | 'Resources'            | 'Dimensions'     | ''                       | ''                                 | ''                             | ''                                 | ''                             | 'Attributes'                   | ''                     |
				| ''                                     | ''            | ''                           | 'Amount'               | 'Company'        | 'Partner'                | 'Legal name'                       | 'Currency'                     | 'Receipt document'                 | 'Multi currency movement type' | 'Deferred calculation'         | ''                     |
				| ''                                     | 'Receipt'     | '$$DateCashReceipt1000050$$' | '8,56'                 | 'Main Company'   | 'Kalipso'                | 'Company Kalipso'                  | 'USD'                          | '$$CashReceipt1000050$$9'          | 'Reporting currency'           | 'No'                           | ''                     |
				| ''                                     | 'Receipt'     | '$$DateCashReceipt1000050$$' | '50'                   | 'Main Company'   | 'Kalipso'                | 'Company Kalipso'                  | 'TRY'                          | '$$CashReceipt1000050$$9'          | 'Local currency'               | 'No'                           | ''                     |
				| ''                                     | 'Receipt'     | '$$DateCashReceipt1000050$$' | '50'                   | 'Main Company'   | 'Kalipso'                | 'Company Kalipso'                  | 'TRY'                          | '$$CashReceipt1000050$$9'          | 'en description is empty'      | 'No'                           | ''                     |
				| ''                                     | 'Expense'     | '$$DateCashReceipt1000050$$' | '8,56'                 | 'Main Company'   | 'Kalipso'                | 'Company Kalipso'                  | 'USD'                          | '$$CashReceipt1000050$$9'          | 'Reporting currency'           | 'No'                           | ''                     |
				| ''                                     | 'Expense'     | '$$DateCashReceipt1000050$$' | '50'                   | 'Main Company'   | 'Kalipso'                | 'Company Kalipso'                  | 'TRY'                          | '$$CashReceipt1000050$$9'          | 'Local currency'               | 'No'                           | ''                     |
				| ''                                     | 'Expense'     | '$$DateCashReceipt1000050$$' | '50'                   | 'Main Company'   | 'Kalipso'                | 'Company Kalipso'                  | 'TRY'                          | '$$CashReceipt1000050$$9'          | 'en description is empty'      | 'No'                           | ''                     |
				| ''                                     | ''            | ''                           | ''                     | ''               | ''                       | ''                                 | ''                             | ''                                 | ''                             | ''                             | ''                     |
				| 'Register  "Account balance"'          | ''            | ''                           | ''                     | ''               | ''                       | ''                                 | ''                             | ''                                 | ''                             | ''                             | ''                     |
				| ''                                     | 'Record type' | 'Period'                     | 'Resources'            | 'Dimensions'     | ''                       | ''                                 | ''                             | 'Attributes'                       | ''                             | ''                             | ''                     |
				| ''                                     | ''            | ''                           | 'Amount'               | 'Company'        | 'Account'                | 'Currency'                         | 'Multi currency movement type' | 'Deferred calculation'             | ''                             | ''                             | ''                     |
	...
	* Create Sales invoice
		...
		* Check movements
			...
			And "ResultTable" spreadsheet document contains lines:
				...
				| ''                                           | 'Period'                      | 'Resources'                   | ''                     | ''               | 'Dimensions'              | ''                                 | ''                        | ''                                 | ''                             | ''                                     | ''                             | ''                             | 'Attributes'           |
				| ''                                           | ''                            | 'Amount'                      | 'Manual amount'        | 'Net amount'     | 'Document'                | 'Tax'                              | 'Analytics'               | 'Tax rate'                         | 'Include to total amount'      | 'Row key'                              | 'Currency'                     | 'Multi currency movement type' | 'Deferred calculation' |
				| ''                                           | '$$DateSalesInvoice0240165$$' | '14,37'                       | '14,37'                | '79,81'          | '$$SalesInvoice0240165$$' | 'VAT'                              | ''                        | '18%'                              | 'Yes'                          | '8fbeea08-dc46-4410-abda-e3f6e3f15e4d' | 'USD'                          | 'Reporting currency'           | 'No'                   |
				| ''                                           | '$$DateSalesInvoice0240165$$' | '83,9'                        | '83,9'                 | '466,1'          | '$$SalesInvoice0240165$$' | 'VAT'                              | ''                        | '18%'                              | 'Yes'                          | '8fbeea08-dc46-4410-abda-e3f6e3f15e4d' | 'TRY'                          | 'Local currency'               | 'No'                   |
				| ''                                           | '$$DateSalesInvoice0240165$$' | '83,9'                        | '83,9'                 | '466,1'          | '$$SalesInvoice0240165$$' | 'VAT'                              | ''                        | '18%'                              | 'Yes'                          | '8fbeea08-dc46-4410-abda-e3f6e3f15e4d' | 'TRY'                          | 'TRY'                          | 'No'                   |
				| ''                                           | '$$DateSalesInvoice0240165$$' | '83,9'                        | '83,9'                 | '466,1'          | '$$SalesInvoice0240165$$' | 'VAT'                              | ''                        | '18%'                              | 'Yes'                          | '8fbeea08-dc46-4410-abda-e3f6e3f15e4d' | 'TRY'                          | 'en description is empty'      | 'No'                   |
				| ''                                           | ''                            | ''                            | ''                     | ''               | ''                        | ''                                 | ''                        | ''                                 | ''                             | ''                                     | ''                             | ''                             | ''                     |
				| 'Register  "Accounts statement"'             | ''                            | ''                            | ''                     | ''               | ''                        | ''                                 | ''                        | ''                                 | ''                             | ''                                     | ''                             | ''                             | ''                     |
				| ''                                           | 'Record type'                 | 'Period'                      | 'Resources'            | ''               | ''                        | ''                                 | 'Dimensions'              | ''                                 | ''                             | ''                                     | ''                             | ''                             | ''                     |
				| ''                                           | ''                            | ''                            | 'Advance to suppliers' | 'Transaction AP' | 'Advance from customers'  | 'Transaction AR'                   | 'Company'                 | 'Partner'                          | 'Legal name'                   | 'Basis document'                       | 'Currency'                     | ''                             | ''                     |
