...
Scenario: _090408 create one Sales order - several Shipment confirmation - one Sales invoice
	...
	* Create Sales invoice for 3 Shipment Confirmation
		...
		| ''                                     | 'Receipt'     | '*'         | '5 719,18'             | 'Main Company'               | '$$SalesInvoice0904083$$'         | 'Ferron BP'      | 'Company Ferron BP'       | 'Basic Partner terms, TRY' | 'USD'                          | 'Reporting currency'           | 'No'                           | ''                             | ''                     |
		...
		| ''                                     | '*'           | '17,63'     | '17,63'                | '1 491,54'                   | '$$SalesInvoice0904083$$'         | 'SalesTax'       | ''                        | '1%'                       | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
		| ''                                     | '*'           | '18,65'     | '18,65'                | '1 577,59'                   | '$$SalesInvoice0904083$$'         | 'SalesTax'       | ''                        | '1%'                       | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
		| ''                                     | '*'           | '20,34'     | '20,34'                | '1 721,01'                   | '$$SalesInvoice0904083$$'         | 'SalesTax'       | ''                        | '1%'                       | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
		...
		| ''                                     | '*'           | '271,65'    | '271,65'               | '1 491,54'                   | '$$SalesInvoice0904083$$'         | 'VAT'            | ''                        | '18%'                      | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
		| ''                                     | '*'           | '287,32'    | '287,32'               | '1 577,59'                   | '$$SalesInvoice0904083$$'         | 'VAT'            | ''                        | '18%'                      | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
		| ''                                     | '*'           | '313,44'    | '313,44'               | '1 721,01'                   | '$$SalesInvoice0904083$$'         | 'VAT'            | ''                        | '18%'                      | 'Yes'                          | '*'                            | 'USD'                          | 'Reporting currency'           | 'No'                   |
		...
		| ''                                     | '*'           | '20'        | '1 780,82'             | '1 491,54'                   | ''                                | 'Main Company'   | '$$SalesInvoice0904083$$' | 'USD'                      | 'M/White'                      | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
		| ''                                     | '*'           | '20'        | '1 883,56'             | '1 577,59'                   | ''                                | 'Main Company'   | '$$SalesInvoice0904083$$' | 'USD'                      | 'L/Green'                      | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
		...
		| ''                                     | '*'           | '30'        | '2 054,79'             | '1 721,01'                   | ''                                | 'Main Company'   | '$$SalesInvoice0904083$$' | 'USD'                      | '36/Yellow'                    | '*'                            | 'Reporting currency'           | ''                             | 'No'                   |
		...
		| ''                                     | 'Expense'     | '*'         | '5'                    | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904081$$' | 'M/White'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '5'                    | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904081$$' | 'L/Green'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '7'                    | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904083$$' | 'M/White'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '7'                    | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904083$$' | 'L/Green'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '8'                    | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904082$$' | 'M/White'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '8'                    | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904082$$' | 'L/Green'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '8'                    | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904083$$' | '36/Yellow'      | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '10'                   | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904081$$' | '36/Yellow'      | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '12'                   | '$$NumberSalesOrder090408$$' | '$$ShipmentConfirmation0904082$$' | '36/Yellow'      | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | ''            | ''          | ''                     | ''                           | ''                                | ''               | ''                        | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		...
		| ''                                     | '*'           | '1 491,54'  | 'Main Company'         | ''                           | ''                                | 'M/White'        | 'USD'                     | ''                         | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
		| ''                                     | '*'           | '1 577,59'  | 'Main Company'         | ''                           | ''                                | 'L/Green'        | 'USD'                     | ''                         | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
		| ''                                     | '*'           | '1 721,01'  | 'Main Company'         | ''                           | ''                                | '36/Yellow'      | 'USD'                     | ''                         | 'Reporting currency'           | 'No'                           | ''                             | ''                             | ''                     |
		...
		| ''                                     | 'Expense'     | '*'         | '20'                   | 'Store 02'                   | '$$NumberSalesOrder090408$$'      | 'M/White'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '20'                   | 'Store 02'                   | '$$NumberSalesOrder090408$$'      | 'L/Green'        | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |
		| ''                                     | 'Expense'     | '*'         | '30'                   | 'Store 02'                   | '$$NumberSalesOrder090408$$'      | '36/Yellow'      | '*'                       | ''                         | ''                             | ''                             | ''                             | ''                             | ''                     |		
		And I close all client application windows