...
Сценарий: создаю документ Item Flow
	И я открываю навигационную ссылку 'e1cib/list/Document.ItemsFlow'
	И я нажимаю на кнопку с именем 'FormCreate'
	И в поле 'Number' я ввожу текст '1'
	Тогда открылось окно '1C:Enterprise'
	И я нажимаю на кнопку 'Yes'
	И в поле 'Date' я ввожу текст '27.11.2018 12:02:32'
	И я нажимаю на кнопку 'Post and close'
	И я жду закрытия окна 'Items flow (create)' в течение 20 секунд
