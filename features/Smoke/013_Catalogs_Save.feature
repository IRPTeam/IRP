...
Scenario: Save item Catalogs "Incoming messages (IAS)" (гкс_ВходящиеСообщенияRMQ)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ВходящиеСообщенияRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ВходящиеСообщенияRMQ" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ВходящиеСообщенияRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ВходящиеСообщенияRMQ" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ВходящиеСообщенияRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ВходящиеСообщенияRMQ" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ВходящиеСообщенияRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ВходящиеСообщенияRMQ" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ВходящиеСообщенияRMQ" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ВходящиеСообщенияRMQ" exception

Scenario: Save item Catalogs "Tasks for processing the incoming message queue (IAS)" (гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ЗаданияОбработкиОчередиВходящихСообщенийRMQ" exception

Scenario: Save item Catalogs "XDTO data models (IAS)" (гкс_МоделиДанныхXDTO)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_МоделиДанныхXDTO" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_МоделиДанныхXDTO" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_МоделиДанныхXDTO" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_МоделиДанныхXDTO" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_МоделиДанныхXDTO" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_МоделиДанныхXDTO" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_МоделиДанныхXDTO" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_МоделиДанныхXDTO" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_МоделиДанныхXDTO" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_МоделиДанныхXDTO" exception

Scenario: Save item Catalogs "Queue for deferred formation of outgoing messages (IAS)" (гкс_ОчередьОтложенногоФормированияИсходящихСообщений)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ОчередьОтложенногоФормированияИсходящихСообщений" exception

Scenario: Save item Catalogs "RMQ data recipients (IAS)" (гкс_ПолучателиДанныхRMQ)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ПолучателиДанныхRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ПолучателиДанныхRMQ" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ПолучателиДанныхRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ПолучателиДанныхRMQ" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ПолучателиДанныхRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ПолучателиДанныхRMQ" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ПолучателиДанныхRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ПолучателиДанныхRMQ" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ПолучателиДанныхRMQ" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ПолучателиДанныхRMQ" exception

Scenario: Save item Catalogs "Event streams (IAS)" (гкс_ПотокиСобытий)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ПотокиСобытий" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ПотокиСобытий" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ПотокиСобытий" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ПотокиСобытий" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ПотокиСобытий" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ПотокиСобытий" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ПотокиСобытий" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ПотокиСобытий" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ПотокиСобытий" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ПотокиСобытий" exception

Scenario: Save item Catalogs "Custom integration settings (IAS)" (гкс_ПроизвольныеНастройкиИнтеграций)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ПроизвольныеНастройкиИнтеграций" exception

Scenario: Save item Catalogs "Data exchange issue types (IAS)" (гкс_ТипыПроблемОбменаДанными)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ТипыПроблемОбменаДанными" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ТипыПроблемОбменаДанными" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ТипыПроблемОбменаДанными" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ТипыПроблемОбменаДанными" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ТипыПроблемОбменаДанными" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ТипыПроблемОбменаДанными" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ТипыПроблемОбменаДанными" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ТипыПроблемОбменаДанными" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ТипыПроблемОбменаДанными" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ТипыПроблемОбменаДанными" exception

Scenario: Save item Catalogs "RMQ exchange points (IAS)" (гкс_ТочкиОбменаRMQ)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ТочкиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ТочкиОбменаRMQ" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ТочкиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ТочкиОбменаRMQ" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ТочкиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ТочкиОбменаRMQ" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ТочкиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ТочкиОбменаRMQ" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ТочкиОбменаRMQ" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ТочкиОбменаRMQ" exception

Scenario: Save item Catalogs "Exchange participants (IAS)" (гкс_УчастникиОбменаRMQ)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_УчастникиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_УчастникиОбменаRMQ" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_УчастникиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_УчастникиОбменаRMQ" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_УчастникиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_УчастникиОбменаRMQ" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_УчастникиОбменаRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_УчастникиОбменаRMQ" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_УчастникиОбменаRMQ" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_УчастникиОбменаRMQ" exception

Scenario: Save item Catalogs "Exchange message formats (IAS)" (гкс_ФорматыОбменаИАС)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs гкс_ФорматыОбменаИАС" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs гкс_ФорматыОбменаИАС" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ФорматыОбменаИАС" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs гкс_ФорматыОбменаИАС" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs гкс_ФорматыОбменаИАС" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs гкс_ФорматыОбменаИАС" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs гкс_ФорматыОбменаИАС" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs гкс_ФорматыОбменаИАС" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs гкс_ФорматыОбменаИАС" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs гкс_ФорматыОбменаИАС" exception

Scenario: Save item Catalogs "Message sending tasks (IAS)" (ЗаданияОтправкиИсходящихСообщений)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs ЗаданияОтправкиИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs ЗаданияОтправкиИсходящихСообщений" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs ЗаданияОтправкиИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs ЗаданияОтправкиИсходящихСообщений" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs ЗаданияОтправкиИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs ЗаданияОтправкиИсходящихСообщений" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs ЗаданияОтправкиИсходящихСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs ЗаданияОтправкиИсходящихСообщений" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs ЗаданияОтправкиИсходящихСообщений" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs ЗаданияОтправкиИсходящихСообщений" exception

Scenario: Save item Catalogs "Outgoing messages (IAS)" (ИсходящиеСообщения)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs ИсходящиеСообщения" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs ИсходящиеСообщения" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs ИсходящиеСообщения" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs ИсходящиеСообщения" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs ИсходящиеСообщения" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs ИсходящиеСообщения" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs ИсходящиеСообщения" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs ИсходящиеСообщения" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs ИсходящиеСообщения" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs ИсходящиеСообщения" exception

Scenario: Save item Catalogs "RMQ event handlers (IAS)" (ОбработчикиСобытийRMQ)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs ОбработчикиСобытийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs ОбработчикиСобытийRMQ" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs ОбработчикиСобытийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs ОбработчикиСобытийRMQ" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs ОбработчикиСобытийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs ОбработчикиСобытийRMQ" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs ОбработчикиСобытийRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs ОбработчикиСобытийRMQ" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs ОбработчикиСобытийRMQ" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs ОбработчикиСобытийRMQ" exception

Scenario: Save item Catalogs "Subscriptions to message queues (IAS)" (ПодпискиНаОчередиСообщений)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs ПодпискиНаОчередиСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs ПодпискиНаОчередиСообщений" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs ПодпискиНаОчередиСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs ПодпискиНаОчередиСообщений" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs ПодпискиНаОчередиСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs ПодпискиНаОчередиСообщений" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs ПодпискиНаОчередиСообщений" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs ПодпискиНаОчередиСообщений" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs ПодпискиНаОчередиСообщений" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs ПодпискиНаОчередиСообщений" exception

Scenario: Save item Catalogs "RMQ queue servers (IAS)" (СерверыОчередейRMQ)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs СерверыОчередейRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs СерверыОчередейRMQ" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs СерверыОчередейRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs СерверыОчередейRMQ" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs СерверыОчередейRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs СерверыОчередейRMQ" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs СерверыОчередейRMQ" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs СерверыОчередейRMQ" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs СерверыОчередейRMQ" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs СерверыОчередейRMQ" exception

Scenario: Save item Catalogs "Simple Catalog" (Тесты_СправочникПростой)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs Тесты_СправочникПростой" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs Тесты_СправочникПростой" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs Тесты_СправочникПростой" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs Тесты_СправочникПростой" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs Тесты_СправочникПростой" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs Тесты_СправочникПростой" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs Тесты_СправочникПростой" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs Тесты_СправочникПростой" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs Тесты_СправочникПростой" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs Тесты_СправочникПростой" exception

Scenario: Save item group Catalogs "Mock service data" (Unit_MockServiceData)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item group Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item group Catalogs Unit_MockServiceData" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item group Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item group Catalogs Unit_MockServiceData" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item group Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemgroup Catalogs Unit_MockServiceData" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item group Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemgroup Catalogs Unit_MockServiceData" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element group Catalogs Unit_MockServiceData" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element group Catalogs Unit_MockServiceData" exception

Scenario: Save item Catalogs "Mock service data" (Unit_MockServiceData)
	...
	If 'ValueIsFilled($НавигационнаяСсылка$)' then
		...
		* Save an existing item
			...
			If 'FormWrite' attribute is present on the form Then
				And I click the button named 'FormWrite'
				If the warning is displayed then
					Then I raise "Failed to save an existing item Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to save an existing item Catalogs Unit_MockServiceData" exception
		...
		* Reread an existing item
			...
			If 'FormReread' attribute is present on the form Then
				And I click the button named 'FormReread'
				If the warning is displayed then
					Then I raise "Failed to Reread an existing item Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Reread an existing item Catalogs Unit_MockServiceData" exception
		...
		* Mark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Mark to delete an existing item Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Mark to delete an existing itemCatalogs Unit_MockServiceData" exception
		...
		* Unmark to delete an existing item
			...
			If 'FormSetDeletionMark' attribute is present on the form Then
				...
				If '1C:Enterprise' window is opened then
					And I click the button named 'Button0'
				If the warning is displayed then
					Then I raise "Failed to Unmark to delete an existing item Catalogs Unit_MockServiceData" exception
				If current form name is "ErrorWindow" Then
					Then I raise "Failed to Unmark to delete an existing itemCatalogs Unit_MockServiceData" exception
		...
		* Save and close an existing element
			...
			If 'FormWriteAndClose' attribute is present on the form Then
				And I click the button named 'FormWriteAndClose'
				If the warning is displayed then
					Then I raise "Failed to Save and close an existing element Catalogs Unit_MockServiceData" exception
				// If current form name is "ErrorWindow" Then
				// 	Then I raise "Failed to Save and close an existing element Catalogs Unit_MockServiceData" exception
