...
Сценарий: _005122 создание номенклатуры для короба Paper box 790х390
# На короб создается отдельный вид номенклатуры Box со своей структурой доп реквизитов и item key
		# И Я устанавливаю ссылку 'https://bilist.atlassian.net/browse/IRP-261' с именем 'IRP-261'
	* Открытие формы создания ревизитов и доп свойств
		И я открываю навигационную ссылку "e1cib/list/ChartOfCharacteristicTypes.AddAttributeAndProperty"
		И я нажимаю на кнопку с именем 'FormCreate'
	* Создание ревизитов: length, width, height
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст 'length'
		И в поле 'TR' я ввожу текст 'length'
		И я нажимаю на кнопку 'Ok'
		И в поле 'Unique ID' я ввожу текст 'length'
		И я нажимаю на кнопку 'Save and close'
		И я нажимаю на кнопку с именем 'FormCreate'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст 'width'
		И в поле 'TR' я ввожу текст 'width'
		И я нажимаю на кнопку 'Ok'
		И в поле 'Unique ID' я ввожу текст 'width'
		И я нажимаю на кнопку 'Save and close'
		И я нажимаю на кнопку с именем 'FormCreate'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст 'height'
		И в поле 'TR' я ввожу текст 'height'
		И я нажимаю на кнопку 'Ok'
		И в поле 'Unique ID' я ввожу текст 'height'
		И я нажимаю на кнопку 'Save and close'
	* Присвоение созданных доп реквизиты Box
		И я открываю навигационную ссылку "e1cib/list/Catalog.AddAttributeAndPropertySets"
		И в таблице "List" я перехожу к строке:
			| Predefined data item name |
			| Catalog_Boxes             |
		...
		И в таблице "Attributes" я завершаю редактирование строки
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст 'Boxes'
		И в поле 'TR' я ввожу текст 'Boxes TR'
		И я нажимаю на кнопку 'Ok'
		И я нажимаю на кнопку 'Save and close'
		И Пауза 5
	* Создание короба Paper box 790х390
		И я открываю навигационную ссылку "e1cib/list/Catalog.Boxes"
		И я нажимаю на кнопку с именем 'FormCreate'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст 'Paper box'
		И в поле 'TR' я ввожу текст 'Paper box TR'
		И я нажимаю на кнопку 'Ok'
		И я нажимаю кнопку выбора у поля "Item type"
		И в таблице "List" я перехожу к строке:
			| Description |
		...
		И в таблице "List" я выбираю текущую строку
		И я нажимаю кнопку выбора у поля "length"
		И я нажимаю на кнопку с именем 'FormCreate'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст '790'
		И в поле 'TR' я ввожу текст '790'
		И я нажимаю на кнопку 'Ok'
		И я нажимаю на кнопку 'Save and close'
		И я нажимаю на кнопку с именем 'FormChoose'
		И я нажимаю кнопку выбора у поля "width"
		И я нажимаю на кнопку с именем 'FormCreate'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст '390'
		И в поле 'TR' я ввожу текст '390'
		И я нажимаю на кнопку 'Ok'
		И я нажимаю на кнопку 'Save and close'
		И я нажимаю на кнопку с именем 'FormChoose'
		И я нажимаю кнопку выбора у поля "height"
		И я нажимаю на кнопку с именем 'FormCreate'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст '430'
		И в поле 'TR' я ввожу текст '430'
		И я нажимаю на кнопку 'Ok'
		И я нажимаю на кнопку 'Save and close'
		И я нажимаю на кнопку с именем 'FormChoose'
		И я нажимаю на кнопку 'Save and close'
		И Пауза 5
	* Создание структуры item key для Box
		И я открываю навигационную ссылку "e1cib/list/Catalog.ItemTypes"
		И в таблице "List" я перехожу к строке:
			| Description |
			| Box         |
		...
		И в таблице "AvailableAttributes" я нажимаю кнопку выбора у реквизита "Attribute"
		И я нажимаю на кнопку с именем 'FormCreate'
		И в поле 'Unique ID' я ввожу текст 'invoice'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст 'Inv. number'
		И в поле 'TR' я ввожу текст 'Inv. number tr'
		И я нажимаю на кнопку 'Ok'
		...
		И в таблице "AvailableAttributes" я нажимаю кнопку выбора у реквизита "Attribute"
		И я нажимаю на кнопку с именем 'FormCreate'
		И в поле 'Unique ID' я ввожу текст 'barcode'
		И я нажимаю на кнопку открытия поля с именем "Description_en"
		И в поле 'ENG' я ввожу текст 'barcode'
		И в поле 'TR' я ввожу текст 'barcode tr'
		И я нажимаю на кнопку 'Ok'
		И я нажимаю кнопку выбора у поля "Value type"
		Тогда открылось окно 'Edit data type'
		И в таблице "" я перехожу к строке:
		...
		И я нажимаю на кнопку с именем 'FormChoose'
		И я нажимаю на кнопку 'Save and close'
		И я выбираю тип значения Barcode String
		И я выбираю тип значения invoice String