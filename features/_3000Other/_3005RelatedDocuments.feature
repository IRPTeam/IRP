...
# Сценарий: проверка подключения к документу CreditDebitNotes системы структуры подчиненности
# 	И я открываю навигационную ссылку "e1cib/list/Document.CreditDebitNotes"

Сценарий: _300517 проверка подключения к документу Boxing системы структуры подчиненности
...
Сценарий: _300518 проверка подключения к документу Unboxing системы структуры подчиненности
