...
Сценарий: _300602 проверка сохранения элемента справочника только с английским наименованием и его отображение в списке
	* Подготовка
...
Сценарий: _300604 ввод по строке наименований на турецком в Sales order
	...
	И я проверяю поиск наименований на турецком в форме заказа
		И я нажимаю на кнопку с именем 'FormCreate'
		И в поле "Partner" я ввожу текст "tr"
