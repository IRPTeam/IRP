...
@tree
@Positive
Функционал: проверка установки паролей пользователей
...
Сценарий: _351001 проверка установки пароля пользователю из режима предприятия
    * Выбор пользователя
...
Сценарий: _351002 проверка генерирования пароля пользователя из режима предприятия
   * Выбор пользователя
        И я открываю навигационную ссылку 'e1cib/list/Catalog.Users'
        И в таблице "List" я перехожу к строке:
            | 'Description'                 |
